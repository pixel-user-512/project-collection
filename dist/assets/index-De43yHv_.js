 ...
 * Subject to the terms at https://gsap.com/standard-license
 * @author: Jack Doyle, jack@greensock.com
*/var Cn,lu,Mi,Rs,Ps,xa,Dx,so,va,Lx,qr,Ji,Ix,Ux=function(){return Cn||typeof window<"u"&&(Cn=window.gsap)&&Cn.registerPlugin&&Cn},Fx=1,aa=[],_t=[],wr=[],Ml=Date.now,th=function(e,t){return t},LM=function(){var e=va.core,t=e.bridge||{},i=e._scrollers,r=e._proxies;i.push.apply(i,_t),r.push.apply(r,wr),_t=i,wr=r,th=function(o,a){return t[o](a)}},Us=function(e,t){return~wr.indexOf(e)&&wr[wr.indexOf(e)+1][t]},wl=function(e){return!!~Lx.indexOf(e)},qn=function(e,t,i,r,s){return e.addEventListener(t,i,{passive:r!==!1,capture:!!s})},jn=function(e,t,i,r){return e.removeEventListener(t,i,!!r)},xc="scrollLeft",vc="scrollTop",nh=function(){return qr&&qr.isPressed||_t.cache++},zu=function(e,t){var i=function r(s){if(s||s===0){Fx&&(Mi.history.scrollRestoration="manual");var o=qr&&qr.isPressed;s=r.v=Math.round(s)||(qr&&qr.iOS?1:0),e(s),r.cacheID=_t.cache,o&&th("ss",s)}else(t||_t.cache!==r.cacheID||th("ref"))&&(r.cacheID=_t.cache,r.v=e());return r.v+r.offset};return i.offset=0,e&&i},ii={s:xc,p:"left",p2:"Left",os:"right",os2:"Right",d:"width",d2:"Width",a:"x",sc:zu(function(n){return arguments.length?Mi.scrollTo(n,pn.sc()):Mi.pageXOffset||Rs[xc]||Ps[xc]||xa[xc]||0})},pn={s:vc,p:"top",p2:"Top",os:"bottom",os2:"Bottom",d:"height",d2:"Height",a:"y",op:ii,sc:zu(function(n){return arguments.length?Mi.scrollTo(ii.sc(),n):Mi.pageYOffset||Rs[vc]||Ps[vc]||xa[vc]||0})},ai=function(e,t){return(t&&t._ctx&&t._ctx.selector||Cn.utils.toArray)(e)[0]||(typeof e=="string"&&Cn.config().nullTargetWarn!==!1?console.warn("Element not found:",e):null)},IM=function(e,t){for(var i=t.length;i--;)if(t[i]===e||t[i].contains(e))return!0;return!1},zs=function(e,t){var i=t.s,r=t.sc;wl(e)&&(e=Rs.scrollingElement||Ps);var s=_t.indexOf(e),o=r===pn.sc?1:2;!~s&&(s=_t.push(e)-1),_t[s+o]||qn(e,"scroll",nh);var a=_t[s+o],l=a||(_t[s+o]=zu(Us(e,i),!0)||(wl(e)?r:zu(function(c){return arguments.length?e[i]=c:e[i]})));return l.target=e,a||(l.smooth=Cn.getProperty(e,"scrollBehavior")==="smooth"),l},ih=function(e,t,i){var r=e,s=e,o=Ml(),a=o,l=t||50,c=Math.max(500,l*3),u=function(g,_){var p=Ml();_||p-o>l?(s=r,r=g,a=o,o=p):i?r+=g:r=s+(g-s)/(p-a)*(o-a)},d=function(){s=r=i?0:r,a=o=0},f=function(g){var _=a,p=s,m=Ml();return(g||g===0)&&g!==r&&u(g),o===a||m-a>c?0:(r+(i?p:-p))/((i?m:o)-_)*1e3};return{update:u,reset:d,getVelocity:f}},Xa=function(e,t){return t&&!e._gsapAllow&&e.cancelable!==!1&&e.preventDefault(),e.changedTouches?e.changedTouches[0]:e},sm=function(e){var t=Math.max.apply(Math,e),i=Math.min.apply(Math,e);return Math.abs(t)>=Math.abs(i)?t:i},Nx=function(){va=Cn.core.globals().ScrollTrigger,va&&va.core&&LM()},Ox=function(e){return Cn=e||Ux(),!lu&&Cn&&typeof document<"u"&&document.body&&(Mi=window,Rs=document,Ps=Rs.documentElement,xa=Rs.body,Lx=[Mi,Rs,Ps,xa],Cn.utils.clamp,Ix=Cn.core.context||function(){},so="onpointerenter"in xa?"pointer":"mouse",Dx=rn.isTouch=Mi.matchMedia&&Mi.matchMedia("(hover: none), (pointer: coarse)").matches?1:"ontouchstart"in Mi||navigator.maxTouchPoints>0||navigator.msMaxTouchPoints>0?2:0,Ji=rn.eventTypes=("ontouchstart"in Ps?"touchstart,touchmove,touchcancel,touchend":"onpointerdown"in Ps?"pointerdown,pointermove,pointercancel,pointerup":"mousedown,mousemove,mouseup,mouseup").split(","),setTimeout(function(){return Fx=0},500),lu=1),va||Nx(),lu};ii.op=pn;_t.cache=0;var rn=(function(){function n(t){this.init(t)}var e=n.prototype;return e.init=function(i){lu||Ox(Cn)||console.warn("Please gsap.registerPlugin(Observer)"),va||Nx();var r=i.tolerance,s=i.dragMinimum,o=i.type,a=i.target,l=i.lineHeight,c=i.debounce,u=i.preventDefault,d=i.onStop,f=i.onStopDelay,h=i.ignore,g=i.wheelSpeed,_=i.event,p=i.onDragStart,m=i.onDragEnd,v=i.onDrag,S=i.onPress,x=i.onRelease,C=i.onRight,A=i.onLeft,R=i.onUp,b=i.onDown,T=i.onChangeX,N=i.onChangeY,U=i.onChange,L=i.onToggleX,G=i.onToggleY,k=i.onHover,V=i.onHoverEnd,X=i.onMove,B=i.ignoreCheck,Y=i.isNormalizer,j=i.onGestureStart,F=i.onGestureEnd,ae=i.onWheel,he=i.onEnable,ge=i.onDisable,xe=i.onClick,Ee=i.scrollSpeed,J=i.capture,ue=i.allowClicks,oe=i.lockAxis,Re=i.onLockAxis;this.target=a=ai(a)||Ps,this.vars=i,h&&(h=Cn.utils.toArray(h)),r=r||1e-9,s=s||0,g=g||1,Ee=Ee||1,o=o||"wheel,touch,pointer",c=c!==!1,l||(l=parseFloat(Mi.getComputedStyle(xa).lineHeight)||22);var Ae,le,w,E,H,ee,q,O=this,I=0,_e=0,fe=i.passive||!u&&i.passive!==!1,ne=zs(a,ii),me=zs(a,pn),P=ne(),M=me(),z=~o.indexOf("touch")&&!~o.indexOf("pointer")&&Ji[0]==="pointerdown",Z=wl(a),Q=a.ownerDocument||Rs,K=[0,0,0],Me=[0,0,0],ve=0,He=function(){return ve=Ml()},Le=function(Ye,ut){return(O.event=Ye)&&h&&IM(Ye.target,h)||ut&&z&&Ye.pointerType!=="touch"||B&&B(Ye,ut)},be=function(){O._vx.reset(),O._vy.reset(),le.pause(),d&&d(O)},we=function(){var Ye=O.deltaX=sm(K),ut=O.deltaY=sm(Me),Be=Math.abs(Ye)>=r,nt=Math.abs(ut)>=r;U&&(Be||nt)&&U(O,Ye,ut,K,Me),Be&&(C&&O.deltaX>0&&C(O),A&&O.deltaX<0&&A(O),T&&T(O),L&&O.deltaX<0!=I<0&&L(O),I=O.deltaX,K[0]=K[1]=K[2]=0),nt&&(b&&O.deltaY>0&&b(O),R&&O.deltaY<0&&R(O),N&&N(O),G&&O.deltaY<0!=_e<0&&G(O),_e=O.deltaY,Me[0]=Me[1]=Me[2]=0),(E||w)&&(X&&X(O),w&&(p&&w===1&&p(O),v&&v(O),w=0),E=!1),ee&&!(ee=!1)&&Re&&Re(O),H&&(ae(O),H=!1),Ae=0},Pe=function(Ye,ut,Be){K[Be]+=Ye,Me[Be]+=ut,O._vx.update(Ye),O._vy.update(ut),c?Ae||(Ae=requestAnimationFrame(we)):we()},Ne=function(Ye,ut){oe&&!q&&(O.axis=q=Math.abs(Ye)>Math.abs(ut)?"x":"y",ee=!0),q!=="y"&&(K[2]+=Ye,O._vx.update(Ye,!0)),q!=="x"&&(Me[2]+=ut,O._vy.update(ut,!0)),c?Ae||(Ae=requestAnimationFrame(we)):we()},Ie=function(Ye){if(!Le(Ye,1)){Ye=Xa(Ye,u);var ut=Ye.clientX,Be=Ye.clientY,nt=ut-O.x,Qe=Be-O.y,it=O.isDragging;O.x=ut,O.y=Be,(it||(nt||Qe)&&(Math.abs(O.startX-ut)>=s||Math.abs(O.startY-Be)>=s))&&(w||(w=it?2:1),it||(O.isDragging=!0),Ne(nt,Qe))}},et=O.onPress=function(Ve){Le(Ve,1)||Ve&&Ve.button||(O.axis=q=null,le.pause(),O.isPressed=!0,Ve=Xa(Ve),I=_e=0,O.startX=O.x=Ve.clientX,O.startY=O.y=Ve.clientY,O._vx.reset(),O._vy.reset(),qn(Y?a:Q,Ji[1],Ie,fe,!0),O.deltaX=O.deltaY=0,S&&S(O))},W=O.onRelease=function(Ve){if(!Le(Ve,1)){jn(Y?a:Q,Ji[1],Ie,!0);var Ye=!isNaN(O.y-O.startY),ut=O.isDragging,Be=ut&&(Math.abs(O.x-O.startX)>3||Math.abs(O.y-O.startY)>3),nt=Xa(Ve);!Be&&Ye&&(O._vx.reset(),O._vy.reset(),u&&ue&&Cn.delayedCall(.08,function(){if(Ml()-ve>300&&!Ve.defaultPrevented){if(Ve.target.click)Ve.target.click();else if(Q.createEvent){var Qe=Q.createEvent("MouseEvents");Qe.initMouseEvent("click",!0,!0,Mi,1,nt.screenX,nt.screenY,nt.clientX,nt.clientY,!1,!1,!1,!1,0,null),Ve.target.dispatchEvent(Qe)}}})),O.isDragging=O.isGesturing=O.isPressed=!1,d&&ut&&!Y&&le.restart(!0),w&&we(),m&&ut&&m(O),x&&x(O,Be)}},Ce=function(Ye){return Ye.touches&&Ye.touches.length>1&&(O.isGesturing=!0)&&j(Ye,O.isDragging)},Te=function(){return(O.isGesturing=!1)||F(O)},Oe=function(Ye){if(!Le(Ye)){var ut=ne(),Be=me();Pe((ut-P)*Ee,(Be-M)*Ee,1),P=ut,M=Be,d&&le.restart(!0)}},Se=function(Ye){if(!Le(Ye)){Ye=Xa(Ye,u),ae&&(H=!0);var ut=(Ye.deltaMode===1?l:Ye.deltaMode===2?Mi.innerHeight:1)*g;Pe(Ye.deltaX*ut,Ye.deltaY*ut,0),d&&!Y&&le.restart(!0)}},ce=function(Ye){if(!Le(Ye)){var ut=Ye.clientX,Be=Ye.clientY,nt=ut-O.x,Qe=Be-O.y;O.x=ut,O.y=Be,E=!0,d&&le.restart(!0),(nt||Qe)&&Ne(nt,Qe)}},Ge=function(Ye){O.event=Ye,k(O)},Je=function(Ye){O.event=Ye,V(O)},Mt=function(Ye){return Le(Ye)||Xa(Ye,u)&&xe(O)};le=O._dc=Cn.delayedCall(f||.25,be).pause(),O.deltaX=O.deltaY=0,O._vx=ih(0,50,!0),O._vy=ih(0,50,!0),O.scrollX=ne,O.scrollY=me,O.isDragging=O.isGesturing=O.isPressed=!1,Ix(this),O.enable=function(Ve){return O.isEnabled||(qn(Z?Q:a,"scroll",nh),o.indexOf("scroll")>=0&&qn(Z?Q:a,"scroll",Oe,fe,J),o.indexOf("wheel")>=0&&qn(a,"wheel",Se,fe,J),(o.indexOf("touch")>=0&&Dx||o.indexOf("pointer")>=0)&&(qn(a,Ji[0],et,fe,J),qn(Q,Ji[2],W),qn(Q,Ji[3],W),ue&&qn(a,"click",He,!0,!0),xe&&qn(a,"click",Mt),j&&qn(Q,"gesturestart",Ce),F&&qn(Q,"gestureend",Te),k&&qn(a,so+"enter",Ge),V&&qn(a,so+"leave",Je),X&&qn(a,so+"move",ce)),O.isEnabled=!0,O.isDragging=O.isGesturing=O.isPressed=E=w=!1,O._vx.reset(),O._vy.reset(),P=ne(),M=me(),Ve&&Ve.type&&et(Ve),he&&he(O)),O},O.disable=function(){O.isEnabled&&(aa.filter(function(Ve){return Ve!==O&&wl(Ve.target)}).length||jn(Z?Q:a,"scroll",nh),O.isPressed&&(O._vx.reset(),O._vy.reset(),jn(Y?a:Q,Ji[1],Ie,!0)),jn(Z?Q:a,"scroll",Oe,J),jn(a,"wheel",Se,J),jn(a,Ji[0],et,J),jn(Q,Ji[2],W),jn(Q,Ji[3],W),jn(a,"click",He,!0),jn(a,"click",Mt),jn(Q,"gesturestart",Ce),jn(Q,"gestureend",Te),jn(a,so+"enter",Ge),jn(a,so+"leave",Je),jn(a,so+"move",ce),O.isEnabled=O.isPressed=O.isDragging=!1,ge&&ge(O))},O.kill=O.revert=function(){O.disable();var Ve=aa.indexOf(O);Ve>=0&&aa.splice(Ve,1),qr===O&&(qr=0)},aa.push(O),Y&&wl(a)&&(qr=O),O.enable(_)},DM(n,[{key:"velocityX",get:function(){return this._vx.getVelocity()}},{key:"velocityY",get:function(){return this._vy.getVelocity()}}]),n})();rn.version="3.15.0";rn.create=function(n){return new rn(n)};rn.register=Ox;rn.getAll=function(){return aa.slice()};rn.getById=function(n){return aa.filter(function(e){return e.vars.id===n})[0]};Ux()&&Cn.registerPlugin(rn);/*!
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Qr,depthTest:!1,depthWrite:!1})}function rA(n,e,t){const i=new Float32Array(ho),r=new se(0,1,0);return new sr({name:"SphericalGaussianBlur",defines:{n:ho,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${n}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:i},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:r}},vertexShader:md(),fragmentShader:`
...
`)+`
`+m);const S=v+p+o,x=v+m+a,C=ag(r,r.VERTEX_SHADER,S),A=ag(r,r.FRAGMENT_SHADER,x);r.attachShader(_,C),r.attachShader(_,A),t.index0AttributeName!==void 0?r.bindAttribLocation(_,0,t.index0AttributeName):t.morphTargets===!0&&r.bindAttribLocation(_,0,"position"),r.linkProgram(_);function R(U){if(n.debug.checkShaderErrors){const L=r.getProgramInfoLog(_)||"",G=r.getShaderInfoLog(C)||"",k=r.getShaderInfoLog(A)||"",V=L.trim(),X=G.trim(),B=k.trim();let Y=!0,j=!0;if(r.getProgramParameter(_,r.LINK_STATUS)===!1)if(Y=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(r,_,C,A);else{const F=cg(r,C,"vertex"),ae=cg(r,A,"fragment");Et("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(_,r.VALIDATE_STATUS)+`
...
Program Info Log: `+V+`
`+F+`
`+ae)}else V!==""?ot("WebGLProgram: Program Info Log:",V):(X===""||B==="")&&(j=!1);j&&(U.diagnostics={runnable:Y,programLog:V,vertexShader:{log:X,prefix:p},fragmentShader:{log:B,prefix:m}})}r.deleteShader(C),r.deleteShader(A),b=new vu(r,_),T=p3(r,_)}let b;this.getUniforms=function(){return b===void 0&&R(this),b};let T;this.getAttributes=function(){return T===void 0&&R(this),T};let N=t.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return N===!1&&(N=r.getProgramParameter(_,r3)),N},this.destroy=function(){i.releaseStatesOfProgram(this),r.deleteProgram(_),this.program=void 0},this.type=t.shaderType,this.name=t.shaderName,this.id=s3++,this.cacheKey=e,this.usedTimes=1,this.program=_,this.vertexShader=C,this.fragmentShader=A,this}let P3=0;class D3{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(e){const t=e.vertexShader,i=e.fragmentShader,r=this._getShaderStage(t),s=this._getShaderStage(i),o=this._getShaderCacheForMaterial(e);return o.has(r)===!1&&(o.add(r),r.usedTimes++),o.has(s)===!1&&(o.add(s),s.usedTimes++),this}remove(e){const t=this.materialCache.get(e);for(const i of t)i.usedTimes--,i.usedTimes===0&&this.shaderCache.delete(i.code);return this.materialCache.delete(e),this}getVertexShaderID(e){return this._getShaderStage(e.vertexShader).id}getFragmentShaderID(e){return this._getShaderStage(e.fragmentShader).id}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(e){const t=this.materialCache;let i=t.get(e);return i===void 0&&(i=new Set,t.set(e,i)),i}_getShaderStage(e){const t=this.shaderCache;let i=t.get(e);return i===void 0&&(i=new L3(e),t.set(e,i)),i}}class L3{constructor(e){this.id=P3++,this.code=e,this.usedTimes=0}}function I3(n,e,t,i,r,s){const o=new yv,a=new D3,l=new Set,c=[],u=new Map,d=i.logarithmicDepthBuffer;let f=i.precision;const h={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distance",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function g(b){return l.add(b),b===0?"uv":`uv${b}`}function _(b,T,N,U,L){const G=U.fog,k=L.geometry,V=b.isMeshStandardMaterial||b.isMeshLambertMaterial||b.isMeshPhongMaterial?U.environment:null,X=b.isMeshStandardMaterial||b.isMeshLambertMaterial&&!b.envMap||b.isMeshPhongMaterial&&!b.envMap,B=e.get(b.envMap||V,X),Y=B&&B.mapping===hd?B.image.height:null,j=h[b.type];b.precision!==null&&(f=i.getMaxPrecision(b.precision),f!==b.precision&&ot("WebGLProgram.getParameters:",b.precision,"not supported, using",f,"instead."));const F=k.morphAttributes.position||k.morphAttributes.normal||k.morphAttributes.color,ae=F!==void 0?F.length:0;let he=0;k.morphAttributes.position!==void 0&&(he=1),k.morphAttributes.normal!==void 0&&(he=2),k.morphAttributes.color!==void 0&&(he=3);let ge,xe,Ee,J;if(j){const Ve=mr[j];ge=Ve.vertexShader,xe=Ve.fragmentShader}else ge=b.vertexShader,xe=b.fragmentShader,a.update(b),Ee=a.getVertexShaderID(b),J=a.getFragmentShaderID(b);const ue=n.getRenderTarget(),oe=n.state.buffers.depth.getReversed(),Re=L.isInstancedMesh===!0,Ae=L.isBatchedMesh===!0,le=!!b.map,w=!!b.matcap,E=!!B,H=!!b.aoMap,ee=!!b.lightMap,q=!!b.bumpMap,O=!!b.normalMap,I=!!b.displacementMap,_e=!!b.emissiveMap,fe=!!b.metalnessMap,ne=!!b.roughnessMap,me=b.anisotropy>0,P=b.clearcoat>0,M=b.dispersion>0,z=b.iridescence>0,Z=b.sheen>0,Q=b.transmission>0,K=me&&!!b.anisotropyMap,Me=P&&!!b.clearcoatMap,ve=P&&!!b.clearcoatNormalMap,He=P&&!!b.clearcoatRoughnessMap,Le=z&&!!b.iridescenceMap,be=z&&!!b.iridescenceThicknessMap,we=Z&&!!b.sheenColorMap,Pe=Z&&!!b.sheenRoughnessMap,Ne=!!b.specularMap,Ie=!!b.specularColorMap,et=!!b.specularIntensityMap,W=Q&&!!b.transmissionMap,Ce=Q&&!!b.thicknessMap,Te=!!b.gradientMap,Oe=!!b.alphaMap,Se=b.alphaTest>0,ce=!!b.alphaHash,Ge=!!b.extensions;let Je=Er;b.toneMapped&&(ue===null||ue.isXRRenderTarget===!0)&&(Je=n.toneMapping);const Mt={shaderID:j,shaderType:b.type,shaderName:b.name,vertexShader:ge,fragmentShader:xe,defines:b.defines,customVertexShaderID:Ee,customFragmentShaderID:J,isRawShaderMaterial:b.isRawShaderMaterial===!0,glslVersion:b.glslVersion,precision:f,batching:Ae,batchingColor:Ae&&L._colorsTexture!==null,instancing:Re,instancingColor:Re&&L.instanceColor!==null,instancingMorph:Re&&L.morphTexture!==null,outputColorSpace:ue===null?n.outputColorSpace:ue.isXRRenderTarget===!0?ue.texture.colorSpace:Fa,alphaToCoverage:!!b.alphaToCoverage,map:le,matcap:w,envMap:E,envMapMode:E&&B.mapping,envMapCubeUVHeight:Y,aoMap:H,lightMap:ee,bumpMap:q,normalMap:O,displacementMap:I,emissiveMap:_e,normalMapObjectSpace:O&&b.normalMapType===bw,normalMapTangentSpace:O&&b.normalMapType===yw,metalnessMap:fe,roughnessMap:ne,anisotropy:me,anisotropyMap:K,clearcoat:P,clearcoatMap:Me,clearcoatNormalMap:ve,clearcoatRoughnessMap:He,dispersion:M,iridescence:z,iridescenceMap:Le,iridescenceThicknessMap:be,sheen:Z,sheenColorMap:we,sheenRoughnessMap:Pe,specularMap:Ne,specularColorMap:Ie,specularIntensityMap:et,transmission:Q,transmissionMap:W,thicknessMap:Ce,gradientMap:Te,opaque:b.transparent===!1&&b.blending===Sa&&b.alphaToCoverage===!1,alphaMap:Oe,alphaTest:Se,alphaHash:ce,combine:b.combine,mapUv:le&&g(b.map.channel),aoMapUv:H&&g(b.aoMap.channel),lightMapUv:ee&&g(b.lightMap.channel),bumpMapUv:q&&g(b.bumpMap.channel),normalMapUv:O&&g(b.normalMap.channel),displacementMapUv:I&&g(b.displacementMap.channel),emissiveMapUv:_e&&g(b.emissiveMap.channel),metalnessMapUv:fe&&g(b.metalnessMap.channel),roughnessMapUv:ne&&g(b.roughnessMap.channel),anisotropyMapUv:K&&g(b.anisotropyMap.channel),clearcoatMapUv:Me&&g(b.clearcoatMap.channel),clearcoatNormalMapUv:ve&&g(b.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:He&&g(b.clearcoatRoughnessMap.channel),iridescenceMapUv:Le&&g(b.iridescenceMap.channel),iridescenceThicknessMapUv:be&&g(b.iridescenceThicknessMap.channel),sheenColorMapUv:we&&g(b.sheenColorMap.channel),sheenRoughnessMapUv:Pe&&g(b.sheenRoughnessMap.channel),specularMapUv:Ne&&g(b.specularMap.channel),specularColorMapUv:Ie&&g(b.specularColorMap.channel),specularIntensityMapUv:et&&g(b.specularIntensityMap.channel),transmissionMapUv:W&&g(b.transmissionMap.channel),thicknessMapUv:Ce&&g(b.thicknessMap.channel),alphaMapUv:Oe&&g(b.alphaMap.channel),vertexTangents:!!k.attributes.tangent&&(O||me),vertexColors:b.vertexColors,vertexAlphas:b.vertexColors===!0&&!!k.attributes.color&&k.attributes.color.itemSize===4,pointsUvs:L.isPoints===!0&&!!k.attributes.uv&&(le||Oe),fog:!!G,useFog:b.fog===!0,fogExp2:!!G&&G.isFogExp2,flatShading:b.wireframe===!1&&(b.flatShading===!0||k.attributes.normal===void 0&&O===!1&&(b.isMeshLambertMaterial||b.isMeshPhongMaterial||b.isMeshStandardMaterial||b.isMeshPhysicalMaterial)),sizeAttenuation:b.sizeAttenuation===!0,logarithmicDepthBuffer:d,reversedDepthBuffer:oe,skinning:L.isSkinnedMesh===!0,morphTargets:k.morphAttributes.position!==void 0,morphNormals:k.morphAttributes.normal!==void 0,morphColors:k.morphAttributes.color!==void 0,morphTargetsCount:ae,morphTextureStride:he,numDirLights:T.directional.length,numPointLights:T.point.length,numSpotLights:T.spot.length,numSpotLightMaps:T.spotLightMap.length,numRectAreaLights:T.rectArea.length,numHemiLights:T.hemi.length,numDirLightShadows:T.directionalShadowMap.length,numPointLightShadows:T.pointShadowMap.length,numSpotLightShadows:T.spotShadowMap.length,numSpotLightShadowsWithMaps:T.numSpotLightShadowsWithMaps,numLightProbes:T.numLightProbes,numClippingPlanes:s.numPlanes,numClipIntersection:s.numIntersection,dithering:b.dithering,shadowMapEnabled:n.shadowMap.enabled&&N.length>0,shadowMapType:n.shadowMap.type,toneMapping:Je,decodeVideoTexture:le&&b.map.isVideoTexture===!0&&St.getTransfer(b.map.colorSpace)===Ut,decodeVideoTextureEmissive:_e&&b.emissiveMap.isVideoTexture===!0&&St.getTransfer(b.emissiveMap.colorSpace)===Ut,premultipliedAlpha:b.premultipliedAlpha,doubleSided:b.side===Yr,flipSided:b.side===hi,useDepthPacking:b.depthPacking>=0,depthPacking:b.depthPacking||0,index0AttributeName:b.index0AttributeName,extensionClipCullDistance:Ge&&b.extensions.clipCullDistance===!0&&t.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(Ge&&b.extensions.multiDraw===!0||Ae)&&t.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:t.has("KHR_parallel_shader_compile"),customProgramCacheKey:b.customProgramCacheKey()};return Mt.vertexUv1s=l.has(1),Mt.vertexUv2s=l.has(2),Mt.vertexUv3s=l.has(3),l.clear(),Mt}function p(b){const T=[];if(b.shaderID?T.push(b.shaderID):(T.push(b.customVertexShaderID),T.push(b.customFragmentShaderID)),b.defines!==void 0)for(const N in b.defines)T.push(N),T.push(b.defines[N]);return b.isRawShaderMaterial===!1&&(m(T,b),v(T,b),T.push(n.outputColorSpace)),T.push(b.customProgramCacheKey),T.join()}function m(b,T){b.push(T.precision),b.push(T.outputColorSpace),b.push(T.envMapMode),b.push(T.envMapCubeUVHeight),b.push(T.mapUv),b.push(T.alphaMapUv),b.push(T.lightMapUv),b.push(T.aoMapUv),b.push(T.bumpMapUv),b.push(T.normalMapUv),b.push(T.displacementMapUv),b.push(T.emissiveMapUv),b.push(T.metalnessMapUv),b.push(T.roughnessMapUv),b.push(T.anisotropyMapUv),b.push(T.clearcoatMapUv),b.push(T.clearcoatNormalMapUv),b.push(T.clearcoatRoughnessMapUv),b.push(T.iridescenceMapUv),b.push(T.iridescenceThicknessMapUv),b.push(T.sheenColorMapUv),b.push(T.sheenRoughnessMapUv),b.push(T.specularMapUv),b.push(T.specularColorMapUv),b.push(T.specularIntensityMapUv),b.push(T.transmissionMapUv),b.push(T.thicknessMapUv),b.push(T.combine),b.push(T.fogExp2),b.push(T.sizeAttenuation),b.push(T.morphTargetsCount),b.push(T.morphAttributeCount),b.push(T.numDirLights),b.push(T.numPointLights),b.push(T.numSpotLights),b.push(T.numSpotLightMaps),b.push(T.numHemiLights),b.push(T.numRectAreaLights),b.push(T.numDirLightShadows),b.push(T.numPointLightShadows),b.push(T.numSpotLightShadows),b.push(T.numSpotLightShadowsWithMaps),b.push(T.numLightProbes),b.push(T.shadowMapType),b.push(T.toneMapping),b.push(T.numClippingPlanes),b.push(T.numClipIntersection),b.push(T.depthPacking)}function v(b,T){o.disableAll(),T.instancing&&o.enable(0),T.instancingColor&&o.enable(1),T.instancingMorph&&o.enable(2),T.matcap&&o.enable(3),T.envMap&&o.enable(4),T.normalMapObjectSpace&&o.enable(5),T.normalMapTangentSpace&&o.enable(6),T.clearcoat&&o.enable(7),T.iridescence&&o.enable(8),T.alphaTest&&o.enable(9),T.vertexColors&&o.enable(10),T.vertexAlphas&&o.enable(11),T.vertexUv1s&&o.enable(12),T.vertexUv2s&&o.enable(13),T.vertexUv3s&&o.enable(14),T.vertexTangents&&o.enable(15),T.anisotropy&&o.enable(16),T.alphaHash&&o.enable(17),T.batching&&o.enable(18),T.dispersion&&o.enable(19),T.batchingColor&&o.enable(20),T.gradientMap&&o.enable(21),b.push(o.mask),o.disableAll(),T.fog&&o.enable(0),T.useFog&&o.enable(1),T.flatShading&&o.enable(2),T.logarithmicDepthBuffer&&o.enable(3),T.reversedDepthBuffer&&o.enable(4),T.skinning&&o.enable(5),T.morphTargets&&o.enable(6),T.morphNormals&&o.enable(7),T.morphColors&&o.enable(8),T.premultipliedAlpha&&o.enable(9),T.shadowMapEnabled&&o.enable(10),T.doubleSided&&o.enable(11),T.flipSided&&o.enable(12),T.useDepthPacking&&o.enable(13),T.dithering&&o.enable(14),T.transmission&&o.enable(15),T.sheen&&o.enable(16),T.opaque&&o.enable(17),T.pointsUvs&&o.enable(18),T.decodeVideoTexture&&o.enable(19),T.decodeVideoTextureEmissive&&o.enable(20),T.alphaToCoverage&&o.enable(21),b.push(o.mask)}function S(b){const T=h[b.type];let N;if(T){const U=mr[T];N=s2.clone(U.uniforms)}else N=b.uniforms;return N}function x(b,T){let N=u.get(T);return N!==void 0?++N.usedTimes:(N=new R3(n,T,b,r),c.push(N),u.set(T,N)),N}function C(b){if(--b.usedTimes===0){const T=c.indexOf(b);c[T]=c[c.length-1],c.pop(),u.delete(b.cacheKey),b.destroy()}}function A(b){a.remove(b)}function R(){a.dispose()}return{getParameters:_,getProgramCacheKey:p,getUniforms:S,acquireProgram:x,releaseProgram:C,releaseShaderCache:A,programs:c,dispose:R}}function U3(){let n=new WeakMap;function e(o){return n.has(o)}function t(o){let a=n.get(o);return a===void 0&&(a={},n.set(o,a)),a}function i(o){n.delete(o)}function r(o,a,l){n.get(o)[a]=l}function s(){n=new WeakMap}return{has:e,get:t,remove:i,update:r,dispose:s}}function F3(n,e){return n.groupOrder!==e.groupOrder?n.groupOrder-e.groupOrder:n.renderOrder!==e.renderOrder?n.renderOrder-e.renderOrder:n.material.id!==e.material.id?n.material.id-e.material.id:n.materialVariant!==e.materialVariant?n.materialVariant-e.materialVariant:n.z!==e.z?n.z-e.z:n.id-e.id}function pg(n,e){return n.groupOrder!==e.groupOrder?n.groupOrder-e.groupOrder:n.renderOrder!==e.renderOrder?n.renderOrder-e.renderOrder:n.z!==e.z?e.z-n.z:n.id-e.id}function mg(){const n=[];let e=0;const t=[],i=[],r=[];function s(){e=0,t.length=0,i.length=0,r.length=0}function o(f){let h=0;return f.isInstancedMesh&&(h+=2),f.isSkinnedMesh&&(h+=1),h}function a(f,h,g,_,p,m){let v=n[e];return v===void 0?(v={id:f.id,object:f,geometry:h,material:g,materialVariant:o(f),groupOrder:_,renderOrder:f.renderOrder,z:p,group:m},n[e]=v):(v.id=f.id,v.object=f,v.geometry=h,v.material=g,v.materialVariant=o(f),v.groupOrder=_,v.renderOrder=f.renderOrder,v.z=p,v.group=m),e++,v}function l(f,h,g,_,p,m){const v=a(f,h,g,_,p,m);g.transmission>0?i.push(v):g.transparent===!0?r.push(v):t.push(v)}function c(f,h,g,_,p,m){const v=a(f,h,g,_,p,m);g.transmission>0?i.unshift(v):g.transparent===!0?r.unshift(v):t.unshift(v)}function u(f,h){t.length>1&&t.sort(f||F3),i.length>1&&i.sort(h||pg),r.length>1&&r.sort(h||pg)}function d(){for(let f=e,h=n.length;f<h;f++){const g=n[f];if(g.id===null)break;g.id=null,g.object=null,g.geometry=null,g.material=null,g.group=null}}return{opaque:t,transmissive:i,transparent:r,init:s,push:l,unshift:c,finish:d,sort:u}}function N3(){let n=new WeakMap;function e(i,r){const s=n.get(i);let o;return s===void 0?(o=new mg,n.set(i,[o])):r>=s.length?(o=new mg,s.push(o)):o=s[r],o}function t(){n=new WeakMap}return{get:e,dispose:t}}function O3(){const n={};return{get:function(e){if(n[e.id]!==void 0)return n[e.id];let t;switch(e.type){case"DirectionalLight":t={direction:new se,color:new Ot};break;case"SpotLight":t={position:new se,direction:new se,color:new Ot,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":t={position:new se,color:new Ot,distance:0,decay:0};break;case"HemisphereLight":t={direction:new se,skyColor:new Ot,groundColor:new Ot};break;case"RectAreaLight":t={color:new Ot,position:new se,halfWidth:new se,halfHeight:new se};break}return n[e.id]=t,t}}}function k3(){const n={};return{get:function(e){if(n[e.id]!==void 0)return n[e.id];let t;switch(e.type){case"DirectionalLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new bt};break;case"SpotLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new bt};break;case"PointLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new bt,shadowCameraNear:1,shadowCameraFar:1e3};break}return n[e.id]=t,t}}}let B3=0;function z3(n,e){return(e.castShadow?2:0)-(n.castShadow?2:0)+(e.map?1:0)-(n.map?1:0)}function V3(n){const e=new O3,t=k3(),i={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let c=0;c<9;c++)i.probe.push(new se);const r=new se,s=new cn,o=new cn;function a(c){let u=0,d=0,f=0;for(let T=0;T<9;T++)i.probe[T].set(0,0,0);let h=0,g=0,_=0,p=0,m=0,v=0,S=0,x=0,C=0,A=0,R=0;c.sort(z3);for(let T=0,N=c.length;T<N;T++){const U=c[T],L=U.color,G=U.intensity,k=U.distance;let V=null;if(U.shadow&&U.shadow.map&&(U.shadow.map.texture.format===Ua?V=U.shadow.map.texture:V=U.shadow.map.depthTexture||U.shadow.map.texture),U.isAmbientLight)u+=L.r*G,d+=L.g*G,f+=L.b*G;else if(U.isLightProbe){for(let X=0;X<9;X++)i.probe[X].addScaledVector(U.sh.coefficients[X],G);R++}else if(U.isDirectionalLight){const X=e.get(U);if(X.color.copy(U.color).multiplyScalar(U.intensity),U.castShadow){const B=U.shadow,Y=t.get(U);Y.shadowIntensity=B.intensity,Y.shadowBias=B.bias,Y.shadowNormalBias=B.normalBias,Y.shadowRadius=B.radius,Y.shadowMapSize=B.mapSize,i.directionalShadow[h]=Y,i.directionalShadowMap[h]=V,i.directionalShadowMatrix[h]=U.shadow.matrix,v++}i.directional[h]=X,h++}else if(U.isSpotLight){const X=e.get(U);X.position.setFromMatrixPosition(U.matrixWorld),X.color.copy(L).multiplyScalar(G),X.distance=k,X.coneCos=Math.cos(U.angle),X.penumbraCos=Math.cos(U.angle*(1-U.penumbra)),X.decay=U.decay,i.spot[_]=X;const B=U.shadow;if(U.map&&(i.spotLightMap[C]=U.map,C++,B.updateMatrices(U),U.castShadow&&A++),i.spotLightMatrix[_]=B.matrix,U.castShadow){const Y=t.get(U);Y.shadowIntensity=B.intensity,Y.shadowBias=B.bias,Y.shadowNormalBias=B.normalBias,Y.shadowRadius=B.radius,Y.shadowMapSize=B.mapSize,i.spotShadow[_]=Y,i.spotShadowMap[_]=V,x++}_++}else if(U.isRectAreaLight){const X=e.get(U);X.color.copy(L).multiplyScalar(G),X.halfWidth.set(U.width*.5,0,0),X.halfHeight.set(0,U.height*.5,0),i.rectArea[p]=X,p++}else if(U.isPointLight){const X=e.get(U);if(X.color.copy(U.color).multiplyScalar(U.intensity),X.distance=U.distance,X.decay=U.decay,U.castShadow){const B=U.shadow,Y=t.get(U);Y.shadowIntensity=B.intensity,Y.shadowBias=B.bias,Y.shadowNormalBias=B.normalBias,Y.shadowRadius=B.radius,Y.shadowMapSize=B.mapSize,Y.shadowCameraNear=B.camera.near,Y.shadowCameraFar=B.camera.far,i.pointShadow[g]=Y,i.pointShadowMap[g]=V,i.pointShadowMatrix[g]=U.shadow.matrix,S++}i.point[g]=X,g++}else if(U.isHemisphereLight){const X=e.get(U);X.skyColor.copy(U.color).multiplyScalar(G),X.groundColor.copy(U.groundColor).multiplyScalar(G),i.hemi[m]=X,m++}}p>0&&(n.has("OES_texture_float_linear")===!0?(i.rectAreaLTC1=ze.LTC_FLOAT_1,i.rectAreaLTC2=ze.LTC_FLOAT_2):(i.rectAreaLTC1=ze.LTC_HALF_1,i.rectAreaLTC2=ze.LTC_HALF_2)),i.ambient[0]=u,i.ambient[1]=d,i.ambient[2]=f;const b=i.hash;(b.directionalLength!==h||b.pointLength!==g||b.spotLength!==_||b.rectAreaLength!==p||b.hemiLength!==m||b.numDirectionalShadows!==v||b.numPointShadows!==S||b.numSpotShadows!==x||b.numSpotMaps!==C||b.numLightProbes!==R)&&(i.directional.length=h,i.spot.length=_,i.rectArea.length=p,i.point.length=g,i.hemi.length=m,i.directionalShadow.length=v,i.directionalShadowMap.length=v,i.pointShadow.length=S,i.pointShadowMap.length=S,i.spotShadow.length=x,i.spotShadowMap.length=x,i.directionalShadowMatrix.length=v,i.pointShadowMatrix.length=S,i.spotLightMatrix.length=x+C-A,i.spotLightMap.length=C,i.numSpotLightShadowsWithMaps=A,i.numLightProbes=R,b.directionalLength=h,b.pointLength=g,b.spotLength=_,b.rectAreaLength=p,b.hemiLength=m,b.numDirectionalShadows=v,b.numPointShadows=S,b.numSpotShadows=x,b.numSpotMaps=C,b.numLightProbes=R,i.version=B3++)}function l(c,u){let d=0,f=0,h=0,g=0,_=0;const p=u.matrixWorldInverse;for(let m=0,v=c.length;m<v;m++){const S=c[m];if(S.isDirectionalLight){const x=i.directional[d];x.direction.setFromMatrixPosition(S.matrixWorld),r.setFromMatrixPosition(S.target.matrixWorld),x.direction.sub(r),x.direction.transformDirection(p),d++}else if(S.isSpotLight){const x=i.spot[h];x.position.setFromMatrixPosition(S.matrixWorld),x.position.applyMatrix4(p),x.direction.setFromMatrixPosition(S.matrixWorld),r.setFromMatrixPosition(S.target.matrixWorld),x.direction.sub(r),x.direction.transformDirection(p),h++}else if(S.isRectAreaLight){const x=i.rectArea[g];x.position.setFromMatrixPosition(S.matrixWorld),x.position.applyMatrix4(p),o.identity(),s.copy(S.matrixWorld),s.premultiply(p),o.extractRotation(s),x.halfWidth.set(S.width*.5,0,0),x.halfHeight.set(0,S.height*.5,0),x.halfWidth.applyMatrix4(o),x.halfHeight.applyMatrix4(o),g++}else if(S.isPointLight){const x=i.point[f];x.position.setFromMatrixPosition(S.matrixWorld),x.position.applyMatrix4(p),f++}else if(S.isHemisphereLight){const x=i.hemi[_];x.direction.setFromMatrixPosition(S.matrixWorld),x.direction.transformDirection(p),_++}}}return{setup:a,setupView:l,state:i}}function gg(n){const e=new V3(n),t=[],i=[];function r(u){c.camera=u,t.length=0,i.length=0}function s(u){t.push(u)}function o(u){i.push(u)}function a(){e.setup(t)}function l(u){e.setupView(t,u)}const c={lightsArray:t,shadowsArray:i,camera:null,lights:e,transmissionRenderTarget:{}};return{init:r,state:c,setupLights:a,setupLightsView:l,pushLight:s,pushShadow:o}}function H3(n){let e=new WeakMap;function t(r,s=0){const o=e.get(r);let a;return o===void 0?(a=new gg(n),e.set(r,[a])):s>=o.length?(a=new gg(n),o.push(a)):a=o[s],a}function i(){e=new WeakMap}return{get:t,dispose:i}}const G3=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`,X3=[new se(1,0,0),new se(-1,0,0),new se(0,1,0),new se(0,-1,0),new se(0,0,1),new se(0,0,-1)],$3=[new se(0,-1,0),new se(0,-1,0),new se(0,0,1),new se(0,0,-1),new se(0,-1,0),new se(0,-1,0)],_g=new cn,Qa=new se,wf=new se;function j3(n,e,t){let i=new Ev;const r=new bt,s=new bt,o=new nn,a=new c2,l=new u2,c={},u=t.maxTextureSize,d={[Vs]:hi,[hi]:Vs,[Yr]:Yr},f=new sr({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new bt},radius:{value:4}},vertexShader:G3,fragmentShader:W3}),h=f.clone();h.defines.HORIZONTAL_PASS=1;const g=new fs;g.setAttribute("position",new Ar(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const _=new Lr(g,f),p=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=pu;let m=this.type;this.render=function(A,R,b){if(p.enabled===!1||p.autoUpdate===!1&&p.needsUpdate===!1||A.length===0)return;this.type===ZM&&(ot("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=pu);const T=n.getRenderTarget(),N=n.getActiveCubeFace(),U=n.getActiveMipmapLevel(),L=n.state;L.setBlending(Qr),L.buffers.depth.getReversed()===!0?L.buffers.color.setClear(0,0,0,0):L.buffers.color.setClear(1,1,1,1),L.buffers.depth.setTest(!0),L.setScissorTest(!1);const G=m!==this.type;G&&R.traverse(function(k){k.material&&(Array.isArray(k.material)?k.material.forEach(V=>V.needsUpdate=!0):k.material.needsUpdate=!0)});for(let k=0,V=A.length;k<V;k++){const X=A[k],B=X.shadow;if(B===void 0){ot("WebGLShadowMap:",X,"has no shadow.");continue}if(B.autoUpdate===!1&&B.needsUpdate===!1)continue;r.copy(B.mapSize);const Y=B.getFrameExtents();r.multiply(Y),s.copy(B.mapSize),(r.x>u||r.y>u)&&(r.x>u&&(s.x=Math.floor(u/Y.x),r.x=s.x*Y.x,B.mapSize.x=s.x),r.y>u&&(s.y=Math.floor(u/Y.y),r.y=s.y*Y.y,B.mapSize.y=s.y));const j=n.state.buffers.depth.getReversed();if(B.camera._reversedDepth=j,B.map===null||G===!0){if(B.map!==null&&(B.map.depthTexture!==null&&(B.map.depthTexture.dispose(),B.map.depthTexture=null),B.map.dispose()),this.type===dl){if(X.isPointLight){ot("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}B.map=new Tr(r.x,r.y,{format:Ua,type:ls,minFilter:Gn,magFilter:Gn,generateMipmaps:!1}),B.map.texture.name=X.name+".shadowMap",B.map.depthTexture=new Jl(r.x,r.y,yr),B.map.depthTexture.name=X.name+".shadowMapDepth",B.map.depthTexture.format=cs,B.map.depthTexture.compareFunction=null,B.map.depthTexture.minFilter=Rn,B.map.depthTexture.magFilter=Rn}else X.isPointLight?(B.map=new Dv(r.x),B.map.depthTexture=new i2(r.x,Dr)):(B.map=new Tr(r.x,r.y),B.map.depthTexture=new Jl(r.x,r.y,Dr)),B.map.depthTexture.name=X.name+".shadowMap",B.map.depthTexture.format=cs,this.type===pu?(B.map.depthTexture.compareFunction=j?Jp:Zp,B.map.depthTexture.minFilter=Gn,B.map.depthTexture.magFilter=Gn):(B.map.depthTexture.compareFunction=null,B.map.depthTexture.minFilter=Rn,B.map.depthTexture.magFilter=Rn);B.camera.updateProjectionMatrix()}const F=B.map.isWebGLCubeRenderTarget?6:1;for(let ae=0;ae<F;ae++){if(B.map.isWebGLCubeRenderTarget)n.setRenderTarget(B.map,ae),n.clear();else{ae===0&&(n.setRenderTarget(B.map),n.clear());const he=B.getViewport(ae);o.set(s.x*he.x,s.y*he.y,s.x*he.z,s.y*he.w),L.viewport(o)}if(X.isPointLight){const he=B.camera,ge=B.matrix,xe=X.distance||he.far;xe!==he.far&&(he.far=xe,he.updateProjectionMatrix()),Qa.setFromMatrixPosition(X.matrixWorld),he.position.copy(Qa),wf.copy(he.position),wf.add(X3[ae]),he.up.copy($3[ae]),he.lookAt(wf),he.updateMatrixWorld(),ge.makeTranslation(-Qa.x,-Qa.y,-Qa.z),_g.multiplyMatrices(he.projectionMatrix,he.matrixWorldInverse),B._frustum.setFromProjectionMatrix(_g,he.coordinateSystem,he.reversedDepth)}else B.updateMatrices(X);i=B.getFrustum(),x(R,b,B.camera,X,this.type)}B.isPointLightShadow!==!0&&this.type===dl&&v(B,b),B.needsUpdate=!1}m=this.type,p.needsUpdate=!1,n.setRenderTarget(T,N,U)};function v(A,R){const b=e.update(_);f.defines.VSM_SAMPLES!==A.blurSamples&&(f.defines.VSM_SAMPLES=A.blurSamples,h.defines.VSM_SAMPLES=A.blurSamples,f.needsUpdate=!0,h.needsUpdate=!0),A.mapPass===null&&(A.mapPass=new Tr(r.x,r.y,{format:Ua,type:ls})),f.uniforms.shadow_pass.value=A.map.depthTexture,f.uniforms.resolution.value=A.mapSize,f.uniforms.radius.value=A.radius,n.setRenderTarget(A.mapPass),n.clear(),n.renderBufferDirect(R,null,b,f,_,null),h.uniforms.shadow_pass.value=A.mapPass.texture,h.uniforms.resolution.value=A.mapSize,h.uniforms.radius.value=A.radius,n.setRenderTarget(A.map),n.clear(),n.renderBufferDirect(R,null,b,h,_,null)}function S(A,R,b,T){let N=null;const U=b.isPointLight===!0?A.customDistanceMaterial:A.customDepthMaterial;if(U!==void 0)N=U;else if(N=b.isPointLight===!0?l:a,n.localClippingEnabled&&R.clipShadows===!0&&Array.isArray(R.clippingPlanes)&&R.clippingPlanes.length!==0||R.displacementMap&&R.displacementScale!==0||R.alphaMap&&R.alphaTest>0||R.map&&R.alphaTest>0||R.alphaToCoverage===!0){const L=N.uuid,G=R.uuid;let k=c[L];k===void 0&&(k={},c[L]=k);let V=k[G];V===void 0&&(V=N.clone(),k[G]=V,R.addEventListener("dispose",C)),N=V}if(N.visible=R.visible,N.wireframe=R.wireframe,T===dl?N.side=R.shadowSide!==null?R.shadowSide:R.side:N.side=R.shadowSide!==null?R.shadowSide:d[R.side],N.alphaMap=R.alphaMap,N.alphaTest=R.alphaToCoverage===!0?.5:R.alphaTest,N.map=R.map,N.clipShadows=R.clipShadows,N.clippingPlanes=R.clippingPlanes,N.clipIntersection=R.clipIntersection,N.displacementMap=R.displacementMap,N.displacementScale=R.displacementScale,N.displacementBias=R.displacementBias,N.wireframeLinewidth=R.wireframeLinewidth,N.linewidth=R.linewidth,b.isPointLight===!0&&N.isMeshDistanceMaterial===!0){const L=n.properties.get(N);L.light=b}return N}function x(A,R,b,T,N){if(A.visible===!1)return;if(A.layers.test(R.layers)&&(A.isMesh||A.isLine||A.isPoints)&&(A.castShadow||A.receiveShadow&&N===dl)&&(!A.frustumCulled||i.intersectsObject(A))){A.modelViewMatrix.multiplyMatrices(b.matrixWorldInverse,A.matrixWorld);const G=e.update(A),k=A.material;if(Array.isArray(k)){const V=G.groups;for(let X=0,B=V.length;X<B;X++){const Y=V[X],j=k[Y.materialIndex];if(j&&j.visible){const F=S(A,j,T,N);A.onBeforeShadow(n,A,R,b,G,F,Y),n.renderBufferDirect(b,null,G,F,A,Y),A.onAfterShadow(n,A,R,b,G,F,Y)}}}else if(k.visible){const V=S(A,k,T,N);A.onBeforeShadow(n,A,R,b,G,V,null),n.renderBufferDirect(b,null,G,V,A,null),A.onAfterShadow(n,A,R,b,G,V,null)}}const L=A.children;for(let G=0,k=L.length;G<k;G++)x(L[G],R,b,T,N)}function C(A){A.target.removeEventListener("dispose",C);for(const b in c){const T=c[b],N=A.target.uuid;N in T&&(T[N].dispose(),delete T[N])}}}function Y3(n,e){function t(){let W=!1;const Ce=new nn;let Te=null;const Oe=new nn(0,0,0,0);return{setMask:function(Se){Te!==Se&&!W&&(n.colorMask(Se,Se,Se,Se),Te=Se)},setLocked:function(Se){W=Se},setClear:function(Se,ce,Ge,Je,Mt){Mt===!0&&(Se*=Je,ce*=Je,Ge*=Je),Ce.set(Se,ce,Ge,Je),Oe.equals(Ce)===!1&&(n.clearColor(Se,ce,Ge,Je),Oe.copy(Ce))},reset:function(){W=!1,Te=null,Oe.set(-1,0,0,0)}}}function i(){let W=!1,Ce=!1,Te=null,Oe=null,Se=null;return{setReversed:function(ce){if(Ce!==ce){const Ge=e.get("EXT_clip_control");ce?Ge.clipControlEXT(Ge.LOWER_LEFT_EXT,Ge.ZERO_TO_ONE_EXT):Ge.clipControlEXT(Ge.LOWER_LEFT_EXT,Ge.NEGATIVE_ONE_TO_ONE_EXT),Ce=ce;const Je=Se;Se=null,this.setClear(Je)}},getReversed:function(){return Ce},setTest:function(ce){ce?ue(n.DEPTH_TEST):oe(n.DEPTH_TEST)},setMask:function(ce){Te!==ce&&!W&&(n.depthMask(ce),Te=ce)},setFunc:function(ce){if(Ce&&(ce=Dw[ce]),Oe!==ce){switch(ce){case hh:n.depthFunc(n.NEVER);break;case ph:n.depthFunc(n.ALWAYS);break;case mh:n.depthFunc(n.LESS);break;case La:n.depthFunc(n.LEQUAL);break;case gh:n.depthFunc(n.EQUAL);break;case _h:n.depthFunc(n.GEQUAL);break;case xh:n.depthFunc(n.GREATER);break;case vh:n.depthFunc(n.NOTEQUAL);break;default:n.depthFunc(n.LEQUAL)}Oe=ce}},setLocked:function(ce){W=ce},setClear:function(ce){Se!==ce&&(Se=ce,Ce&&(ce=1-ce),n.clearDepth(ce))},reset:function(){W=!1,Te=null,Oe=null,Se=null,Ce=!1}}}function r(){let W=!1,Ce=null,Te=null,Oe=null,Se=null,ce=null,Ge=null,Je=null,Mt=null;return{setTest:function(Ve){W||(Ve?ue(n.STENCIL_TEST):oe(n.STENCIL_TEST))},setMask:function(Ve){Ce!==Ve&&!W&&(n.stencilMask(Ve),Ce=Ve)},setFunc:function(Ve,Ye,ut){(Te!==Ve||Oe!==Ye||Se!==ut)&&(n.stencilFunc(Ve,Ye,ut),Te=Ve,Oe=Ye,Se=ut)},setOp:function(Ve,Ye,ut){(ce!==Ve||Ge!==Ye||Je!==ut)&&(n.stencilOp(Ve,Ye,ut),ce=Ve,Ge=Ye,Je=ut)},setLocked:function(Ve){W=Ve},setClear:function(Ve){Mt!==Ve&&(n.clearStencil(Ve),Mt=Ve)},reset:function(){W=!1,Ce=null,Te=null,Oe=null,Se=null,ce=null,Ge=null,Je=null,Mt=null}}}const s=new t,o=new i,a=new r,l=new WeakMap,c=new WeakMap;let u={},d={},f=new WeakMap,h=[],g=null,_=!1,p=null,m=null,v=null,S=null,x=null,C=null,A=null,R=new Ot(0,0,0),b=0,T=!1,N=null,U=null,L=null,G=null,k=null;const V=n.getParameter(n.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let X=!1,B=0;const Y=n.getParameter(n.VERSION);Y.indexOf("WebGL")!==-1?(B=parseFloat(/^WebGL (\d)/.exec(Y)[1]),X=B>=1):Y.indexOf("OpenGL ES")!==-1&&(B=parseFloat(/^OpenGL ES (\d)/.exec(Y)[1]),X=B>=2);let j=null,F={};const ae=n.getParameter(n.SCISSOR_BOX),he=n.getParameter(n.VIEWPORT),ge=new nn().fromArray(ae),xe=new nn().fromArray(he);function Ee(W,Ce,Te,Oe){const Se=new Uint8Array(4),ce=n.createTexture();n.bindTexture(W,ce),n.texParameteri(W,n.TEXTURE_MIN_FILTER,n.NEAREST),n.texParameteri(W,n.TEXTURE_MAG_FILTER,n.NEAREST);for(let Ge=0;Ge<Te;Ge++)W===n.TEXTURE_3D||W===n.TEXTURE_2D_ARRAY?n.texImage3D(Ce,0,n.RGBA,1,1,Oe,0,n.RGBA,n.UNSIGNED_BYTE,Se):n.texImage2D(Ce+Ge,0,n.RGBA,1,1,0,n.RGBA,n.UNSIGNED_BYTE,Se);return ce}const J={};J[n.TEXTURE_2D]=Ee(n.TEXTURE_2D,n.TEXTURE_2D,1),J[n.TEXTURE_CUBE_MAP]=Ee(n.TEXTURE_CUBE_MAP,n.TEXTURE_CUBE_MAP_POSITIVE_X,6),J[n.TEXTURE_2D_ARRAY]=Ee(n.TEXTURE_2D_ARRAY,n.TEXTURE_2D_ARRAY,1,1),J[n.TEXTURE_3D]=Ee(n.TEXTURE_3D,n.TEXTURE_3D,1,1),s.setClear(0,0,0,1),o.setClear(1),a.setClear(0),ue(n.DEPTH_TEST),o.setFunc(La),q(!1),O(Mm),ue(n.CULL_FACE),H(Qr);function ue(W){u[W]!==!0&&(n.enable(W),u[W]=!0)}function oe(W){u[W]!==!1&&(n.disable(W),u[W]=!1)}function Re(W,Ce){return d[W]!==Ce?(n.bindFramebuffer(W,Ce),d[W]=Ce,W===n.DRAW_FRAMEBUFFER&&(d[n.FRAMEBUFFER]=Ce),W===n.FRAMEBUFFER&&(d[n.DRAW_FRAMEBUFFER]=Ce),!0):!1}function Ae(W,Ce){let Te=h,Oe=!1;if(W){Te=f.get(Ce),Te===void 0&&(Te=[],f.set(Ce,Te));const Se=W.textures;if(Te.length!==Se.length||Te[0]!==n.COLOR_ATTACHMENT0){for(let ce=0,Ge=Se.length;ce<Ge;ce++)Te[ce]=n.COLOR_ATTACHMENT0+ce;Te.length=Se.length,Oe=!0}}else Te[0]!==n.BACK&&(Te[0]=n.BACK,Oe=!0);Oe&&n.drawBuffers(Te)}function le(W){return g!==W?(n.useProgram(W),g=W,!0):!1}const w={[fo]:n.FUNC_ADD,[QM]:n.FUNC_SUBTRACT,[ew]:n.FUNC_REVERSE_SUBTRACT};w[tw]=n.MIN,w[nw]=n.MAX;const E={[iw]:n.ZERO,[rw]:n.ONE,[sw]:n.SRC_COLOR,[dh]:n.SRC_ALPHA,[dw]:n.SRC_ALPHA_SATURATE,[cw]:n.DST_COLOR,[aw]:n.DST_ALPHA,[ow]:n.ONE_MINUS_SRC_COLOR,[fh]:n.ONE_MINUS_SRC_ALPHA,[uw]:n.ONE_MINUS_DST_COLOR,[lw]:n.ONE_MINUS_DST_ALPHA,[fw]:n.CONSTANT_COLOR,[hw]:n.ONE_MINUS_CONSTANT_COLOR,[pw]:n.CONSTANT_ALPHA,[mw]:n.ONE_MINUS_CONSTANT_ALPHA};function H(W,Ce,Te,Oe,Se,ce,Ge,Je,Mt,Ve){if(W===Qr){_===!0&&(oe(n.BLEND),_=!1);return}if(_===!1&&(ue(n.BLEND),_=!0),W!==JM){if(W!==p||Ve!==T){if((m!==fo||x!==fo)&&(n.blendEquation(n.FUNC_ADD),m=fo,x=fo),Ve)switch(W){case Sa:n.blendFuncSeparate(n.ONE,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case wm:n.blendFunc(n.ONE,n.ONE);break;case Em:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case Tm:n.blendFuncSeparate(n.DST_COLOR,n.ONE_MINUS_SRC_ALPHA,n.ZERO,n.ONE);break;default:Et("WebGLState: Invalid blending: ",W);break}else switch(W){case Sa:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case wm:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE,n.ONE,n.ONE);break;case Em:Et("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case Tm:Et("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:Et("WebGLState: Invalid blending: ",W);break}v=null,S=null,C=null,A=null,R.set(0,0,0),b=0,p=W,T=Ve}return}Se=Se||Ce,ce=ce||Te,Ge=Ge||Oe,(Ce!==m||Se!==x)&&(n.blendEquationSeparate(w[Ce],w[Se]),m=Ce,x=Se),(Te!==v||Oe!==S||ce!==C||Ge!==A)&&(n.blendFuncSeparate(E[Te],E[Oe],E[ce],E[Ge]),v=Te,S=Oe,C=ce,A=Ge),(Je.equals(R)===!1||Mt!==b)&&(n.blendColor(Je.r,Je.g,Je.b,Mt),R.copy(Je),b=Mt),p=W,T=!1}function ee(W,Ce){W.side===Yr?oe(n.CULL_FACE):ue(n.CULL_FACE);let Te=W.side===hi;Ce&&(Te=!Te),q(Te),W.blending===Sa&&W.transparent===!1?H(Qr):H(W.blending,W.blendEquation,W.blendSrc,W.blendDst,W.blendEquationAlpha,W.blendSrcAlpha,W.blendDstAlpha,W.blendColor,W.blendAlpha,W.premultipliedAlpha),o.setFunc(W.depthFunc),o.setTest(W.depthTest),o.setMask(W.depthWrite),s.setMask(W.colorWrite);const Oe=W.stencilWrite;a.setTest(Oe),Oe&&(a.setMask(W.stencilWriteMask),a.setFunc(W.stencilFunc,W.stencilRef,W.stencilFuncMask),a.setOp(W.stencilFail,W.stencilZFail,W.stencilZPass)),_e(W.polygonOffset,W.polygonOffsetFactor,W.polygonOffsetUnits),W.alphaToCoverage===!0?ue(n.SAMPLE_ALPHA_TO_COVERAGE):oe(n.SAMPLE_ALPHA_TO_COVERAGE)}function q(W){N!==W&&(W?n.frontFace(n.CW):n.frontFace(n.CCW),N=W)}function O(W){W!==qM?(ue(n.CULL_FACE),W!==U&&(W===Mm?n.cullFace(n.BACK):W===KM?n.cullFace(n.FRONT):n.cullFace(n.FRONT_AND_BACK))):oe(n.CULL_FACE),U=W}function I(W){W!==L&&(X&&n.lineWidth(W),L=W)}function _e(W,Ce,Te){W?(ue(n.POLYGON_OFFSET_FILL),(G!==Ce||k!==Te)&&(G=Ce,k=Te,o.getReversed()&&(Ce=-Ce),n.polygonOffset(Ce,Te))):oe(n.POLYGON_OFFSET_FILL)}function fe(W){W?ue(n.SCISSOR_TEST):oe(n.SCISSOR_TEST)}function ne(W){W===void 0&&(W=n.TEXTURE0+V-1),j!==W&&(n.activeTexture(W),j=W)}function me(W,Ce,Te){Te===void 0&&(j===null?Te=n.TEXTURE0+V-1:Te=j);let Oe=F[Te];Oe===void 0&&(Oe={type:void 0,texture:void 0},F[Te]=Oe),(Oe.type!==W||Oe.texture!==Ce)&&(j!==Te&&(n.activeTexture(Te),j=Te),n.bindTexture(W,Ce||J[W]),Oe.type=W,Oe.texture=Ce)}function P(){const W=F[j];W!==void 0&&W.type!==void 0&&(n.bindTexture(W.type,null),W.type=void 0,W.texture=void 0)}function M(){try{n.compressedTexImage2D(...arguments)}catch(W){Et("WebGLState:",W)}}function z(){try{n.compressedTexImage3D(...arguments)}catch(W){Et("WebGLState:",W)}}function Z(){try{n.texSubImage2D(...arguments)}catch(W){Et("WebGLState:",W)}}function Q(){try{n.texSubImage3D(...arguments)}catch(W){Et("WebGLState:",W)}}function K(){try{n.compressedTexSubImage2D(...arguments)}catch(W){Et("WebGLState:",W)}}function Me(){try{n.compressedTexSubImage3D(...arguments)}catch(W){Et("WebGLState:",W)}}function ve(){try{n.texStorage2D(...arguments)}catch(W){Et("WebGLState:",W)}}function He(){try{n.texStorage3D(...arguments)}catch(W){Et("WebGLState:",W)}}function Le(){try{n.texImage2D(...arguments)}catch(W){Et("WebGLState:",W)}}function be(){try{n.texImage3D(...arguments)}catch(W){Et("WebGLState:",W)}}function we(W){ge.equals(W)===!1&&(n.scissor(W.x,W.y,W.z,W.w),ge.copy(W))}function Pe(W){xe.equals(W)===!1&&(n.viewport(W.x,W.y,W.z,W.w),xe.copy(W))}function Ne(W,Ce){let Te=c.get(Ce);Te===void 0&&(Te=new WeakMap,c.set(Ce,Te));let Oe=Te.get(W);Oe===void 0&&(Oe=n.getUniformBlockIndex(Ce,W.name),Te.set(W,Oe))}function Ie(W,Ce){const Oe=c.get(Ce).get(W);l.get(Ce)!==Oe&&(n.uniformBlockBinding(Ce,Oe,W.__bindingPointIndex),l.set(Ce,Oe))}function et(){n.disable(n.BLEND),n.disable(n.CULL_FACE),n.disable(n.DEPTH_TEST),n.disable(n.POLYGON_OFFSET_FILL),n.disable(n.SCISSOR_TEST),n.disable(n.STENCIL_TEST),n.disable(n.SAMPLE_ALPHA_TO_COVERAGE),n.blendEquation(n.FUNC_ADD),n.blendFunc(n.ONE,n.ZERO),n.blendFuncSeparate(n.ONE,n.ZERO,n.ONE,n.ZERO),n.blendColor(0,0,0,0),n.colorMask(!0,!0,!0,!0),n.clearColor(0,0,0,0),n.depthMask(!0),n.depthFunc(n.LESS),o.setReversed(!1),n.clearDepth(1),n.stencilMask(4294967295),n.stencilFunc(n.ALWAYS,0,4294967295),n.stencilOp(n.KEEP,n.KEEP,n.KEEP),n.clearStencil(0),n.cullFace(n.BACK),n.frontFace(n.CCW),n.polygonOffset(0,0),n.activeTexture(n.TEXTURE0),n.bindFramebuffer(n.FRAMEBUFFER,null),n.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),n.bindFramebuffer(n.READ_FRAMEBUFFER,null),n.useProgram(null),n.lineWidth(1),n.scissor(0,0,n.canvas.width,n.canvas.height),n.viewport(0,0,n.canvas.width,n.canvas.height),u={},j=null,F={},d={},f=new WeakMap,h=[],g=null,_=!1,p=null,m=null,v=null,S=null,x=null,C=null,A=null,R=new Ot(0,0,0),b=0,T=!1,N=null,U=null,L=null,G=null,k=null,ge.set(0,0,n.canvas.width,n.canvas.height),xe.set(0,0,n.canvas.width,n.canvas.height),s.reset(),o.reset(),a.reset()}return{buffers:{color:s,depth:o,stencil:a},enable:ue,disable:oe,bindFramebuffer:Re,drawBuffers:Ae,useProgram:le,setBlending:H,setMaterial:ee,setFlipSided:q,setCullFace:O,setLineWidth:I,setPolygonOffset:_e,setScissorTest:fe,activeTexture:ne,bindTexture:me,unbindTexture:P,compressedTexImage2D:M,compressedTexImage3D:z,texImage2D:Le,texImage3D:be,updateUBOMapping:Ne,uniformBlockBinding:Ie,texStorage2D:ve,texStorage3D:He,texSubImage2D:Z,texSubImage3D:Q,compressedTexSubImage2D:K,compressedTexSubImage3D:Me,scissor:we,viewport:Pe,reset:et}}function q3(n,e,t,i,r,s,o){const a=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new bt,u=new WeakMap;let d;const f=new WeakMap;let h=!1;try{h=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function g(P,M){return h?new OffscreenCanvas(P,M):$u("canvas")}function _(P,M,z){let Z=1;const Q=me(P);if((Q.width>z||Q.height>z)&&(Z=z/Math.max(Q.width,Q.height)),Z<1)if(typeof HTMLImageElement<"u"&&P instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&P instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&P instanceof ImageBitmap||typeof VideoFrame<"u"&&P instanceof VideoFrame){const K=Math.floor(Z*Q.width),Me=Math.floor(Z*Q.height);d===void 0&&(d=g(K,Me));const ve=M?g(K,Me):d;return ve.width=K,ve.height=Me,ve.getContext("2d").drawImage(P,0,0,K,Me),ot("WebGLRenderer: Texture has been resized from ("+Q.width+"x"+Q.height+") to ("+K+"x"+Me+")."),ve}else return"data"in P&&ot("WebGLRenderer: Image in DataTexture is too big ("+Q.width+"x"+Q.height+")."),P;return P}function p(P){return P.generateMipmaps}function m(P){n.generateMipmap(P)}function v(P){return P.isWebGLCubeRenderTarget?n.TEXTURE_CUBE_MAP:P.isWebGL3DRenderTarget?n.TEXTURE_3D:P.isWebGLArrayRenderTarget||P.isCompressedArrayTexture?n.TEXTURE_2D_ARRAY:n.TEXTURE_2D}function S(P,M,z,Z,Q=!1){if(P!==null){if(n[P]!==void 0)return n[P];ot("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+P+"'")}let K=M;if(M===n.RED&&(z===n.FLOAT&&(K=n.R32F),z===n.HALF_FLOAT&&(K=n.R16F),z===n.UNSIGNED_BYTE&&(K=n.R8)),M===n.RED_INTEGER&&(z===n.UNSIGNED_BYTE&&(K=n.R8UI),z===n.UNSIGNED_SHORT&&(K=n.R16UI),z===n.UNSIGNED_INT&&(K=n.R32UI),z===n.BYTE&&(K=n.R8I),z===n.SHORT&&(K=n.R16I),z===n.INT&&(K=n.R32I)),M===n.RG&&(z===n.FLOAT&&(K=n.RG32F),z===n.HALF_FLOAT&&(K=n.RG16F),z===n.UNSIGNED_BYTE&&(K=n.RG8)),M===n.RG_INTEGER&&(z===n.UNSIGNED_BYTE&&(K=n.RG8UI),z===n.UNSIGNED_SHORT&&(K=n.RG16UI),z===n.UNSIGNED_INT&&(K=n.RG32UI),z===n.BYTE&&(K=n.RG8I),z===n.SHORT&&(K=n.RG16I),z===n.INT&&(K=n.RG32I)),M===n.RGB_INTEGER&&(z===n.UNSIGNED_BYTE&&(K=n.RGB8UI),z===n.UNSIGNED_SHORT&&(K=n.RGB16UI),z===n.UNSIGNED_INT&&(K=n.RGB32UI),z===n.BYTE&&(K=n.RGB8I),z===n.SHORT&&(K=n.RGB16I),z===n.INT&&(K=n.RGB32I)),M===n.RGBA_INTEGER&&(z===n.UNSIGNED_BYTE&&(K=n.RGBA8UI),z===n.UNSIGNED_SHORT&&(K=n.RGBA16UI),z===n.UNSIGNED_INT&&(K=n.RGBA32UI),z===n.BYTE&&(K=n.RGBA8I),z===n.SHORT&&(K=n.RGBA16I),z===n.INT&&(K=n.RGBA32I)),M===n.RGB&&(z===n.UNSIGNED_INT_5_9_9_9_REV&&(K=n.RGB9_E5),z===n.UNSIGNED_INT_10F_11F_11F_REV&&(K=n.R11F_G11F_B10F)),M===n.RGBA){const Me=Q?Wu:St.getTransfer(Z);z===n.FLOAT&&(K=n.RGBA32F),z===n.HALF_FLOAT&&(K=n.RGBA16F),z===n.UNSIGNED_BYTE&&(K=Me===Ut?n.SRGB8_ALPHA8:n.RGBA8),z===n.UNSIGNED_SHORT_4_4_4_4&&(K=n.RGBA4),z===n.UNSIGNED_SHORT_5_5_5_1&&(K=n.RGB5_A1)}return(K===n.R16F||K===n.R32F||K===n.RG16F||K===n.RG32F||K===n.RGBA16F||K===n.RGBA32F)&&e.get("EXT_color_buffer_float"),K}function x(P,M){let z;return P?M===null||M===Dr||M===Zl?z=n.DEPTH24_STENCIL8:M===yr?z=n.DEPTH32F_STENCIL8:M===Kl&&(z=n.DEPTH24_STENCIL8,ot("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):M===null||M===Dr||M===Zl?z=n.DEPTH_COMPONENT24:M===yr?z=n.DEPTH_COMPONENT32F:M===Kl&&(z=n.DEPTH_COMPONENT16),z}function C(P,M){return p(P)===!0||P.isFramebufferTexture&&P.minFilter!==Rn&&P.minFilter!==Gn?Math.log2(Math.max(M.width,M.height))+1:P.mipmaps!==void 0&&P.mipmaps.length>0?P.mipmaps.length:P.isCompressedTexture&&Array.isArray(P.image)?M.mipmaps.length:1}function A(P){const M=P.target;M.removeEventListener("dispose",A),b(M),M.isVideoTexture&&u.delete(M)}function R(P){const M=P.target;M.removeEventListener("dispose",R),N(M)}function b(P){const M=i.get(P);if(M.__webglInit===void 0)return;const z=P.source,Z=f.get(z);if(Z){const Q=Z[M.__cacheKey];Q.usedTimes--,Q.usedTimes===0&&T(P),Object.keys(Z).length===0&&f.delete(z)}i.remove(P)}function T(P){const M=i.get(P);n.deleteTexture(M.__webglTexture);const z=P.source,Z=f.get(z);delete Z[M.__cacheKey],o.memory.textures--}function N(P){const M=i.get(P);if(P.depthTexture&&(P.depthTexture.dispose(),i.remove(P.depthTexture)),P.isWebGLCubeRenderTarget)for(let Z=0;Z<6;Z++){if(Array.isArray(M.__webglFramebuffer[Z]))for(let Q=0;Q<M.__webglFramebuffer[Z].length;Q++)n.deleteFramebuffer(M.__webglFramebuffer[Z][Q]);else n.deleteFramebuffer(M.__webglFramebuffer[Z]);M.__webglDepthbuffer&&n.deleteRenderbuffer(M.__webglDepthbuffer[Z])}else{if(Array.isArray(M.__webglFramebuffer))for(let Z=0;Z<M.__webglFramebuffer.length;Z++)n.deleteFramebuffer(M.__webglFramebuffer[Z]);else n.deleteFramebuffer(M.__webglFramebuffer);if(M.__webglDepthbuffer&&n.deleteRenderbuffer(M.__webglDepthbuffer),M.__webglMultisampledFramebuffer&&n.deleteFramebuffer(M.__webglMultisampledFramebuffer),M.__webglColorRenderbuffer)for(let Z=0;Z<M.__webglColorRenderbuffer.length;Z++)M.__webglColorRenderbuffer[Z]&&n.deleteRenderbuffer(M.__webglColorRenderbuffer[Z]);M.__webglDepthRenderbuffer&&n.deleteRenderbuffer(M.__webglDepthRenderbuffer)}const z=P.textures;for(let Z=0,Q=z.length;Z<Q;Z++){const K=i.get(z[Z]);K.__webglTexture&&(n.deleteTexture(K.__webglTexture),o.memory.textures--),i.remove(z[Z])}i.remove(P)}let U=0;function L(){U=0}function G(){const P=U;return P>=r.maxTextures&&ot("WebGLTextures: Trying to use "+P+" texture units while this GPU supports only "+r.maxTextures),U+=1,P}function k(P){const M=[];return M.push(P.wrapS),M.push(P.wrapT),M.push(P.wrapR||0),M.push(P.magFilter),M.push(P.minFilter),M.push(P.anisotropy),M.push(P.internalFormat),M.push(P.format),M.push(P.type),M.push(P.generateMipmaps),M.push(P.premultiplyAlpha),M.push(P.flipY),M.push(P.unpackAlignment),M.push(P.colorSpace),M.join()}function V(P,M){const z=i.get(P);if(P.isVideoTexture&&fe(P),P.isRenderTargetTexture===!1&&P.isExternalTexture!==!0&&P.version>0&&z.__version!==P.version){const Z=P.image;if(Z===null)ot("WebGLRenderer: Texture marked for update but no image data found.");else if(Z.complete===!1)ot("WebGLRenderer: Texture marked for update but image is incomplete");else{J(z,P,M);return}}else P.isExternalTexture&&(z.__webglTexture=P.sourceTexture?P.sourceTexture:null);t.bindTexture(n.TEXTURE_2D,z.__webglTexture,n.TEXTURE0+M)}function X(P,M){const z=i.get(P);if(P.isRenderTargetTexture===!1&&P.version>0&&z.__version!==P.version){J(z,P,M);return}else P.isExternalTexture&&(z.__webglTexture=P.sourceTexture?P.sourceTexture:null);t.bindTexture(n.TEXTURE_2D_ARRAY,z.__webglTexture,n.TEXTURE0+M)}function B(P,M){const z=i.get(P);if(P.isRenderTargetTexture===!1&&P.version>0&&z.__version!==P.version){J(z,P,M);return}t.bindTexture(n.TEXTURE_3D,z.__webglTexture,n.TEXTURE0+M)}function Y(P,M){const z=i.get(P);if(P.isCubeDepthTexture!==!0&&P.version>0&&z.__version!==P.version){ue(z,P,M);return}t.bindTexture(n.TEXTURE_CUBE_MAP,z.__webglTexture,n.TEXTURE0+M)}const j={[yh]:n.REPEAT,[Kr]:n.CLAMP_TO_EDGE,[bh]:n.MIRRORED_REPEAT},F={[Rn]:n.NEAREST,[xw]:n.NEAREST_MIPMAP_NEAREST,[Pc]:n.NEAREST_MIPMAP_LINEAR,[Gn]:n.LINEAR,[jd]:n.LINEAR_MIPMAP_NEAREST,[_o]:n.LINEAR_MIPMAP_LINEAR},ae={[Sw]:n.NEVER,[Aw]:n.ALWAYS,[Mw]:n.LESS,[Zp]:n.LEQUAL,[ww]:n.EQUAL,[Jp]:n.GEQUAL,[Ew]:n.GREATER,[Tw]:n.NOTEQUAL};function he(P,M){if(M.type===yr&&e.has("OES_texture_float_linear")===!1&&(M.magFilter===Gn||M.magFilter===jd||M.magFilter===Pc||M.magFilter===_o||M.minFilter===Gn||M.minFilter===jd||M.minFilter===Pc||M.minFilter===_o)&&ot("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),n.texParameteri(P,n.TEXTURE_WRAP_S,j[M.wrapS]),n.texParameteri(P,n.TEXTURE_WRAP_T,j[M.wrapT]),(P===n.TEXTURE_3D||P===n.TEXTURE_2D_ARRAY)&&n.texParameteri(P,n.TEXTURE_WRAP_R,j[M.wrapR]),n.texParameteri(P,n.TEXTURE_MAG_FILTER,F[M.magFilter]),n.texParameteri(P,n.TEXTURE_MIN_FILTER,F[M.minFilter]),M.compareFunction&&(n.texParameteri(P,n.TEXTURE_COMPARE_MODE,n.COMPARE_REF_TO_TEXTURE),n.texParameteri(P,n.TEXTURE_COMPARE_FUNC,ae[M.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(M.magFilter===Rn||M.minFilter!==Pc&&M.minFilter!==_o||M.type===yr&&e.has("OES_texture_float_linear")===!1)return;if(M.anisotropy>1||i.get(M).__currentAnisotropy){const z=e.get("EXT_texture_filter_anisotropic");n.texParameterf(P,z.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(M.anisotropy,r.getMaxAnisotropy())),i.get(M).__currentAnisotropy=M.anisotropy}}}function ge(P,M){let z=!1;P.__webglInit===void 0&&(P.__webglInit=!0,M.addEventListener("dispose",A));const Z=M.source;let Q=f.get(Z);Q===void 0&&(Q={},f.set(Z,Q));const K=k(M);if(K!==P.__cacheKey){Q[K]===void 0&&(Q[K]={texture:n.createTexture(),usedTimes:0},o.memory.textures++,z=!0),Q[K].usedTimes++;const Me=Q[P.__cacheKey];Me!==void 0&&(Q[P.__cacheKey].usedTimes--,Me.usedTimes===0&&T(M)),P.__cacheKey=K,P.__webglTexture=Q[K].texture}return z}function xe(P,M,z){return Math.floor(Math.floor(P/z)/M)}function Ee(P,M,z,Z){const K=P.updateRanges;if(K.length===0)t.texSubImage2D(n.TEXTURE_2D,0,0,0,M.width,M.height,z,Z,M.data);else{K.sort((be,we)=>be.start-we.start);let Me=0;for(let be=1;be<K.length;be++){const we=K[Me],Pe=K[be],Ne=we.start+we.count,Ie=xe(Pe.start,M.width,4),et=xe(we.start,M.width,4);Pe.start<=Ne+1&&Ie===et&&xe(Pe.start+Pe.count-1,M.width,4)===Ie?we.count=Math.max(we.count,Pe.start+Pe.count-we.start):(++Me,K[Me]=Pe)}K.length=Me+1;const ve=n.getParameter(n.UNPACK_ROW_LENGTH),He=n.getParameter(n.UNPACK_SKIP_PIXELS),Le=n.getParameter(n.UNPACK_SKIP_ROWS);n.pixelStorei(n.UNPACK_ROW_LENGTH,M.width);for(let be=0,we=K.length;be<we;be++){const Pe=K[be],Ne=Math.floor(Pe.start/4),Ie=Math.ceil(Pe.count/4),et=Ne%M.width,W=Math.floor(Ne/M.width),Ce=Ie,Te=1;n.pixelStorei(n.UNPACK_SKIP_PIXELS,et),n.pixelStorei(n.UNPACK_SKIP_ROWS,W),t.texSubImage2D(n.TEXTURE_2D,0,et,W,Ce,Te,z,Z,M.data)}P.clearUpdateRanges(),n.pixelStorei(n.UNPACK_ROW_LENGTH,ve),n.pixelStorei(n.UNPACK_SKIP_PIXELS,He),n.pixelStorei(n.UNPACK_SKIP_ROWS,Le)}}function J(P,M,z){let Z=n.TEXTURE_2D;(M.isDataArrayTexture||M.isCompressedArrayTexture)&&(Z=n.TEXTURE_2D_ARRAY),M.isData3DTexture&&(Z=n.TEXTURE_3D);const Q=ge(P,M),K=M.source;t.bindTexture(Z,P.__webglTexture,n.TEXTURE0+z);const Me=i.get(K);if(K.version!==Me.__version||Q===!0){t.activeTexture(n.TEXTURE0+z);const ve=St.getPrimaries(St.workingColorSpace),He=M.colorSpace===ws?null:St.getPrimaries(M.colorSpace),Le=M.colorSpace===ws||ve===He?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,M.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,M.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,M.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,Le);let be=_(M.image,!1,r.maxTextureSize);be=ne(M,be);const we=s.convert(M.format,M.colorSpace),Pe=s.convert(M.type);let Ne=S(M.internalFormat,we,Pe,M.colorSpace,M.isVideoTexture);he(Z,M);let Ie;const et=M.mipmaps,W=M.isVideoTexture!==!0,Ce=Me.__version===void 0||Q===!0,Te=K.dataReady,Oe=C(M,be);if(M.isDepthTexture)Ne=x(M.format===xo,M.type),Ce&&(W?t.texStorage2D(n.TEXTURE_2D,1,Ne,be.width,be.height):t.texImage2D(n.TEXTURE_2D,0,Ne,be.width,be.height,0,we,Pe,null));else if(M.isDataTexture)if(et.length>0){W&&Ce&&t.texStorage2D(n.TEXTURE_2D,Oe,Ne,et[0].width,et[0].height);for(let Se=0,ce=et.length;Se<ce;Se++)Ie=et[Se],W?Te&&t.texSubImage2D(n.TEXTURE_2D,Se,0,0,Ie.width,Ie.height,we,Pe,Ie.data):t.texImage2D(n.TEXTURE_2D,Se,Ne,Ie.width,Ie.height,0,we,Pe,Ie.data);M.generateMipmaps=!1}else W?(Ce&&t.texStorage2D(n.TEXTURE_2D,Oe,Ne,be.width,be.height),Te&&Ee(M,be,we,Pe)):t.texImage2D(n.TEXTURE_2D,0,Ne,be.width,be.height,0,we,Pe,be.data);else if(M.isCompressedTexture)if(M.isCompressedArrayTexture){W&&Ce&&t.texStorage3D(n.TEXTURE_2D_ARRAY,Oe,Ne,et[0].width,et[0].height,be.depth);for(let Se=0,ce=et.length;Se<ce;Se++)if(Ie=et[Se],M.format!==tr)if(we!==null)if(W){if(Te)if(M.layerUpdates.size>0){const Ge=Ym(Ie.width,Ie.height,M.format,M.type);for(const Je of M.layerUpdates){const Mt=Ie.data.subarray(Je*Ge/Ie.data.BYTES_PER_ELEMENT,(Je+1)*Ge/Ie.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,Se,0,0,Je,Ie.width,Ie.height,1,we,Mt)}M.clearLayerUpdates()}else t.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,Se,0,0,0,Ie.width,Ie.height,be.depth,we,Ie.data)}else t.compressedTexImage3D(n.TEXTURE_2D_ARRAY,Se,Ne,Ie.width,Ie.height,be.depth,0,Ie.data,0,0);else ot("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else W?Te&&t.texSubImage3D(n.TEXTURE_2D_ARRAY,Se,0,0,0,Ie.width,Ie.height,be.depth,we,Pe,Ie.data):t.texImage3D(n.TEXTURE_2D_ARRAY,Se,Ne,Ie.width,Ie.height,be.depth,0,we,Pe,Ie.data)}else{W&&Ce&&t.texStorage2D(n.TEXTURE_2D,Oe,Ne,et[0].width,et[0].height);for(let Se=0,ce=et.length;Se<ce;Se++)Ie=et[Se],M.format!==tr?we!==null?W?Te&&t.compressedTexSubImage2D(n.TEXTURE_2D,Se,0,0,Ie.width,Ie.height,we,Ie.data):t.compressedTexImage2D(n.TEXTURE_2D,Se,Ne,Ie.width,Ie.height,0,Ie.data):ot("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):W?Te&&t.texSubImage2D(n.TEXTURE_2D,Se,0,0,Ie.width,Ie.height,we,Pe,Ie.data):t.texImage2D(n.TEXTURE_2D,Se,Ne,Ie.width,Ie.height,0,we,Pe,Ie.data)}else if(M.isDataArrayTexture)if(W){if(Ce&&t.texStorage3D(n.TEXTURE_2D_ARRAY,Oe,Ne,be.width,be.height,be.depth),Te)if(M.layerUpdates.size>0){const Se=Ym(be.width,be.height,M.format,M.type);for(const ce of M.layerUpdates){const Ge=be.data.subarray(ce*Se/be.data.BYTES_PER_ELEMENT,(ce+1)*Se/be.data.BYTES_PER_ELEMENT);t.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,ce,be.width,be.height,1,we,Pe,Ge)}M.clearLayerUpdates()}else t.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,0,be.width,be.height,be.depth,we,Pe,be.data)}else t.texImage3D(n.TEXTURE_2D_ARRAY,0,Ne,be.width,be.height,be.depth,0,we,Pe,be.data);else if(M.isData3DTexture)W?(Ce&&t.texStorage3D(n.TEXTURE_3D,Oe,Ne,be.width,be.height,be.depth),Te&&t.texSubImage3D(n.TEXTURE_3D,0,0,0,0,be.width,be.height,be.depth,we,Pe,be.data)):t.texImage3D(n.TEXTURE_3D,0,Ne,be.width,be.height,be.depth,0,we,Pe,be.data);else if(M.isFramebufferTexture){if(Ce)if(W)t.texStorage2D(n.TEXTURE_2D,Oe,Ne,be.width,be.height);else{let Se=be.width,ce=be.height;for(let Ge=0;Ge<Oe;Ge++)t.texImage2D(n.TEXTURE_2D,Ge,Ne,Se,ce,0,we,Pe,null),Se>>=1,ce>>=1}}else if(et.length>0){if(W&&Ce){const Se=me(et[0]);t.texStorage2D(n.TEXTURE_2D,Oe,Ne,Se.width,Se.height)}for(let Se=0,ce=et.length;Se<ce;Se++)Ie=et[Se],W?Te&&t.texSubImage2D(n.TEXTURE_2D,Se,0,0,we,Pe,Ie):t.texImage2D(n.TEXTURE_2D,Se,Ne,we,Pe,Ie);M.generateMipmaps=!1}else if(W){if(Ce){const Se=me(be);t.texStorage2D(n.TEXTURE_2D,Oe,Ne,Se.width,Se.height)}Te&&t.texSubImage2D(n.TEXTURE_2D,0,0,0,we,Pe,be)}else t.texImage2D(n.TEXTURE_2D,0,Ne,we,Pe,be);p(M)&&m(Z),Me.__version=K.version,M.onUpdate&&M.onUpdate(M)}P.__version=M.version}function ue(P,M,z){if(M.image.length!==6)return;const Z=ge(P,M),Q=M.source;t.bindTexture(n.TEXTURE_CUBE_MAP,P.__webglTexture,n.TEXTURE0+z);const K=i.get(Q);if(Q.version!==K.__version||Z===!0){t.activeTexture(n.TEXTURE0+z);const Me=St.getPrimaries(St.workingColorSpace),ve=M.colorSpace===ws?null:St.getPrimaries(M.colorSpace),He=M.colorSpace===ws||Me===ve?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,M.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,M.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,M.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,He);const Le=M.isCompressedTexture||M.image[0].isCompressedTexture,be=M.image[0]&&M.image[0].isDataTexture,we=[];for(let ce=0;ce<6;ce++)!Le&&!be?we[ce]=_(M.image[ce],!0,r.maxCubemapSize):we[ce]=be?M.image[ce].image:M.image[ce],we[ce]=ne(M,we[ce]);const Pe=we[0],Ne=s.convert(M.format,M.colorSpace),Ie=s.convert(M.type),et=S(M.internalFormat,Ne,Ie,M.colorSpace),W=M.isVideoTexture!==!0,Ce=K.__version===void 0||Z===!0,Te=Q.dataReady;let Oe=C(M,Pe);he(n.TEXTURE_CUBE_MAP,M);let Se;if(Le){W&&Ce&&t.texStorage2D(n.TEXTURE_CUBE_MAP,Oe,et,Pe.width,Pe.height);for(let ce=0;ce<6;ce++){Se=we[ce].mipmaps;for(let Ge=0;Ge<Se.length;Ge++){const Je=Se[Ge];M.format!==tr?Ne!==null?W?Te&&t.compressedTexSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ce,Ge,0,0,Je.width,Je.height,Ne,Je.data):t.compressedTexImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ce,Ge,et,Je.width,Je.height,0,Je.data):ot("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):W?Te&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ce,Ge,0,0,Je.width,Je.height,Ne,Ie,Je.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ce,Ge,et,Je.width,Je.height,0,Ne,Ie,Je.data)}}}else{if(Se=M.mipmaps,W&&Ce){Se.length>0&&Oe++;const ce=me(we[0]);t.texStorage2D(n.TEXTURE_CUBE_MAP,Oe,et,ce.width,ce.height)}for(let ce=0;ce<6;ce++)if(be){W?Te&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ce,0,0,0,we[ce].width,we[ce].height,Ne,Ie,we[ce].data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ce,0,et,we[ce].width,we[ce].height,0,Ne,Ie,we[ce].data);for(let Ge=0;Ge<Se.length;Ge++){const Mt=Se[Ge].image[ce].image;W?Te&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ce,Ge+1,0,0,Mt.width,Mt.height,Ne,Ie,Mt.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ce,Ge+1,et,Mt.width,Mt.height,0,Ne,Ie,Mt.data)}}else{W?Te&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ce,0,0,0,Ne,Ie,we[ce]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ce,0,et,Ne,Ie,we[ce]);for(let Ge=0;Ge<Se.length;Ge++){const Je=Se[Ge];W?Te&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ce,Ge+1,0,0,Ne,Ie,Je.image[ce]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ce,Ge+1,et,Ne,Ie,Je.image[ce])}}}p(M)&&m(n.TEXTURE_CUBE_MAP),K.__version=Q.version,M.onUpdate&&M.onUpdate(M)}P.__version=M.version}function oe(P,M,z,Z,Q,K){const Me=s.convert(z.format,z.colorSpace),ve=s.convert(z.type),He=S(z.internalFormat,Me,ve,z.colorSpace),Le=i.get(M),be=i.get(z);if(be.__renderTarget=M,!Le.__hasExternalTextures){const we=Math.max(1,M.width>>K),Pe=Math.max(1,M.height>>K);Q===n.TEXTURE_3D||Q===n.TEXTURE_2D_ARRAY?t.texImage3D(Q,K,He,we,Pe,M.depth,0,Me,ve,null):t.texImage2D(Q,K,He,we,Pe,0,Me,ve,null)}t.bindFramebuffer(n.FRAMEBUFFER,P),_e(M)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,Z,Q,be.__webglTexture,0,I(M)):(Q===n.TEXTURE_2D||Q>=n.TEXTURE_CUBE_MAP_POSITIVE_X&&Q<=n.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&n.framebufferTexture2D(n.FRAMEBUFFER,Z,Q,be.__webglTexture,K),t.bindFramebuffer(n.FRAMEBUFFER,null)}function Re(P,M,z){if(n.bindRenderbuffer(n.RENDERBUFFER,P),M.depthBuffer){const Z=M.depthTexture,Q=Z&&Z.isDepthTexture?Z.type:null,K=x(M.stencilBuffer,Q),Me=M.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;_e(M)?a.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,I(M),K,M.width,M.height):z?n.renderbufferStorageMultisample(n.RENDERBUFFER,I(M),K,M.width,M.height):n.renderbufferStorage(n.RENDERBUFFER,K,M.width,M.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,Me,n.RENDERBUFFER,P)}else{const Z=M.textures;for(let Q=0;Q<Z.length;Q++){const K=Z[Q],Me=s.convert(K.format,K.colorSpace),ve=s.convert(K.type),He=S(K.internalFormat,Me,ve,K.colorSpace);_e(M)?a.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,I(M),He,M.width,M.height):z?n.renderbufferStorageMultisample(n.RENDERBUFFER,I(M),He,M.width,M.height):n.renderbufferStorage(n.RENDERBUFFER,He,M.width,M.height)}}n.bindRenderbuffer(n.RENDERBUFFER,null)}function Ae(P,M,z){const Z=M.isWebGLCubeRenderTarget===!0;if(t.bindFramebuffer(n.FRAMEBUFFER,P),!(M.depthTexture&&M.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const Q=i.get(M.depthTexture);if(Q.__renderTarget=M,(!Q.__webglTexture||M.depthTexture.image.width!==M.width||M.depthTexture.image.height!==M.height)&&(M.depthTexture.image.width=M.width,M.depthTexture.image.height=M.height,M.depthTexture.needsUpdate=!0),Z){if(Q.__webglInit===void 0&&(Q.__webglInit=!0,M.depthTexture.addEventListener("dispose",A)),Q.__webglTexture===void 0){Q.__webglTexture=n.createTexture(),t.bindTexture(n.TEXTURE_CUBE_MAP,Q.__webglTexture),he(n.TEXTURE_CUBE_MAP,M.depthTexture);const Le=s.convert(M.depthTexture.format),be=s.convert(M.depthTexture.type);let we;M.depthTexture.format===cs?we=n.DEPTH_COMPONENT24:M.depthTexture.format===xo&&(we=n.DEPTH24_STENCIL8);for(let Pe=0;Pe<6;Pe++)n.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+Pe,0,we,M.width,M.height,0,Le,be,null)}}else V(M.depthTexture,0);const K=Q.__webglTexture,Me=I(M),ve=Z?n.TEXTURE_CUBE_MAP_POSITIVE_X+z:n.TEXTURE_2D,He=M.depthTexture.format===xo?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;if(M.depthTexture.format===cs)_e(M)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,He,ve,K,0,Me):n.framebufferTexture2D(n.FRAMEBUFFER,He,ve,K,0);else if(M.depthTexture.format===xo)_e(M)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,He,ve,K,0,Me):n.framebufferTexture2D(n.FRAMEBUFFER,He,ve,K,0);else throw new Error("Unknown depthTexture format")}function le(P){const M=i.get(P),z=P.isWebGLCubeRenderTarget===!0;if(M.__boundDepthTexture!==P.depthTexture){const Z=P.depthTexture;if(M.__depthDisposeCallback&&M.__depthDisposeCallback(),Z){const Q=()=>{delete M.__boundDepthTexture,delete M.__depthDisposeCallback,Z.removeEventListener("dispose",Q)};Z.addEventListener("dispose",Q),M.__depthDisposeCallback=Q}M.__boundDepthTexture=Z}if(P.depthTexture&&!M.__autoAllocateDepthBuffer)if(z)for(let Z=0;Z<6;Z++)Ae(M.__webglFramebuffer[Z],P,Z);else{const Z=P.texture.mipmaps;Z&&Z.length>0?Ae(M.__webglFramebuffer[0],P,0):Ae(M.__webglFramebuffer,P,0)}else if(z){M.__webglDepthbuffer=[];for(let Z=0;Z<6;Z++)if(t.bindFramebuffer(n.FRAMEBUFFER,M.__webglFramebuffer[Z]),M.__webglDepthbuffer[Z]===void 0)M.__webglDepthbuffer[Z]=n.createRenderbuffer(),Re(M.__webglDepthbuffer[Z],P,!1);else{const Q=P.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,K=M.__webglDepthbuffer[Z];n.bindRenderbuffer(n.RENDERBUFFER,K),n.framebufferRenderbuffer(n.FRAMEBUFFER,Q,n.RENDERBUFFER,K)}}else{const Z=P.texture.mipmaps;if(Z&&Z.length>0?t.bindFramebuffer(n.FRAMEBUFFER,M.__webglFramebuffer[0]):t.bindFramebuffer(n.FRAMEBUFFER,M.__webglFramebuffer),M.__webglDepthbuffer===void 0)M.__webglDepthbuffer=n.createRenderbuffer(),Re(M.__webglDepthbuffer,P,!1);else{const Q=P.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,K=M.__webglDepthbuffer;n.bindRenderbuffer(n.RENDERBUFFER,K),n.framebufferRenderbuffer(n.FRAMEBUFFER,Q,n.RENDERBUFFER,K)}}t.bindFramebuffer(n.FRAMEBUFFER,null)}function w(P,M,z){const Z=i.get(P);M!==void 0&&oe(Z.__webglFramebuffer,P,P.texture,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,0),z!==void 0&&le(P)}function E(P){const M=P.texture,z=i.get(P),Z=i.get(M);P.addEventListener("dispose",R);const Q=P.textures,K=P.isWebGLCubeRenderTarget===!0,Me=Q.length>1;if(Me||(Z.__webglTexture===void 0&&(Z.__webglTexture=n.createTexture()),Z.__version=M.version,o.memory.textures++),K){z.__webglFramebuffer=[];for(let ve=0;ve<6;ve++)if(M.mipmaps&&M.mipmaps.length>0){z.__webglFramebuffer[ve]=[];for(let He=0;He<M.mipmaps.length;He++)z.__webglFramebuffer[ve][He]=n.createFramebuffer()}else z.__webglFramebuffer[ve]=n.createFramebuffer()}else{if(M.mipmaps&&M.mipmaps.length>0){z.__webglFramebuffer=[];for(let ve=0;ve<M.mipmaps.length;ve++)z.__webglFramebuffer[ve]=n.createFramebuffer()}else z.__webglFramebuffer=n.createFramebuffer();if(Me)for(let ve=0,He=Q.length;ve<He;ve++){const Le=i.get(Q[ve]);Le.__webglTexture===void 0&&(Le.__webglTexture=n.createTexture(),o.memory.textures++)}if(P.samples>0&&_e(P)===!1){z.__webglMultisampledFramebuffer=n.createFramebuffer(),z.__webglColorRenderbuffer=[],t.bindFramebuffer(n.FRAMEBUFFER,z.__webglMultisampledFramebuffer);for(let ve=0;ve<Q.length;ve++){const He=Q[ve];z.__webglColorRenderbuffer[ve]=n.createRenderbuffer(),n.bindRenderbuffer(n.RENDERBUFFER,z.__webglColorRenderbuffer[ve]);const Le=s.convert(He.format,He.colorSpace),be=s.convert(He.type),we=S(He.internalFormat,Le,be,He.colorSpace,P.isXRRenderTarget===!0),Pe=I(P);n.renderbufferStorageMultisample(n.RENDERBUFFER,Pe,we,P.width,P.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+ve,n.RENDERBUFFER,z.__webglColorRenderbuffer[ve])}n.bindRenderbuffer(n.RENDERBUFFER,null),P.depthBuffer&&(z.__webglDepthRenderbuffer=n.createRenderbuffer(),Re(z.__webglDepthRenderbuffer,P,!0)),t.bindFramebuffer(n.FRAMEBUFFER,null)}}if(K){t.bindTexture(n.TEXTURE_CUBE_MAP,Z.__webglTexture),he(n.TEXTURE_CUBE_MAP,M);for(let ve=0;ve<6;ve++)if(M.mipmaps&&M.mipmaps.length>0)for(let He=0;He<M.mipmaps.length;He++)oe(z.__webglFramebuffer[ve][He],P,M,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+ve,He);else oe(z.__webglFramebuffer[ve],P,M,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+ve,0);p(M)&&m(n.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(Me){for(let ve=0,He=Q.length;ve<He;ve++){const Le=Q[ve],be=i.get(Le);let we=n.TEXTURE_2D;(P.isWebGL3DRenderTarget||P.isWebGLArrayRenderTarget)&&(we=P.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),t.bindTexture(we,be.__webglTexture),he(we,Le),oe(z.__webglFramebuffer,P,Le,n.COLOR_ATTACHMENT0+ve,we,0),p(Le)&&m(we)}t.unbindTexture()}else{let ve=n.TEXTURE_2D;if((P.isWebGL3DRenderTarget||P.isWebGLArrayRenderTarget)&&(ve=P.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),t.bindTexture(ve,Z.__webglTexture),he(ve,M),M.mipmaps&&M.mipmaps.length>0)for(let He=0;He<M.mipmaps.length;He++)oe(z.__webglFramebuffer[He],P,M,n.COLOR_ATTACHMENT0,ve,He);else oe(z.__webglFramebuffer,P,M,n.COLOR_ATTACHMENT0,ve,0);p(M)&&m(ve),t.unbindTexture()}P.depthBuffer&&le(P)}function H(P){const M=P.textures;for(let z=0,Z=M.length;z<Z;z++){const Q=M[z];if(p(Q)){const K=v(P),Me=i.get(Q).__webglTexture;t.bindTexture(K,Me),m(K),t.unbindTexture()}}}const ee=[],q=[];function O(P){if(P.samples>0){if(_e(P)===!1){const M=P.textures,z=P.width,Z=P.height;let Q=n.COLOR_BUFFER_BIT;const K=P.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,Me=i.get(P),ve=M.length>1;if(ve)for(let Le=0;Le<M.length;Le++)t.bindFramebuffer(n.FRAMEBUFFER,Me.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+Le,n.RENDERBUFFER,null),t.bindFramebuffer(n.FRAMEBUFFER,Me.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+Le,n.TEXTURE_2D,null,0);t.bindFramebuffer(n.READ_FRAMEBUFFER,Me.__webglMultisampledFramebuffer);const He=P.texture.mipmaps;He&&He.length>0?t.bindFramebuffer(n.DRAW_FRAMEBUFFER,Me.__webglFramebuffer[0]):t.bindFramebuffer(n.DRAW_FRAMEBUFFER,Me.__webglFramebuffer);for(let Le=0;Le<M.length;Le++){if(P.resolveDepthBuffer&&(P.depthBuffer&&(Q|=n.DEPTH_BUFFER_BIT),P.stencilBuffer&&P.resolveStencilBuffer&&(Q|=n.STENCIL_BUFFER_BIT)),ve){n.framebufferRenderbuffer(n.READ_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.RENDERBUFFER,Me.__webglColorRenderbuffer[Le]);const be=i.get(M[Le]).__webglTexture;n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,be,0)}n.blitFramebuffer(0,0,z,Z,0,0,z,Z,Q,n.NEAREST),l===!0&&(ee.length=0,q.length=0,ee.push(n.COLOR_ATTACHMENT0+Le),P.depthBuffer&&P.resolveDepthBuffer===!1&&(ee.push(K),q.push(K),n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,q)),n.invalidateFramebuffer(n.READ_FRAMEBUFFER,ee))}if(t.bindFramebuffer(n.READ_FRAMEBUFFER,null),t.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),ve)for(let Le=0;Le<M.length;Le++){t.bindFramebuffer(n.FRAMEBUFFER,Me.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+Le,n.RENDERBUFFER,Me.__webglColorRenderbuffer[Le]);const be=i.get(M[Le]).__webglTexture;t.bindFramebuffer(n.FRAMEBUFFER,Me.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+Le,n.TEXTURE_2D,be,0)}t.bindFramebuffer(n.DRAW_FRAMEBUFFER,Me.__webglMultisampledFramebuffer)}else if(P.depthBuffer&&P.resolveDepthBuffer===!1&&l){const M=P.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,[M])}}}function I(P){return Math.min(r.maxSamples,P.samples)}function _e(P){const M=i.get(P);return P.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&M.__useRenderToTexture!==!1}function fe(P){const M=o.render.frame;u.get(P)!==M&&(u.set(P,M),P.update())}function ne(P,M){const z=P.colorSpace,Z=P.format,Q=P.type;return P.isCompressedTexture===!0||P.isVideoTexture===!0||z!==Fa&&z!==ws&&(St.getTransfer(z)===Ut?(Z!==tr||Q!==zi)&&ot("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):Et("WebGLTextures: Unsupported texture color space:",z)),M}function me(P){return typeof HTMLImageElement<"u"&&P instanceof HTMLImageElement?(c.width=P.naturalWidth||P.width,c.height=P.naturalHeight||P.height):typeof VideoFrame<"u"&&P instanceof VideoFrame?(c.width=P.displayWidth,c.height=P.displayHeight):(c.width=P.width,c.height=P.height),c}this.allocateTextureUnit=G,this.resetTextureUnits=L,this.setTexture2D=V,this.setTexture2DArray=X,this.setTexture3D=B,this.setTextureCube=Y,this.rebindTextures=w,this.setupRenderTarget=E,this.updateRenderTargetMipmap=H,this.updateMultisampleRenderTarget=O,this.setupDepthRenderbuffer=le,this.setupFrameBufferTexture=oe,this.useMultisampledRTT=_e,this.isReversedDepthBuffer=function(){return t.buffers.depth.getReversed()}}function K3(n,e){function t(i,r=ws){let s;const o=St.getTransfer(r);if(i===zi)return n.UNSIGNED_BYTE;if(i===$p)return n.UNSIGNED_SHORT_4_4_4_4;if(i===jp)return n.UNSIGNED_SHORT_5_5_5_1;if(i===hv)return n.UNSIGNED_INT_5_9_9_9_REV;if(i===pv)return n.UNSIGNED_INT_10F_11F_11F_REV;if(i===dv)return n.BYTE;if(i===fv)return n.SHORT;if(i===Kl)return n.UNSIGNED_SHORT;if(i===Xp)return n.INT;if(i===Dr)return n.UNSIGNED_INT;if(i===yr)return n.FLOAT;if(i===ls)return n.HALF_FLOAT;if(i===mv)return n.ALPHA;if(i===gv)return n.RGB;if(i===tr)return n.RGBA;if(i===cs)return n.DEPTH_COMPONENT;if(i===xo)return n.DEPTH_STENCIL;if(i===_v)return n.RED;if(i===Yp)return n.RED_INTEGER;if(i===Ua)return n.RG;if(i===qp)return n.RG_INTEGER;if(i===Kp)return n.RGBA_INTEGER;if(i===mu||i===gu||i===_u||i===xu)if(o===Ut)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(i===mu)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===gu)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===_u)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===xu)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(i===mu)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===gu)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===_u)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===xu)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===Sh||i===Mh||i===wh||i===Eh)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(i===Sh)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===Mh)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===wh)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===Eh)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===Th||i===Ah||i===Ch||i===Rh||i===Ph||i===Dh||i===Lh)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(i===Th||i===Ah)return o===Ut?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(i===Ch)return o===Ut?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC;if(i===Rh)return s.COMPRESSED_R11_EAC;if(i===Ph)return s.COMPRESSED_SIGNED_R11_EAC;if(i===Dh)return s.COMPRESSED_RG11_EAC;if(i===Lh)return s.COMPRESSED_SIGNED_RG11_EAC}else return null;if(i===Ih||i===Uh||i===Fh||i===Nh||i===Oh||i===kh||i===Bh||i===zh||i===Vh||i===Hh||i===Gh||i===Wh||i===Xh||i===$h)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(i===Ih)return o===Ut?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===Uh)return o===Ut?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===Fh)return o===Ut?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===Nh)return o===Ut?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===Oh)return o===Ut?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===kh)return o===Ut?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===Bh)return o===Ut?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===zh)return o===Ut?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===Vh)return o===Ut?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===Hh)return o===Ut?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===Gh)return o===Ut?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===Wh)return o===Ut?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===Xh)return o===Ut?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===$h)return o===Ut?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===jh||i===Yh||i===qh)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(i===jh)return o===Ut?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===Yh)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===qh)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===Kh||i===Zh||i===Jh||i===Qh)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(i===Kh)return s.COMPRESSED_RED_RGTC1_EXT;if(i===Zh)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===Jh)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===Qh)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===Zl?n.UNSIGNED_INT_24_8:n[i]!==void 0?n[i]:null}return{convert:t}}const Z3=`
void main() {
...
}`;class Q3{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t){if(this.texture===null){const i=new Av(e.texture);(e.depthNear!==t.depthNear||e.depthFar!==t.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=i}}getMesh(e){if(this.texture!==null&&this.mesh===null){const t=e.cameras[0].viewport,i=new sr({vertexShader:Z3,fragmentShader:J3,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new Lr(new cc(20,20),i)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class eC extends Oa{constructor(e,t){super();const i=this;let r=null,s=1,o=null,a="local-floor",l=1,c=null,u=null,d=null,f=null,h=null,g=null;const _=typeof XRWebGLBinding<"u",p=new Q3,m={},v=t.getContextAttributes();let S=null,x=null;const C=[],A=[],R=new bt;let b=null;const T=new Qi;T.viewport=new nn;const N=new Qi;N.viewport=new nn;const U=[T,N],L=new f2;let G=null,k=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(J){let ue=C[J];return ue===void 0&&(ue=new tf,C[J]=ue),ue.getTargetRaySpace()},this.getControllerGrip=function(J){let ue=C[J];return ue===void 0&&(ue=new tf,C[J]=ue),ue.getGripSpace()},this.getHand=function(J){let ue=C[J];return ue===void 0&&(ue=new tf,C[J]=ue),ue.getHandSpace()};function V(J){const ue=A.indexOf(J.inputSource);if(ue===-1)return;const oe=C[ue];oe!==void 0&&(oe.update(J.inputSource,J.frame,c||o),oe.dispatchEvent({type:J.type,data:J.inputSource}))}function X(){r.removeEventListener("select",V),r.removeEventListener("selectstart",V),r.removeEventListener("selectend",V),r.removeEventListener("squeeze",V),r.removeEventListener("squeezestart",V),r.removeEventListener("squeezeend",V),r.removeEventListener("end",X),r.removeEventListener("inputsourceschange",B);for(let J=0;J<C.length;J++){const ue=A[J];ue!==null&&(A[J]=null,C[J].disconnect(ue))}G=null,k=null,p.reset();for(const J in m)delete m[J];e.setRenderTarget(S),h=null,f=null,d=null,r=null,x=null,Ee.stop(),i.isPresenting=!1,e.setPixelRatio(b),e.setSize(R.width,R.height,!1),i.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(J){s=J,i.isPresenting===!0&&ot("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(J){a=J,i.isPresenting===!0&&ot("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||o},this.setReferenceSpace=function(J){c=J},this.getBaseLayer=function(){return f!==null?f:h},this.getBinding=function(){return d===null&&_&&(d=new XRWebGLBinding(r,t)),d},this.getFrame=function(){return g},this.getSession=function(){return r},this.setSession=async function(J){if(r=J,r!==null){if(S=e.getRenderTarget(),r.addEventListener("select",V),r.addEventListener("selectstart",V),r.addEventListener("selectend",V),r.addEventListener("squeeze",V),r.addEventListener("squeezestart",V),r.addEventListener("squeezeend",V),r.addEventListener("end",X),r.addEventListener("inputsourceschange",B),v.xrCompatible!==!0&&await t.makeXRCompatible(),b=e.getPixelRatio(),e.getSize(R),_&&"createProjectionLayer"in XRWebGLBinding.prototype){let oe=null,Re=null,Ae=null;v.depth&&(Ae=v.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,oe=v.stencil?xo:cs,Re=v.stencil?Zl:Dr);const le={colorFormat:t.RGBA8,depthFormat:Ae,scaleFactor:s};d=this.getBinding(),f=d.createProjectionLayer(le),r.updateRenderState({layers:[f]}),e.setPixelRatio(1),e.setSize(f.textureWidth,f.textureHeight,!1),x=new Tr(f.textureWidth,f.textureHeight,{format:tr,type:zi,depthTexture:new Jl(f.textureWidth,f.textureHeight,Re,void 0,void 0,void 0,void 0,void 0,void 0,oe),stencilBuffer:v.stencil,colorSpace:e.outputColorSpace,samples:v.antialias?4:0,resolveDepthBuffer:f.ignoreDepthValues===!1,resolveStencilBuffer:f.ignoreDepthValues===!1})}else{const oe={antialias:v.antialias,alpha:!0,depth:v.depth,stencil:v.stencil,framebufferScaleFactor:s};h=new XRWebGLLayer(r,t,oe),r.updateRenderState({baseLayer:h}),e.setPixelRatio(1),e.setSize(h.framebufferWidth,h.framebufferHeight,!1),x=new Tr(h.framebufferWidth,h.framebufferHeight,{format:tr,type:zi,colorSpace:e.outputColorSpace,stencilBuffer:v.stencil,resolveDepthBuffer:h.ignoreDepthValues===!1,resolveStencilBuffer:h.ignoreDepthValues===!1})}x.isXRRenderTarget=!0,this.setFoveation(l),c=null,o=await r.requestReferenceSpace(a),Ee.setContext(r),Ee.start(),i.isPresenting=!0,i.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return p.getDepthTexture()};function B(J){for(let ue=0;ue<J.removed.length;ue++){const oe=J.removed[ue],Re=A.indexOf(oe);Re>=0&&(A[Re]=null,C[Re].disconnect(oe))}for(let ue=0;ue<J.added.length;ue++){const oe=J.added[ue];let Re=A.indexOf(oe);if(Re===-1){for(let le=0;le<C.length;le++)if(le>=A.length){A.push(oe),Re=le;break}else if(A[le]===null){A[le]=oe,Re=le;break}if(Re===-1)break}const Ae=C[Re];Ae&&Ae.connect(oe)}}const Y=new se,j=new se;function F(J,ue,oe){Y.setFromMatrixPosition(ue.matrixWorld),j.setFromMatrixPosition(oe.matrixWorld);const Re=Y.distanceTo(j),Ae=ue.projectionMatrix.elements,le=oe.projectionMatrix.elements,w=Ae[14]/(Ae[10]-1),E=Ae[14]/(Ae[10]+1),H=(Ae[9]+1)/Ae[5],ee=(Ae[9]-1)/Ae[5],q=(Ae[8]-1)/Ae[0],O=(le[8]+1)/le[0],I=w*q,_e=w*O,fe=Re/(-q+O),ne=fe*-q;if(ue.matrixWorld.decompose(J.position,J.quaternion,J.scale),J.translateX(ne),J.translateZ(fe),J.matrixWorld.compose(J.position,J.quaternion,J.scale),J.matrixWorldInverse.copy(J.matrixWorld).invert(),Ae[10]===-1)J.projectionMatrix.copy(ue.projectionMatrix),J.projectionMatrixInverse.copy(ue.projectionMatrixInverse);else{const me=w+fe,P=E+fe,M=I-ne,z=_e+(Re-ne),Z=H*E/P*me,Q=ee*E/P*me;J.projectionMatrix.makePerspective(M,z,Z,Q,me,P),J.projectionMatrixInverse.copy(J.projectionMatrix).invert()}}function ae(J,ue){ue===null?J.matrixWorld.copy(J.matrix):J.matrixWorld.multiplyMatrices(ue.matrixWorld,J.matrix),J.matrixWorldInverse.copy(J.matrixWorld).invert()}this.updateCamera=function(J){if(r===null)return;let ue=J.near,oe=J.far;p.texture!==null&&(p.depthNear>0&&(ue=p.depthNear),p.depthFar>0&&(oe=p.depthFar)),L.near=N.near=T.near=ue,L.far=N.far=T.far=oe,(G!==L.near||k!==L.far)&&(r.updateRenderState({depthNear:L.near,depthFar:L.far}),G=L.near,k=L.far),L.layers.mask=J.layers.mask|6,T.layers.mask=L.layers.mask&-5,N.layers.mask=L.layers.mask&-3;const Re=J.parent,Ae=L.cameras;ae(L,Re);for(let le=0;le<Ae.length;le++)ae(Ae[le],Re);Ae.length===2?F(L,T,N):L.projectionMatrix.copy(T.projectionMatrix),he(J,L,Re)};function he(J,ue,oe){oe===null?J.matrix.copy(ue.matrixWorld):(J.matrix.copy(oe.matrixWorld),J.matrix.invert(),J.matrix.multiply(ue.matrixWorld)),J.matrix.decompose(J.position,J.quaternion,J.scale),J.updateMatrixWorld(!0),J.projectionMatrix.copy(ue.projectionMatrix),J.projectionMatrixInverse.copy(ue.projectionMatrixInverse),J.isPerspectiveCamera&&(J.fov=ep*2*Math.atan(1/J.projectionMatrix.elements[5]),J.zoom=1)}this.getCamera=function(){return L},this.getFoveation=function(){if(!(f===null&&h===null))return l},this.setFoveation=function(J){l=J,f!==null&&(f.fixedFoveation=J),h!==null&&h.fixedFoveation!==void 0&&(h.fixedFoveation=J)},this.hasDepthSensing=function(){return p.texture!==null},this.getDepthSensingMesh=function(){return p.getMesh(L)},this.getCameraTexture=function(J){return m[J]};let ge=null;function xe(J,ue){if(u=ue.getViewerPose(c||o),g=ue,u!==null){const oe=u.views;h!==null&&(e.setRenderTargetFramebuffer(x,h.framebuffer),e.setRenderTarget(x));let Re=!1;oe.length!==L.cameras.length&&(L.cameras.length=0,Re=!0);for(let E=0;E<oe.length;E++){const H=oe[E];let ee=null;if(h!==null)ee=h.getViewport(H);else{const O=d.getViewSubImage(f,H);ee=O.viewport,E===0&&(e.setRenderTargetTextures(x,O.colorTexture,O.depthStencilTexture),e.setRenderTarget(x))}let q=U[E];q===void 0&&(q=new Qi,q.layers.enable(E),q.viewport=new nn,U[E]=q),q.matrix.fromArray(H.transform.matrix),q.matrix.decompose(q.position,q.quaternion,q.scale),q.projectionMatrix.fromArray(H.projectionMatrix),q.projectionMatrixInverse.copy(q.projectionMatrix).invert(),q.viewport.set(ee.x,ee.y,ee.width,ee.height),E===0&&(L.matrix.copy(q.matrix),L.matrix.decompose(L.position,L.quaternion,L.scale)),Re===!0&&L.cameras.push(q)}const Ae=r.enabledFeatures;if(Ae&&Ae.includes("depth-sensing")&&r.depthUsage=="gpu-optimized"&&_){d=i.getBinding();const E=d.getDepthInformation(oe[0]);E&&E.isValid&&E.texture&&p.init(E,r.renderState)}if(Ae&&Ae.includes("camera-access")&&_){e.state.unbindTexture(),d=i.getBinding();for(let E=0;E<oe.length;E++){const H=oe[E].camera;if(H){let ee=m[H];ee||(ee=new Av,m[H]=ee);const q=d.getCameraImage(H);ee.sourceTexture=q}}}}for(let oe=0;oe<C.length;oe++){const Re=A[oe],Ae=C[oe];Re!==null&&Ae!==void 0&&Ae.update(Re,ue,c||o)}ge&&ge(J,ue),ue.detectedPlanes&&i.dispatchEvent({type:"planesdetected",data:ue}),g=null}const Ee=new Pv;Ee.setAnimationLoop(xe),this.setAnimationLoop=function(J){ge=J},this.dispose=function(){}}}const no=new us,tC=new cn;function nC(n,e){function t(p,m){p.matrixAutoUpdate===!0&&p.updateMatrix(),m.value.copy(p.matrix)}function i(p,m){m.color.getRGB(p.fogColor.value,Cv(n)),m.isFog?(p.fogNear.value=m.near,p.fogFar.value=m.far):m.isFogExp2&&(p.fogDensity.value=m.density)}function r(p,m,v,S,x){m.isMeshBasicMaterial?s(p,m):m.isMeshLambertMaterial?(s(p,m),m.envMap&&(p.envMapIntensity.value=m.envMapIntensity)):m.isMeshToonMaterial?(s(p,m),d(p,m)):m.isMeshPhongMaterial?(s(p,m),u(p,m),m.envMap&&(p.envMapIntensity.value=m.envMapIntensity)):m.isMeshStandardMaterial?(s(p,m),f(p,m),m.isMeshPhysicalMaterial&&h(p,m,x)):m.isMeshMatcapMaterial?(s(p,m),g(p,m)):m.isMeshDepthMaterial?s(p,m):m.isMeshDistanceMaterial?(s(p,m),_(p,m)):m.isMeshNormalMaterial?s(p,m):m.isLineBasicMaterial?(o(p,m),m.isLineDashedMaterial&&a(p,m)):m.isPointsMaterial?l(p,m,v,S):m.isSpriteMaterial?c(p,m):m.isShadowMaterial?(p.color.value.copy(m.color),p.opacity.value=m.opacity):m.isShaderMaterial&&(m.uniformsNeedUpdate=!1)}function s(p,m){p.opacity.value=m.opacity,m.color&&p.diffuse.value.copy(m.color),m.emissive&&p.emissive.value.copy(m.emissive).multiplyScalar(m.emissiveIntensity),m.map&&(p.map.value=m.map,t(m.map,p.mapTransform)),m.alphaMap&&(p.alphaMap.value=m.alphaMap,t(m.alphaMap,p.alphaMapTransform)),m.bumpMap&&(p.bumpMap.value=m.bumpMap,t(m.bumpMap,p.bumpMapTransform),p.bumpScale.value=m.bumpScale,m.side===hi&&(p.bumpScale.value*=-1)),m.normalMap&&(p.normalMap.value=m.normalMap,t(m.normalMap,p.normalMapTransform),p.normalScale.value.copy(m.normalScale),m.side===hi&&p.normalScale.value.negate()),m.displacementMap&&(p.displacementMap.value=m.displacementMap,t(m.displacementMap,p.displacementMapTransform),p.displacementScale.value=m.displacementScale,p.displacementBias.value=m.displacementBias),m.emissiveMap&&(p.emissiveMap.value=m.emissiveMap,t(m.emissiveMap,p.emissiveMapTransform)),m.specularMap&&(p.specularMap.value=m.specularMap,t(m.specularMap,p.specularMapTransform)),m.alphaTest>0&&(p.alphaTest.value=m.alphaTest);const v=e.get(m),S=v.envMap,x=v.envMapRotation;S&&(p.envMap.value=S,no.copy(x),no.x*=-1,no.y*=-1,no.z*=-1,S.isCubeTexture&&S.isRenderTargetTexture===!1&&(no.y*=-1,no.z*=-1),p.envMapRotation.value.setFromMatrix4(tC.makeRotationFromEuler(no)),p.flipEnvMap.value=S.isCubeTexture&&S.isRenderTargetTexture===!1?-1:1,p.reflectivity.value=m.reflectivity,p.ior.value=m.ior,p.refractionRatio.value=m.refractionRatio),m.lightMap&&(p.lightMap.value=m.lightMap,p.lightMapIntensity.value=m.lightMapIntensity,t(m.lightMap,p.lightMapTransform)),m.aoMap&&(p.aoMap.value=m.aoMap,p.aoMapIntensity.value=m.aoMapIntensity,t(m.aoMap,p.aoMapTransform))}function o(p,m){p.diffuse.value.copy(m.color),p.opacity.value=m.opacity,m.map&&(p.map.value=m.map,t(m.map,p.mapTransform))}function a(p,m){p.dashSize.value=m.dashSize,p.totalSize.value=m.dashSize+m.gapSize,p.scale.value=m.scale}function l(p,m,v,S){p.diffuse.value.copy(m.color),p.opacity.value=m.opacity,p.size.value=m.size*v,p.scale.value=S*.5,m.map&&(p.map.value=m.map,t(m.map,p.uvTransform)),m.alphaMap&&(p.alphaMap.value=m.alphaMap,t(m.alphaMap,p.alphaMapTransform)),m.alphaTest>0&&(p.alphaTest.value=m.alphaTest)}function c(p,m){p.diffuse.value.copy(m.color),p.opacity.value=m.opacity,p.rotation.value=m.rotation,m.map&&(p.map.value=m.map,t(m.map,p.mapTransform)),m.alphaMap&&(p.alphaMap.value=m.alphaMap,t(m.alphaMap,p.alphaMapTransform)),m.alphaTest>0&&(p.alphaTest.value=m.alphaTest)}function u(p,m){p.specular.value.copy(m.specular),p.shininess.value=Math.max(m.shininess,1e-4)}function d(p,m){m.gradientMap&&(p.gradientMap.value=m.gradientMap)}function f(p,m){p.metalness.value=m.metalness,m.metalnessMap&&(p.metalnessMap.value=m.metalnessMap,t(m.metalnessMap,p.metalnessMapTransform)),p.roughness.value=m.roughness,m.roughnessMap&&(p.roughnessMap.value=m.roughnessMap,t(m.roughnessMap,p.roughnessMapTransform)),m.envMap&&(p.envMapIntensity.value=m.envMapIntensity)}function h(p,m,v){p.ior.value=m.ior,m.sheen>0&&(p.sheenColor.value.copy(m.sheenColor).multiplyScalar(m.sheen),p.sheenRoughness.value=m.sheenRoughness,m.sheenColorMap&&(p.sheenColorMap.value=m.sheenColorMap,t(m.sheenColorMap,p.sheenColorMapTransform)),m.sheenRoughnessMap&&(p.sheenRoughnessMap.value=m.sheenRoughnessMap,t(m.sheenRoughnessMap,p.sheenRoughnessMapTransform))),m.clearcoat>0&&(p.clearcoat.value=m.clearcoat,p.clearcoatRoughness.value=m.clearcoatRoughness,m.clearcoatMap&&(p.clearcoatMap.value=m.clearcoatMap,t(m.clearcoatMap,p.clearcoatMapTransform)),m.clearcoatRoughnessMap&&(p.clearcoatRoughnessMap.value=m.clearcoatRoughnessMap,t(m.clearcoatRoughnessMap,p.clearcoatRoughnessMapTransform)),m.clearcoatNormalMap&&(p.clearcoatNormalMap.value=m.clearcoatNormalMap,t(m.clearcoatNormalMap,p.clearcoatNormalMapTransform),p.clearcoatNormalScale.value.copy(m.clearcoatNormalScale),m.side===hi&&p.clearcoatNormalScale.value.negate())),m.dispersion>0&&(p.dispersion.value=m.dispersion),m.iridescence>0&&(p.iridescence.value=m.iridescence,p.iridescenceIOR.value=m.iridescenceIOR,p.iridescenceThicknessMinimum.value=m.iridescenceThicknessRange[0],p.iridescenceThicknessMaximum.value=m.iridescenceThicknessRange[1],m.iridescenceMap&&(p.iridescenceMap.value=m.iridescenceMap,t(m.iridescenceMap,p.iridescenceMapTransform)),m.iridescenceThicknessMap&&(p.iridescenceThicknessMap.value=m.iridescenceThicknessMap,t(m.iridescenceThicknessMap,p.iridescenceThicknessMapTransform))),m.transmission>0&&(p.transmission.value=m.transmission,p.transmissionSamplerMap.value=v.texture,p.transmissionSamplerSize.value.set(v.width,v.height),m.transmissionMap&&(p.transmissionMap.value=m.transmissionMap,t(m.transmissionMap,p.transmissionMapTransform)),p.thickness.value=m.thickness,m.thicknessMap&&(p.thicknessMap.value=m.thicknessMap,t(m.thicknessMap,p.thicknessMapTransform)),p.attenuationDistance.value=m.attenuationDistance,p.attenuationColor.value.copy(m.attenuationColor)),m.anisotropy>0&&(p.anisotropyVector.value.set(m.anisotropy*Math.cos(m.anisotropyRotation),m.anisotropy*Math.sin(m.anisotropyRotation)),m.anisotropyMap&&(p.anisotropyMap.value=m.anisotropyMap,t(m.anisotropyMap,p.anisotropyMapTransform))),p.specularIntensity.value=m.specularIntensity,p.specularColor.value.copy(m.specularColor),m.specularColorMap&&(p.specularColorMap.value=m.specularColorMap,t(m.specularColorMap,p.specularColorMapTransform)),m.specularIntensityMap&&(p.specularIntensityMap.value=m.specularIntensityMap,t(m.specularIntensityMap,p.specularIntensityMapTransform))}function g(p,m){m.matcap&&(p.matcap.value=m.matcap)}function _(p,m){const v=e.get(m).light;p.referencePosition.value.setFromMatrixPosition(v.matrixWorld),p.nearDistance.value=v.shadow.camera.near,p.farDistance.value=v.shadow.camera.far}return{refreshFogUniforms:i,refreshMaterialUniforms:r}}function iC(n,e,t,i){let r={},s={},o=[];const a=n.getParameter(n.MAX_UNIFORM_BUFFER_BINDINGS);function l(v,S){const x=S.program;i.uniformBlockBinding(v,x)}function c(v,S){let x=r[v.id];x===void 0&&(g(v),x=u(v),r[v.id]=x,v.addEventListener("dispose",p));const C=S.program;i.updateUBOMapping(v,C);const A=e.render.frame;s[v.id]!==A&&(f(v),s[v.id]=A)}function u(v){const S=d();v.__bindingPointIndex=S;const x=n.createBuffer(),C=v.__size,A=v.usage;return n.bindBuffer(n.UNIFORM_BUFFER,x),n.bufferData(n.UNIFORM_BUFFER,C,A),n.bindBuffer(n.UNIFORM_BUFFER,null),n.bindBufferBase(n.UNIFORM_BUFFER,S,x),x}function d(){for(let v=0;v<a;v++)if(o.indexOf(v)===-1)return o.push(v),v;return Et("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function f(v){const S=r[v.id],x=v.uniforms,C=v.__cache;n.bindBuffer(n.UNIFORM_BUFFER,S);for(let A=0,R=x.length;A<R;A++){const b=Array.isArray(x[A])?x[A]:[x[A]];for(let T=0,N=b.length;T<N;T++){const U=b[T];if(h(U,A,T,C)===!0){const L=U.__offset,G=Array.isArray(U.value)?U.value:[U.value];let k=0;for(let V=0;V<G.length;V++){const X=G[V],B=_(X);typeof X=="number"||typeof X=="boolean"?(U.__data[0]=X,n.bufferSubData(n.UNIFORM_BUFFER,L+k,U.__data)):X.isMatrix3?(U.__data[0]=X.elements[0],U.__data[1]=X.elements[1],U.__data[2]=X.elements[2],U.__data[3]=0,U.__data[4]=X.elements[3],U.__data[5]=X.elements[4],U.__data[6]=X.elements[5],U.__data[7]=0,U.__data[8]=X.elements[6],U.__data[9]=X.elements[7],U.__data[10]=X.elements[8],U.__data[11]=0):(X.toArray(U.__data,k),k+=B.storage/Float32Array.BYTES_PER_ELEMENT)}n.bufferSubData(n.UNIFORM_BUFFER,L,U.__data)}}}n.bindBuffer(n.UNIFORM_BUFFER,null)}function h(v,S,x,C){const A=v.value,R=S+"_"+x;if(C[R]===void 0)return typeof A=="number"||typeof A=="boolean"?C[R]=A:C[R]=A.clone(),!0;{const b=C[R];if(typeof A=="number"||typeof A=="boolean"){if(b!==A)return C[R]=A,!0}else if(b.equals(A)===!1)return b.copy(A),!0}return!1}function g(v){const S=v.uniforms;let x=0;const C=16;for(let R=0,b=S.length;R<b;R++){const T=Array.isArray(S[R])?S[R]:[S[R]];for(let N=0,U=T.length;N<U;N++){const L=T[N],G=Array.isArray(L.value)?L.value:[L.value];for(let k=0,V=G.length;k<V;k++){const X=G[k],B=_(X),Y=x%C,j=Y%B.boundary,F=Y+j;x+=j,F!==0&&C-F<B.storage&&(x+=C-F),L.__data=new Float32Array(B.storage/Float32Array.BYTES_PER_ELEMENT),L.__offset=x,x+=B.storage}}}const A=x%C;return A>0&&(x+=C-A),v.__size=x,v.__cache={},this}function _(v){const S={boundary:0,storage:0};return typeof v=="number"||typeof v=="boolean"?(S.boundary=4,S.storage=4):v.isVector2?(S.boundary=8,S.storage=8):v.isVector3||v.isColor?(S.boundary=16,S.storage=12):v.isVector4?(S.boundary=16,S.storage=16):v.isMatrix3?(S.boundary=48,S.storage=48):v.isMatrix4?(S.boundary=64,S.storage=64):v.isTexture?ot("WebGLRenderer: Texture samplers can not be part of an uniforms group."):ot("WebGLRenderer: Unsupported uniform value type.",v),S}function p(v){const S=v.target;S.removeEventListener("dispose",p);const x=o.indexOf(S.__bindingPointIndex);o.splice(x,1),n.deleteBuffer(r[S.id]),delete r[S.id],delete s[S.id]}function m(){for(const v in r)n.deleteBuffer(r[v]);o=[],r={},s={}}return{bind:l,update:c,dispose:m}}const rC=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]);let cr=null;function sC(){return cr===null&&(cr=new Qw(rC,16,16,Ua,ls),cr.name="DFG_LUT",cr.minFilter=Gn,cr.magFilter=Gn,cr.wrapS=Kr,cr.wrapT=Kr,cr.generateMipmaps=!1,cr.needsUpdate=!0),cr}class oC{constructor(e={}){const{canvas:t=Rw(),context:i=null,depth:r=!0,stencil:s=!1,alpha:o=!1,antialias:a=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:u="default",failIfMajorPerformanceCaveat:d=!1,reversedDepthBuffer:f=!1,outputBufferType:h=zi}=e;this.isWebGLRenderer=!0;let g;if(i!==null){if(typeof WebGLRenderingContext<"u"&&i instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");g=i.getContextAttributes().alpha}else g=o;const _=h,p=new Set([Kp,qp,Yp]),m=new Set([zi,Dr,Kl,Zl,$p,jp]),v=new Uint32Array(4),S=new Int32Array(4);let x=null,C=null;const A=[],R=[];let b=null;this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=Er,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const T=this;let N=!1;this._outputColorSpace=Oi;let U=0,L=0,G=null,k=-1,V=null;const X=new nn,B=new nn;let Y=null;const j=new Ot(0);let F=0,ae=t.width,he=t.height,ge=1,xe=null,Ee=null;const J=new nn(0,0,ae,he),ue=new nn(0,0,ae,he);let oe=!1;const Re=new Ev;let Ae=!1,le=!1;const w=new cn,E=new se,H=new nn,ee={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let q=!1;function O(){return G===null?ge:1}let I=i;function _e(D,$){return t.getContext(D,$)}try{const D={alpha:!0,depth:r,stencil:s,antialias:a,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:u,failIfMajorPerformanceCaveat:d};if("setAttribute"in t&&t.setAttribute("data-engine",`three.js r${Wp}`),t.addEventListener("webglcontextlost",Ge,!1),t.addEventListener("webglcontextrestored",Je,!1),t.addEventListener("webglcontextcreationerror",Mt,!1),I===null){const $="webgl2";if(I=_e($,D),I===null)throw _e($)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(D){throw Et("WebGLRenderer: "+D.message),D}let fe,ne,me,P,M,z,Z,Q,K,Me,ve,He,Le,be,we,Pe,Ne,Ie,et,W,Ce,Te,Oe;function Se(){fe=new oA(I),fe.init(),Ce=new K3(I,fe),ne=new JT(I,fe,e,Ce),me=new Y3(I,fe),ne.reversedDepthBuffer&&f&&me.buffers.depth.setReversed(!0),P=new cA(I),M=new U3,z=new q3(I,fe,me,M,ne,Ce,P),Z=new sA(T),Q=new p2(I),Te=new KT(I,Q),K=new aA(I,Q,P,Te),Me=new dA(I,K,Q,Te,P),Ie=new uA(I,ne,z),we=new QT(M),ve=new I3(T,Z,fe,ne,Te,we),He=new nC(T,M),Le=new N3,be=new H3(fe),Ne=new qT(T,Z,me,Me,g,l),Pe=new j3(T,Me,ne),Oe=new iC(I,P,ne,me),et=new ZT(I,fe,P),W=new lA(I,fe,P),P.programs=ve.programs,T.capabilities=ne,T.extensions=fe,T.properties=M,T.renderLists=Le,T.shadowMap=Pe,T.state=me,T.info=P}Se(),_!==zi&&(b=new hA(_,t.width,t.height,r,s));const ce=new eC(T,I);this.xr=ce,this.getContext=function(){return I},this.getContextAttributes=function(){return I.getContextAttributes()},this.forceContextLoss=function(){const D=fe.get("WEBGL_lose_context");D&&D.loseContext()},this.forceContextRestore=function(){const D=fe.get("WEBGL_lose_context");D&&D.restoreContext()},this.getPixelRatio=function(){return ge},this.setPixelRatio=function(D){D!==void 0&&(ge=D,this.setSize(ae,he,!1))},this.getSize=function(D){return D.set(ae,he)},this.setSize=function(D,$,re=!0){if(ce.isPresenting){ot("WebGLRenderer: Can't change size while VR device is presenting.");return}ae=D,he=$,t.width=Math.floor(D*ge),t.height=Math.floor($*ge),re===!0&&(t.style.width=D+"px",t.style.height=$+"px"),b!==null&&b.setSize(t.width,t.height),this.setViewport(0,0,D,$)},this.getDrawingBufferSize=function(D){return D.set(ae*ge,he*ge).floor()},this.setDrawingBufferSize=function(D,$,re){ae=D,he=$,ge=re,t.width=Math.floor(D*re),t.height=Math.floor($*re),this.setViewport(0,0,D,$)},this.setEffects=function(D){if(_===zi){console.error("THREE.WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(D){for(let $=0;$<D.length;$++)if(D[$].isOutputPass===!0){console.warn("THREE.WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}b.setEffects(D||[])},this.getCurrentViewport=function(D){return D.copy(X)},this.getViewport=function(D){return D.copy(J)},this.setViewport=function(D,$,re,ie){D.isVector4?J.set(D.x,D.y,D.z,D.w):J.set(D,$,re,ie),me.viewport(X.copy(J).multiplyScalar(ge).round())},this.getScissor=function(D){return D.copy(ue)},this.setScissor=function(D,$,re,ie){D.isVector4?ue.set(D.x,D.y,D.z,D.w):ue.set(D,$,re,ie),me.scissor(B.copy(ue).multiplyScalar(ge).round())},this.getScissorTest=function(){return oe},this.setScissorTest=function(D){me.setScissorTest(oe=D)},this.setOpaqueSort=function(D){xe=D},this.setTransparentSort=function(D){Ee=D},this.getClearColor=function(D){return D.copy(Ne.getClearColor())},this.setClearColor=function(){Ne.setClearColor(...arguments)},this.getClearAlpha=function(){return Ne.getClearAlpha()},this.setClearAlpha=function(){Ne.setClearAlpha(...arguments)},this.clear=function(D=!0,$=!0,re=!0){let ie=0;if(D){let te=!1;if(G!==null){const Ue=G.texture.format;te=p.has(Ue)}if(te){const Ue=G.texture.type,ke=m.has(Ue),Fe=Ne.getClearColor(),Xe=Ne.getClearAlpha(),We=Fe.r,lt=Fe.g,pt=Fe.b;ke?(v[0]=We,v[1]=lt,v[2]=pt,v[3]=Xe,I.clearBufferuiv(I.COLOR,0,v)):(S[0]=We,S[1]=lt,S[2]=pt,S[3]=Xe,I.clearBufferiv(I.COLOR,0,S))}else ie|=I.COLOR_BUFFER_BIT}$&&(ie|=I.DEPTH_BUFFER_BIT),re&&(ie|=I.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),ie!==0&&I.clear(ie)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){t.removeEventListener("webglcontextlost",Ge,!1),t.removeEventListener("webglcontextrestored",Je,!1),t.removeEventListener("webglcontextcreationerror",Mt,!1),Ne.dispose(),Le.dispose(),be.dispose(),M.dispose(),Z.dispose(),Me.dispose(),Te.dispose(),Oe.dispose(),ve.dispose(),ce.dispose(),ce.removeEventListener("sessionstart",it),ce.removeEventListener("sessionend",Qt),at.stop()};function Ge(D){D.preventDefault(),Dm("WebGLRenderer: Context Lost."),N=!0}function Je(){Dm("WebGLRenderer: Context Restored."),N=!1;const D=P.autoReset,$=Pe.enabled,re=Pe.autoUpdate,ie=Pe.needsUpdate,te=Pe.type;Se(),P.autoReset=D,Pe.enabled=$,Pe.autoUpdate=re,Pe.needsUpdate=ie,Pe.type=te}function Mt(D){Et("WebGLRenderer: A WebGL context could not be created. Reason: ",D.statusMessage)}function Ve(D){const $=D.target;$.removeEventListener("dispose",Ve),Ye($)}function Ye(D){ut(D),M.remove(D)}function ut(D){const $=M.get(D).programs;$!==void 0&&($.forEach(function(re){ve.releaseProgram(re)}),D.isShaderMaterial&&ve.releaseShaderCache(D))}this.renderBufferDirect=function(D,$,re,ie,te,Ue){$===null&&($=ee);const ke=te.isMesh&&te.matrixWorld.determinant()<0,Fe=Li(D,$,re,ie,te);me.setMaterial(ie,ke);let Xe=re.index,We=1;if(ie.wireframe===!0){if(Xe=K.getWireframeAttribute(re),Xe===void 0)return;We=2}const lt=re.drawRange,pt=re.attributes.position;let Ze=lt.start*We,Ft=(lt.start+lt.count)*We;Ue!==null&&(Ze=Math.max(Ze,Ue.start*We),Ft=Math.min(Ft,(Ue.start+Ue.count)*We)),Xe!==null?(Ze=Math.max(Ze,0),Ft=Math.min(Ft,Xe.count)):pt!=null&&(Ze=Math.max(Ze,0),Ft=Math.min(Ft,pt.count));const en=Ft-Ze;if(en<0||en===1/0)return;Te.setup(te,ie,Fe,re,Xe);let Zt,Nt=et;if(Xe!==null&&(Zt=Q.get(Xe),Nt=W,Nt.setIndex(Zt)),te.isMesh)ie.wireframe===!0?(me.setLineWidth(ie.wireframeLinewidth*O()),Nt.setMode(I.LINES)):Nt.setMode(I.TRIANGLES);else if(te.isLine){let Un=ie.linewidth;Un===void 0&&(Un=1),me.setLineWidth(Un*O()),te.isLineSegments?Nt.setMode(I.LINES):te.isLineLoop?Nt.setMode(I.LINE_LOOP):Nt.setMode(I.LINE_STRIP)}else te.isPoints?Nt.setMode(I.POINTS):te.isSprite&&Nt.setMode(I.TRIANGLES);if(te.isBatchedMesh)if(te._multiDrawInstances!==null)ju("WebGLRenderer: renderMultiDrawInstances has been deprecated and will be removed in r184. Append to renderMultiDraw arguments and use indirection."),Nt.renderMultiDrawInstances(te._multiDrawStarts,te._multiDrawCounts,te._multiDrawCount,te._multiDrawInstances);else if(fe.get("WEBGL_multi_draw"))Nt.renderMultiDraw(te._multiDrawStarts,te._multiDrawCounts,te._multiDrawCount);else{const Un=te._multiDrawStarts,qe=te._multiDrawCounts,mi=te._multiDrawCount,wt=Xe?Q.get(Xe).bytesPerElement:1,Yi=M.get(ie).currentProgram.getUniforms();for(let or=0;or<mi;or++)Yi.setValue(I,"_gl_DrawID",or),Nt.render(Un[or]/wt,qe[or])}else if(te.isInstancedMesh)Nt.renderInstances(Ze,en,te.count);else if(re.isInstancedBufferGeometry){const Un=re._maxInstanceCount!==void 0?re._maxInstanceCount:1/0,qe=Math.min(re.instanceCount,Un);Nt.renderInstances(Ze,en,qe)}else Nt.render(Ze,en)};function Be(D,$,re){D.transparent===!0&&D.side===Yr&&D.forceSinglePass===!1?(D.side=hi,D.needsUpdate=!0,Ln(D,$,re),D.side=Vs,D.needsUpdate=!0,Ln(D,$,re),D.side=Yr):Ln(D,$,re)}this.compile=function(D,$,re=null){re===null&&(re=D),C=be.get(re),C.init($),R.push(C),re.traverseVisible(function(te){te.isLight&&te.layers.test($.layers)&&(C.pushLight(te),te.castShadow&&C.pushShadow(te))}),D!==re&&D.traverseVisible(function(te){te.isLight&&te.layers.test($.layers)&&(C.pushLight(te),te.castShadow&&C.pushShadow(te))}),C.setupLights();const ie=new Set;return D.traverse(function(te){if(!(te.isMesh||te.isPoints||te.isLine||te.isSprite))return;const Ue=te.material;if(Ue)if(Array.isArray(Ue))for(let ke=0;ke<Ue.length;ke++){const Fe=Ue[ke];Be(Fe,re,te),ie.add(Fe)}else Be(Ue,re,te),ie.add(Ue)}),C=R.pop(),ie},this.compileAsync=function(D,$,re=null){const ie=this.compile(D,$,re);return new Promise(te=>{function Ue(){if(ie.forEach(function(ke){M.get(ke).currentProgram.isReady()&&ie.delete(ke)}),ie.size===0){te(D);return}setTimeout(Ue,10)}fe.get("KHR_parallel_shader_compile")!==null?Ue():setTimeout(Ue,10)})};let nt=null;function Qe(D){nt&&nt(D)}function it(){at.stop()}function Qt(){at.start()}const at=new Pv;at.setAnimationLoop(Qe),typeof self<"u"&&at.setContext(self),this.setAnimationLoop=function(D){nt=D,ce.setAnimationLoop(D),D===null?at.stop():at.start()},ce.addEventListener("sessionstart",it),ce.addEventListener("sessionend",Qt),this.render=function(D,$){if($!==void 0&&$.isCamera!==!0){Et("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(N===!0)return;const re=ce.enabled===!0&&ce.isPresenting===!0,ie=b!==null&&(G===null||re)&&b.begin(T,G);if(D.matrixWorldAutoUpdate===!0&&D.updateMatrixWorld(),$.parent===null&&$.matrixWorldAutoUpdate===!0&&$.updateMatrixWorld(),ce.enabled===!0&&ce.isPresenting===!0&&(b===null||b.isCompositing()===!1)&&(ce.cameraAutoUpdate===!0&&ce.updateCamera($),$=ce.getCamera()),D.isScene===!0&&D.onBeforeRender(T,D,$,G),C=be.get(D,R.length),C.init($),R.push(C),w.multiplyMatrices($.projectionMatrix,$.matrixWorldInverse),Re.setFromProjectionMatrix(w,br,$.reversedDepth),le=this.localClippingEnabled,Ae=we.init(this.clippingPlanes,le),x=Le.get(D,A.length),x.init(),A.push(x),ce.enabled===!0&&ce.isPresenting===!0){const ke=T.xr.getDepthSensingMesh();ke!==null&&Wt(ke,$,-1/0,T.sortObjects)}Wt(D,$,0,T.sortObjects),x.finish(),T.sortObjects===!0&&x.sort(xe,Ee),q=ce.enabled===!1||ce.isPresenting===!1||ce.hasDepthSensing()===!1,q&&Ne.addToRenderList(x,D),this.info.render.frame++,Ae===!0&&we.beginShadows();const te=C.state.shadowsArray;if(Pe.render(te,D,$),Ae===!0&&we.endShadows(),this.info.autoReset===!0&&this.info.reset(),(ie&&b.hasRenderPass())===!1){const ke=x.opaque,Fe=x.transmissive;if(C.setupLights(),$.isArrayCamera){const Xe=$.cameras;if(Fe.length>0)for(let We=0,lt=Xe.length;We<lt;We++){const pt=Xe[We];Xt(ke,Fe,D,pt)}q&&Ne.render(D);for(let We=0,lt=Xe.length;We<lt;We++){const pt=Xe[We];un(x,D,pt,pt.viewport)}}else Fe.length>0&&Xt(ke,Fe,D,$),q&&Ne.render(D),un(x,D,$)}G!==null&&L===0&&(z.updateMultisampleRenderTarget(G),z.updateRenderTargetMipmap(G)),ie&&b.end(T),D.isScene===!0&&D.onAfterRender(T,D,$),Te.resetDefaultState(),k=-1,V=null,R.pop(),R.length>0?(C=R[R.length-1],Ae===!0&&we.setGlobalState(T.clippingPlanes,C.state.camera)):C=null,A.pop(),A.length>0?x=A[A.length-1]:x=null};function Wt(D,$,re,ie){if(D.visible===!1)return;if(D.layers.test($.layers)){if(D.isGroup)re=D.renderOrder;else if(D.isLOD)D.autoUpdate===!0&&D.update($);else if(D.isLight)C.pushLight(D),D.castShadow&&C.pushShadow(D);else if(D.isSprite){if(!D.frustumCulled||Re.intersectsSprite(D)){ie&&H.setFromMatrixPosition(D.matrixWorld).applyMatrix4(w);const ke=Me.update(D),Fe=D.material;Fe.visible&&x.push(D,ke,Fe,re,H.z,null)}}else if((D.isMesh||D.isLine||D.isPoints)&&(!D.frustumCulled||Re.intersectsObject(D))){const ke=Me.update(D),Fe=D.material;if(ie&&(D.boundingSphere!==void 0?(D.boundingSphere===null&&D.computeBoundingSphere(),H.copy(D.boundingSphere.center)):(ke.boundingSphere===null&&ke.computeBoundingSphere(),H.copy(ke.boundingSphere.center)),H.applyMatrix4(D.matrixWorld).applyMatrix4(w)),Array.isArray(Fe)){const Xe=ke.groups;for(let We=0,lt=Xe.length;We<lt;We++){const pt=Xe[We],Ze=Fe[pt.materialIndex];Ze&&Ze.visible&&x.push(D,ke,Ze,re,H.z,pt)}}else Fe.visible&&x.push(D,ke,Fe,re,H.z,null)}}const Ue=D.children;for(let ke=0,Fe=Ue.length;ke<Fe;ke++)Wt(Ue[ke],$,re,ie)}function un(D,$,re,ie){const{opaque:te,transmissive:Ue,transparent:ke}=D;C.setupLightsView(re),Ae===!0&&we.setGlobalState(T.clippingPlanes,re),ie&&me.viewport(X.copy(ie)),te.length>0&&Lt(te,$,re),Ue.length>0&&Lt(Ue,$,re),ke.length>0&&Lt(ke,$,re),me.buffers.depth.setTest(!0),me.buffers.depth.setMask(!0),me.buffers.color.setMask(!0),me.setPolygonOffset(!1)}function Xt(D,$,re,ie){if((re.isScene===!0?re.overrideMaterial:null)!==null)return;if(C.state.transmissionRenderTarget[ie.id]===void 0){const Ze=fe.has("EXT_color_buffer_half_float")||fe.has("EXT_color_buffer_float");C.state.transmissionRenderTarget[ie.id]=new Tr(1,1,{generateMipmaps:!0,type:Ze?ls:zi,minFilter:_o,samples:Math.max(4,ne.samples),stencilBuffer:s,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:St.workingColorSpace})}const Ue=C.state.transmissionRenderTarget[ie.id],ke=ie.viewport||X;Ue.setSize(ke.z*T.transmissionResolutionScale,ke.w*T.transmissionResolutionScale);const Fe=T.getRenderTarget(),Xe=T.getActiveCubeFace(),We=T.getActiveMipmapLevel();T.setRenderTarget(Ue),T.getClearColor(j),F=T.getClearAlpha(),F<1&&T.setClearColor(16777215,.5),T.clear(),q&&Ne.render(re);const lt=T.toneMapping;T.toneMapping=Er;const pt=ie.viewport;if(ie.viewport!==void 0&&(ie.viewport=void 0),C.setupLightsView(ie),Ae===!0&&we.setGlobalState(T.clippingPlanes,ie),Lt(D,re,ie),z.updateMultisampleRenderTarget(Ue),z.updateRenderTargetMipmap(Ue),fe.has("WEBGL_multisampled_render_to_texture")===!1){let Ze=!1;for(let Ft=0,en=$.length;Ft<en;Ft++){const Zt=$[Ft],{object:Nt,geometry:Un,material:qe,group:mi}=Zt;if(qe.side===Yr&&Nt.layers.test(ie.layers)){const wt=qe.side;qe.side=hi,qe.needsUpdate=!0,Ct(Nt,re,ie,Un,qe,mi),qe.side=wt,qe.needsUpdate=!0,Ze=!0}}Ze===!0&&(z.updateMultisampleRenderTarget(Ue),z.updateRenderTargetMipmap(Ue))}T.setRenderTarget(Fe,Xe,We),T.setClearColor(j,F),pt!==void 0&&(ie.viewport=pt),T.toneMapping=lt}function Lt(D,$,re){const ie=$.isScene===!0?$.overrideMaterial:null;for(let te=0,Ue=D.length;te<Ue;te++){const ke=D[te],{object:Fe,geometry:Xe,group:We}=ke;let lt=ke.material;lt.allowOverride===!0&&ie!==null&&(lt=ie),Fe.layers.test(re.layers)&&Ct(Fe,$,re,Xe,lt,We)}}function Ct(D,$,re,ie,te,Ue){D.onBeforeRender(T,$,re,ie,te,Ue),D.modelViewMatrix.multiplyMatrices(re.matrixWorldInverse,D.matrixWorld),D.normalMatrix.getNormalMatrix(D.modelViewMatrix),te.onBeforeRender(T,$,re,ie,D,Ue),te.transparent===!0&&te.side===Yr&&te.forceSinglePass===!1?(te.side=hi,te.needsUpdate=!0,T.renderBufferDirect(re,$,ie,te,D,Ue),te.side=Vs,te.needsUpdate=!0,T.renderBufferDirect(re,$,ie,te,D,Ue),te.side=Yr):T.renderBufferDirect(re,$,ie,te,D,Ue),D.onAfterRender(T,$,re,ie,te,Ue)}function Ln(D,$,re){$.isScene!==!0&&($=ee);const ie=M.get(D),te=C.state.lights,Ue=C.state.shadowsArray,ke=te.state.version,Fe=ve.getParameters(D,te.state,Ue,$,re),Xe=ve.getProgramCacheKey(Fe);let We=ie.programs;ie.environment=D.isMeshStandardMaterial||D.isMeshLambertMaterial||D.isMeshPhongMaterial?$.environment:null,ie.fog=$.fog;const lt=D.isMeshStandardMaterial||D.isMeshLambertMaterial&&!D.envMap||D.isMeshPhongMaterial&&!D.envMap;ie.envMap=Z.get(D.envMap||ie.environment,lt),ie.envMapRotation=ie.environment!==null&&D.envMap===null?$.environmentRotation:D.envMapRotation,We===void 0&&(D.addEventListener("dispose",Ve),We=new Map,ie.programs=We);let pt=We.get(Xe);if(pt!==void 0){if(ie.currentProgram===pt&&ie.lightsStateVersion===ke)return In(D,Fe),pt}else Fe.uniforms=ve.getUniforms(D),D.onBeforeCompile(Fe,T),pt=ve.acquireProgram(Fe,Xe),We.set(Xe,pt),ie.uniforms=Fe.uniforms;const Ze=ie.uniforms;return(!D.isShaderMaterial&&!D.isRawShaderMaterial||D.clipping===!0)&&(Ze.clippingPlanes=we.uniform),In(D,Fe),ie.needsLights=fn(D),ie.lightsStateVersion=ke,ie.needsLights&&(Ze.ambientLightColor.value=te.state.ambient,Ze.lightProbe.value=te.state.probe,Ze.directionalLights.value=te.state.directional,Ze.directionalLightShadows.value=te.state.directionalShadow,Ze.spotLights.value=te.state.spot,Ze.spotLightShadows.value=te.state.spotShadow,Ze.rectAreaLights.value=te.state.rectArea,Ze.ltc_1.value=te.state.rectAreaLTC1,Ze.ltc_2.value=te.state.rectAreaLTC2,Ze.pointLights.value=te.state.point,Ze.pointLightShadows.value=te.state.pointShadow,Ze.hemisphereLights.value=te.state.hemi,Ze.directionalShadowMatrix.value=te.state.directionalShadowMatrix,Ze.spotLightMatrix.value=te.state.spotLightMatrix,Ze.spotLightMap.value=te.state.spotLightMap,Ze.pointShadowMatrix.value=te.state.pointShadowMatrix),ie.currentProgram=pt,ie.uniformsList=null,pt}function Ht(D){if(D.uniformsList===null){const $=D.currentProgram.getUniforms();D.uniformsList=vu.seqWithValue($.seq,D.uniforms)}return D.uniformsList}function In(D,$){const re=M.get(D);re.outputColorSpace=$.outputColorSpace,re.batching=$.batching,re.batchingColor=$.batchingColor,re.instancing=$.instancing,re.instancingColor=$.instancingColor,re.instancingMorph=$.instancingMorph,re.skinning=$.skinning,re.morphTargets=$.morphTargets,re.morphNormals=$.morphNormals,re.morphColors=$.morphColors,re.morphTargetsCount=$.morphTargetsCount,re.numClippingPlanes=$.numClippingPlanes,re.numIntersection=$.numClipIntersection,re.vertexAlphas=$.vertexAlphas,re.vertexTangents=$.vertexTangents,re.toneMapping=$.toneMapping}function Li(D,$,re,ie,te){$.isScene!==!0&&($=ee),z.resetTextureUnits();const Ue=$.fog,ke=ie.isMeshStandardMaterial||ie.isMeshLambertMaterial||ie.isMeshPhongMaterial?$.environment:null,Fe=G===null?T.outputColorSpace:G.isXRRenderTarget===!0?G.texture.colorSpace:Fa,Xe=ie.isMeshStandardMaterial||ie.isMeshLambertMaterial&&!ie.envMap||ie.isMeshPhongMaterial&&!ie.envMap,We=Z.get(ie.envMap||ke,Xe),lt=ie.vertexColors===!0&&!!re.attributes.color&&re.attributes.color.itemSize===4,pt=!!re.attributes.tangent&&(!!ie.normalMap||ie.anisotropy>0),Ze=!!re.morphAttributes.position,Ft=!!re.morphAttributes.normal,en=!!re.morphAttributes.color;let Zt=Er;ie.toneMapped&&(G===null||G.isXRRenderTarget===!0)&&(Zt=T.toneMapping);const Nt=re.morphAttributes.position||re.morphAttributes.normal||re.morphAttributes.color,Un=Nt!==void 0?Nt.length:0,qe=M.get(ie),mi=C.state.lights;if(Ae===!0&&(le===!0||D!==V)){const xn=D===V&&ie.id===k;we.setState(ie,D,xn)}let wt=!1;ie.version===qe.__version?(qe.needsLights&&qe.lightsStateVersion!==mi.state.version||qe.outputColorSpace!==Fe||te.isBatchedMesh&&qe.batching===!1||!te.isBatchedMesh&&qe.batching===!0||te.isBatchedMesh&&qe.batchingColor===!0&&te.colorTexture===null||te.isBatchedMesh&&qe.batchingColor===!1&&te.colorTexture!==null||te.isInstancedMesh&&qe.instancing===!1||!te.isInstancedMesh&&qe.instancing===!0||te.isSkinnedMesh&&qe.skinning===!1||!te.isSkinnedMesh&&qe.skinning===!0||te.isInstancedMesh&&qe.instancingColor===!0&&te.instanceColor===null||te.isInstancedMesh&&qe.instancingColor===!1&&te.instanceColor!==null||te.isInstancedMesh&&qe.instancingMorph===!0&&te.morphTexture===null||te.isInstancedMesh&&qe.instancingMorph===!1&&te.morphTexture!==null||qe.envMap!==We||ie.fog===!0&&qe.fog!==Ue||qe.numClippingPlanes!==void 0&&(qe.numClippingPlanes!==we.numPlanes||qe.numIntersection!==we.numIntersection)||qe.vertexAlphas!==lt||qe.vertexTangents!==pt||qe.morphTargets!==Ze||qe.morphNormals!==Ft||qe.morphColors!==en||qe.toneMapping!==Zt||qe.morphTargetsCount!==Un)&&(wt=!0):(wt=!0,qe.__version=ie.version);let Yi=qe.currentProgram;wt===!0&&(Yi=Ln(ie,$,te));let or=!1,Ws=!1,Fo=!1;const kt=Yi.getUniforms(),En=qe.uniforms;if(me.useProgram(Yi.program)&&(or=!0,Ws=!0,Fo=!0),ie.id!==k&&(k=ie.id,Ws=!0),or||V!==D){me.buffers.depth.getReversed()&&D.reversedDepth!==!0&&(D._reversedDepth=!0,D.updateProjectionMatrix()),kt.setValue(I,"projectionMatrix",D.projectionMatrix),kt.setValue(I,"viewMatrix",D.matrixWorldInverse);const ps=kt.map.cameraPosition;ps!==void 0&&ps.setValue(I,E.setFromMatrixPosition(D.matrixWorld)),ne.logarithmicDepthBuffer&&kt.setValue(I,"logDepthBufFC",2/(Math.log(D.far+1)/Math.LN2)),(ie.isMeshPhongMaterial||ie.isMeshToonMaterial||ie.isMeshLambertMaterial||ie.isMeshBasicMaterial||ie.isMeshStandardMaterial||ie.isShaderMaterial)&&kt.setValue(I,"isOrthographic",D.isOrthographicCamera===!0),V!==D&&(V=D,Ws=!0,Fo=!0)}if(qe.needsLights&&(mi.state.directionalShadowMap.length>0&&kt.setValue(I,"directionalShadowMap",mi.state.directionalShadowMap,z),mi.state.spotShadowMap.length>0&&kt.setValue(I,"spotShadowMap",mi.state.spotShadowMap,z),mi.state.pointShadowMap.length>0&&kt.setValue(I,"pointShadowMap",mi.state.pointShadowMap,z)),te.isSkinnedMesh){kt.setOptional(I,te,"bindMatrix"),kt.setOptional(I,te,"bindMatrixInverse");const xn=te.skeleton;xn&&(xn.boneTexture===null&&xn.computeBoneTexture(),kt.setValue(I,"boneTexture",xn.boneTexture,z))}te.isBatchedMesh&&(kt.setOptional(I,te,"batchingTexture"),kt.setValue(I,"batchingTexture",te._matricesTexture,z),kt.setOptional(I,te,"batchingIdTexture"),kt.setValue(I,"batchingIdTexture",te._indirectTexture,z),kt.setOptional(I,te,"batchingColorTexture"),te._colorsTexture!==null&&kt.setValue(I,"batchingColorTexture",te._colorsTexture,z));const hs=re.morphAttributes;if((hs.position!==void 0||hs.normal!==void 0||hs.color!==void 0)&&Ie.update(te,re,Yi),(Ws||qe.receiveShadow!==te.receiveShadow)&&(qe.receiveShadow=te.receiveShadow,kt.setValue(I,"receiveShadow",te.receiveShadow)),(ie.isMeshStandardMaterial||ie.isMeshLambertMaterial||ie.isMeshPhongMaterial)&&ie.envMap===null&&$.environment!==null&&(En.envMapIntensity.value=$.environmentIntensity),En.dfgLUT!==void 0&&(En.dfgLUT.value=sC()),Ws&&(kt.setValue(I,"toneMappingExposure",T.toneMappingExposure),qe.needsLights&&dn(En,Fo),Ue&&ie.fog===!0&&He.refreshFogUniforms(En,Ue),He.refreshMaterialUniforms(En,ie,ge,he,C.state.transmissionRenderTarget[D.id]),vu.upload(I,Ht(qe),En,z)),ie.isShaderMaterial&&ie.uniformsNeedUpdate===!0&&(vu.upload(I,Ht(qe),En,z),ie.uniformsNeedUpdate=!1),ie.isSpriteMaterial&&kt.setValue(I,"center",te.center),kt.setValue(I,"modelViewMatrix",te.modelViewMatrix),kt.setValue(I,"normalMatrix",te.normalMatrix),kt.setValue(I,"modelMatrix",te.matrixWorld),ie.isShaderMaterial||ie.isRawShaderMaterial){const xn=ie.uniformsGroups;for(let ps=0,No=xn.length;ps<No;ps++){const r0=xn[ps];Oe.update(r0,Yi),Oe.bind(r0,Yi)}}return Yi}function dn(D,$){D.ambientLightColor.needsUpdate=$,D.lightProbe.needsUpdate=$,D.directionalLights.needsUpdate=$,D.directionalLightShadows.needsUpdate=$,D.pointLights.needsUpdate=$,D.pointLightShadows.needsUpdate=$,D.spotLights.needsUpdate=$,D.spotLightShadows.needsUpdate=$,D.rectAreaLights.needsUpdate=$,D.hemisphereLights.needsUpdate=$}function fn(D){return D.isMeshLambertMaterial||D.isMeshToonMaterial||D.isMeshPhongMaterial||D.isMeshStandardMaterial||D.isShadowMaterial||D.isShaderMaterial&&D.lights===!0}this.getActiveCubeFace=function(){return U},this.getActiveMipmapLevel=function(){return L},this.getRenderTarget=function(){return G},this.setRenderTargetTextures=function(D,$,re){const ie=M.get(D);ie.__autoAllocateDepthBuffer=D.resolveDepthBuffer===!1,ie.__autoAllocateDepthBuffer===!1&&(ie.__useRenderToTexture=!1),M.get(D.texture).__webglTexture=$,M.get(D.depthTexture).__webglTexture=ie.__autoAllocateDepthBuffer?void 0:re,ie.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(D,$){const re=M.get(D);re.__webglFramebuffer=$,re.__useDefaultFramebuffer=$===void 0};const _n=I.createFramebuffer();this.setRenderTarget=function(D,$=0,re=0){G=D,U=$,L=re;let ie=null,te=!1,Ue=!1;if(D){const Fe=M.get(D);if(Fe.__useDefaultFramebuffer!==void 0){me.bindFramebuffer(I.FRAMEBUFFER,Fe.__webglFramebuffer),X.copy(D.viewport),B.copy(D.scissor),Y=D.scissorTest,me.viewport(X),me.scissor(B),me.setScissorTest(Y),k=-1;return}else if(Fe.__webglFramebuffer===void 0)z.setupRenderTarget(D);else if(Fe.__hasExternalTextures)z.rebindTextures(D,M.get(D.texture).__webglTexture,M.get(D.depthTexture).__webglTexture);else if(D.depthBuffer){const lt=D.depthTexture;if(Fe.__boundDepthTexture!==lt){if(lt!==null&&M.has(lt)&&(D.width!==lt.image.width||D.height!==lt.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");z.setupDepthRenderbuffer(D)}}const Xe=D.texture;(Xe.isData3DTexture||Xe.isDataArrayTexture||Xe.isCompressedArrayTexture)&&(Ue=!0);const We=M.get(D).__webglFramebuffer;D.isWebGLCubeRenderTarget?(Array.isArray(We[$])?ie=We[$][re]:ie=We[$],te=!0):D.samples>0&&z.useMultisampledRTT(D)===!1?ie=M.get(D).__webglMultisampledFramebuffer:Array.isArray(We)?ie=We[re]:ie=We,X.copy(D.viewport),B.copy(D.scissor),Y=D.scissorTest}else X.copy(J).multiplyScalar(ge).floor(),B.copy(ue).multiplyScalar(ge).floor(),Y=oe;if(re!==0&&(ie=_n),me.bindFramebuffer(I.FRAMEBUFFER,ie)&&me.drawBuffers(D,ie),me.viewport(X),me.scissor(B),me.setScissorTest(Y),te){const Fe=M.get(D.texture);I.framebufferTexture2D(I.FRAMEBUFFER,I.COLOR_ATTACHMENT0,I.TEXTURE_CUBE_MAP_POSITIVE_X+$,Fe.__webglTexture,re)}else if(Ue){const Fe=$;for(let Xe=0;Xe<D.textures.length;Xe++){const We=M.get(D.textures[Xe]);I.framebufferTextureLayer(I.FRAMEBUFFER,I.COLOR_ATTACHMENT0+Xe,We.__webglTexture,re,Fe)}}else if(D!==null&&re!==0){const Fe=M.get(D.texture);I.framebufferTexture2D(I.FRAMEBUFFER,I.COLOR_ATTACHMENT0,I.TEXTURE_2D,Fe.__webglTexture,re)}k=-1},this.readRenderTargetPixels=function(D,$,re,ie,te,Ue,ke,Fe=0){if(!(D&&D.isWebGLRenderTarget)){Et("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Xe=M.get(D).__webglFramebuffer;if(D.isWebGLCubeRenderTarget&&ke!==void 0&&(Xe=Xe[ke]),Xe){me.bindFramebuffer(I.FRAMEBUFFER,Xe);try{const We=D.textures[Fe],lt=We.format,pt=We.type;if(D.textures.length>1&&I.readBuffer(I.COLOR_ATTACHMENT0+Fe),!ne.textureFormatReadable(lt)){Et("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!ne.textureTypeReadable(pt)){Et("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}$>=0&&$<=D.width-ie&&re>=0&&re<=D.height-te&&I.readPixels($,re,ie,te,Ce.convert(lt),Ce.convert(pt),Ue)}finally{const We=G!==null?M.get(G).__webglFramebuffer:null;me.bindFramebuffer(I.FRAMEBUFFER,We)}}},this.readRenderTargetPixelsAsync=async function(D,$,re,ie,te,Ue,ke,Fe=0){if(!(D&&D.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Xe=M.get(D).__webglFramebuffer;if(D.isWebGLCubeRenderTarget&&ke!==void 0&&(Xe=Xe[ke]),Xe)if($>=0&&$<=D.width-ie&&re>=0&&re<=D.height-te){me.bindFramebuffer(I.FRAMEBUFFER,Xe);const We=D.textures[Fe],lt=We.format,pt=We.type;if(D.textures.length>1&&I.readBuffer(I.COLOR_ATTACHMENT0+Fe),!ne.textureFormatReadable(lt))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!ne.textureTypeReadable(pt))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const Ze=I.createBuffer();I.bindBuffer(I.PIXEL_PACK_BUFFER,Ze),I.bufferData(I.PIXEL_PACK_BUFFER,Ue.byteLength,I.STREAM_READ),I.readPixels($,re,ie,te,Ce.convert(lt),Ce.convert(pt),0);const Ft=G!==null?M.get(G).__webglFramebuffer:null;me.bindFramebuffer(I.FRAMEBUFFER,Ft);const en=I.fenceSync(I.SYNC_GPU_COMMANDS_COMPLETE,0);return I.flush(),await Pw(I,en,4),I.bindBuffer(I.PIXEL_PACK_BUFFER,Ze),I.getBufferSubData(I.PIXEL_PACK_BUFFER,0,Ue),I.deleteBuffer(Ze),I.deleteSync(en),Ue}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(D,$=null,re=0){const ie=Math.pow(2,-re),te=Math.floor(D.image.width*ie),Ue=Math.floor(D.image.height*ie),ke=$!==null?$.x:0,Fe=$!==null?$.y:0;z.setTexture2D(D,0),I.copyTexSubImage2D(I.TEXTURE_2D,re,0,0,ke,Fe,te,Ue),me.unbindTexture()};const Ir=I.createFramebuffer(),Uo=I.createFramebuffer();this.copyTextureToTexture=function(D,$,re=null,ie=null,te=0,Ue=0){let ke,Fe,Xe,We,lt,pt,Ze,Ft,en;const Zt=D.isCompressedTexture?D.mipmaps[Ue]:D.image;if(re!==null)ke=re.max.x-re.min.x,Fe=re.max.y-re.min.y,Xe=re.isBox3?re.max.z-re.min.z:1,We=re.min.x,lt=re.min.y,pt=re.isBox3?re.min.z:0;else{const En=Math.pow(2,-te);ke=Math.floor(Zt.width*En),Fe=Math.floor(Zt.height*En),D.isDataArrayTexture?Xe=Zt.depth:D.isData3DTexture?Xe=Math.floor(Zt.depth*En):Xe=1,We=0,lt=0,pt=0}ie!==null?(Ze=ie.x,Ft=ie.y,en=ie.z):(Ze=0,Ft=0,en=0);const Nt=Ce.convert($.format),Un=Ce.convert($.type);let qe;$.isData3DTexture?(z.setTexture3D($,0),qe=I.TEXTURE_3D):$.isDataArrayTexture||$.isCompressedArrayTexture?(z.setTexture2DArray($,0),qe=I.TEXTURE_2D_ARRAY):(z.setTexture2D($,0),qe=I.TEXTURE_2D),I.pixelStorei(I.UNPACK_FLIP_Y_WEBGL,$.flipY),I.pixelStorei(I.UNPACK_PREMULTIPLY_ALPHA_WEBGL,$.premultiplyAlpha),I.pixelStorei(I.UNPACK_ALIGNMENT,$.unpackAlignment);const mi=I.getParameter(I.UNPACK_ROW_LENGTH),wt=I.getParameter(I.UNPACK_IMAGE_HEIGHT),Yi=I.getParameter(I.UNPACK_SKIP_PIXELS),or=I.getParameter(I.UNPACK_SKIP_ROWS),Ws=I.getParameter(I.UNPACK_SKIP_IMAGES);I.pixelStorei(I.UNPACK_ROW_LENGTH,Zt.width),I.pixelStorei(I.UNPACK_IMAGE_HEIGHT,Zt.height),I.pixelStorei(I.UNPACK_SKIP_PIXELS,We),I.pixelStorei(I.UNPACK_SKIP_ROWS,lt),I.pixelStorei(I.UNPACK_SKIP_IMAGES,pt);const Fo=D.isDataArrayTexture||D.isData3DTexture,kt=$.isDataArrayTexture||$.isData3DTexture;if(D.isDepthTexture){const En=M.get(D),hs=M.get($),xn=M.get(En.__renderTarget),ps=M.get(hs.__renderTarget);me.bindFramebuffer(I.READ_FRAMEBUFFER,xn.__webglFramebuffer),me.bindFramebuffer(I.DRAW_FRAMEBUFFER,ps.__webglFramebuffer);for(let No=0;No<Xe;No++)Fo&&(I.framebufferTextureLayer(I.READ_FRAMEBUFFER,I.COLOR_ATTACHMENT0,M.get(D).__webglTexture,te,pt+No),I.framebufferTextureLayer(I.DRAW_FRAMEBUFFER,I.COLOR_ATTACHMENT0,M.get($).__webglTexture,Ue,en+No)),I.blitFramebuffer(We,lt,ke,Fe,Ze,Ft,ke,Fe,I.DEPTH_BUFFER_BIT,I.NEAREST);me.bindFramebuffer(I.READ_FRAMEBUFFER,null),me.bindFramebuffer(I.DRAW_FRAMEBUFFER,null)}else if(te!==0||D.isRenderTargetTexture||M.has(D)){const En=M.get(D),hs=M.get($);me.bindFramebuffer(I.READ_FRAMEBUFFER,Ir),me.bindFramebuffer(I.DRAW_FRAMEBUFFER,Uo);for(let xn=0;xn<Xe;xn++)Fo?I.framebufferTextureLayer(I.READ_FRAMEBUFFER,I.COLOR_ATTACHMENT0,En.__webglTexture,te,pt+xn):I.framebufferTexture2D(I.READ_FRAMEBUFFER,I.COLOR_ATTACHMENT0,I.TEXTURE_2D,En.__webglTexture,te),kt?I.framebufferTextureLayer(I.DRAW_FRAMEBUFFER,I.COLOR_ATTACHMENT0,hs.__webglTexture,Ue,en+xn):I.framebufferTexture2D(I.DRAW_FRAMEBUFFER,I.COLOR_ATTACHMENT0,I.TEXTURE_2D,hs.__webglTexture,Ue),te!==0?I.blitFramebuffer(We,lt,ke,Fe,Ze,Ft,ke,Fe,I.COLOR_BUFFER_BIT,I.NEAREST):kt?I.copyTexSubImage3D(qe,Ue,Ze,Ft,en+xn,We,lt,ke,Fe):I.copyTexSubImage2D(qe,Ue,Ze,Ft,We,lt,ke,Fe);me.bindFramebuffer(I.READ_FRAMEBUFFER,null),me.bindFramebuffer(I.DRAW_FRAMEBUFFER,null)}else kt?D.isDataTexture||D.isData3DTexture?I.texSubImage3D(qe,Ue,Ze,Ft,en,ke,Fe,Xe,Nt,Un,Zt.data):$.isCompressedArrayTexture?I.compressedTexSubImage3D(qe,Ue,Ze,Ft,en,ke,Fe,Xe,Nt,Zt.data):I.texSubImage3D(qe,Ue,Ze,Ft,en,ke,Fe,Xe,Nt,Un,Zt):D.isDataTexture?I.texSubImage2D(I.TEXTURE_2D,Ue,Ze,Ft,ke,Fe,Nt,Un,Zt.data):D.isCompressedTexture?I.compressedTexSubImage2D(I.TEXTURE_2D,Ue,Ze,Ft,Zt.width,Zt.height,Nt,Zt.data):I.texSubImage2D(I.TEXTURE_2D,Ue,Ze,Ft,ke,Fe,Nt,Un,Zt);I.pixelStorei(I.UNPACK_ROW_LENGTH,mi),I.pixelStorei(I.UNPACK_IMAGE_HEIGHT,wt),I.pixelStorei(I.UNPACK_SKIP_PIXELS,Yi),I.pixelStorei(I.UNPACK_SKIP_ROWS,or),I.pixelStorei(I.UNPACK_SKIP_IMAGES,Ws),Ue===0&&$.generateMipmaps&&I.generateMipmap(qe),me.unbindTexture()},this.initRenderTarget=function(D){M.get(D).__webglFramebuffer===void 0&&z.setupRenderTarget(D)},this.initTexture=function(D){D.isCubeTexture?z.setTextureCube(D,0):D.isData3DTexture?z.setTexture3D(D,0):D.isDataArrayTexture||D.isCompressedArrayTexture?z.setTexture2DArray(D,0):z.setTexture2D(D,0),me.unbindTexture()},this.resetState=function(){U=0,L=0,G=null,me.reset(),Te.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return br}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const t=this.getContext();t.drawingBufferColorSpace=St._getDrawingBufferColorSpace(e),t.unpackColorSpace=St._getUnpackColorSpace()}}function aC(n,e=50){const t=new Map;let i=null;const r=o=>{try{return JSON.stringify(o)}catch{return String(o)}},s=(...o)=>{const a=r(o);if(t.has(a))return t.get(a);const l=n(...o);return t.set(a,l),i&&clearTimeout(i),i=setTimeout(()=>{t.clear(),i=null},e),l};return s.cancel=()=>{i&&(clearTimeout(i),i=null),t.clear()},s}const Ef=9,lC=`
  varying vec2 vUv;
  void main() {
    vUv = uv;
    gl_Position = vec4(position.xy, 0.0, 1.0);
  }
`,cC={__name:"Blob3DBackground",setup(n,{expose:e}){const t=De(null);let i=null;const r={sampleScreenPixel:null,samplePoints:null},s=aC((p,m)=>{var T;if(!l||!d)return null;const v=(T=t.value)==null?void 0:T.getBoundingClientRect();if(!v)return null;const S=Math.round((p-v.left)*l.getPixelRatio()),x=Math.round((m-v.top)*l.getPixelRatio()),C=Math.round(v.width*l.getPixelRatio()),A=Math.round(v.height*l.getPixelRatio());if(S<0||x<0||S>=C||x>=A)return null;const R=l.getContext(),b=new Uint8Array(4);return R.readPixels(S,A-x-1,1,1,R.RGBA,R.UNSIGNED_BYTE,b),{r:b[0],g:b[1],b:b[2],a:b[3]}},50),o=(p,m,v,S)=>{var k;if(!l||!d)return null;const x=(k=t.value)==null?void 0:k.getBoundingClientRect();if(!x)return null;const C=l.getPixelRatio(),A=Math.round(x.width*C),R=Math.round(x.height*C);let b=Math.floor((p-x.left)*C),T=Math.floor((m-x.top)*C),N=Math.ceil(v*C),U=Math.ceil(S*C);if(b<0&&(N+=b,b=0),T<0&&(U+=T,T=0),N=Math.min(N,A-b),U=Math.min(U,R-T),N<=0||U<=0)return null;const L=N*U*4;(!i||i.length<L)&&(i=new Uint8Array(L));const G=l.getContext();return G.readPixels(b,R-(T+U),N,U,G.RGBA,G.UNSIGNED_BYTE,i),{data:i,px:b,py:T,pw:N,ph:U,ratio:C,left:x.left,top:x.top}},a=p=>{if(!p||p.length===0)return[];let m=1/0,v=1/0,S=-1/0,x=-1/0;for(const V of p)V.x<m&&(m=V.x),V.x>S&&(S=V.x),V.y<v&&(v=V.y),V.y>x&&(x=V.y);const C=o(m,v,S-m+1,x-v+1);if(!C)return p.map(()=>null);const{data:A,px:R,py:b,pw:T,ph:N,ratio:U,left:L,top:G}=C,k=new Array(p.length);for(let V=0;V<p.length;V++){const X=Math.floor((p[V].x-L)*U),B=Math.floor((p[V].y-G)*U);if(X<R||X>=R+T||B<b||B>=b+N){k[V]=null;continue}const j=((b+N-1-B)*T+(X-R))*4;k[V]={r:A[j],g:A[j+1],b:A[j+2],a:A[j+3]}}return k};r.sampleScreenPixel=s,r.samplePoints=a,window.__blobSampler=r,e({sampleScreenPixel:s,samplePoints:a});let l=null,c=null,u=null,d=null,f=null,h=[];function g(p,m){const v=getComputedStyle(document.documentElement).getPropertyValue(p).trim();if(!v)return m;const S=v.split(/\s+/).map(Number);return S.length<3||S.some(Number.isNaN)?m:new se(S[0]/255,S[1]/255,S[2]/255)}const _=`
  precision highp float;
...
`;return Dn(()=>{const p=t.value,m=p.clientWidth,v=p.clientHeight;l=new oC({antialias:!1,alpha:!0,preserveDrawingBuffer:!0}),l.setSize(m,v),l.setPixelRatio(Math.min(window.devicePixelRatio,1)),p.appendChild(l.domElement),c=new $w,u=new t0(-1,1,1,-1,0,1);const S=[{base:[-3.4,1.4,-.5],amp:[2.4,2,1.3],spd:[.13,.089,.061],ph:[0,1.7,3.4],r:2.6},{base:[3.6,-1.2,.4],amp:[2.2,2.3,1.2],spd:[.101,.127,.073],ph:[2.1,.4,5.2],r:2.3},{base:[-.8,-2.6,-1.1],amp:[2.6,1.9,1.5],spd:[.083,.113,.055],ph:[4.3,2.9,1.1],r:1.95},{base:[1.9,2.6,-.8],amp:[2,2.1,1.1],spd:[.119,.067,.091],ph:[1.2,5.1,2.7],r:1.5},{base:[-4.1,-1.9,.7],amp:[1.8,2.2,1.4],spd:[.071,.103,.047],ph:[3.8,1.5,4.6],r:1.25},{base:[4.2,1.8,-1.4],amp:[2.1,1.8,1.6],spd:[.109,.079,.121],ph:[5.5,3.2,.8],r:1.1},{base:[.4,3.3,.3],amp:[2.3,1.5,1.2],spd:[.059,.131,.085],ph:[2.6,4.8,3.9],r:.75},{base:[-2.1,2.9,-1.7],amp:[1.9,2,1.3],spd:[.127,.053,.097],ph:[.7,2.3,5.8],r:.58},{base:[1.4,-3.2,-.3],amp:[2.2,1.7,1.5],spd:[.093,.117,.065],ph:[4.9,.9,2.2],r:.45}],x=S.map(()=>new se),C=S.map(oe=>oe.r),A=new se(.06,.73,.51),R=new se(.02,.47,.34),b=new se(.02,.31,.23),T=new se(.2,.83,.6);d=new sr({vertexShader:lC,fragmentShader:_,transparent:!0,depthWrite:!1,uniforms:{uResolution:{value:new bt(m,v)},uTime:{value:0},uScroll:{value:0},uMouse:{value:new bt(0,0)},uMouseDir:{value:new bt(1,0)},uMouseStrength:{value:0},uBallPos:{value:x},uBallRadius:{value:C},uColorA:{value:A.clone()},uColorB:{value:R.clone()},uColorC:{value:b.clone()},uColorHi:{value:T.clone()}}});const N=new Lr(new cc(2,2),d);N.frustumCulled=!1,c.add(N);const U=()=>{d.uniforms.uColorA.value.copy(g("--color-primary-500",A)),d.uniforms.uColorB.value.copy(g("--color-primary-700",R)),d.uniforms.uColorC.value.copy(g("--color-primary-900",b)),d.uniforms.uColorHi.value.copy(g("--color-primary-400",T))};U(),window.addEventListener("colorpalettechange",U);const L=new bt(0,0),G=new bt(0,0),k=new bt(1,0);let V=0,X=!1;const B=oe=>{const Re=oe.clientX/window.innerWidth*2-1,Ae=-(oe.clientY/window.innerHeight*2-1),le=Re-G.x,w=Ae-G.y,E=Math.hypot(le,w);if(E>8e-4){k.x+=(le/E-k.x)*.25,k.y+=(w/E-k.y)*.25;const H=Math.hypot(k.x,k.y)||1;k.x/=H,k.y/=H,V=Math.min(1,V+E*7)}G.set(Re,Ae),L.set(Re,Ae),X=!0},Y=()=>{X=!1},j=oe=>{if(oe.touches.length>0){const Re=oe.touches[0],Ae=Re.clientX/window.innerWidth*2-1,le=-(Re.clientY/window.innerHeight*2-1);G.set(Ae,le),L.set(Ae,le),X=!0}},F=oe=>{if(oe.touches.length>0){const Re=oe.touches[0],Ae=Re.clientX/window.innerWidth*2-1,le=-(Re.clientY/window.innerHeight*2-1),w=Ae-G.x,E=le-G.y,H=Math.hypot(w,E);if(H>8e-4){k.x+=(w/H-k.x)*.25,k.y+=(E/H-k.y)*.25;const ee=Math.hypot(k.x,k.y)||1;k.x/=ee,k.y/=ee,V=Math.min(1,V+H*7)}G.set(Ae,le),L.set(Ae,le),X=!0}},ae=()=>{X=!1};window.addEventListener("mousemove",B,{passive:!0}),document.addEventListener("mouseleave",Y),window.addEventListener("touchstart",j,{passive:!0}),window.addEventListener("touchmove",F,{passive:!0}),window.addEventListener("touchend",ae,{passive:!0});let he=!0,ge=0;const xe=()=>{ge=Math.min(1,window.scrollY/window.innerHeight);const oe=he;he=ge<.95,oe&&!he?(cancelAnimationFrame(f),f=null):!oe&&he&&ue()};window.addEventListener("scroll",xe,{passive:!0});const Ee=()=>{const oe=p.clientWidth,Re=p.clientHeight;l.setSize(oe,Re),d.uniforms.uResolution.value.set(oe*l.getPixelRatio(),Re*l.getPixelRatio())};Ee(),window.addEventListener("resize",Ee);const J=performance.now(),ue=()=>{if(f=requestAnimationFrame(ue),!he)return;const oe=(performance.now()-J)/1e3,Re=d.uniforms.uScroll.value;d.uniforms.uScroll.value=Re+(ge-Re)*.08;const Ae=d.uniforms.uScroll.value,le=d.uniforms.uMouse.value;le.x+=(L.x-le.x)*.1,le.y+=(L.y-le.y)*.1,V*=.93;const w=X?.3+V*.85:0,E=d.uniforms.uMouseStrength;E.value+=(w-E.value)*.12;const H=d.uniforms.uMouseDir.value;H.x+=(k.x-H.x)*.1,H.y+=(k.y-H.y)*.1;const ee=Math.hypot(H.x,H.y)||1;H.x/=ee,H.y/=ee;for(let q=0;q<S.length;q++){const O=S[q],I=1+Ae*1.1,_e=1-Ae*.25,fe=1.55;x[q].set((O.base[0]+Math.sin(oe*O.spd[0]*fe+O.ph[0])*O.amp[0])*I,(O.base[1]+Math.sin(oe*O.spd[1]*fe+O.ph[1])*O.amp[1])*_e-Ae*1.6,O.base[2]+Math.cos(oe*O.spd[2]*fe+O.ph[2])*O.amp[2]-Ae*1.2),C[q]=O.r*(1+Math.sin(oe*(.055+q*.009)+q*1.9)*.16)*(1-Ae*.15);const ne=le.x*3.6,me=le.y*2.3,P=ne-x[q].x,M=me-x[q].y,z=Math.hypot(P,M),Z=C[q]+.9;if(z<Z){const K=(1-z/Z)*E.value*.1;x[q].x+=H.x*K,x[q].y+=H.y*K}}d.uniforms.uTime.value=oe,l.render(c,u)};xe(),he&&ue(),h.push(()=>{cancelAnimationFrame(f),window.removeEventListener("scroll",xe),window.removeEventListener("resize",Ee),window.removeEventListener("mousemove",B),document.removeEventListener("mouseleave",Y),window.removeEventListener("touchstart",j),window.removeEventListener("touchmove",F),window.removeEventListener("touchend",ae),window.removeEventListener("colorpalettechange",U),N.geometry.dispose(),d.dispose(),l.dispose(),l.domElement.parentNode&&l.domElement.parentNode.removeChild(l.domElement)})}),$n(()=>{h.forEach(p=>p())}),(p,m)=>(de(),pe("div",{ref_key:"containerRef",ref:t,class:"absolute inset-0 overflow-hidden pointer-events-none"},null,512))}},uc=(n,e)=>{const t=n.__vccOpts||n;for(const[i,r]of e)t[i]=r;return t},uC={class:"text-primary-500 light:text-primary-600"},dC={__name:"HeroSection",setup(n){Ke.registerPlugin(ft);const e=De(""),t=De(0),i=De(!1),r=["Frontend Developer","Vue.js Specialist","UI/UX Enthusiast","Problem Solver"];let s=null,o=null,a=[],l=null,c=null;const u=De(null),d=De(null),f=De(null),h=De(null),g=De(null),_=De(null),p=De(null),m=De(null),v=()=>{const S=r[t.value],x=e.value.length;if(i.value){if(e.value=S.substring(0,x-1),x===0){i.value=!1,t.value=(t.value+1)%r.length,s=setTimeout(v,500);return}s=setTimeout(v,50)}else{if(e.value=S.substring(0,x+1),x===S.length){i.value=!0,s=setTimeout(v,2e3);return}s=setTimeout(v,100)}};return Dn(()=>{s=setTimeout(v,500),o=Ke.timeline({defaults:{ease:"power3.out"}}),o.fromTo(u.value,{opacity:0,y:30,filter:"blur(8px)"},{opacity:1,y:0,filter:"blur(0px)",clearProps:"filter",duration:.8}).fromTo(d.value,{opacity:0,y:50,filter:"blur(12px)"},{opacity:1,y:0,filter:"blur(0px)",clearProps:"filter",duration:1.1},"-=0.4").fromTo(f.value,{opacity:0,y:50,filter:"blur(12px)"},{opacity:1,y:0,filter:"blur(0px)",clearProps:"filter",duration:1.1},"-=0.6").fromTo(h.value,{opacity:0,y:40,filter:"blur(10px)"},{opacity:1,y:0,filter:"blur(0px)",clearProps:"filter",duration:1},"-=0.5").fromTo(g.value,{opacity:0,y:30,filter:"blur(8px)"},{opacity:1,y:0,filter:"blur(0px)",clearProps:"filter",duration:.8,stagger:.15},"-=0.5"),l=Ke.to(_.value,{yPercent:-30,opacity:.2,ease:"none",scrollTrigger:{trigger:p.value,start:"top top",end:"bottom top",scrub:!0}});const S=d.value,x=14,C=R=>{const b=S.getBoundingClientRect(),T=(R.clientX-b.left)/b.width-.5,N=(R.clientY-b.top)/b.height-.5;c&&c.kill(),c=Ke.to(S,{rotationY:T*x*2,rotationX:-N*x*2,transformPerspective:600,transformOrigin:"center center",duration:.4,ease:"power2.out"})},A=()=>{c&&c.kill(),c=Ke.to(S,{rotationX:0,rotationY:0,duration:.8,ease:"elastic.out(1, 0.4)"})};S.addEventListener("mousemove",C),S.addEventListener("mouseleave",A),a.push(()=>{S.removeEventListener("mousemove",C),S.removeEventListener("mouseleave",A)})}),$n(()=>{var S;clearTimeout(s),o&&o.kill(),l&&((S=l.scrollTrigger)==null||S.kill()),a.forEach(x=>x())}),(S,x)=>(de(),pe("section",{ref_key:"heroSectionRef",ref:p,id:"home",class:"relative h-screen flex items-center justify-center overflow-hidden sticky top-0"},[x[3]||(x[3]=y("div",{class:"absolute inset-0 bg-grid opacity-20"},null,-1)),At(cC),y("div",{ref_key:"contentRef",ref:_,class:"relative text-center px-4 sm:px-6 lg:px-8 mx-auto"},[y("p",{ref_key:"greetingRef",ref:u,class:"text-primary-400 tracking-widest text-sm mb-4 drop-shadow-[0_2px_8px_rgba(0,0,0,0.5)] light:drop-shadow-[0_2px_8px_rgba(0,0,0,0.3)]"}," PORTFOLIO ",512),y("h1",{ref_key:"nameRef",ref:d,class:"font-griaste text-5xl sm:text-6xl md:text-7xl text-white light:text-secondary-900 mb-4 foil-text name-glow"}," Kenneth Cortez ",512),y("h2",{ref_key:"roleRef",ref:f,class:"text-2xl sm:text-3xl md:text-4xl font-semibold text-secondary-300 light:text-secondary-800 mb-6 drop-shadow-[0_2px_8px_rgba(0,0,0,0.5)] light:drop-shadow-[0_2px_8px_rgba(0,0,0,0.3)]"},[x[0]||(x[0]=Hi(" I'm a ",-1)),y("span",uC,ye(e.value),1),x[1]||(x[1]=y("span",{class:"animate-pulse text-primary-500 light:text-primary-600"},"|",-1))],512),y("p",{ref_key:"descriptionRef",ref:h,class:"light:text-black text-white text-lg mb-8 max-w-2xl mx-auto"}," I build modern, responsive web applications. In every project, creating a seamless user experience is my primary focus. ",512),y("div",{ref_key:"buttonsRef",ref:g,class:"flex flex-col sm:flex-row items-center justify-center gap-4"},[x[2]||(x[2]=y("a",{href:"#projects",class:"bg-primary-600 hover:bg-primary-700 text-white px-8 py-3 rounded-lg font-semibold transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-primary-500/25 w-full sm:w-auto drop-shadow-[0_2px_8px_rgba(0,0,0,0.4)] light:drop-shadow-[0_2px_8px_rgba(0,0,0,0.25)]"}," View My Work ",-1)),y("a",{ref_key:"resumeBtnRef",ref:m,href:"https://docs.google.com/document/d/1pxuH9Ue2NJ18GnzGR44gVKfEIvoe9YvMHj26P7A0RDY/edit?usp=sharing",target:"_blank",class:"resume-btn light:text-primary-800 light:border-primary-800 relative border border-white text-white px-8 py-3 rounded-lg font-semibold transition-all duration-300 hover:scale-105 w-full sm:w-auto"}," MY RESUME ",512)],512)],512)],512))}},fC=uc(dC,[["__scopeId","data-v-d1ff7438"]]);/*!
...
*/var Hn,Nv,ns,Sr,Fs,Ov,wa,Qc,kv=function(){return typeof window<"u"},Bv=function(){return Hn||kv()&&(Hn=window.gsap)&&Hn.registerPlugin&&Hn},zv=function(e){return typeof e=="string"},xg=function(e){return typeof e=="function"},Ql=function(e,t){var i=t==="x"?"Width":"Height",r="scroll"+i,s="client"+i;return e===ns||e===Sr||e===Fs?Math.max(Sr[r],Fs[r])-(ns["inner"+i]||Sr[s]||Fs[s]):e[r]-e["offset"+i]},ec=function(e,t){var i="scroll"+(t==="x"?"Left":"Top");return e===ns&&(e.pageXOffset!=null?i="page"+t.toUpperCase()+"Offset":e=Sr[i]!=null?Sr:Fs),function(){return e[i]}},hC=function(e,t,i,r){if(xg(e)&&(e=e(t,i,r)),typeof e!="object")return zv(e)&&e!=="max"&&e.charAt(1)!=="="?{x:e,y:e}:{y:e};if(e.nodeType)return{y:e,x:e};var s={},o;for(o in e)s[o]=o!=="onAutoKill"&&xg(e[o])?e[o](t,i,r):e[o];return s},Vv=function(e,t){if(e=Ov(e)[0],!e||!e.getBoundingClientRect)return console.warn("scrollTo target doesn't exist. Using 0")||{x:0,y:0};var i=e.getBoundingClientRect(),r=!t||t===ns||t===Fs,s=r?{top:Sr.clientTop-(ns.pageYOffset||Sr.scrollTop||Fs.scrollTop||0),left:Sr.clientLeft-(ns.pageXOffset||Sr.scrollLeft||Fs.scrollLeft||0)}:t.getBoundingClientRect(),o={x:i.left-s.left,y:i.top-s.top};return!r&&t&&(o.x+=ec(t,"x")(),o.y+=ec(t,"y")()),o},vg=function(e,t,i,r,s){return!isNaN(e)&&typeof e!="object"?parseFloat(e)-s:zv(e)&&e.charAt(1)==="="?parseFloat(e.substr(2))*(e.charAt(0)==="-"?-1:1)+r-s:e==="max"?Ql(t,i)-s:Math.min(Ql(t,i),Vv(e,t)[i]-s)},ip=function(){Hn=Bv(),kv()&&Hn&&typeof document<"u"&&document.body&&(ns=window,Fs=document.body,Sr=document.documentElement,Ov=Hn.utils.toArray,Hn.config({autoKillThreshold:7}),wa=Hn.config(),Nv=1)},za={version:"3.15.0",name:"scrollTo",rawVars:1,register:function(e){Hn=e,ip()},init:function(e,t,i,r,s){Nv||ip();var o=this,a=Hn.getProperty(e,"scrollSnapType");o.isWin=e===ns,o.target=e,o.tween=i,t=hC(t,r,e,s),o.vars=t,o.autoKill=!!("autoKill"in t?t:wa).autoKill,o.getX=ec(e,"x"),o.getY=ec(e,"y"),o.x=o.xPrev=o.getX(),o.y=o.yPrev=o.getY(),Qc||(Qc=Hn.core.globals().ScrollTrigger),Hn.getProperty(e,"scrollBehavior")==="smooth"&&Hn.set(e,{scrollBehavior:"auto"}),a&&a!=="none"&&(o.snap=1,o.snapInline=e.style.scrollSnapType,e.style.scrollSnapType="none"),t.x!=null?(o.add(o,"x",o.x,vg(t.x,e,"x",o.x,t.offsetX||0),r,s),o._props.push("scrollTo_x")):o.skipX=1,t.y!=null?(o.add(o,"y",o.y,vg(t.y,e,"y",o.y,t.offsetY||0),r,s),o._props.push("scrollTo_y")):o.skipY=1},render:function(e,t){for(var i=t._pt,r=t.target,s=t.tween,o=t.autoKill,a=t.xPrev,l=t.yPrev,c=t.isWin,u=t.snap,d=t.snapInline,f,h,g,_,p;i;)i.r(e,i.d),i=i._next;f=c||!t.skipX?t.getX():a,h=c||!t.skipY?t.getY():l,g=h-l,_=f-a,p=wa.autoKillThreshold,t.x<0&&(t.x=0),t.y<0&&(t.y=0),o&&(!t.skipX&&(_>p||_<-p)&&f<Ql(r,"x")&&(t.skipX=1),!t.skipY&&(g>p||g<-p)&&h<Ql(r,"y")&&(t.skipY=1),t.skipX&&t.skipY&&(s.kill(),t.vars.onAutoKill&&t.vars.onAutoKill.apply(s,t.vars.onAutoKillParams||[]))),c?ns.scrollTo(t.skipX?f:t.x,t.skipY?h:t.y):(t.skipY||(r.scrollTop=t.y),t.skipX||(r.scrollLeft=t.x)),u&&(e===1||e===0)&&(h=r.scrollTop,f=r.scrollLeft,d?r.style.scrollSnapType=d:r.style.removeProperty("scroll-snap-type"),r.scrollTop=h+1,r.scrollLeft=f+1,r.scrollTop=h,r.scrollLeft=f),t.xPrev=t.x,t.yPrev=t.y,Qc&&Qc.update()},kill:function(e){var t=e==="scrollTo",i=this._props.indexOf(e);return(t||e==="scrollTo_x")&&(this.skipX=1),(t||e==="scrollTo_y")&&(this.skipY=1),i>-1&&this._props.splice(i,1),!this._props.length}};za.max=Ql;za.getOffset=Vv;za.buildGetter=ec;za.config=function(n){wa||ip()||(wa=Hn.config());for(var e in n)wa[e]=n[e]};Bv()&&Hn.registerPlugin(za);Ke.registerPlugin(ft,za);function n0(n,e={}){const{y:t=60,duration:i=1.2,stagger:r=.12,start:s="top 85%",blur:o=12,scale:a=1.05,ease:l="power3.out",delay:c=0,onComplete:u}=e;Ke.set(n,{opacity:0,y:t,scale:a,filter:`blur(${o}px)`,willChange:"transform, opacity, filter"});const f=Ke.to(n,{opacity:1,y:0,scale:1,filter:"blur(0px)",duration:i,stagger:r,delay:c,ease:l,scrollTrigger:{trigger:n,start:s,once:!0},onComplete:u}).scrollTrigger;return Array.isArray(f)?f:[f]}function _d(n,e={}){const{x:t=-120,opacity:i=1,start:r="top 90%",end:s="top 40%",stagger:o=0,blur:a=0}=e;Ke.set(n,{x:t,opacity:0,filter:a?`blur(${a}px)`:"blur(0px)",willChange:"transform, opacity, filter"});const c=Ke.to(n,{x:0,opacity:i,filter:"blur(0px)",ease:"none",stagger:o,scrollTrigger:{trigger:n,start:r,end:s,scrub:!0}}).scrollTrigger;return Array.isArray(c)?c:[c]}function pC(n,e=8){const t=r=>{const s=n.getBoundingClientRect(),o=(r.clientX-s.left)/s.width-.5,a=(r.clientY-s.top)/s.height-.5;Ke.to(n,{rotationY:o*e*2,rotationX:-a*e*2,transformPerspective:800,duration:.3,ease:"power2.out"})},i=()=>{Ke.to(n,{rotationX:0,rotationY:0,duration:.5,ease:"elastic.out(1, 0.5)"})};return n.addEventListener("mousemove",t),n.addEventListener("mouseleave",i),()=>{n.removeEventListener("mousemove",t),n.removeEventListener("mouseleave",i)}}function mC(n={}){const{size:e=40,trailLength:t=200,trailWidth:i=18}=n,r=N=>getComputedStyle(document.documentElement).getPropertyValue(N).trim()||"16 185 129";let s=null;const o=()=>{if(s)return s;const N=r("--color-primary-500").split(" ").map(Number),U=r("--color-primary-400").split(" ").map(Number),L=r("--color-primary-300").split(" ").map(Number),G=r("--color-primary-700").split(" ").map(Number),k=r("--color-primary-900").split(" ").map(Number);return s={particleColors:[[255,255,255],L,N,G],outerGlow:[N,G,k,k],midGlow:[L,N,G],coreGlow:[[255,255,255],U,L,N]},s},a=()=>{s=null};window.addEventListener("colorpalettechange",a);const l=document.createElement("canvas");l.style.cssText=`
    ...
    pointer-events: none;
    z-index: 9999;
  `,document.body.appendChild(l);const c=l.getContext("2d"),u=()=>{l.width=window.innerWidth,l.height=window.innerHeight};u(),window.addEventListener("resize",u);const d={x:window.innerWidth/2,y:window.innerHeight/2},f={x:d.x,y:d.y},h=[];let g=!1,_=null;const p=N=>{d.x=N.clientX,d.y=N.clientY,g=!0,clearTimeout(_),_=setTimeout(()=>{g=!1},200)},m=()=>{g=!1,clearTimeout(_)},v=N=>{N.touches.length>0&&(d.x=N.touches[0].clientX,d.y=N.touches[0].clientY)},S=()=>{g=!0,clearTimeout(_)},x=()=>{clearTimeout(_),_=setTimeout(()=>{g=!1},200)},C=N=>{N.touches.length>0&&(d.x=N.touches[0].clientX,d.y=N.touches[0].clientY,f.x=d.x,f.y=d.y,g=!0)},A=()=>{g=!1},R=()=>{g=!1},b=Ke.to({},{duration:.2,repeat:-1,yoyo:!0,ease:"sine.inOut",onUpdate:function(){}}),T=Ke.ticker.add(()=>{c.clearRect(0,0,l.width,l.height);const N=d.x-f.x,U=d.y-f.y,L=Math.sqrt(N*N+U*U);if(g){const G=Math.max(1,Math.min(4,Math.floor(L*.15)+1));for(let k=0;k<G;k++){const V=Math.random()*Math.PI*2,X=Math.random()*e*.4;h.push({x:d.x+Math.cos(V)*X,y:d.y+Math.sin(V)*X,vx:(Math.random()-.5)*.4,vy:(Math.random()-.5)*.4,radius:(Math.random()*.6+.4)*(i*.35),life:1,decay:.004+Math.random()*.004,colorIndex:Math.floor(Math.random()*4),swirl:(Math.random()-.5)*.02,angle:Math.random()*Math.PI*2})}}h.length>t&&h.splice(0,h.length-t);for(let G=h.length-1;G>=0;G--){const k=h[G];if(k.life-=k.decay,k.life<=0){h.splice(G,1);continue}k.angle+=k.swirl,k.x+=k.vx+Math.cos(k.angle)*.15,k.y+=k.vy+Math.sin(k.angle)*.15;const V=k.life*.35,{particleColors:X}=o(),[B,Y,j]=X[k.colorIndex],F=c.createRadialGradient(k.x,k.y,0,k.x,k.y,k.radius*2.5);F.addColorStop(0,`rgba(${B}, ${Y}, ${j}, ${V})`),F.addColorStop(.5,`rgba(${B}, ${Y}, ${j}, ${V*.4})`),F.addColorStop(1,`rgba(${B}, ${Y}, ${j}, 0)`),c.beginPath(),c.arc(k.x,k.y,k.radius*2.5,0,Math.PI*2),c.fillStyle=F,c.fill()}if(g){const G=Date.now()/1e3,k=1+Math.sin(G*3)*.08+Math.sin(G*7)*.05,V=Math.sin(G*2.5)*2,X=Math.cos(G*2.1)*2,{outerGlow:B,midGlow:Y,coreGlow:j}=o(),F=c.createRadialGradient(d.x+V,d.y+X,0,d.x+V,d.y+X,e*1.5*k);F.addColorStop(0,`rgba(${B[0]}, 0.3)`),F.addColorStop(.4,`rgba(${B[1]}, 0.18)`),F.addColorStop(.7,`rgba(${B[2]}, 0.08)`),F.addColorStop(1,`rgba(${B[3]}, 0)`),c.beginPath(),c.arc(d.x+V,d.y+X,e*1.5*k,0,Math.PI*2),c.fillStyle=F,c.fill();const ae=c.createRadialGradient(d.x+V,d.y+X,0,d.x+V,d.y+X,e*.7*k);ae.addColorStop(0,`rgba(${Y[0]}, 0.5)`),ae.addColorStop(.5,`rgba(${Y[1]}, 0.3)`),ae.addColorStop(1,`rgba(${Y[2]}, 0)`),c.beginPath(),c.arc(d.x+V,d.y+X,e*.7*k,0,Math.PI*2),c.fillStyle=ae,c.fill();const he=c.createRadialGradient(d.x+V,d.y+X,0,d.x+V,d.y+X,e*.35*k);he.addColorStop(0,`rgba(${j[0]}, 0.85)`),he.addColorStop(.3,`rgba(${j[1]}, 0.6)`),he.addColorStop(.7,`rgba(${j[2]}, 0.25)`),he.addColorStop(1,`rgba(${j[3]}, 0)`),c.beginPath(),c.arc(d.x+V,d.y+X,e*.35*k,0,Math.PI*2),c.fillStyle=he,c.fill()}f.x=d.x,f.y=d.y});return window.addEventListener("mousemove",p),window.addEventListener("mouseleave",m),window.addEventListener("mousedown",S),window.addEventListener("mouseup",x),window.addEventListener("touchmove",v,{passive:!0}),window.addEventListener("touchstart",C,{passive:!0}),window.addEventListener("touchend",A,{passive:!0}),window.addEventListener("touchcancel",R,{passive:!0}),()=>{clearTimeout(_),window.removeEventListener("mousemove",p),window.removeEventListener("mouseleave",m),window.removeEventListener("mousedown",S),window.removeEventListener("mouseup",x),window.removeEventListener("touchmove",v),window.removeEventListener("touchstart",C),window.removeEventListener("touchend",A),window.removeEventListener("touchcancel",R),window.removeEventListener("resize",u),window.removeEventListener("colorpalettechange",a),Ke.ticker.remove(T),b.kill(),l.remove()}}const gC={id:"about",class:"pt-40 sm:pt-48 md:pt-56 pb-20 relative"},_C={class:"relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"},xC={class:"flex items-center justify-between mb-10"},vC={class:"hidden md:flex items-center gap-1 p-1 rounded-lg bg-secondary-800 border border-secondary-700 light:bg-secondary-100 light:border-secondary-200"},yC={class:"grid lg:grid-cols-2 gap-12 items-start"},bC={class:"flex flex-wrap gap-3"},SC={class:"text-3xl mb-3 group-hover:scale-110 group-hover:rotate-6 transition-transform duration-300 inline-block"},MC={class:"text-white light:text-secondary-900 font-semibold mb-2 text-xl"},wC=["data-count"],EC={class:"text-secondary-400 light:text-secondary-500 text-sm"},TC=["src","alt"],AC={class:"absolute inset-x-0 bottom-0 p-4 sm:p-6 pointer-events-none"},CC={class:"text-white font-bold text-lg sm:text-2xl mb-1 sm:mb-2 drop-shadow-lg"},RC=["data-count"],PC={class:"text-white/80 text-xs sm:text-sm drop-shadow"},DC={__name:"AboutSection",setup(n){Ke.registerPlugin(ft);const e=new Date("2021-09-01"),t=an(()=>{const x=(new Date-e)/(1e3*60*60*24*365.25);return Math.floor(x)}),i=an(()=>[{value:t.value,suffix:"+",title:"Years Work Experience",description:"Building production-ready web applications",icon:"💼",image:"https://images.unsplash.com/photo-1550859492-d5da9d8e45f3?w=600&q=80",bgClass:"bg-secondary-800 light:bg-white"},{value:50,suffix:"+",title:"Projects Delivered",description:"Scalable, maintainable, and user-friendly applications",icon:"🚀",image:"https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?w=600&q=80",bgClass:"bg-secondary-700 light:bg-secondary-50"},{title:"Creative Designer",description:"Crafting visually stunning and memorable experiences",icon:"🎨",image:"https://images.unsplash.com/photo-1557672172-298e090bd0f1?w=600&q=80",bgClass:"bg-secondary-600 light:bg-secondary-100"},{title:"Continuous Learner",description:"Always exploring new technologies and best practices",icon:"📚",image:"https://images.unsplash.com/photo-1614850715649-1d0106293bd1?w=600&q=80",bgClass:"bg-secondary-500 light:bg-secondary-200"}]),r=De(null),s=De(null),o=De(null),a=De(null),l=De("stack"),c=De(!1);let u=[],d=[],f=[],h=null;const g=()=>{c.value=window.innerWidth<768,c.value&&l.value==="stack"&&(l.value="grid")},_=()=>{const v=l.value==="stack"?a.value:o.value;if(!v)return;d.forEach(x=>{var C;(C=x.scrollTrigger)==null||C.kill(),x.kill()}),d=[],v.querySelectorAll("[data-count]").forEach(x=>{const C=parseInt(x.dataset.count,10),A={val:0},R=Ke.to(A,{val:C,duration:Math.max(.5,C*.04),ease:"power2.out",scrollTrigger:{trigger:x,start:"top 85%",once:!0},onUpdate:()=>{x.textContent=Math.floor(A.val)}});d.push(R)})},p=()=>{if(!a.value)return;f.forEach(k=>k()),f=[];const v=Array.from(a.value.querySelectorAll(".stack-card"));if(v.length===0)return;const S=[0,0,0,0],x=[0,10,20,30],C=()=>{v.forEach((k,V)=>{V===0?Ke.to(k,{x:0,y:0,rotation:0,zIndex:v.length-V,duration:.3,ease:"power2.out"}):Ke.to(k,{x:0,y:x[V%x.length],rotation:S[V%S.length],zIndex:v.length-V,duration:.3,ease:"power2.out"})})};C();let A=!1,R=0,b=0,T=0,N=0,U=0,L=0;const G=k=>{f.forEach(Y=>Y()),f=[];const V=Y=>{A=!0;const j=Y.touches?Y.touches[0]:Y;R=j.clientX,b=j.clientY,T=0,N=0;const F=k.getBoundingClientRect();U=F.left,L=window.innerWidth-F.right,Ke.killTweensOf(k),Ke.set(k,{cursor:"grabbing"})},X=Y=>{if(!A)return;const j=Y.touches?Y.touches[0]:Y;T=j.clientX-R,N=j.clientY-b,T=Math.max(-U,Math.min(L,T));const F=c.value?1:.3;Ke.set(k,{x:T,y:N*F,rotation:T*.05})},B=()=>{if(!A)return;A=!1,Ke.set(k,{cursor:"grab"});const Y=120,j=Math.abs(T),F=Math.abs(N);if(c.value?j>Y||F>Y:j>Y){const he=T>0?1:-1,ge=N>0?1:-1,xe=he>0?L:U,Ee=he*Math.min(Math.abs(T)+100,xe),J=c.value?ge*200:0;Ke.to(k,{x:Ee,y:J,rotation:he*20,opacity:0,duration:.5,ease:"power2.in",onComplete:()=>{Ke.set(k,{opacity:1}),v.push(v.shift()),C(),G(v[0])}})}else Ke.to(k,{x:0,y:0,rotation:0,duration:.4,ease:"power3.out"})};k.addEventListener("pointerdown",V),window.addEventListener("pointermove",X),window.addEventListener("pointerup",B),f.push(()=>{k.removeEventListener("pointerdown",V),window.removeEventListener("pointermove",X),window.removeEventListener("pointerup",B)})};G(v[0])},m=v=>{l.value=v,Rr(()=>{v==="stack"&&p(),_()})};return Dn(()=>{g(),h=()=>g(),window.addEventListener("resize",h),u.push(..._d(r.value,{x:-120,start:"top 90%",end:"top 40%"})),c.value||p(),_()}),$n(()=>{h&&window.removeEventListener("resize",h),u.forEach(v=>v.kill()),d.forEach(v=>{var S;(S=v.scrollTrigger)==null||S.kill(),v.kill()}),f.forEach(v=>v())}),(v,S)=>(de(),pe("section",gC,[S[7]||(S[7]=co('<svg width="0" height="0" class="absolute" aria-hidden="true"><defs><clipPath id="about-concave-clip" clipPathUnits="objectBoundingBox"><path d="M0 0 Q0.5 0.2 1 0 L1 1 L0 1 Z"></path></clipPath></defs></svg><div class="absolute -top-24 sm:-top-24 md:-top-32 left-0 right-0 bottom-0 bg-dark-800 light:bg-white" style="clip-path:url(#about-concave-clip);"></div><svg class="absolute -top-24 sm:-top-24 md:-top-32 left-0 w-full h-[calc(100%+6rem)] sm:h-[calc(100%+6rem)] md:h-[calc(100%+8rem)] pointer-events-none" viewBox="0 0 1 1" preserveAspectRatio="none" aria-hidden="true"><path d="M0 0 Q0.5 0.2 1 0" fill="none" stroke="rgb(var(--color-primary-500) / 0.4)" stroke-width="0.002" vector-effect="non-scaling-stroke"></path></svg>',3)),y("div",_C,[y("div",xC,[y("h2",{ref_key:"titleRef",ref:r,class:"section-title"},"About Me",512),y("div",vC,[y("button",{onClick:S[0]||(S[0]=x=>m("grid")),class:st(["px-3 py-1.5 rounded-md text-sm font-medium transition-all duration-300",l.value==="grid"?"bg-primary-600 text-white shadow-md shadow-primary-500/25":"text-secondary-400 hover:text-white light:text-secondary-500 light:hover:text-secondary-900"]),"aria-label":"Grid view"},[...S[2]||(S[2]=[y("svg",{class:"w-4 h-4",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24"},[y("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"2",d:"M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z"})],-1)])],2),y("button",{onClick:S[1]||(S[1]=x=>m("stack")),class:st(["px-3 py-1.5 rounded-md text-sm font-medium transition-all duration-300",l.value==="stack"?"bg-primary-600 text-white shadow-md shadow-primary-500/25":"text-secondary-400 hover:text-white light:text-secondary-500 light:hover:text-secondary-900"]),"aria-label":"Stack view"},[...S[3]||(S[3]=[y("svg",{class:"w-4 h-4",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24"},[y("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"2",d:"M4 6h16M4 12h16M4 18h16"})],-1)])],2)])]),y("div",yC,[y("div",{ref_key:"textRef",ref:s,class:"order-1 lg:order-1"},[S[4]||(S[4]=y("p",{class:"text-secondary-300 light:text-secondary-700 text-lg leading-relaxed mb-6"}," I build modern web applications that are as functional as they are beautiful. What started as a curiosity about the web has evolved into a career creating impactful digital products. ",-1)),S[5]||(S[5]=y("p",{class:"text-secondary-400 light:text-secondary-500 leading-relaxed mb-8"}," I specialize in the Vue.js ecosystem but I'm able to adjust to any framework, always prioritizing clean, maintainable code and highly intuitive user experiences. ",-1)),y("div",bC,[(de(),pe(je,null,rt(["Vue 3","JavaScript","TypeScript","Node.js","Tailwind CSS"],x=>y("span",{key:x,class:"px-4 py-2 bg-secondary-800/50 border border-secondary-700 rounded-full text-sm text-secondary-300 hover:border-primary-500/50 hover:text-primary-400 light:bg-secondary-100 light:border-secondary-200 light:text-secondary-600 light:hover:border-primary-500/50 light:hover:text-primary-600 transition-all duration-300 hover:scale-105 cursor-default"},ye(x),1)),64)),(de(),pe(je,null,rt(["Git","Figma"],x=>y("span",{key:x,class:"px-4 py-2 bg-secondary-800/50 border border-secondary-700 rounded-full text-sm text-secondary-300 hover:border-primary-500/50 hover:text-primary-400 light:bg-secondary-100 light:border-secondary-200 light:text-secondary-600 light:hover:border-primary-500/50 light:hover:text-primary-600 transition-all duration-300 hover:scale-105 cursor-default"},ye(x),1)),64))])],512),l.value==="grid"||c.value?(de(),pe("div",{key:0,ref_key:"gridRef",ref:o,class:"order-2 lg:order-2 grid sm:grid-cols-2 gap-6"},[(de(!0),pe(je,null,rt(i.value,x=>(de(),pe("div",{key:x.title,class:"group bg-secondary-800 border border-secondary-700 rounded-xl p-6 hover:border-primary-500/50 hover:shadow-xl hover:shadow-primary-500/10 hover:-translate-y-1 transition-all duration-300 light:bg-white light:border-secondary-200 light:hover:border-primary-500/50 light:hover:shadow-primary-500/10"},[y("div",SC,ye(x.icon),1),y("h3",MC,[x.value!==void 0?(de(),pe(je,{key:0},[y("span",{"data-count":x.value},ye(x.value),9,wC),Hi(ye(x.suffix),1)],64)):(de(),pe(je,{key:1},[Hi(ye(x.title),1)],64))]),y("p",EC,ye(x.description),1)]))),128))],512)):c.value?An("",!0):(de(),pe("div",{key:1,ref_key:"stackRef",ref:a,class:"order-2 lg:order-2 relative h-[12rem] sm:h-[18rem] w-full sm:max-w-none select-none"},[(de(!0),pe(je,null,rt(i.value,(x,C)=>(de(),pe("div",{key:x.title,class:st(["stack-card absolute inset-0 group border border-secondary-700 rounded-xl overflow-hidden hover:border-primary-500/50 hover:shadow-xl hover:shadow-primary-500/10 transition-colors duration-300 light:border-secondary-200 light:hover:border-primary-500/50 light:hover:shadow-primary-500/10 cursor-grab active:cursor-grabbing touch-none",x.bgClass]),style:Sn({zIndex:i.value.length-C})},[y("img",{src:x.image,alt:x.title,class:"absolute inset-0 w-full h-full object-cover pointer-events-none select-none",loading:"lazy",draggable:"false"},null,8,TC),S[6]||(S[6]=y("div",{class:"absolute inset-x-0 bottom-0 h-3/4 bg-gradient-to-t from-black/90 via-black/50 to-transparent pointer-events-none"},null,-1)),y("div",AC,[y("h3",CC,[x.value!==void 0?(de(),pe(je,{key:0},[y("span",{"data-count":x.value},ye(x.value),9,RC),Hi(ye(x.suffix)+" "+ye(x.title),1)],64)):(de(),pe(je,{key:1},[Hi(ye(x.title),1)],64))]),y("p",PC,ye(x.description),1)])],6))),128))],512))])])]))}},Tf=[{name:"Vue.js",category:"Frontend",description:"Progressive JavaScript framework for building user interfaces",image:"https://cdn.jsdelivr.net/gh/devicons/devicon/icons/vuejs/vuejs-original.svg"},{name:"TypeScript",category:"Language",description:"Typed superset of JavaScript for safer code",image:"https://cdn.jsdelivr.net/gh/devicons/devicon/icons/typescript/typescript-original.svg"},{name:"JavaScript",category:"Language",description:"High-level programming language for the web",image:"https://cdn.jsdelivr.net/gh/devicons/devicon/icons/javascript/javascript-original.svg"},{name:"Node.js",category:"Backend",description:"JavaScript runtime for building server-side applications",image:"https://cdn.jsdelivr.net/gh/devicons/devicon/icons/nodejs/nodejs-original.svg"},{name:"Tailwind CSS",category:"Styling",description:"Utility-first CSS framework for rapid UI development",image:"https://cdn.jsdelivr.net/gh/devicons/devicon/icons/tailwindcss/tailwindcss-original.svg"},{name:"Vite",category:"Tooling",description:"Next-generation frontend build tool",image:"https://cdn.jsdelivr.net/gh/devicons/devicon/icons/vitejs/vitejs-original.svg"},{name:"GitHub",category:"DevOps",description:"Platform for version control and collaboration",image:"https://cdn.jsdelivr.net/gh/devicons/devicon/icons/github/github-original.svg"},{name:"GitHub Desktop",category:"Tooling",description:"Visual interface for Git version control",image:"https://cdn.jsdelivr.net/gh/devicons/devicon/icons/github/github-original.svg"},{name:"Pinia",category:"Frontend",description:"State management library for Vue.js",image:"https://pinia.vuejs.org/logo.svg"},{name:"Three.js",category:"Frontend",description:"3D graphics library for the web",image:"https://cdn.jsdelivr.net/gh/devicons/devicon/icons/threejs/threejs-original.svg"},{name:"GSAP",category:"Frontend",description:"High-performance animation library",image:"https://gsap.com/favicon.ico"},{name:"Lucide",category:"Frontend",description:"Beautiful & consistent icon toolkit",image:"https://lucide.dev/favicon.ico"},{name:"Axios",category:"Backend",description:"Promise-based HTTP client for the browser and Node.js",image:"https://cdn.jsdelivr.net/gh/devicons/devicon/icons/axios/axios-plain.svg"},{name:"shadcn/ui",category:"Frontend",description:"Reusable components built with Radix UI and Tailwind",image:"https://ui.shadcn.com/favicon.ico"},{name:"Python",category:"Language",description:"Versatile programming language for data and automation",image:"https://cdn.jsdelivr.net/gh/devicons/devicon/icons/python/python-original.svg"},{name:"Jupyter Notebook",category:"Tooling",description:"Interactive computing environment for data science",image:"https://cdn.jsdelivr.net/gh/devicons/devicon/icons/jupyter/jupyter-original.svg"},{name:"Google Colab",category:"Tooling",description:"Free cloud-based Jupyter notebook environment",image:"https://colab.research.google.com/img/colab_favicon_256px.png"},{name:"VS Code",category:"Tooling",description:"Powerful code editor with rich extension ecosystem",image:"https://cdn.jsdelivr.net/gh/devicons/devicon/icons/vscode/vscode-original.svg"},{name:"Figma",category:"Design",description:"Collaborative interface design tool for prototyping and UI/UX",image:"https://cdn.jsdelivr.net/gh/devicons/devicon/icons/figma/figma-original.svg"}],LC={id:"tech-stack",class:"py-20 bg-dark-800 light:bg-secondary-100 relative overflow-hidden"},IC={class:"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"},UC=["onClick"],FC=["data-column"],NC={class:"tech-brick group relative bg-secondary-800 border border-secondary-700 rounded-xl p-6 overflow-hidden hover:border-primary-500 hover:shadow-xl hover:shadow-primary-500/10 transition-colors duration-300 light:bg-white light:border-secondary-200 light:hover:border-primary-500 light:hover:shadow-primary-500/10"},OC={class:"tech-image-overlay absolute inset-0 z-10 flex items-center justify-center bg-dark-900/95 light:bg-white/95 backdrop-blur-sm overflow-hidden"},kC=["src","alt"],BC={class:"relative z-0 flex flex-col h-full"},zC={class:"flex items-start justify-between mb-4"},VC={class:"w-10 h-10 group-hover:scale-110 group-hover:rotate-6 transition-transform duration-300"},HC=["src","alt"],GC={class:"text-xs text-primary-400 bg-primary-500/10 px-2 py-1 rounded-full"},WC={class:"text-white light:text-secondary-900 font-bold text-lg mb-2 group-hover:text-primary-400 transition-colors duration-300"},XC={class:"text-secondary-300 light:text-secondary-500 text-sm"},$C={__name:"TechStack",setup(n){Ke.registerPlugin(ft);const e=an(()=>["All",...new Set(Tf.map(v=>v.category))]),t=De("All"),i=De(null),r=De(null),s=De(null),o=De(null),a=De(typeof window<"u"?window.innerWidth:1024);let l=[],c=[],u=[],d=null,f=null;const h=an(()=>t.value==="All"?Tf:Tf.filter(v=>v.category===t.value)),g=an(()=>{if(t.value!=="All")return!1;const v=h.value.length;return a.value>=1024?v>4:a.value>=640?v>2:!1}),_=v=>{t.value=v},p=()=>{if(!i.value)return;const v=i.value.querySelectorAll(".brick-wrapper");if(c.forEach(x=>{var C;(C=x.scrollTrigger)==null||C.kill(),x.kill()}),c=[],t.value!=="All"){v.forEach(x=>{const C=x.querySelector(".tech-brick");C&&Ke.set(C,{yPercent:0})});return}const S=window.innerWidth>=768;v.forEach(x=>{const C=x.querySelector(".tech-brick");if(!C)return;const A=parseInt(x.dataset.column,10);if(!S){Ke.set(C,{yPercent:0});return}if(A===1||A===3){const R=Ke.fromTo(C,{yPercent:-20},{yPercent:20,ease:"none",scrollTrigger:{trigger:i.value,start:"top bottom",end:"bottom top",scrub:.6}});c.push(R)}})},m=()=>{if(!i.value)return;u.forEach(S=>S()),u=[],i.value.querySelectorAll(".tech-brick").forEach(S=>{const x=S.querySelector(".tech-image-overlay");if(!x)return;Ke.set(x,{clipPath:"circle(0% at 50% 0%)",visibility:"hidden"});const C=()=>{Ke.killTweensOf(x),Ke.set(x,{visibility:"visible"}),Ke.to(x,{clipPath:"circle(150% at 50% 0%)",duration:.6,ease:"power3.out",overwrite:"auto"})},A=()=>{Ke.killTweensOf(x),Ke.set(x,{visibility:"hidden"}),Ke.to(x,{clipPath:"circle(0% at 50% 0%)",duration:.5,ease:"power3.in",overwrite:"auto"})};S.addEventListener("mouseenter",C),S.addEventListener("mouseleave",A),S.addEventListener("touchstart",C,{passive:!0}),S.addEventListener("touchend",A,{passive:!0}),S.addEventListener("touchcancel",A,{passive:!0}),u.push(()=>{S.removeEventListener("mouseenter",C),S.removeEventListener("mouseleave",A),S.removeEventListener("touchstart",C),S.removeEventListener("touchend",A),S.removeEventListener("touchcancel",A)})})};return Dn(()=>{l.push(..._d(r.value,{x:-120,start:"top 90%",end:"top 40%"})),p(),m(),f=window.innerWidth>=768;const v=()=>{a.value=window.innerWidth;const S=window.innerWidth>=768;S!==f&&(f=S,p())};window.addEventListener("resize",v),d=()=>window.removeEventListener("resize",v)}),$n(()=>{l.forEach(v=>v.kill()),c.forEach(v=>{var S;(S=v.scrollTrigger)==null||S.kill(),v.kill()}),u.forEach(v=>v()),d==null||d()}),Ai(h,async()=>{await Rr(),p(),m()}),(v,S)=>(de(),pe("section",LC,[S[0]||(S[0]=y("div",{class:"absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-primary-500/50 to-transparent"},null,-1)),y("div",IC,[y("h2",{ref_key:"titleRef",ref:r,class:"section-title text-4xl font-bold text-white light:text-secondary-900 mb-6"},"Tech Stack",512),y("p",{ref_key:"subtitleRef",ref:s,class:"section-subtitle text-secondary-400 light:text-secondary-500 mb-8"},"Technologies and tools I work with",512),y("div",{ref_key:"filterRef",ref:o,class:"flex flex-wrap gap-3 mb-10"},[(de(!0),pe(je,null,rt(e.value,x=>(de(),pe("button",{key:x,onClick:C=>_(x),class:st(["px-4 py-2 rounded-lg text-sm font-medium transition-all duration-300 hover:scale-105",t.value===x?"bg-primary-600 text-white shadow-lg shadow-primary-500/25":"bg-secondary-800 text-secondary-400 hover:text-white border border-secondary-700 light:bg-white light:text-secondary-500 light:hover:text-secondary-900 light:border-secondary-200"])},ye(x),11,UC))),128))],512),y("div",{ref_key:"gridRef",ref:i,class:"brick-wall"},[(de(!0),pe(je,null,rt(h.value,(x,C)=>(de(),pe("div",{key:x.name,"data-column":C%4,class:st(["brick-wrapper",{"brick-offset":g.value}])},[y("div",NC,[y("div",OC,[y("img",{src:x.image,alt:`${x.name} logo`,class:"w-24 h-24 object-contain drop-shadow-lg",loading:"lazy"},null,8,kC)]),y("div",BC,[y("div",zC,[y("div",VC,[y("img",{src:x.image,alt:`${x.name} logo`,class:"w-full h-full object-contain",loading:"lazy"},null,8,HC)]),y("span",GC,ye(x.category),1)]),y("h3",WC,ye(x.name),1),y("p",XC,ye(x.description),1)])])],10,FC))),128))],512)])]))}},jC=uc($C,[["__scopeId","data-v-3c28cea0"]]),Af=[{id:1,title:"E-Commerce Platform",description:"A full-featured e-commerce platform with product management, cart functionality, and Stripe payment integration.",tech:["Vue 3","Node.js","MongoDB","Stripe"],github:"https://github.com/yourusername/ecommerce-platform",demo:"https://ecommerce-demo.example.com",image:"https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?w=600&h=400&fit=crop",features:["Product catalog with search, filtering, and category browsing","Shopping cart with real-time price calculations and quantity management","Secure Stripe payment integration with order confirmation","User authentication with profile and order history","Admin dashboard for product and inventory management"]},{id:2,title:"Task Management App",description:"A collaborative task management application with real-time updates, drag-and-drop boards, and team collaboration features.",tech:["Vue 3","Firebase","Tailwind CSS"],github:"https://github.com/yourusername/task-manager",demo:"https://task-manager-demo.example.com",image:"https://images.unsplash.com/photo-1484480974693-6ca0a78fb36b?w=600&h=400&fit=crop",features:["Drag-and-drop kanban boards for task organization","Real-time collaboration with live updates across team members","Task assignments, due dates, and priority levels","Project workspaces with customizable columns and labels","Activity timeline and notifications for team updates"]},{id:3,title:"Weather Dashboard",description:"A real-time weather dashboard with location-based forecasts, interactive maps, and 7-day weather predictions.",tech:["Vue 3","REST API","Chart.js"],github:"https://github.com/yourusername/weather-dashboard",demo:"https://weather-demo.example.com",image:"https://images.unsplash.com/photo-1504608524841-42fe6f032b4b?w=600&h=400&fit=crop",features:["Real-time weather data with location-based search","Interactive 7-day forecast with temperature trends","Hourly breakdown with precipitation and wind speed","Visual weather charts using Chart.js for data visualization","Responsive design optimized for mobile and desktop"]},{id:4,title:"Social Media Analytics",description:"An analytics dashboard for social media managers to track engagement, follower growth, and content performance across platforms.",tech:["Vue 3","D3.js","Express","PostgreSQL"],github:"https://github.com/yourusername/social-analytics",demo:"https://analytics-demo.example.com",image:"https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=600&h=400&fit=crop",features:["Cross-platform analytics aggregation for major social networks","Interactive data visualizations with D3.js charts","Follower growth tracking with trend analysis","Content performance metrics and engagement scoring","Customizable reporting with export capabilities"]},{id:5,title:"Recipe Finder",description:"A recipe discovery app with ingredient-based search, meal planning, and step-by-step cooking instructions.",tech:["Vue 3","Vuex","Tailwind CSS"],github:"https://github.com/yourusername/recipe-finder",demo:"https://recipe-demo.example.com",image:"https://images.unsplash.com/photo-1466637574441-749b8f19452f?w=600&h=400&fit=crop",features:["Ingredient-based recipe search with smart matching","Meal planning calendar with grocery list generation","Step-by-step cooking instructions with timers","Recipe filtering by dietary preferences and cuisine","Save and organize favorite recipes in collections"]},{id:6,title:"Dev Portfolio Template",description:"A modern, responsive developer portfolio template with dark mode, smooth animations, and project showcase features.",tech:["Vue 3","Tailwind CSS","Vite"],github:"https://github.com/yourusername/dev-portfolio",demo:"https://portfolio-demo.example.com",image:"https://images.unsplash.com/photo-1461749280684-dccba630e2f6?w=600&h=400&fit=crop",features:["Dark/light mode with smooth theme transitions","GSAP-powered scroll animations and micro-interactions","Interactive project showcase with detail modals","Fully responsive layout across all device sizes","Optimized performance with Vite build tooling"]},{id:7,title:"Dev Portfolio",description:"A modern, responsive developer portfolio template with dark mode, smooth animations, and project showcase features.",tech:["Vue 3","Tailwind CSS","Vite"],github:"https://github.com/yourusername/dev-portfolio",demo:"https://portfolio-demo.example.com",image:"https://images.unsplash.com/photo-1461749280684-dccba630e2f6?w=600&h=400&fit=crop",features:["Dark/light mode with smooth theme transitions","GSAP-powered scroll animations and micro-interactions","Interactive project showcase with detail modals","Fully responsive layout across all device sizes","Optimized performance with Vite build tooling"]},{id:8,title:"Dev Template",description:"A modern, responsive developer portfolio template with dark mode, smooth animations, and project showcase features.",tech:["Vue 3","Tailwind CSS","Vite"],github:"https://github.com/yourusername/dev-portfolio",demo:"https://portfolio-demo.example.com",image:"https://images.unsplash.com/photo-1461749280684-dccba630e2f6?w=600&h=400&fit=crop",features:["Dark/light mode with smooth theme transitions","GSAP-powered scroll animations and micro-interactions","Interactive project showcase with detail modals","Fully responsive layout across all device sizes","Optimized performance with Vite build tooling"]}],YC={class:"w-full h-full bg-secondary-900 light:bg-secondary-100 overflow-hidden relative flex flex-col"},qC={class:"flex items-center gap-2 px-3 sm:px-4 py-2 bg-secondary-800 light:bg-white border-b border-secondary-700 light:border-secondary-200 flex-shrink-0"},KC={class:"flex-1 max-w-md mx-auto"},ZC={class:"bg-secondary-700/50 light:bg-secondary-100 rounded-md px-2 sm:px-3 py-1 text-[10px] sm:text-xs text-secondary-400 light:text-secondary-500 flex items-center gap-1.5 sm:gap-2 truncate"},JC={class:"truncate"},QC={key:0,class:"flex-1 flex flex-col min-h-0 relative"},eR={class:"flex items-center justify-between px-3 sm:px-6 py-2.5 sm:py-3 bg-secondary-800 light:bg-white border-b border-secondary-700 light:border-secondary-200 flex-shrink-0"},tR={class:"flex items-center gap-2 sm:gap-4"},nR={key:0,class:"absolute -top-1 -right-1 w-3.5 h-3.5 sm:w-4 sm:h-4 bg-accent-500 rounded-full text-[8px] sm:text-[9px] text-white flex items-center justify-center font-bold"},iR={class:"flex-1 p-3 sm:p-4 grid grid-cols-2 sm:grid-cols-3 gap-2 sm:gap-3 overflow-y-auto min-h-0 overscroll-contain"},rR={class:"text-[9px] sm:text-[10px] text-secondary-400 light:text-secondary-500 mb-1 truncate"},sR={class:"flex items-center justify-between"},oR={class:"text-[10px] sm:text-xs font-semibold text-primary-500"},aR=["onClick"],lR={key:0,class:"absolute inset-y-0 right-0 w-64 sm:w-80 bg-secondary-800 light:bg-white border-l border-secondary-700 light:border-secondary-200 shadow-2xl z-20 flex flex-col"},cR={class:"flex items-center justify-between px-4 py-3 border-b border-secondary-700 light:border-secondary-200"},uR={class:"flex-1 overflow-y-auto p-4 space-y-3 overscroll-contain"},dR={key:0,class:"text-center py-8"},fR={class:"flex-1 min-w-0"},hR={class:"text-[10px] text-white light:text-secondary-900 font-medium truncate"},pR={class:"text-[9px] text-primary-500"},mR={class:"flex items-center gap-1.5"},gR=["onClick"],_R={class:"text-[10px] text-white light:text-secondary-900 w-4 text-center"},xR=["onClick"],vR={class:"p-4 border-t border-secondary-700 light:border-secondary-200"},yR={class:"flex justify-between mb-3"},bR={class:"text-sm font-bold text-white light:text-secondary-900"},SR={key:1,class:"flex-1 flex flex-col min-h-0"},MR={class:"px-3 sm:px-6 py-2.5 bg-secondary-800/50 light:bg-secondary-100/50 border-b border-secondary-700 light:border-secondary-200 flex-shrink-0"},wR={class:"flex gap-2"},ER=["value"],TR={class:"flex-1 p-2 sm:p-4 flex gap-2 sm:gap-3 overflow-x-auto min-h-0"},AR={class:"flex-1 min-w-[140px] sm:min-w-0 bg-secondary-800/50 light:bg-secondary-200/50 rounded-lg p-2 sm:p-2.5 flex flex-col"},CR={class:"flex items-center justify-between mb-2 px-1 flex-shrink-0"},RR={class:"text-[8px] sm:text-[9px] text-secondary-500 light:text-secondary-400"},PR={class:"space-y-1.5 sm:space-y-2 overflow-y-auto flex-1 min-h-0 overscroll-contain"},DR=["onClick"],LR={class:"flex items-start gap-1.5"},IR=["onClick"],UR={class:"flex-1 min-w-0"},FR={class:"text-[9px] sm:text-[10px] text-white light:text-secondary-900 leading-tight"},NR={class:"flex-1 min-w-[140px] sm:min-w-0 bg-secondary-800/50 light:bg-secondary-200/50 rounded-lg p-2 sm:p-2.5 flex flex-col"},OR={class:"flex items-center justify-between mb-2 px-1 flex-shrink-0"},kR={class:"text-[8px] sm:text-[9px] text-secondary-500 light:text-secondary-400"},BR={class:"space-y-1.5 sm:space-y-2 overflow-y-auto flex-1 min-h-0 overscroll-contain"},zR=["onClick"],VR={class:"flex items-start gap-1.5"},HR=["onClick"],GR={class:"flex-1 min-w-0"},WR={class:"text-[9px] sm:text-[10px] text-white light:text-secondary-900 leading-tight"},XR={class:"flex-1 min-w-[140px] sm:min-w-0 bg-secondary-800/50 light:bg-secondary-200/50 rounded-lg p-2 sm:p-2.5 flex flex-col"},$R={class:"flex items-center justify-between mb-2 px-1 flex-shrink-0"},jR={class:"text-[8px] sm:text-[9px] text-secondary-500 light:text-secondary-400"},YR={class:"space-y-1.5 sm:space-y-2 overflow-y-auto flex-1 min-h-0 overscroll-contain"},qR=["onClick"],KR={class:"flex items-start gap-1.5"},ZR={class:"flex-1 min-w-0"},JR={class:"text-[9px] sm:text-[10px] text-secondary-400 light:text-secondary-500 line-through leading-tight"},QR={key:2,class:"flex-1 flex flex-col min-h-0"},eP={class:"flex items-center justify-between px-3 sm:px-6 py-2.5 sm:py-3 bg-secondary-800 light:bg-white border-b border-secondary-700 light:border-secondary-200 flex-shrink-0"},tP={class:"flex items-center gap-2"},nP={class:"flex rounded-lg overflow-hidden border border-secondary-600 light:border-secondary-200"},iP={class:"px-3 sm:px-6 py-2.5 bg-secondary-800/50 light:bg-secondary-100/50 border-b border-secondary-700 light:border-secondary-200 flex-shrink-0 relative"},rP={class:"flex gap-2"},sP={class:"flex-1 relative"},oP={key:0,class:"absolute left-3 sm:left-6 right-3 sm:right-6 top-full mt-1 bg-secondary-800 light:bg-white border border-secondary-700 light:border-secondary-200 rounded-lg shadow-xl z-10 overflow-hidden"},aP=["onClick"],lP={class:"ml-auto text-secondary-500 light:text-secondary-400"},cP={class:"px-3 sm:px-6 py-3 sm:py-4 bg-gradient-to-br from-primary-600/30 to-primary-500/10 flex-shrink-0"},uP={class:"flex items-center justify-between"},dP={class:"text-2xl sm:text-3xl font-bold text-white light:text-secondary-900"},fP={class:"text-[9px] sm:text-[10px] text-secondary-400 light:text-secondary-500 mt-0.5"},hP={class:"text-[8px] sm:text-[9px] text-secondary-500 light:text-secondary-400 mt-0.5"},pP={class:"text-4xl sm:text-5xl"},mP={class:"px-3 sm:px-6 py-2.5 flex-shrink-0"},gP={class:"flex gap-1.5 sm:gap-2 overflow-x-auto"},_P={class:"text-[8px] sm:text-[9px] text-secondary-500 light:text-secondary-400 mb-0.5"},xP={class:"text-sm sm:text-base mb-0.5"},vP={class:"text-[9px] sm:text-[10px] font-semibold text-white light:text-secondary-900"},yP={class:"flex-1 px-3 sm:px-6 pb-3 sm:pb-4 min-h-0 overflow-y-auto overscroll-contain"},bP={class:"space-y-1 sm:space-y-1.5"},SP={class:"text-[9px] sm:text-[10px] text-secondary-400 light:text-secondary-500 w-8 sm:w-10"},MP={class:"text-sm sm:text-base"},wP={class:"flex-1 mx-2 sm:mx-3 h-1 bg-secondary-700 light:bg-secondary-200 rounded-full overflow-hidden"},EP={class:"text-[9px] sm:text-[10px] text-white light:text-secondary-900 font-semibold w-10 sm:w-12 text-right"},TP={key:3,class:"flex-1 flex flex-col min-h-0"},AP={class:"flex-1 flex overflow-hidden min-h-0"},CP={class:"w-10 sm:w-14 bg-secondary-800 light:bg-white border-r border-secondary-700 light:border-secondary-200 flex flex-col items-center py-2 sm:py-3 gap-2 sm:gap-3 flex-shrink-0"},RP={class:"flex-1 p-2 sm:p-4 overflow-y-auto min-h-0 overscroll-contain"},PP={class:"flex gap-1.5 sm:gap-2 mb-3 flex-wrap"},DP=["onClick"],LP={class:"grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-3 mb-3"},IP={class:"bg-secondary-800 light:bg-white rounded-lg p-2 sm:p-3 border border-secondary-700 light:border-secondary-200"},UP={class:"text-sm sm:text-lg font-bold text-white light:text-secondary-900"},FP={class:"bg-secondary-800 light:bg-white rounded-lg p-2 sm:p-3 border border-secondary-700 light:border-secondary-200"},NP={class:"text-sm sm:text-lg font-bold text-white light:text-secondary-900"},OP={class:"bg-secondary-800 light:bg-white rounded-lg p-2 sm:p-3 border border-secondary-700 light:border-secondary-200"},kP={class:"text-sm sm:text-lg font-bold text-white light:text-secondary-900"},BP={class:"bg-secondary-800 light:bg-white rounded-lg p-2 sm:p-3 border border-secondary-700 light:border-secondary-200"},zP={class:"text-sm sm:text-lg font-bold text-white light:text-secondary-900"},VP={class:"bg-secondary-800 light:bg-white rounded-lg p-2.5 sm:p-3 border border-secondary-700 light:border-secondary-200 mb-3"},HP={class:"h-20 sm:h-24 flex items-end gap-1"},GP=["onMouseenter","onMouseleave"],WP={class:"text-[6px] sm:text-[7px] text-secondary-500 light:text-secondary-400"},XP={class:"grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3"},$P={class:"bg-secondary-800 light:bg-white rounded-lg p-2.5 sm:p-3 border border-secondary-700 light:border-secondary-200"},jP={class:"space-y-1.5 sm:space-y-2"},YP=["onClick"],qP={class:"text-[8px] sm:text-[9px] text-secondary-400 light:text-secondary-500 flex-1"},KP={class:"text-[8px] sm:text-[9px] font-semibold text-white light:text-secondary-900"},ZP={class:"bg-secondary-800 light:bg-white rounded-lg p-2.5 sm:p-3 border border-secondary-700 light:border-secondary-200"},JP={class:"space-y-1.5 sm:space-y-2"},QP={class:"text-[8px] sm:text-[9px] text-primary-500"},eD={key:4,class:"flex-1 flex flex-col min-h-0"},tD={class:"px-3 sm:px-6 py-2.5 sm:py-3 bg-secondary-800 light:bg-white border-b border-secondary-700 light:border-secondary-200 flex-shrink-0"},nD={class:"flex gap-1.5 sm:gap-2"},iD={class:"flex-1 relative"},rD={class:"px-3 sm:px-6 py-2 flex gap-1.5 sm:gap-2 overflow-x-auto flex-shrink-0"},sD=["onClick"],oD={class:"flex-1 px-3 sm:px-6 pb-3 sm:pb-4 grid grid-cols-2 gap-2 sm:gap-3 overflow-y-auto min-h-0 overscroll-contain"},aD=["onClick"],lD={class:"absolute top-1.5 right-1.5 bg-accent-500 text-white text-[7px] sm:text-[8px] px-1.5 py-0.5 rounded-full font-medium"},cD={class:"p-2 sm:p-2.5"},uD={class:"text-[9px] sm:text-[10px] text-white light:text-secondary-900 font-medium mb-1 truncate"},dD={class:"flex items-center gap-1"},fD={class:"text-[8px] sm:text-[9px] text-secondary-500 light:text-secondary-400"},hD={class:"ml-auto text-[7px] sm:text-[8px] text-secondary-500 light:text-secondary-400"},pD={key:0,class:"col-span-2 text-center py-8"},mD={class:"flex items-start justify-between mb-3"},gD={class:"text-3xl"},_D={class:"text-sm font-bold text-white light:text-secondary-900 mb-1"},xD={class:"flex items-center gap-2 mb-3"},vD={class:"text-yellow-500 text-xs"},yD={class:"text-[9px] text-secondary-500 light:text-secondary-400"},bD={class:"text-[9px] text-secondary-500 light:text-secondary-400"},SD={class:"space-y-2 mb-4"},MD={key:5,class:"flex-1 flex flex-col min-h-0"},wD={class:"flex items-center justify-between px-3 sm:px-6 py-2.5 sm:py-3 bg-secondary-800 light:bg-white border-b border-secondary-700 light:border-secondary-200 flex-shrink-0"},ED={class:"flex gap-2 sm:gap-4 text-[9px] sm:text-[10px] text-secondary-400 light:text-secondary-500"},TD=["onClick"],AD={class:"flex-1 overflow-y-auto min-h-0 overscroll-contain"},CD={key:0,class:"h-full flex items-center justify-center px-4 sm:px-6 bg-gradient-to-br from-secondary-800 to-secondary-900 light:from-white light:to-secondary-100"},RD={class:"text-center"},PD={class:"flex gap-2 justify-center"},DD={key:1,class:"p-4 sm:p-6"},LD={class:"space-y-2 mb-4"},ID={class:"grid grid-cols-2 gap-2"},UD={class:"text-[9px] sm:text-[10px] text-primary-500 font-medium"},FD={class:"mt-1.5 h-1 bg-secondary-700 light:bg-secondary-200 rounded-full overflow-hidden"},ND={key:2,class:"p-4 sm:p-6"},OD={class:"grid grid-cols-2 gap-2 sm:gap-3"},kD={key:3,class:"p-4 sm:p-6"},BD={class:"px-3 sm:px-6 py-2 sm:py-3 bg-secondary-800 light:bg-white border-t border-secondary-700 light:border-secondary-200 flex-shrink-0"},zD={class:"flex justify-center gap-1.5 sm:gap-3 overflow-x-auto"},VD={key:6,class:"flex-1 flex flex-col min-h-0"},HD={class:"flex items-center justify-between px-3 sm:px-6 py-2.5 sm:py-3 bg-secondary-800 light:bg-white border-b border-secondary-700 light:border-secondary-200 flex-shrink-0"},GD={class:"text-xs sm:text-sm font-bold text-primary-500"},WD={class:"flex gap-2 sm:gap-3 text-[9px] sm:text-[10px] text-secondary-400 light:text-secondary-500"},XD=["onClick"],$D={class:"flex-1 overflow-y-auto min-h-0 overscroll-contain"},jD={key:0,class:"h-full flex items-center justify-center px-4 sm:px-6 bg-gradient-to-br from-primary-600/20 to-primary-500/5"},YD={class:"text-center max-w-sm"},qD={class:"text-sm sm:text-base font-bold text-white light:text-secondary-900 mb-1.5"},KD={class:"text-[9px] sm:text-[10px] text-secondary-400 light:text-secondary-500 mb-3 sm:mb-4 leading-relaxed"},ZD={class:"flex gap-1.5 sm:gap-2 justify-center flex-wrap"},JD={key:1,class:"p-4 sm:p-6"},QD={class:"space-y-2"},eL={class:"text-[9px] sm:text-[10px] text-secondary-300 light:text-secondary-600 leading-relaxed"},tL={key:2,class:"p-4 sm:p-6"},nL={class:"space-y-2"},iL={__name:"ProjectPreview",props:{project:{type:Object,required:!0}},setup(n){const e=n,t=an(()=>{const le=e.project.title.toLowerCase();return le.includes("e-commerce")?"ecommerce":le.includes("task")?"task":le.includes("weather")?"weather":le.includes("social")||le.includes("analytics")?"analytics":le.includes("recipe")?"recipe":le.includes("portfolio")||le.includes("template")?"portfolio":"generic"}),i=[{id:1,name:"Wireless Headphones",price:89,emoji:"🎧",color:"from-purple-500 to-indigo-500"},{id:2,name:"Smart Watch",price:199,emoji:"⌚",color:"from-blue-500 to-cyan-500"},{id:3,name:"Laptop Stand",price:45,emoji:"💻",color:"from-emerald-500 to-teal-500"},{id:4,name:"Mechanical Keyboard",price:129,emoji:"⌨️",color:"from-amber-500 to-orange-500"},{id:5,name:"USB-C Hub",price:59,emoji:"🔌",color:"from-rose-500 to-pink-500"},{id:6,name:"Desk Lamp",price:35,emoji:"💡",color:"from-yellow-500 to-amber-500"}],r=ua([]),s=De(!1),o=an(()=>r.reduce((le,w)=>le+w.qty,0)),a=an(()=>r.reduce((le,w)=>le+w.price*w.qty,0)),l=le=>{const w=r.find(E=>E.id===le.id);w?w.qty++:r.push({...le,qty:1})},c=le=>{const w=r.findIndex(E=>E.id===le);w!==-1&&r.splice(w,1)},u=(le,w)=>{const E=r.find(H=>H.id===le);E&&(E.qty+=w,E.qty<=0&&c(le))},d=ua({todo:[{id:1,title:"Design landing page",tag:"Design",tagColor:"bg-purple-500/20 text-purple-400",done:!1},{id:2,title:"Set up database schema",tag:"Backend",tagColor:"bg-blue-500/20 text-blue-400",done:!1},{id:3,title:"Write API endpoints",tag:"Backend",tagColor:"bg-blue-500/20 text-blue-400",done:!1}],progress:[{id:4,title:"Build auth system",tag:"Frontend",tagColor:"bg-emerald-500/20 text-emerald-400",done:!1},{id:5,title:"Implement dark mode",tag:"UI",tagColor:"bg-amber-500/20 text-amber-400",done:!1}],done:[{id:6,title:"Project setup",tag:"Setup",tagColor:"bg-gray-500/20 text-gray-400",done:!0},{id:7,title:"Create wireframes",tag:"Design",tagColor:"bg-purple-500/20 text-purple-400",done:!0},{id:8,title:"Configure CI/CD",tag:"DevOps",tagColor:"bg-rose-500/20 text-rose-400",done:!0}]}),f=De(""),h=De("General"),g=["General","Design","Frontend","Backend","UI","DevOps"],_=()=>{f.value.trim()&&(d.todo.push({id:Date.now(),title:f.value.trim(),tag:h.value,tagColor:"bg-primary-500/20 text-primary-400",done:!1}),f.value="")},p=(le,w)=>{const E=d[le].find(H=>H.id===w);if(E)if(E.done=!E.done,E.done){const H=d[le].findIndex(q=>q.id===w),[ee]=d[le].splice(H,1);d.done.push(ee)}else{const H=d.done.findIndex(q=>q.id===w),[ee]=d.done.splice(H,1);d.todo.push(ee)}},m=(le,w,E)=>{const H=d[le].findIndex(q=>q.id===E);if(H===-1)return;const[ee]=d[le].splice(H,1);d[w].push(ee)},v={Manila:{temp:28,condition:"Partly Cloudy",emoji:"⛅",humidity:72,wind:12},Tokyo:{temp:22,condition:"Clear Sky",emoji:"☀️",humidity:55,wind:8},"New York":{temp:18,condition:"Rainy",emoji:"🌧️",humidity:85,wind:20},London:{temp:15,condition:"Cloudy",emoji:"☁️",humidity:78,wind:15},Sydney:{temp:25,condition:"Sunny",emoji:"🌤️",humidity:60,wind:10}},S=De("Manila"),x=De(""),C=De("C"),A=an(()=>v[S.value]||v.Manila),R=an(()=>{const le=A.value.temp;return C.value==="C"?le:Math.round(le*9/5+32)}),b=an(()=>{const le=A.value.temp;return Array.from({length:6},(w,E)=>({time:`${(E+1)*3}:00`,temp:le+[0,2,3,1,-1,-2][E],emoji:["⛅","☀️","☀️","⛅","☁️","🌙"][E]}))}),T=an(()=>{const le=A.value.temp;return["Mon","Tue","Wed","Thu","Fri","Sat","Sun"].map((E,H)=>({day:E,high:le+[2,4,3,5,1,0,-1][H],low:le-[4,3,5,2,6,5,7][H],emoji:["⛅","☀️","🌧️","⛅","☀️","☁️","🌧️"][H]}))}),N=an(()=>{const le=x.value.toLowerCase();return le?Object.keys(v).filter(w=>w.toLowerCase().includes(le)):Object.keys(v)}),U=le=>{S.value=le,x.value=""},L=ua({followers:12800,engagement:4.2,reach:45200,posts:128}),G=De("All"),k=["All","Instagram","Twitter","LinkedIn"],V={All:{followers:12800,engagement:4.2,reach:45200,posts:128},Instagram:{followers:8500,engagement:5.1,reach:28e3,posts:64},Twitter:{followers:3200,engagement:3.4,reach:12e3,posts:42},LinkedIn:{followers:1100,engagement:2.8,reach:5200,posts:22}},X=an(()=>{const w=(V[G.value]||V.All).followers/12800;return[30,45,38,60,52,75,68,90,82,100,88,95].map((E,H)=>({value:Math.round(E*w),label:["J","F","M","A","M","J","J","A","S","O","N","D"][H]}))}),B=le=>{G.value=le;const w=V[le]||V.All;L.followers=w.followers,L.engagement=w.engagement,L.reach=w.reach,L.posts=w.posts},Y=[{id:1,name:"Creamy Garlic Pasta",time:25,rating:4.5,emoji:"🍝",category:"Dinner",color:"from-amber-500/40 to-orange-500/40"},{id:2,name:"Avocado Toast",time:10,rating:4.2,emoji:"🥑",category:"Breakfast",color:"from-emerald-500/40 to-green-500/40"},{id:3,name:"Chocolate Cake",time:45,rating:4.8,emoji:"🍰",category:"Dessert",color:"from-rose-500/40 to-pink-500/40"},{id:4,name:"Chicken Stir Fry",time:20,rating:3.9,emoji:"🍗",category:"Lunch",color:"from-red-500/40 to-orange-500/40"},{id:5,name:"Berry Smoothie",time:5,rating:4.6,emoji:"🥤",category:"Breakfast",color:"from-purple-500/40 to-indigo-500/40"},{id:6,name:"Beef Tacos",time:30,rating:4.4,emoji:"🌮",category:"Dinner",color:"from-yellow-500/40 to-amber-500/40"}],j=De("All"),F=De(""),ae=De(null),he=["All","Breakfast","Lunch","Dinner","Dessert"],ge=an(()=>Y.filter(le=>{const w=j.value==="All"||le.category===j.value,E=le.name.toLowerCase().includes(F.value.toLowerCase());return w&&E})),xe=le=>{ae.value=le},Ee=De("home"),J=["home","about","projects","contact"],ue=le=>{Ee.value=le},oe=De("home"),Re=["home","features","about"],Ae=le=>{oe.value=le};return(le,w)=>(de(),pe("div",YC,[y("div",qC,[w[16]||(w[16]=y("div",{class:"flex gap-1.5"},[y("span",{class:"w-2.5 h-2.5 sm:w-3 sm:h-3 rounded-full bg-accent-500"}),y("span",{class:"w-2.5 h-2.5 sm:w-3 sm:h-3 rounded-full bg-yellow-500"}),y("span",{class:"w-2.5 h-2.5 sm:w-3 sm:h-3 rounded-full bg-primary-500"})],-1)),y("div",KC,[y("div",ZC,[w[15]||(w[15]=y("svg",{class:"w-2.5 h-2.5 sm:w-3 sm:h-3 flex-shrink-0",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24"},[y("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"2",d:"M12 11c0 3.517-1.009 6.799-2.753 9.571m-3.44-2.04l.054-.09A13.916 13.916 0 008 8a4 4 0 118 0c0 1.017-.07 2.019-.203 3m-2.118 6.844A21.88 21.88 0 0115.171 17m3.839 1.132c.645-2.266.99-4.659.99-7.132A8 8 0 008 4.07M3 15.364c.64-1.319 1-2.8 1-4.364 0-1.457.39-2.823 1.07-4"})],-1)),y("span",JC,ye(n.project.demo),1)])])]),t.value==="ecommerce"?(de(),pe("div",QC,[y("div",eR,[w[19]||(w[19]=y("div",{class:"text-primary-500 font-bold text-xs sm:text-sm"},"🛍️ ShopHub",-1)),y("div",tR,[w[18]||(w[18]=y("div",{class:"hidden sm:flex gap-3 text-[10px] text-secondary-400 light:text-secondary-500"},[y("span",{class:"cursor-pointer hover:text-primary-500 transition-colors"},"Home"),y("span",{class:"cursor-pointer hover:text-primary-500 transition-colors"},"Products"),y("span",{class:"cursor-pointer hover:text-primary-500 transition-colors"},"About")],-1)),y("button",{onClick:w[0]||(w[0]=E=>s.value=!s.value),class:"relative w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-primary-500/20 flex items-center justify-center hover:bg-primary-500/30 transition-colors cursor-pointer","aria-label":"Open cart"},[w[17]||(w[17]=y("svg",{class:"w-4 h-4 sm:w-5 sm:h-5 text-primary-500",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24"},[y("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"2",d:"M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z"})],-1)),o.value>0?(de(),pe("span",nR,ye(o.value),1)):An("",!0)])])]),w[25]||(w[25]=co('<div class="px-3 sm:px-6 py-3 sm:py-4 bg-gradient-to-r from-primary-600 to-primary-500 flex-shrink-0" data-v-b832dd55><div class="text-white" data-v-b832dd55><div class="text-[9px] sm:text-[10px] uppercase tracking-wider opacity-80 mb-1" data-v-b832dd55>Summer Sale</div><div class="text-xs sm:text-sm font-bold mb-1.5 sm:mb-2" data-v-b832dd55>Up to 50% Off Everything</div><div class="inline-block bg-white text-primary-600 text-[9px] sm:text-[10px] font-semibold px-2.5 sm:px-3 py-1 rounded-full cursor-pointer hover:bg-primary-50 transition-colors" data-v-b832dd55>Shop Now →</div></div></div>',1)),y("div",iR,[(de(),pe(je,null,rt(i,E=>y("div",{key:E.id,class:"bg-secondary-800 light:bg-white rounded-lg p-2 sm:p-2.5 border border-secondary-700 light:border-secondary-200 hover:border-primary-500/50 transition-all duration-200 cursor-pointer hover:shadow-lg hover:shadow-primary-500/10"},[y("div",{class:st(["aspect-square rounded-md bg-gradient-to-br mb-2 flex items-center justify-center text-2xl sm:text-3xl",E.color])},[y("span",null,ye(E.emoji),1)],2),y("div",rR,ye(E.name),1),y("div",sR,[y("div",oR,"$"+ye(E.price),1),y("button",{onClick:Es(H=>l(E),["stop"]),class:"w-5 h-5 sm:w-6 sm:h-6 rounded bg-primary-500 hover:bg-primary-400 flex items-center justify-center transition-colors cursor-pointer","aria-label":"Add to cart"},[...w[20]||(w[20]=[y("svg",{class:"w-3 h-3 sm:w-3.5 sm:h-3.5 text-white",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24"},[y("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"2",d:"M12 4v16m8-8H4"})],-1)])],8,aR)])])),64))]),At(zf,{name:"slide"},{default:Mu(()=>[s.value?(de(),pe("div",lR,[y("div",cR,[w[22]||(w[22]=y("span",{class:"text-xs font-semibold text-white light:text-secondary-900"},"Shopping Cart",-1)),y("button",{onClick:w[1]||(w[1]=E=>s.value=!1),class:"text-secondary-400 hover:text-white light:hover:text-secondary-900 transition-colors cursor-pointer","aria-label":"Close cart"},[...w[21]||(w[21]=[y("svg",{class:"w-4 h-4",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24"},[y("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"2",d:"M6 18L18 6M6 6l12 12"})],-1)])])]),y("div",uR,[r.length===0?(de(),pe("div",dR,[...w[23]||(w[23]=[y("div",{class:"text-3xl mb-2"},"🛒",-1),y("p",{class:"text-xs text-secondary-400 light:text-secondary-500"},"Your cart is empty",-1),y("p",{class:"text-[10px] text-secondary-500 light:text-secondary-400 mt-1"},"Add some products!",-1)])])):An("",!0),(de(!0),pe(je,null,rt(r,E=>(de(),pe("div",{key:E.id,class:"flex items-center gap-3 bg-secondary-700/50 light:bg-secondary-100 rounded-lg p-2.5"},[y("div",{class:st(["w-8 h-8 rounded-md bg-gradient-to-br flex items-center justify-center text-sm flex-shrink-0",E.color])},ye(E.emoji),3),y("div",fR,[y("div",hR,ye(E.name),1),y("div",pR,"$"+ye(E.price),1)]),y("div",mR,[y("button",{onClick:H=>u(E.id,-1),class:"w-4 h-4 rounded bg-secondary-600 light:bg-secondary-200 text-white light:text-secondary-900 text-[9px] flex items-center justify-center hover:bg-accent-500 transition-colors cursor-pointer"},"−",8,gR),y("span",_R,ye(E.qty),1),y("button",{onClick:H=>u(E.id,1),class:"w-4 h-4 rounded bg-secondary-600 light:bg-secondary-200 text-white light:text-secondary-900 text-[9px] flex items-center justify-center hover:bg-primary-500 transition-colors cursor-pointer"},"+",8,xR)])]))),128))]),y("div",vR,[y("div",yR,[w[24]||(w[24]=y("span",{class:"text-[10px] text-secondary-400 light:text-secondary-500"},"Total",-1)),y("span",bR,"$"+ye(a.value.toFixed(2)),1)]),y("button",{onClick:w[2]||(w[2]=E=>s.value=!1),class:"w-full py-2 rounded-lg bg-primary-600 hover:bg-primary-500 text-white text-[10px] font-semibold transition-colors cursor-pointer"}," Checkout ")])])):An("",!0)]),_:1})])):t.value==="task"?(de(),pe("div",SR,[w[30]||(w[30]=co('<div class="flex items-center justify-between px-3 sm:px-6 py-2.5 sm:py-3 bg-secondary-800 light:bg-white border-b border-secondary-700 light:border-secondary-200 flex-shrink-0" data-v-b832dd55><div class="flex items-center gap-2" data-v-b832dd55><div class="w-5 h-5 sm:w-6 sm:h-6 rounded bg-primary-500 flex items-center justify-center" data-v-b832dd55><svg class="w-3 h-3 sm:w-3.5 sm:h-3.5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-b832dd55><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4" data-v-b832dd55></path></svg></div><span class="text-xs sm:text-sm font-semibold text-white light:text-secondary-900" data-v-b832dd55>TaskFlow</span></div><div class="flex items-center gap-1.5 sm:gap-2" data-v-b832dd55><div class="w-5 h-5 sm:w-6 sm:h-6 rounded-full bg-primary-500/20 flex items-center justify-center text-[9px] sm:text-[10px] text-primary-500 font-bold" data-v-b832dd55>+</div><div class="w-5 h-5 sm:w-6 sm:h-6 rounded-full bg-accent-500/20 flex items-center justify-center text-[9px] sm:text-[10px] text-accent-500 font-bold" data-v-b832dd55>A</div><div class="w-5 h-5 sm:w-6 sm:h-6 rounded-full bg-yellow-500/20 flex items-center justify-center text-[9px] sm:text-[10px] text-yellow-500 font-bold" data-v-b832dd55>B</div></div></div>',1)),y("div",MR,[y("div",wR,[pc(y("input",{"onUpdate:modelValue":w[3]||(w[3]=E=>f.value=E),onKeyup:pb(_,["enter"]),type:"text",placeholder:"Add a new task...",class:"flex-1 bg-secondary-700/50 light:bg-white border border-secondary-600 light:border-secondary-200 rounded-lg px-3 py-1.5 text-[10px] sm:text-xs text-white light:text-secondary-900 placeholder-secondary-500 light:placeholder-secondary-400 focus:outline-none focus:border-primary-500 transition-colors"},null,544),[[Pd,f.value]]),pc(y("select",{"onUpdate:modelValue":w[4]||(w[4]=E=>h.value=E),class:"bg-secondary-700/50 light:bg-white border border-secondary-600 light:border-secondary-200 rounded-lg px-2 py-1.5 text-[9px] sm:text-[10px] text-secondary-300 light:text-secondary-600 focus:outline-none focus:border-primary-500 transition-colors cursor-pointer"},[(de(),pe(je,null,rt(g,E=>y("option",{key:E,value:E},ye(E),9,ER)),64))],512),[[ub,h.value]]),y("button",{onClick:_,class:"px-3 py-1.5 rounded-lg bg-primary-600 hover:bg-primary-500 text-white text-[10px] sm:text-xs font-semibold transition-colors cursor-pointer flex-shrink-0"}," Add ")])]),y("div",TR,[y("div",AR,[y("div",CR,[w[26]||(w[26]=y("span",{class:"text-[9px] sm:text-[10px] font-semibold text-secondary-400 light:text-secondary-500"},"TO DO",-1)),y("span",RR,ye(d.todo.length),1)]),y("div",PR,[(de(!0),pe(je,null,rt(d.todo,E=>(de(),pe("div",{key:E.id,class:"bg-secondary-800 light:bg-white rounded-md p-2 sm:p-2.5 border border-secondary-700 light:border-secondary-200 hover:border-primary-500/40 transition-colors cursor-pointer group",onClick:H=>m("todo","progress",E.id)},[y("div",LR,[y("button",{onClick:Es(H=>p("todo",E.id),["stop"]),class:"w-3.5 h-3.5 sm:w-4 sm:h-4 rounded-full border border-secondary-500 light:border-secondary-300 flex-shrink-0 mt-0.5 hover:border-primary-500 transition-colors cursor-pointer","aria-label":"Mark as done"},null,8,IR),y("div",UR,[y("div",FR,ye(E.title),1),y("span",{class:st(["inline-block mt-1 px-1.5 py-0.5 rounded-full text-[7px] sm:text-[8px] font-medium",E.tagColor])},ye(E.tag),3)])])],8,DR))),128))])]),y("div",NR,[y("div",OR,[w[27]||(w[27]=y("span",{class:"text-[9px] sm:text-[10px] font-semibold text-primary-500"},"IN PROGRESS",-1)),y("span",kR,ye(d.progress.length),1)]),y("div",BR,[(de(!0),pe(je,null,rt(d.progress,E=>(de(),pe("div",{key:E.id,class:"bg-secondary-800 light:bg-white rounded-md p-2 sm:p-2.5 border border-primary-500/30 hover:border-primary-500/60 transition-colors cursor-pointer group",onClick:H=>m("progress","done",E.id)},[y("div",VR,[y("button",{onClick:Es(H=>p("progress",E.id),["stop"]),class:"w-3.5 h-3.5 sm:w-4 sm:h-4 rounded-full border border-primary-500 flex-shrink-0 mt-0.5 hover:bg-primary-500/20 transition-colors cursor-pointer","aria-label":"Mark as done"},null,8,HR),y("div",GR,[y("div",WR,ye(E.title),1),y("span",{class:st(["inline-block mt-1 px-1.5 py-0.5 rounded-full text-[7px] sm:text-[8px] font-medium",E.tagColor])},ye(E.tag),3)])])],8,zR))),128))])]),y("div",XR,[y("div",$R,[w[28]||(w[28]=y("span",{class:"text-[9px] sm:text-[10px] font-semibold text-primary-500"},"DONE",-1)),y("span",jR,ye(d.done.length),1)]),y("div",YR,[(de(!0),pe(je,null,rt(d.done,E=>(de(),pe("div",{key:E.id,class:"bg-secondary-800 light:bg-white rounded-md p-2 sm:p-2.5 border border-secondary-700 light:border-secondary-200 opacity-70 hover:opacity-100 transition-opacity cursor-pointer",onClick:H=>p("done",E.id)},[y("div",KR,[w[29]||(w[29]=y("div",{class:"w-3.5 h-3.5 sm:w-4 sm:h-4 rounded-full bg-primary-500 flex items-center justify-center flex-shrink-0 mt-0.5"},[y("svg",{class:"w-2 h-2 sm:w-2.5 sm:h-2.5 text-white",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24"},[y("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"3",d:"M5 13l4 4L19 7"})])],-1)),y("div",ZR,[y("div",JR,ye(E.title),1),y("span",{class:st(["inline-block mt-1 px-1.5 py-0.5 rounded-full text-[7px] sm:text-[8px] font-medium",E.tagColor])},ye(E.tag),3)])])],8,qR))),128))])])])])):t.value==="weather"?(de(),pe("div",QR,[y("div",eP,[w[31]||(w[31]=y("div",{class:"flex items-center gap-2"},[y("span",{class:"text-base sm:text-lg"},"🌤️"),y("span",{class:"text-xs sm:text-sm font-semibold text-white light:text-secondary-900"},"SkyCast")],-1)),y("div",tP,[y("div",nP,[y("button",{onClick:w[5]||(w[5]=E=>C.value="C"),class:st(["px-2 py-0.5 text-[9px] sm:text-[10px] font-semibold transition-colors cursor-pointer",C.value==="C"?"bg-primary-600 text-white":"text-secondary-400 light:text-secondary-500 hover:text-white light:hover:text-secondary-900"])},"°C",2),y("button",{onClick:w[6]||(w[6]=E=>C.value="F"),class:st(["px-2 py-0.5 text-[9px] sm:text-[10px] font-semibold transition-colors cursor-pointer",C.value==="F"?"bg-primary-600 text-white":"text-secondary-400 light:text-secondary-500 hover:text-white light:hover:text-secondary-900"])},"°F",2)])])]),y("div",iP,[y("div",rP,[y("div",sP,[w[32]||(w[32]=y("svg",{class:"w-3 h-3 sm:w-3.5 sm:h-3.5 absolute left-2.5 top-1/2 -translate-y-1/2 text-secondary-500 light:text-secondary-400",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24"},[y("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"2",d:"M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"})],-1)),pc(y("input",{"onUpdate:modelValue":w[7]||(w[7]=E=>x.value=E),type:"text",placeholder:"Search city...",class:"w-full bg-secondary-700/50 light:bg-white border border-secondary-600 light:border-secondary-200 rounded-lg pl-7 pr-3 py-1.5 text-[10px] sm:text-xs text-white light:text-secondary-900 placeholder-secondary-500 light:placeholder-secondary-400 focus:outline-none focus:border-primary-500 transition-colors"},null,512),[[Pd,x.value]])])]),x.value?(de(),pe("div",oP,[(de(!0),pe(je,null,rt(N.value,E=>(de(),pe("button",{key:E,onClick:H=>U(E),class:"w-full px-3 py-2 text-left text-[10px] sm:text-xs text-secondary-300 light:text-secondary-600 hover:bg-primary-500/10 hover:text-primary-500 transition-colors cursor-pointer flex items-center gap-2"},[y("span",null,ye(v[E].emoji),1),y("span",null,ye(E),1),y("span",lP,ye(v[E].temp)+"°",1)],8,aP))),128))])):An("",!0)]),y("div",cP,[y("div",uP,[y("div",null,[y("div",dP,ye(R.value)+"°"+ye(C.value),1),y("div",fP,ye(A.value.condition),1),y("div",hP,ye(S.value)+" • 💧 "+ye(A.value.humidity)+"% • 🌬️ "+ye(A.value.wind)+" km/h",1)]),y("div",pP,ye(A.value.emoji),1)])]),y("div",mP,[w[33]||(w[33]=y("div",{class:"text-[9px] sm:text-[10px] font-semibold text-secondary-400 light:text-secondary-500 mb-1.5 uppercase tracking-wider"},"Hourly Forecast",-1)),y("div",gP,[(de(!0),pe(je,null,rt(b.value,(E,H)=>(de(),pe("div",{key:H,class:"flex-1 min-w-[50px] sm:min-w-0 bg-secondary-800 light:bg-white rounded-lg p-1.5 sm:p-2 text-center border border-secondary-700 light:border-secondary-200 hover:border-primary-500/40 transition-colors cursor-pointer"},[y("div",_P,ye(E.time),1),y("div",xP,ye(E.emoji),1),y("div",vP,ye(E.temp)+"°",1)]))),128))])]),y("div",yP,[w[34]||(w[34]=y("div",{class:"text-[9px] sm:text-[10px] font-semibold text-secondary-400 light:text-secondary-500 mb-1.5 uppercase tracking-wider"},"7-Day Forecast",-1)),y("div",bP,[(de(!0),pe(je,null,rt(T.value,(E,H)=>(de(),pe("div",{key:H,class:"flex items-center justify-between bg-secondary-800 light:bg-white rounded-md px-2.5 sm:px-3 py-1.5 sm:py-2 border border-secondary-700 light:border-secondary-200 hover:border-primary-500/40 transition-colors cursor-pointer"},[y("span",SP,ye(E.day),1),y("span",MP,ye(E.emoji),1),y("div",wP,[y("div",{class:"h-full bg-gradient-to-r from-yellow-500 to-primary-500 rounded-full",style:Sn({width:(E.high-10)*5+"%"})},null,4)]),y("span",EP,ye(E.high)+"° / "+ye(E.low)+"°",1)]))),128))])])])):t.value==="analytics"?(de(),pe("div",TP,[y("div",AP,[y("div",CP,[w[36]||(w[36]=y("div",{class:"w-6 h-6 sm:w-7 sm:h-7 rounded-lg bg-primary-500 flex items-center justify-center"},[y("svg",{class:"w-3.5 h-3.5 sm:w-4 sm:h-4 text-white",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24"},[y("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"2",d:"M13 7h8m0 0v8m0-8l-8 8-4-4-6 6"})])],-1)),(de(),pe(je,null,rt(4,E=>y("div",{key:E,class:"w-5 h-5 sm:w-6 sm:h-6 rounded-md bg-secondary-700/50 light:bg-secondary-200 flex items-center justify-center cursor-pointer hover:bg-primary-500/20 transition-colors"},[...w[35]||(w[35]=[y("div",{class:"w-2.5 h-2.5 sm:w-3 sm:h-3 rounded-sm bg-secondary-500 light:bg-secondary-400"},null,-1)])])),64))]),y("div",RP,[y("div",PP,[(de(),pe(je,null,rt(k,E=>y("button",{key:E,onClick:H=>B(E),class:st(["px-2 sm:px-3 py-1 rounded-full text-[8px] sm:text-[9px] font-medium transition-all cursor-pointer",G.value===E?"bg-primary-600 text-white shadow-md shadow-primary-500/25":"bg-secondary-800 light:bg-white text-secondary-400 light:text-secondary-500 border border-secondary-700 light:border-secondary-200 hover:text-white light:hover:text-secondary-900"])},ye(E),11,DP)),64))]),y("div",LP,[y("div",IP,[w[37]||(w[37]=y("div",{class:"text-[8px] sm:text-[9px] text-secondary-500 light:text-secondary-400 mb-0.5"},"Followers",-1)),y("div",UP,ye(L.followers.toLocaleString()),1),w[38]||(w[38]=y("div",{class:"text-[8px] sm:text-[9px] text-primary-500 mt-0.5"},"▲ 12%",-1))]),y("div",FP,[w[39]||(w[39]=y("div",{class:"text-[8px] sm:text-[9px] text-secondary-500 light:text-secondary-400 mb-0.5"},"Engagement",-1)),y("div",NP,ye(L.engagement)+"%",1),w[40]||(w[40]=y("div",{class:"text-[8px] sm:text-[9px] text-primary-500 mt-0.5"},"▲ 0.8%",-1))]),y("div",OP,[w[41]||(w[41]=y("div",{class:"text-[8px] sm:text-[9px] text-secondary-500 light:text-secondary-400 mb-0.5"},"Reach",-1)),y("div",kP,ye(L.reach.toLocaleString()),1),w[42]||(w[42]=y("div",{class:"text-[8px] sm:text-[9px] text-primary-500 mt-0.5"},"▲ 23%",-1))]),y("div",BP,[w[43]||(w[43]=y("div",{class:"text-[8px] sm:text-[9px] text-secondary-500 light:text-secondary-400 mb-0.5"},"Posts",-1)),y("div",zP,ye(L.posts),1),w[44]||(w[44]=y("div",{class:"text-[8px] sm:text-[9px] text-primary-500 mt-0.5"},"▲ 5%",-1))])]),y("div",VP,[w[45]||(w[45]=y("div",{class:"text-[9px] sm:text-[10px] font-semibold text-secondary-400 light:text-secondary-500 mb-2"},"Engagement Over Time",-1)),y("div",HP,[(de(!0),pe(je,null,rt(X.value,(E,H)=>(de(),pe("div",{key:H,class:"flex-1 flex flex-col items-center gap-1 group cursor-pointer",onMouseenter:ee=>E.hover=!0,onMouseleave:ee=>E.hover=!1},[y("div",{class:st(["w-full rounded-t bg-gradient-to-t from-primary-600 to-primary-400 transition-all duration-300 group-hover:from-primary-500 group-hover:to-primary-300",{"opacity-40":H%3===0}]),style:Sn({height:E.value+"%"})},null,6),y("span",WP,ye(E.label),1)],40,GP))),128))])]),y("div",XP,[y("div",$P,[w[46]||(w[46]=y("div",{class:"text-[9px] sm:text-[10px] font-semibold text-secondary-400 light:text-secondary-500 mb-2"},"Platforms",-1)),y("div",jP,[(de(),pe(je,null,rt(["Instagram","Twitter","LinkedIn"],(E,H)=>y("div",{key:E,class:"flex items-center gap-2 cursor-pointer hover:bg-secondary-700/30 light:hover:bg-secondary-100 rounded-md px-1.5 py-1 transition-colors",onClick:ee=>B(E)},[y("div",{class:st(["w-3.5 h-3.5 sm:w-4 sm:h-4 rounded-full",["bg-primary-500","bg-accent-500","bg-yellow-500"][H]])},null,2),y("span",qP,ye(E),1),y("span",KP,ye([45,30,25][H])+"%",1)],8,YP)),64))])]),y("div",ZP,[w[48]||(w[48]=y("div",{class:"text-[9px] sm:text-[10px] font-semibold text-secondary-400 light:text-secondary-500 mb-2"},"Top Posts",-1)),y("div",JP,[(de(),pe(je,null,rt(3,E=>y("div",{key:E,class:"flex items-center gap-2 cursor-pointer hover:bg-secondary-700/30 light:hover:bg-secondary-100 rounded-md px-1.5 py-1 transition-colors"},[y("div",{class:st(["w-5 h-5 sm:w-6 sm:h-6 rounded bg-gradient-to-br flex items-center justify-center text-[10px] sm:text-xs flex-shrink-0",["from-primary-500/30 to-primary-500/10","from-accent-500/30 to-accent-500/10","from-yellow-500/30 to-yellow-500/10"][E-1]])},ye(["📸","🐦","💼"][E-1]),3),w[47]||(w[47]=y("div",{class:"flex-1 min-w-0"},[y("div",{class:"h-1.5 bg-secondary-700 light:bg-secondary-200 rounded mb-1 w-4/5"}),y("div",{class:"h-1 bg-secondary-700 light:bg-secondary-200 rounded w-1/2"})],-1)),y("span",QP,ye([1200,890,650][E-1]),1)])),64))])])])])])])):t.value==="recipe"?(de(),pe("div",eD,[y("div",tD,[w[51]||(w[51]=co('<div class="flex items-center justify-between mb-2" data-v-b832dd55><div class="text-xs sm:text-sm font-bold text-primary-500" data-v-b832dd55>🍳 FlavorFind</div><div class="w-6 h-6 sm:w-7 sm:h-7 rounded-full bg-primary-500/20 flex items-center justify-center cursor-pointer hover:bg-primary-500/30 transition-colors" data-v-b832dd55><svg class="w-3.5 h-3.5 sm:w-4 sm:h-4 text-primary-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-b832dd55><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" data-v-b832dd55></path></svg></div></div>',1)),y("div",nD,[y("div",iD,[w[49]||(w[49]=y("svg",{class:"w-3 h-3 sm:w-3.5 sm:h-3.5 absolute left-2.5 top-1/2 -translate-y-1/2 text-secondary-500 light:text-secondary-400",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24"},[y("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"2",d:"M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"})],-1)),pc(y("input",{"onUpdate:modelValue":w[8]||(w[8]=E=>F.value=E),type:"text",placeholder:"Search recipes...",class:"w-full bg-secondary-700/50 light:bg-secondary-100 rounded-lg pl-7 pr-3 py-1.5 sm:py-2 text-[10px] sm:text-xs text-white light:text-secondary-900 placeholder-secondary-500 light:placeholder-secondary-400 focus:outline-none focus:border-primary-500 border border-transparent focus:border-primary-500/50 transition-colors"},null,512),[[Pd,F.value]])]),w[50]||(w[50]=y("button",{class:"bg-primary-500 hover:bg-primary-400 rounded-lg px-3 sm:px-4 py-1.5 sm:py-2 flex items-center transition-colors cursor-pointer"},[y("span",{class:"text-[10px] sm:text-xs text-white font-semibold"},"Search")],-1))])]),y("div",rD,[(de(),pe(je,null,rt(he,E=>y("button",{key:E,onClick:H=>j.value=E,class:st(["px-2.5 sm:px-3 py-1 rounded-full text-[8px] sm:text-[9px] font-medium whitespace-nowrap transition-all cursor-pointer",j.value===E?"bg-primary-500 text-white shadow-md shadow-primary-500/25":"bg-secondary-800 light:bg-white text-secondary-400 light:text-secondary-500 border border-secondary-700 light:border-secondary-200 hover:text-white light:hover:text-secondary-900"])},ye(E),11,sD)),64))]),y("div",oD,[(de(!0),pe(je,null,rt(ge.value,E=>(de(),pe("div",{key:E.id,onClick:H=>xe(E),class:"bg-secondary-800 light:bg-white rounded-lg overflow-hidden border border-secondary-700 light:border-secondary-200 hover:border-primary-500/50 hover:shadow-lg hover:shadow-primary-500/10 transition-all duration-200 cursor-pointer"},[y("div",{class:st(["h-14 sm:h-16 bg-gradient-to-br relative flex items-center justify-center text-2xl sm:text-3xl",E.color])},[y("span",null,ye(E.emoji),1),y("div",lD,"⏱ "+ye(E.time)+" min",1)],2),y("div",cD,[y("div",uD,ye(E.name),1),y("div",dD,[w[52]||(w[52]=y("span",{class:"text-yellow-500 text-[9px] sm:text-[10px]"},"★",-1)),y("span",fD,ye(E.rating),1),y("span",hD,ye(E.category),1)])])],8,aD))),128)),ge.value.length===0?(de(),pe("div",pD,[...w[53]||(w[53]=[y("div",{class:"text-3xl mb-2"},"🔍",-1),y("p",{class:"text-xs text-secondary-400 light:text-secondary-500"},"No recipes found",-1)])])):An("",!0)]),At(zf,{name:"fade"},{default:Mu(()=>[ae.value?(de(),pe("div",{key:0,class:"absolute inset-0 bg-dark-900/80 light:bg-secondary-900/80 backdrop-blur-sm z-20 flex items-center justify-center p-4",onClick:w[12]||(w[12]=E=>ae.value=null)},[y("div",{class:"bg-secondary-800 light:bg-white rounded-xl max-w-sm w-full p-5 border border-secondary-700 light:border-secondary-200 shadow-2xl",onClick:w[11]||(w[11]=Es(()=>{},["stop"]))},[y("div",mD,[y("div",gD,ye(ae.value.emoji),1),y("button",{onClick:w[9]||(w[9]=E=>ae.value=null),class:"text-secondary-400 hover:text-white light:hover:text-secondary-900 transition-colors cursor-pointer","aria-label":"Close recipe"},[...w[54]||(w[54]=[y("svg",{class:"w-4 h-4",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24"},[y("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"2",d:"M6 18L18 6M6 6l12 12"})],-1)])])]),y("h3",_D,ye(ae.value.name),1),y("div",xD,[y("span",vD,"★ "+ye(ae.value.rating),1),w[55]||(w[55]=y("span",{class:"text-[9px] text-secondary-500 light:text-secondary-400"},"•",-1)),y("span",yD,"⏱ "+ye(ae.value.time)+" min",1),w[56]||(w[56]=y("span",{class:"text-[9px] text-secondary-500 light:text-secondary-400"},"•",-1)),y("span",bD,ye(ae.value.category),1)]),y("div",SD,[(de(),pe(je,null,rt(4,E=>y("div",{key:E,class:"flex items-center gap-2"},[w[57]||(w[57]=y("div",{class:"w-1.5 h-1.5 rounded-full bg-primary-500 flex-shrink-0"},null,-1)),y("div",{class:"h-1.5 bg-secondary-700 light:bg-secondary-200 rounded flex-1",style:Sn({width:60+E*8+"%"})},null,4)])),64))]),y("button",{onClick:w[10]||(w[10]=E=>ae.value=null),class:"w-full py-2 rounded-lg bg-primary-600 hover:bg-primary-500 text-white text-[10px] font-semibold transition-colors cursor-pointer"}," Start Cooking ")])])):An("",!0)]),_:1})])):t.value==="portfolio"?(de(),pe("div",MD,[y("div",wD,[w[58]||(w[58]=y("div",{class:"text-xs sm:text-sm font-bold text-primary-500"},"👨‍💻 DevName",-1)),y("div",ED,[(de(),pe(je,null,rt(J,E=>y("button",{key:E,onClick:H=>ue(E),class:st(["capitalize cursor-pointer transition-colors",Ee.value===E?"text-primary-500 font-semibold":"hover:text-white light:hover:text-secondary-900"])},ye(E),11,TD)),64))])]),y("div",AD,[Ee.value==="home"?(de(),pe("div",CD,[y("div",RD,[w[59]||(w[59]=co('<div class="w-14 h-14 sm:w-16 sm:h-16 rounded-full bg-gradient-to-br from-primary-500 to-primary-700 mx-auto mb-3 sm:mb-4 flex items-center justify-center" data-v-b832dd55><svg class="w-7 h-7 sm:w-8 sm:h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-b832dd55><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" data-v-b832dd55></path></svg></div><div class="text-base sm:text-lg font-bold text-white light:text-secondary-900 mb-1.5" data-v-b832dd55>Hi, I&#39;m a Developer</div><div class="text-[9px] sm:text-[10px] text-secondary-400 light:text-secondary-500 mb-3 sm:mb-4" data-v-b832dd55>Building beautiful web experiences</div>',3)),y("div",PD,[y("button",{onClick:w[13]||(w[13]=E=>ue("projects")),class:"bg-primary-500 hover:bg-primary-400 text-white text-[9px] sm:text-[10px] font-semibold px-3 sm:px-4 py-1.5 rounded-full transition-colors cursor-pointer"},"View Work"),y("button",{onClick:w[14]||(w[14]=E=>ue("contact")),class:"border border-secondary-600 light:border-secondary-300 text-secondary-300 light:text-secondary-600 hover:text-white light:hover:text-secondary-900 text-[9px] sm:text-[10px] font-semibold px-3 sm:px-4 py-1.5 rounded-full transition-colors cursor-pointer"},"Contact Me")])])])):Ee.value==="about"?(de(),pe("div",DD,[w[60]||(w[60]=y("h3",{class:"text-sm sm:text-base font-bold text-white light:text-secondary-900 mb-3"},"About Me",-1)),y("div",LD,[(de(),pe(je,null,rt(4,E=>y("div",{key:E,class:"h-2 bg-secondary-700 light:bg-secondary-200 rounded",style:Sn({width:70+E*5+"%"})},null,4)),64))]),y("div",ID,[(de(),pe(je,null,rt(["Vue.js","React","Node.js","TypeScript","Tailwind","GraphQL"],E=>y("div",{key:E,class:"bg-secondary-800 light:bg-white rounded-lg p-2.5 border border-secondary-700 light:border-secondary-200 text-center"},[y("div",UD,ye(E),1),y("div",FD,[y("div",{class:"h-full bg-primary-500 rounded-full",style:Sn({width:60+E.length*3+"%"})},null,4)])])),64))])])):Ee.value==="projects"?(de(),pe("div",ND,[w[62]||(w[62]=y("h3",{class:"text-sm sm:text-base font-bold text-white light:text-secondary-900 mb-3"},"My Projects",-1)),y("div",OD,[(de(),pe(je,null,rt(4,E=>y("div",{key:E,class:"bg-secondary-800 light:bg-white rounded-lg overflow-hidden border border-secondary-700 light:border-secondary-200 hover:border-primary-500/50 transition-colors cursor-pointer"},[y("div",{class:st(["h-12 sm:h-16 bg-gradient-to-br flex items-center justify-center text-xl sm:text-2xl",["from-primary-500/30 to-primary-500/10","from-accent-500/30 to-accent-500/10","from-yellow-500/30 to-yellow-500/10","from-blue-500/30 to-blue-500/10"][E-1]])},ye(["📱","🌐","🎮","📊"][E-1]),3),w[61]||(w[61]=y("div",{class:"p-2 sm:p-2.5"},[y("div",{class:"h-1.5 bg-secondary-700 light:bg-secondary-200 rounded mb-1 w-4/5"}),y("div",{class:"h-1 bg-secondary-700 light:bg-secondary-200 rounded w-1/2"})],-1))])),64))])])):(de(),pe("div",kD,[...w[63]||(w[63]=[co('<h3 class="text-sm sm:text-base font-bold text-white light:text-secondary-900 mb-3" data-v-b832dd55>Get In Touch</h3><div class="space-y-2 mb-4" data-v-b832dd55><div class="flex items-center gap-2 bg-secondary-800 light:bg-white rounded-lg p-2.5 border border-secondary-700 light:border-secondary-200" data-v-b832dd55><span class="text-base" data-v-b832dd55>📧</span><span class="text-[9px] sm:text-[10px] text-secondary-400 light:text-secondary-500" data-v-b832dd55>hello@devname.com</span></div><div class="flex items-center gap-2 bg-secondary-800 light:bg-white rounded-lg p-2.5 border border-secondary-700 light:border-secondary-200" data-v-b832dd55><span class="text-base" data-v-b832dd55>💼</span><span class="text-[9px] sm:text-[10px] text-secondary-400 light:text-secondary-500" data-v-b832dd55>linkedin.com/in/devname</span></div><div class="flex items-center gap-2 bg-secondary-800 light:bg-white rounded-lg p-2.5 border border-secondary-700 light:border-secondary-200" data-v-b832dd55><span class="text-base" data-v-b832dd55>🐙</span><span class="text-[9px] sm:text-[10px] text-secondary-400 light:text-secondary-500" data-v-b832dd55>github.com/devname</span></div></div><button class="w-full py-2 rounded-lg bg-primary-600 hover:bg-primary-500 text-white text-[10px] font-semibold transition-colors cursor-pointer" data-v-b832dd55>Send Message</button>',3)])]))]),y("div",BD,[y("div",zD,[(de(),pe(je,null,rt(["Vue","React","Node","Python","Go"],E=>y("div",{key:E,class:"px-2 sm:px-2.5 py-0.5 sm:py-1 rounded-md bg-secondary-700/50 light:bg-secondary-100 text-[8px] sm:text-[9px] text-secondary-400 light:text-secondary-500 border border-secondary-700 light:border-secondary-200 whitespace-nowrap"},ye(E),1)),64))])])])):(de(),pe("div",VD,[y("div",HD,[y("div",GD,ye(n.project.title),1),y("div",WD,[(de(),pe(je,null,rt(Re,E=>y("button",{key:E,onClick:H=>Ae(E),class:st(["capitalize cursor-pointer transition-colors",oe.value===E?"text-primary-500 font-semibold":"hover:text-white light:hover:text-secondary-900"])},ye(E),11,XD)),64))])]),y("div",$D,[oe.value==="home"?(de(),pe("div",jD,[y("div",YD,[w[64]||(w[64]=y("div",{class:"w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-primary-500/20 mx-auto mb-2 sm:mb-3 flex items-center justify-center"},[y("svg",{class:"w-5 h-5 sm:w-6 sm:h-6 text-primary-500",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24"},[y("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"1.5",d:"M4 5a1 1 0 011-1h14a1 1 0 011 1v14a1 1 0 01-1 1H5a1 1 0 01-1-1V5z"}),y("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"1.5",d:"M8 9h8M8 13h5"})])],-1)),y("div",qD,ye(n.project.title),1),y("div",KD,ye(n.project.description),1),y("div",ZD,[(de(!0),pe(je,null,rt(n.project.tech.slice(0,3),E=>(de(),pe("div",{key:E,class:"px-2 sm:px-2.5 py-0.5 sm:py-1 rounded-full bg-primary-500/10 text-[8px] sm:text-[9px] text-primary-500 border border-primary-500/20"},ye(E),1))),128))])])])):oe.value==="features"?(de(),pe("div",JD,[w[66]||(w[66]=y("h3",{class:"text-sm sm:text-base font-bold text-white light:text-secondary-900 mb-3"},"Features",-1)),y("div",QD,[(de(!0),pe(je,null,rt(n.project.features||["Feature 1","Feature 2","Feature 3","Feature 4"],(E,H)=>(de(),pe("div",{key:H,class:"flex items-start gap-2 bg-secondary-800 light:bg-white rounded-lg p-2.5 sm:p-3 border border-secondary-700 light:border-secondary-200"},[w[65]||(w[65]=y("div",{class:"w-5 h-5 sm:w-6 sm:h-6 rounded-full bg-primary-500/20 flex items-center justify-center flex-shrink-0"},[y("svg",{class:"w-3 h-3 sm:w-3.5 sm:h-3.5 text-primary-500",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24"},[y("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"2",d:"M5 13l4 4L19 7"})])],-1)),y("span",eL,ye(E),1)]))),128))])])):(de(),pe("div",tL,[w[67]||(w[67]=y("h3",{class:"text-sm sm:text-base font-bold text-white light:text-secondary-900 mb-3"},"About",-1)),y("div",nL,[(de(),pe(je,null,rt(5,E=>y("div",{key:E,class:"h-2 bg-secondary-700 light:bg-secondary-200 rounded",style:Sn({width:65+E*5+"%"})},null,4)),64))])]))])]))]))}},i0=uc(iL,[["__scopeId","data-v-b832dd55"]]),rL={class:"relative w-full h-[500px] select-none"},sL=["disabled"],oL=["onClick","onMouseenter","onMouseleave"],aL={class:"relative overflow-hidden rounded-t-xl h-48"},lL={key:0,class:"absolute inset-0 bg-gradient-to-t from-dark-900/80 to-transparent rounded-t-xl pointer-events-none"},cL={class:"p-5 bg-secondary-800 h-full light:bg-white rounded-b-xl"},uL={class:"text-white light:text-secondary-900 font-semibold text-lg mb-2"},dL={class:"text-secondary-400 light:text-secondary-500 text-sm mb-3 leading-relaxed line-clamp-2"},fL={class:"flex flex-wrap gap-1.5 mb-3"},hL=["disabled"],pL={class:"absolute bottom-0 left-1/2 -translate-x-1/2 w-64 sm:w-80"},mL={class:"h-1 rounded-full bg-secondary-800 light:bg-secondary-200 overflow-hidden"},Cf=300,yg=380,el=2,eu=.6,tl=.5,gL=215,_L=34,xL=8,vL=1.08,yL=16,bL=58,SL={__name:"ProjectWheel",props:{projects:{type:Array,required:!0}},emits:["open"],setup(n,{emit:e}){const t=n,i=e,{isDark:r}=Fp(),s=De(null),o=De(0),a=De(0),l=De(!1),c=De(null);let u=[],d=!1,f=0,h=0,g=!1;const _=an(()=>t.projects.length>1),p=an(()=>t.projects.length===0?0:(o.value+1)/t.projects.length*100),m=async()=>{await Rr(),!(!s.value||(u=Array.from(s.value.children),u.length===0))&&(u.forEach(xe=>{Ke.set(xe,{position:"absolute",top:"50%",left:"50%",width:Cf,height:yg,marginLeft:-Cf/2,marginTop:-yg/2,transformOrigin:"center center",willChange:"transform, opacity",borderRadius:"1rem",boxShadow:r.value?"0 10px 30px rgba(0,0,0,0.3)":"none",cursor:"pointer",backgroundColor:"rgb(var(--color-secondary-800))"})}),o.value=0,a.value=0,A(!0))},v=ge=>{const xe=el;return ge<=xe?(eu+tl)*ge-tl*ge*ge/(2*xe):(eu+tl)*xe-tl*xe/2+eu*(ge-xe)},S=v(1),x=ge=>{const Ee=360/u.length,J=o.value+a.value;let oe=(ge*Ee-J*Ee)%360;oe>180&&(oe-=360),oe<-180&&(oe+=360);const Re=oe/Ee,Ae=Math.abs(Re),le=Math.min(Ae,el),w=Math.max(0,1-Ae/(el+1)),E=Math.sign(Re)*gL*(v(Ae)/S),H=_L*(1-Math.cos(le/el*(Math.PI/2))),ee=Math.sign(Re)*xL*(le/el),q=eu+w*tl,O=w,I=Math.round(w*100);return{x:E,y:H,scale:q,opacity:O,zIndex:I,rotation:ee,normalized:oe,offset:Re}},C=()=>!l.value&&!d,A=(ge=!1,xe=!1)=>{const Ee=C()?c.value:null,J=Ee!==null&&u[Ee]?x(Ee).offset:null;u.forEach((ue,oe)=>{const{x:Re,y:Ae,scale:le,opacity:w,zIndex:E,rotation:H,normalized:ee,offset:q}=x(oe),O=Math.abs(ee)<5,I=Ee===oe;let _e=Re,fe=Ae,ne=le,me=H,P=E,M=ge?"none":"power3.out",z=ge?0:.8;if(I)ne=le*vL,fe=Ae-yL,me=H*.35,P=150,ge||(M=xe?"elastic.out(1, 0.45)":"back.out(2)",z=xe?.9:.5);else if(J!==null){const K=q-J,Me=Math.abs(K);if(Me>.01){const ve=bL/Me*Math.sign(K);_e=Re+ve,fe=Ae+Math.min(10,10/Me),ge||(M=xe?"back.out(3)":"power3.out",z=xe?.75:.5)}}const Z=w>.05?1:0,Q={x:_e,y:fe,scale:ne,rotation:me,opacity:Z,zIndex:P,filter:O||I?"brightness(1)":r.value?"brightness(0.7)":"brightness(0.85)",boxShadow:I?"0 25px 60px rgb(var(--color-primary-500) / 0.45)":O?"0 0 50px rgb(var(--color-primary-500) / 0.35)":r.value?"0 0 0px rgb(var(--color-primary-500) / 0)":"none",pointerEvents:w>.05?"auto":"none",duration:z,ease:M,overwrite:"auto",borderRadius:"1rem",transformOrigin:"center center"};ge?Ke.set(ue,Q):Ke.to(ue,Q)})},R=ge=>{l.value||d||c.value!==ge&&(c.value=ge,A(!1,!0))},b=ge=>{c.value===ge&&(c.value=null,!(l.value||d)&&A(!1,!0))},T=ge=>{if(d||u.length===0||!_.value)return;d=!0,c.value=null;const xe=u.length;o.value=(o.value+ge+xe)%xe,Ke.to({},{duration:1,ease:"power3.inOut",onUpdate:()=>{A()},onComplete:()=>{d=!1,A()}})},N=ge=>{d||u.length===0||l.value||g||U(ge)},U=ge=>{const xe=u[ge];if(!xe)return;const Ee=xe.getBoundingClientRect();i("open",{project:t.projects[ge],originRect:{left:Ee.left,top:Ee.top,width:Ee.width,height:Ee.height}})},L=ge=>{d||u.length===0||!_.value||(l.value=!0,c.value=null,g=!1,f=ge.clientX,h=ge.clientX,ge.preventDefault())},G=ge=>{if(!l.value)return;const xe=ge.clientX-h;h=ge.clientX,Math.abs(ge.clientX-f)>5&&(g=!0),a.value-=xe/Cf,A()},k=()=>{if(!l.value)return;l.value=!1;const ge=u.length,xe=Math.round(a.value);if(!g&&xe===0){a.value=0;return}xe!==0&&(o.value=(o.value+xe+ge)%ge),a.value=0,d=!0,Ke.to({},{duration:.5,ease:"power3.out",onUpdate:()=>{A()},onComplete:()=>{d=!1,A(),setTimeout(()=>{g=!1},50)}})},V=()=>{l.value&&k()},X=()=>{c.value!==null&&(c.value=null,!l.value&&!d&&A(!1,!0)),k()},B=ge=>{const xe=ge.currentTarget;if(!xe.querySelector(".fill-overlay"))return;const J=xe.getBoundingClientRect(),ue=ge.clientX-J.left,oe=ge.clientY-J.top;xe.style.setProperty("--mx",`${ue}px`),xe.style.setProperty("--my",`${oe}px`)},Y=ge=>{const xe=ge.currentTarget;if(xe.style.setProperty("--mx","50%"),xe.style.setProperty("--my","50%"),j){const Ee=xe.querySelector(".fill-overlay");Ee&&(Ee.classList.remove("active"),Ee.classList.add("fade-out"),setTimeout(()=>{Ee.classList.remove("fade-out")},500))}},j=window.matchMedia("(hover: hover)").matches,F=ge=>{if(j)return;const xe=ge.currentTarget,Ee=xe.querySelector(".fill-overlay");if(!Ee)return;const J=xe.getBoundingClientRect(),ue=ge.clientX-J.left,oe=ge.clientY-J.top;xe.style.setProperty("--mx",`${ue}px`),xe.style.setProperty("--my",`${oe}px`),Ee.classList.add("active")},ae=ge=>{if(j)return;const Ee=ge.currentTarget.querySelector(".fill-overlay");Ee&&(Ee.classList.remove("active"),Ee.classList.add("fade-out"),setTimeout(()=>{Ee.classList.remove("fade-out")},500))},he=ge=>{if(!j)return;const xe=ge.currentTarget,Ee=xe.querySelector(".fill-overlay");if(!Ee)return;const J=xe.getBoundingClientRect(),ue=ge.clientX-J.left,oe=ge.clientY-J.top;xe.style.setProperty("--mx",`${ue}px`),xe.style.setProperty("--my",`${oe}px`),Ee.classList.add("active")};return Dn(async()=>{await m()}),Ai(()=>t.projects,async()=>{await m()}),Ai(r,()=>{u.length>0&&A(!0)}),(ge,xe)=>(de(),pe("div",rL,[y("button",{onClick:xe[0]||(xe[0]=Ee=>T(-1)),onMousemove:B,onMouseleave:Y,onMouseenter:he,onPointerdown:F,onPointerup:ae,onPointercancel:ae,disabled:!_.value,class:"absolute -left-24 md:-left-24 lg:-left-40 top-1/2 -translate-y-1/2 size-[200px] md:size-[200px] lg:size-[300px] rounded-full flex items-center justify-center text-secondary-300 light:text-secondary-500 disabled:opacity-40 disabled:cursor-not-allowed z-[110] border-2 border-primary-500/50 light:border-primary-600/50 hover:border-primary-500 light:hover:border-primary-600 hover:scale-105 transition-all duration-300 overflow-hidden","aria-label":"Previous project"},[...xe[2]||(xe[2]=[y("span",{class:"fill-overlay"},null,-1),y("svg",{class:"absolute z-10 w-8 h-8 md:w-8 md:h-8 lg:w-10 lg:h-10 right-10 md:right-10 lg:right-16 top-1/2 -translate-y-1/2 text-primary-500 light:text-primary-600",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24"},[y("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"1.5",d:"M19 12H5M12 19l-7-7 7-7"})],-1)])],40,sL),y("div",{ref_key:"wheelRef",ref:s,class:st(["relative w-full h-full",{"cursor-grabbing":l.value,"cursor-grab":!l.value}]),onPointerdown:L,onPointermove:G,onPointerup:k,onPointercancel:V,onPointerleave:X},[(de(!0),pe(je,null,rt(n.projects,(Ee,J)=>(de(),pe("div",{key:Ee.id,onClick:ue=>N(J),onMouseenter:ue=>R(J),onMouseleave:ue=>b(J),class:"absolute rounded-xl overflow-hidden shadow-xl light:shadow-none",style:{width:"300px",height:"360px"}},[y("div",aL,[At(i0,{project:Ee,class:"w-full h-full"},null,8,["project"]),xt(r)?(de(),pe("div",lL)):An("",!0)]),y("div",cL,[y("h3",uL,ye(Ee.title),1),y("p",dL,ye(Ee.description),1),y("div",fL,[(de(!0),pe(je,null,rt(Ee.tech.slice(0,3),ue=>(de(),pe("span",{key:ue,class:"text-xs text-primary-400 bg-primary-500/10 px-2 py-0.5 rounded-full"},ye(ue),1))),128))])])],40,oL))),128))],34),y("button",{onClick:xe[1]||(xe[1]=Ee=>T(1)),onMousemove:B,onMouseleave:Y,onMouseenter:he,onPointerdown:F,onPointerup:ae,onPointercancel:ae,disabled:!_.value,class:"absolute -right-24 md:-right-24 lg:-right-40 top-1/2 -translate-y-1/2 size-[200px] md:size-[200px] lg:size-[300px] rounded-full flex items-center justify-center text-secondary-300 light:text-secondary-500 disabled:opacity-40 disabled:cursor-not-allowed z-[110] border-2 border-primary-500/50 light:border-primary-600/50 hover:border-primary-500 light:hover:border-primary-600 hover:scale-105 transition-all duration-300 overflow-hidden","aria-label":"Next project"},[...xe[3]||(xe[3]=[y("span",{class:"fill-overlay"},null,-1),y("svg",{class:"absolute z-10 w-8 h-8 md:w-8 md:h-8 lg:w-10 lg:h-10 left-10 md:left-10 lg:left-16 top-1/2 -translate-y-1/2 text-primary-500 light:text-primary-600",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24"},[y("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"1.5",d:"M5 12h14M12 5l7 7-7 7"})],-1)])],40,hL),y("div",pL,[y("div",mL,[y("div",{class:"h-full rounded-full bg-primary-500 light:bg-primary-600 transition-all duration-500 ease-out",style:Sn({width:p.value+"%"})},null,4)])])]))}},ML=uc(SL,[["__scopeId","data-v-4fd9bb21"]]),wL={class:"relative overflow-hidden h-48"},EL={class:"p-6"},TL={class:"text-white light:text-secondary-900 font-semibold text-lg mb-2 group-hover:text-primary-400 transition-colors duration-200"},AL={class:"text-secondary-400 light:text-secondary-500 text-sm mb-4 leading-relaxed"},CL={class:"flex flex-wrap gap-2 mb-4"},bg={__name:"ProjectCard",props:{project:{type:Object,required:!0}},emits:["open"],setup(n,{emit:e}){const t=n,i=e,r=De(null);let s=null;const o=()=>{if(!r.value)return;const a=r.value.getBoundingClientRect();i("open",{project:t.project,originRect:{left:a.left,top:a.top,width:a.width,height:a.height}})};return Dn(()=>{r.value&&(s=pC(r.value,6))}),$n(()=>{s&&s()}),(a,l)=>(de(),pe("div",{ref_key:"cardRef",ref:r,onClick:o,class:"group bg-secondary-800 border border-secondary-700 rounded-xl overflow-hidden hover:border-primary-500/50 hover:shadow-xl hover:shadow-primary-500/10 transition-all duration-300 will-change-transform cursor-pointer light:bg-white light:border-secondary-200 light:hover:border-primary-500/50 light:hover:shadow-primary-500/10"},[y("div",wL,[At(i0,{project:n.project,class:"w-full h-full group-hover:scale-105 transition-transform duration-500"},null,8,["project"]),l[0]||(l[0]=y("div",{class:"absolute inset-0 bg-gradient-to-t from-dark-900/80 to-transparent pointer-events-none"},null,-1))]),y("div",EL,[y("h3",TL,ye(n.project.title),1),y("p",AL,ye(n.project.description),1),y("div",CL,[(de(!0),pe(je,null,rt(n.project.tech,c=>(de(),pe("span",{key:c,class:"text-xs text-primary-400 bg-primary-500/10 px-2 py-1 rounded-full"},ye(c),1))),128))])])],512))}},RL={class:"min-h-full flex flex-col lg:flex-row"},PL={class:"relative lg:w-1/2 lg:h-screen overflow-hidden flex-shrink-0"},DL={class:"absolute bottom-0 left-0 right-0 p-5 sm:p-8 lg:hidden bg-gradient-to-t from-dark-900/90 via-dark-900/50 to-transparent"},LL={class:"text-xl sm:text-3xl font-bold text-white mb-2"},IL={class:"flex flex-wrap gap-2"},UL={class:"flex-1 p-5 sm:p-8 lg:p-12 lg:overflow-y-auto"},FL={class:"hidden lg:block text-4xl font-bold text-white light:text-secondary-900 mb-4"},NL={class:"hidden lg:flex flex-wrap gap-2 mb-6"},OL={class:"mb-8"},kL={class:"text-secondary-300 light:text-secondary-600 leading-relaxed text-lg"},BL={class:"mb-8"},zL={class:"space-y-3"},VL={class:"flex flex-wrap gap-4"},HL=["href"],GL=["href"],WL={__name:"ProjectDetailModal",props:{project:{type:Object,required:!0},originRect:{type:Object,default:null}},emits:["close"],setup(n,{emit:e}){const t=n,i=e,r=["Responsive design that works across all devices","Optimized performance with lazy loading and code splitting","Clean, maintainable code following best practices","Accessible UI with semantic HTML and ARIA labels"],s=De(null),o=De(null),a=De(null),l=De(null),c=De(!1);let u=null;const d=async()=>{if(await Rr(),!s.value||!o.value)return;const g=s.value,_=o.value,p=a.value,m=t.originRect||{left:0,top:0,width:0,height:0},v=window.innerWidth,S=window.innerHeight;Ke.set(g,{opacity:0,pointerEvents:"none"}),Ke.set(_,{position:"fixed",left:m.left,top:m.top,width:m.width,height:m.height,margin:0,borderRadius:"1rem",zIndex:9999,overflow:"hidden"}),Ke.set(p,{opacity:0,y:30}),Ke.to(g,{opacity:1,duration:.3,ease:"power2.out",pointerEvents:"auto"}),u=Ke.timeline({defaults:{ease:"power3.inOut"}}),u.to(_,{left:0,top:0,width:v,height:S,borderRadius:0,duration:.7}).to(p,{opacity:1,y:0,duration:.5,ease:"power2.out"},"-=0.3").from(l.value,{opacity:0,scale:.8,duration:.3,ease:"back.out(1.7)"},"-=0.2")},f=()=>{if(c.value)return;c.value=!0;const g=s.value,_=o.value,p=a.value,m=t.originRect||{left:0,top:0,width:0,height:0};u&&u.kill(),Ke.timeline({defaults:{ease:"power3.inOut"},onComplete:()=>{i("close")}}).to(p,{opacity:0,y:-30,duration:.3,ease:"power2.in"}).to(_,{left:m.left,top:m.top,width:m.width,height:m.height,borderRadius:"1rem",duration:.6},"-=0.1").to(g,{opacity:0,duration:.3,ease:"power2.in"},"-=0.3")},h=g=>{g.key==="Escape"&&f()};return Dn(()=>{d(),document.body.style.overflow="hidden",window.addEventListener("keydown",h)}),$n(()=>{document.body.style.overflow="",window.removeEventListener("keydown",h),u&&u.kill()}),(g,_)=>(de(),pe("div",{ref_key:"overlayRef",ref:s,class:"fixed inset-0 z-[9998] bg-dark-900/90 light:bg-secondary-900/90 backdrop-blur-sm",onClick:Es(f,["self"])},[y("div",{ref_key:"cardRef",ref:o,class:"bg-secondary-800 light:bg-white shadow-2xl"},[y("button",{ref_key:"closeBtnRef",ref:l,onClick:f,class:"fixed top-4 right-4 z-[10000] w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-dark-900/80 light:bg-white/90 border border-secondary-700 light:border-secondary-200 flex items-center justify-center text-secondary-300 light:text-secondary-600 hover:text-primary-400 light:hover:text-primary-600 hover:border-primary-500/50 transition-colors duration-200 shadow-lg backdrop-blur-sm","aria-label":"Close project details"},[..._[0]||(_[0]=[y("svg",{class:"w-5 h-5 sm:w-6 sm:h-6",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24"},[y("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"2",d:"M6 18L18 6M6 6l12 12"})],-1)])],512),y("div",{ref_key:"contentRef",ref:a,class:"h-full w-full overflow-y-auto overscroll-contain"},[y("div",RL,[y("div",PL,[At(i0,{project:n.project,class:"w-full h-[60vh] sm:h-[55vh] lg:h-full"},null,8,["project"]),y("div",DL,[y("h2",LL,ye(n.project.title),1),y("div",IL,[(de(!0),pe(je,null,rt(n.project.tech,p=>(de(),pe("span",{key:p,class:"text-xs text-primary-300 bg-primary-500/20 px-3 py-1 rounded-full backdrop-blur-sm"},ye(p),1))),128))])])]),y("div",UL,[y("h2",FL,ye(n.project.title),1),y("div",NL,[(de(!0),pe(je,null,rt(n.project.tech,p=>(de(),pe("span",{key:p,class:"text-sm text-primary-400 bg-primary-500/10 px-3 py-1 rounded-full"},ye(p),1))),128))]),y("div",OL,[_[1]||(_[1]=y("h3",{class:"text-lg font-semibold text-primary-400 light:text-primary-600 mb-3 uppercase tracking-wider"}," About This Project ",-1)),y("p",kL,ye(n.project.description),1)]),y("div",BL,[_[3]||(_[3]=y("h3",{class:"text-lg font-semibold text-primary-400 light:text-primary-600 mb-3 uppercase tracking-wider"}," Key Features ",-1)),y("ul",zL,[(de(!0),pe(je,null,rt(n.project.features||r,(p,m)=>(de(),pe("li",{key:m,class:"flex items-start gap-3 text-secondary-300 light:text-secondary-600"},[_[2]||(_[2]=y("svg",{class:"w-5 h-5 text-primary-500 mt-0.5 flex-shrink-0",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24"},[y("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"2",d:"M5 13l4 4L19 7"})],-1)),y("span",null,ye(p),1)]))),128))])]),y("div",VL,[y("a",{href:n.project.github,target:"_blank",rel:"noopener noreferrer",class:"inline-flex items-center gap-2 px-6 py-3 rounded-lg bg-secondary-700 light:bg-secondary-100 text-white light:text-secondary-900 font-medium hover:bg-primary-600 light:hover:bg-primary-600 light:hover:text-white transition-colors duration-300"},[..._[4]||(_[4]=[y("svg",{class:"w-5 h-5",fill:"currentColor",viewBox:"0 0 24 24"},[y("path",{"fill-rule":"evenodd",d:"M12 2C6.477 2 2 6.484 2 12.017c0 4.425 2.865 8.18 6.839 9.504.5.092.682-.217.682-.483 0-.237-.008-.868-.013-1.703-2.782.605-3.369-1.343-3.369-1.343-.454-1.158-1.11-1.466-1.11-1.466-.908-.62.069-.608.069-.608 1.003.07 1.531 1.032 1.531 1.032.892 1.53 2.341 1.088 2.91.832.092-.647.35-1.088.636-1.338-2.22-.253-4.555-1.113-4.555-4.951 0-1.093.39-1.988 1.029-2.688-.103-.253-.446-1.272.098-2.65 0 0 .84-.27 2.75 1.026A9.564 9.564 0 0112 6.844c.85.004 1.705.115 2.504.337 1.909-1.296 2.747-1.027 2.747-1.027.546 1.379.202 2.398.1 2.651.64.7 1.028 1.595 1.028 2.688 0 3.848-2.339 4.695-4.566 4.943.359.309.678.92.678 1.855 0 1.338-.012 2.419-.012 2.747 0 .268.18.58.688.482A10.019 10.019 0 0022 12.017C22 6.484 17.522 2 12 2z","clip-rule":"evenodd"})],-1),Hi(" View Code ",-1)])],8,HL),y("a",{href:n.project.demo,target:"_blank",rel:"noopener noreferrer",class:"inline-flex items-center gap-2 px-6 py-3 rounded-lg bg-primary-600 text-white font-medium hover:bg-primary-500 transition-colors duration-300 shadow-lg shadow-primary-500/25"},[..._[5]||(_[5]=[y("svg",{class:"w-5 h-5",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24"},[y("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"2",d:"M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"})],-1),Hi(" Live Demo ",-1)])],8,GL)])])])],512)],512)],512))}},XL={class:"h-1 bg-secondary-800/50 light:bg-secondary-200/50 backdrop-blur-sm"},$L={class:"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"},jL={class:"flex flex-wrap gap-3"},YL=["onClick"],qL={key:0,class:"ml-auto flex items-center gap-1 p-1 rounded-lg bg-secondary-800 border border-secondary-700 light:bg-secondary-100 light:border-secondary-200"},KL={class:"grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6"},ZL={__name:"ProjectsSection",setup(n){Ke.registerPlugin(ft);const e=De("All"),t=De("carousel"),i=De(!1),r=De(0),s=De(0),o=De(!1),a=De(null),l=De(null),c=De(null),u=De(null),d=De(null),f=De(null),h=De(null),g=De(null),_=De(null),p=De(null);let m=[],v=null,S=null,x=null,C=null;const A=an(()=>{const j=Af.flatMap(F=>F.tech);return["All",...new Set(j)]}),R=an(()=>e.value==="All"?Af:Af.filter(j=>j.tech.includes(e.value))),b=j=>{e.value=j},T=({project:j,originRect:F})=>{_.value=j,p.value=F},N=()=>{_.value=null,p.value=null};Ai(R,async()=>{await Rr(),G(),t.value==="horizontal"&&B()});const U=j=>{i.value||(t.value=j,j==="horizontal"?Rr(()=>B()):Y())},L=j=>{i.value=j.matches,j.matches&&(t.value="grid",Y())},G=()=>{if(!d.value)return;const j=d.value.getBoundingClientRect(),F=window.innerHeight,ae=j.height-F,he=Math.min(Math.max(-j.top,0),ae);r.value=ae>0?he/ae*100:100},k=()=>{S&&window.removeEventListener("scroll",S,{passive:!0}),S=()=>G(),window.addEventListener("scroll",S,{passive:!0}),G()},V=()=>{if(!f.value)return;const j=f.value.getBoundingClientRect(),F=window.innerHeight,he=j.height-F;if(o.value=j.top<F&&j.bottom>0,he>0){const ge=Math.min(Math.max(-j.top,0),he);s.value=ge/he*100}else s.value=o.value?100:0},X=()=>{x&&window.removeEventListener("scroll",x,{passive:!0}),x=()=>V(),window.addEventListener("scroll",x,{passive:!0}),V()},B=()=>{if(Y(),!h.value||!g.value||!u.value)return;const j=g.value,F=u.value,he=j.scrollWidth-window.innerWidth;he<=0||(C=Ke.to(j,{x:-he,ease:"none",scrollTrigger:{trigger:F,start:"top top",end:()=>`+=${he}`,pin:!0,pinSpacing:!0,scrub:!0,anticipatePin:1,invalidateOnRefresh:!0,preventOverlaps:!0,fastScrollEnd:!0}}))},Y=()=>{var j;C&&((j=C.scrollTrigger)==null||j.kill(),C.kill(),C=null)};return Dn(()=>{v=window.matchMedia("(max-width: 768px)"),i.value=v.matches,i.value&&(t.value="grid"),v.addEventListener("change",L),m.push(..._d(a.value,{x:-120,start:"top 90%",end:"top 40%"})),m.push(...n0(u.value,{y:60,duration:1.2,start:"top 80%",blur:14})),k(),X()}),$n(()=>{m.forEach(j=>j.kill()),Y(),v&&v.removeEventListener("change",L),S&&window.removeEventListener("scroll",S,{passive:!0}),x&&window.removeEventListener("scroll",x,{passive:!0})}),(j,F)=>(de(),pe("section",{ref_key:"sectionRef",ref:f,id:"projects",class:st(["pt-20 pb-0 bg-dark-800 light:bg-white relative",t.value==="horizontal"?"overflow-visible":"overflow-hidden"])},[F[5]||(F[5]=y("div",{class:"absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-primary-500/50 to-transparent"},null,-1)),o.value?(de(),pe("div",{key:0,class:st(["fixed top-16 left-0 right-0 z-40 transition-opacity duration-300",s.value>=100?"opacity-0 pointer-events-none":"opacity-100"])},[y("div",XL,[y("div",{class:"h-full bg-gradient-to-r from-primary-500 to-accent-500 light:from-primary-600 light:to-accent-600 transition-all duration-150 ease-out",style:Sn({width:s.value+"%"})},null,4)])],2)):An("",!0),y("div",$L,[y("h2",{ref_key:"titleRef",ref:a,class:"section-title"},"Featured Projects",512),y("p",{ref_key:"subtitleRef",ref:l,class:"section-subtitle"},"A selection of projects I've built",512),y("div",{ref_key:"filterRef",ref:c,class:"flex flex-wrap items-center gap-3 mb-10"},[y("div",jL,[(de(!0),pe(je,null,rt(A.value,ae=>(de(),pe("button",{key:ae,onClick:he=>b(ae),class:st(["px-4 py-2 rounded-lg text-sm font-medium transition-all duration-300 hover:scale-105",e.value===ae?"bg-primary-600 text-white shadow-lg shadow-primary-500/25":"bg-secondary-800 text-secondary-400 hover:text-white border border-secondary-700 light:bg-white light:text-secondary-500 light:hover:text-secondary-900 light:border-secondary-200"])},ye(ae),11,YL))),128))]),i.value?An("",!0):(de(),pe("div",qL,[y("button",{onClick:F[0]||(F[0]=ae=>U("grid")),class:st(["px-3 py-1.5 rounded-md text-sm font-medium transition-all duration-300",t.value==="grid"?"bg-primary-600 text-white shadow-md shadow-primary-500/25":"text-secondary-400 hover:text-white light:text-secondary-500 light:hover:text-secondary-900"]),"aria-label":"Grid view"},[...F[2]||(F[2]=[y("svg",{class:"w-4 h-4",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24"},[y("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"2",d:"M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z"})],-1)])],2),y("button",{onClick:F[1]||(F[1]=ae=>U("carousel")),class:st(["px-3 py-1.5 rounded-md text-sm font-medium transition-all duration-300",t.value==="carousel"?"bg-primary-600 text-white shadow-md shadow-primary-500/25":"text-secondary-400 hover:text-white light:text-secondary-500 light:hover:text-secondary-900"]),"aria-label":"Carousel view"},[...F[3]||(F[3]=[y("svg",{class:"w-4 h-4",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24"},[y("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"2",d:"M4 6h16M4 12h16M4 18h16"})],-1)])],2)]))],512)]),y("div",{ref_key:"wheelContainerRef",ref:u,class:"w-full"},[t.value==="grid"?(de(),pe("div",{key:0,ref_key:"gridContainerRef",ref:d,class:"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-20"},[y("div",KL,[(de(!0),pe(je,null,rt(R.value,ae=>(de(),vl(bg,{key:ae.id,project:ae,onOpen:T},null,8,["project"]))),128))]),F[4]||(F[4]=y("div",{class:"mt-10 flex justify-center"},[y("div",{class:"w-64 sm:w-80"})],-1))],512)):t.value==="carousel"?(de(),vl(ML,{key:1,projects:R.value,onOpen:T},null,8,["projects"])):t.value==="horizontal"?(de(),pe("div",{key:2,ref_key:"horizontalContainerRef",ref:h,class:"relative h-screen overflow-hidden"},[y("div",{ref_key:"horizontalTrackRef",ref:g,class:"flex items-center gap-8 px-8 sm:px-12 lg:px-16 h-full w-max"},[(de(!0),pe(je,null,rt(R.value,ae=>(de(),pe("div",{key:ae.id,class:"w-[320px] sm:w-[380px] lg:w-[420px] shrink-0"},[At(bg,{project:ae,onOpen:T},null,8,["project"])]))),128))],512)],512)):An("",!0)],512),_.value?(de(),vl(WL,{key:1,project:_.value,"origin-rect":p.value,onClose:N},null,8,["project","origin-rect"])):An("",!0)],2))}},JL={id:"contact",class:"py-20 bg-dark-800 light:bg-white relative overflow-hidden"},QL={class:"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"},e5={class:"text-center mb-16"},t5={class:"text-center"},n5={class:"flex items-center justify-center gap-4"},i5=["href","aria-label"],r5={class:"w-6 h-6",fill:"currentColor",viewBox:"0 0 24 24"},s5=["d"],o5={__name:"ContactSection",setup(n){const e=De(null),t=De(null),i=De(null);let r=[];const s=[{name:"GitHub",href:"https://github.com/pixel-user-512",icon:"M12 2C6.477 2 2 6.484 2 12.017c0 4.425 2.865 8.18 6.839 9.504.5.092.682-.217.682-.483 0-.237-.008-.868-.013-1.703-2.782.605-3.369-1.343-3.369-1.343-.454-1.158-1.11-1.466-1.11-1.466-.908-.62.069-.608.069-.608 1.003.07 1.531 1.032 1.531 1.032.892 1.53 2.341 1.088 2.91.832.092-.647.35-1.088.636-1.338-2.22-.253-4.555-1.113-4.555-4.951 0-1.093.39-1.988 1.029-2.688-.103-.253-.446-1.272.098-2.65 0 0 .84-.27 2.75 1.026A9.564 9.564 0 0112 6.844c.85.004 1.705.115 2.504.337 1.909-1.296 2.747-1.027 2.747-1.027.546 1.379.202 2.398.1 2.651.64.7 1.028 1.595 1.028 2.688 0 3.848-2.339 4.695-4.566 4.943.359.309.678.92.678 1.855 0 1.338-.012 2.419-.012 2.747 0 .268.18.58.688.482A10.019 10.019 0 0022 12.017C22 6.484 17.522 2 12 2z"},{name:"LinkedIn",href:"https://linkedin.com/in/kenneth-paul-cortez",icon:"M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.225 0z"}];return Dn(()=>{r.push(..._d(t.value,{x:-120,start:"top 90%",end:"top 40%"})),r.push(...n0(e.value,{y:60,duration:1.2,stagger:.15,start:"top 80%",blur:14}))}),$n(()=>{r.forEach(o=>o.kill())}),(o,a)=>(de(),pe("section",JL,[a[2]||(a[2]=y("div",{class:"absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-primary-500/50 to-transparent"},null,-1)),y("div",QL,[y("div",e5,[y("h2",{ref_key:"titleRef",ref:t,class:"section-title"},"Get In Touch",512),y("p",{ref_key:"subtitleRef",ref:i,class:"section-subtitle"},"Have a project in mind? Let's work together!",512)]),y("div",{ref_key:"infoRef",ref:e,class:"max-w-3xl mx-auto"},[a[1]||(a[1]=co('<div class="text-center mb-12"><p class="text-secondary-400 light:text-secondary-500 text-lg leading-relaxed"> I&#39;m always open to discussing new projects, creative ideas, or opportunities to be part of your vision. Feel free to reach out! </p></div><div class="grid sm:grid-cols-2 gap-4 mb-12"><a href="mailto:kenneth.cortez.512@gmail.com" class="group flex items-center gap-4 bg-secondary-800/50 border border-secondary-700 rounded-2xl p-5 hover:border-primary-500/50 hover:bg-secondary-800/80 transition-all duration-300 light:bg-white light:border-secondary-200 light:hover:border-primary-500/50"><span class="w-12 h-12 flex items-center justify-center bg-secondary-800 border border-secondary-700 rounded-xl group-hover:border-primary-500/50 group-hover:scale-110 transition-all duration-300 light:bg-secondary-50 light:border-secondary-200 shrink-0"><svg class="w-6 h-6 text-primary-400 light:text-primary-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path></svg></span><span class="min-w-0"><span class="block text-xs text-secondary-500 light:text-secondary-400 uppercase tracking-wider mb-1">Email</span><span class="block text-secondary-200 light:text-secondary-700 font-medium truncate">kenneth.cortez.512@gmail.com</span></span></a><a href="tel:+639664002142" class="group flex items-center gap-4 bg-secondary-800/50 border border-secondary-700 rounded-2xl p-5 hover:border-primary-500/50 hover:bg-secondary-800/80 transition-all duration-300 light:bg-white light:border-secondary-200 light:hover:border-primary-500/50"><span class="w-12 h-12 flex items-center justify-center bg-secondary-800 border border-secondary-700 rounded-xl group-hover:border-primary-500/50 group-hover:scale-110 transition-all duration-300 light:bg-secondary-50 light:border-secondary-200 shrink-0"><svg class="w-6 h-6 text-primary-400 light:text-primary-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path></svg></span><span class="min-w-0"><span class="block text-xs text-secondary-500 light:text-secondary-400 uppercase tracking-wider mb-1">Phone</span><span class="block text-secondary-200 light:text-secondary-700 font-medium">+63 (966) 400-2142</span></span></a></div>',2)),y("div",t5,[a[0]||(a[0]=y("h4",{class:"text-white light:text-secondary-900 text-sm font-semibold uppercase tracking-wider mb-5"},"Follow Me",-1)),y("div",n5,[(de(),pe(je,null,rt(s,l=>y("a",{key:l.name,href:l.href,target:"_blank",rel:"noopener noreferrer",class:"w-12 h-12 flex items-center justify-center bg-secondary-800 border border-secondary-700 rounded-xl text-secondary-400 hover:text-primary-400 hover:border-primary-500/50 hover:scale-110 transition-all duration-300 light:bg-white light:border-secondary-200 light:text-secondary-500 light:hover:text-primary-600","aria-label":l.name},[(de(),pe("svg",r5,[y("path",{d:l.icon},null,8,s5)]))],8,i5)),64))])])],512)])]))}},a5={class:"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"},l5={class:"flex flex-col md:flex-row items-center justify-between gap-4"},c5={class:"text-secondary-400 light:text-secondary-500 text-sm"},u5={class:"flex items-center gap-6"},d5={__name:"Footer",setup(n){const e=new Date().getFullYear(),t=De(null);let i=[];const r=()=>{window.scrollTo({top:0,behavior:"smooth"})};return Dn(()=>{i=n0(t.value,{y:30,duration:1,start:"top bottom",blur:8})}),$n(()=>{i.forEach(s=>s.kill())}),(s,o)=>(de(),pe("footer",{ref_key:"footerRef",ref:t,class:"bg-dark-800 border-t border-dark-700 light:bg-white light:border-secondary-200 py-8"},[y("div",a5,[y("div",l5,[y("div",c5," © "+ye(xt(e))+" Kenneth Paul Cortez ",1),y("div",u5,[y("a",{href:"#home",onClick:Es(r,["prevent"]),class:"text-secondary-400 hover:text-primary-400 light:text-secondary-500 light:hover:text-primary-600 transition-colors duration-200 text-sm"}," Home "),o[0]||(o[0]=y("a",{href:"#about",class:"text-secondary-400 hover:text-primary-400 light:text-secondary-500 light:hover:text-primary-600 transition-colors duration-200 text-sm"}," About ",-1)),o[1]||(o[1]=y("a",{href:"#projects",class:"text-secondary-400 hover:text-primary-400 light:text-secondary-500 light:hover:text-primary-600 transition-colors duration-200 text-sm"}," Projects ",-1)),o[2]||(o[2]=y("a",{href:"#contact",class:"text-secondary-400 hover:text-primary-400 light:text-secondary-500 light:hover:text-primary-600 transition-colors duration-200 text-sm"}," Contact ",-1))]),o[3]||(o[3]=y("div",{class:"text-secondary-500 light:text-secondary-400 text-sm"},[Hi(" Built with "),y("span",{class:"text-primary-500"},"Vue 3"),Hi(" & "),y("span",{class:"text-primary-500"},"Tailwind CSS")],-1))])])],512))}},f5={__name:"BackToTop",setup(n){const e=De(!1),t=()=>{e.value=window.scrollY>400},i=()=>{window.scrollTo({top:0,behavior:"smooth"})};return Dn(()=>{window.addEventListener("scroll",t)}),$n(()=>{window.removeEventListener("scroll",t)}),(r,s)=>(de(),vl(zf,{"enter-active-class":"transition-all duration-300 ease-out","enter-from-class":"opacity-0 translate-y-4","enter-to-class":"opacity-100 translate-y-0","leave-active-class":"transition-all duration-300 ease-in","leave-from-class":"opacity-100 translate-y-0","leave-to-class":"opacity-0 translate-y-4"},{default:Mu(()=>[e.value?(de(),pe("button",{key:0,onClick:i,class:"fixed bottom-6 right-6 z-50 w-12 h-12 flex items-center justify-center bg-primary-500 hover:bg-primary-600 text-white rounded-xl shadow-lg shadow-primary-500/25 hover:scale-110 transition-all duration-300","aria-label":"Back to top"},[...s[0]||(s[0]=[y("svg",{class:"w-6 h-6",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24"},[y("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"2",d:"M5 15l7-7 7 7"})],-1)])])):An("",!0)]),_:1}))}},h5={__name:"MouseTrail",setup(n){const{isMouseTrailEnabled:e}=Px();let t=null;const i=()=>{t||(t=mC({size:45,trailLength:400,trailWidth:16}))},r=()=>{t&&(t(),t=null)};return Dn(()=>{e.value&&i()}),$n(()=>{r()}),Ai(e,s=>{s?i():r()}),(s,o)=>null}},p5={__name:"IntroLoader",setup(n){const e=De(!0),t=De(null);return Dn(()=>{document.body.style.overflow="hidden";const i=getComputedStyle(document.documentElement).getPropertyValue("--color-primary-500").trim();t.value.style.backgroundColor=`rgb(${i})`;const r={size:3};t.value.style.setProperty("--hole-size",`${r.size}%`),Ke.delayedCall(.5,()=>{Ke.to(r,{size:100,duration:.6,ease:"power2.inOut",onUpdate:()=>{t.value.style.setProperty("--hole-size",`${r.size}%`)},onComplete:()=>{e.value=!1,document.body.style.overflow=""}})})}),$n(()=>{document.body.style.overflow=""}),(i,r)=>e.value?(de(),pe("div",{key:0,ref_key:"overlayRef",ref:t,class:"intro-overlay"},null,512)):An("",!0)}},m5=uc(p5,[["__scopeId","data-v-151ea3fb"]]),g5={class:"min-h-screen bg-dark-900 light:bg-secondary-50"},_5={__name:"App",setup(n){return(e,t)=>(de(),pe("div",g5,[At(RM),y("main",null,[At(fC),At(DC),At(jC),At(ZL),At(o5)]),At(d5),At(f5),At(h5),At(m5)]))}};_b(_5).mount("#app");
