...
`].filter(Sl).join(`
`)),o=dp(o),o=Mg(o,t),o=Eg(o,t),a=dp(a),a=Mg(a,t),a=Eg(a,t),o=Tg(o),a=Tg(a),t.isRawShaderMaterial!==!0&&(y=`#version 300 es
...
`)+`
`+g);const v=y+p+o,b=y+g+a,C=bg(r,r.VERTEX_SHADER,v),R=bg(r,r.FRAGMENT_SHADER,b);r.attachShader(x,C),r.attachShader(x,R),t.index0AttributeName!==void 0?r.bindAttribLocation(x,0,t.index0AttributeName):t.morphTargets===!0&&r.bindAttribLocation(x,0,"position"),r.linkProgram(x);function E(I){if(n.debug.checkShaderErrors){const L=r.getProgramInfoLog(x)||"",G=r.getShaderInfoLog(C)||"",B=r.getShaderInfoLog(R)||"",V=L.trim(),$=G.trim(),k=B.trim();let Z=!0,j=!0;if(r.getProgramParameter(x,r.LINK_STATUS)===!1)if(Z=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(r,x,C,R);else{const F=wg(r,C,"vertex"),ue=wg(r,R,"fragment");At("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(x,r.VALIDATE_STATUS)+`
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const iP=(...n)=>n.filter((e,t,i)=>!!e&&e.trim()!==""&&i.indexOf(e)===t).join(" ").trim();/**
 * @license @lucide/vue v1.33.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const rP=n=>n.replace(/^([A-Z])|[\s-_]+(\w)/g,(e,t,i)=>i?i.toUpperCase():t.toLowerCase());/**
 * @license @lucide/vue v1.33.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const sP=n=>{const e=rP(n);return e.charAt(0).toUpperCase()+e.slice(1)};/**
 * @license @lucide/vue v1.33.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const oP=Symbol("lucide-icons");function aP(){return Tl(oP,{})}/**
 * @license @lucide/vue v1.33.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const lP=({name:n,iconNode:e,"icon-node":t,absoluteStrokeWidth:i,"absolute-stroke-width":r,strokeWidth:s,"stroke-width":o,size:a,color:l,...c},{slots:u})=>{const{size:d,color:f,strokeWidth:h=2,absoluteStrokeWidth:m=!1,class:x=""}=aP(),p=Xt(()=>{const g=Fg(i)||Fg(r)||i===!0||r===!0||m===!0,y=s||o||h||ca["stroke-width"];return g?Number(y)*24/Number(a??d??ca.width):y});return Bu("svg",{...ca,...c,width:a??d??ca.width,height:a??d??ca.height,stroke:l??f??ca.stroke,"stroke-width":p.value,class:iP("lucide",x,...n?[`lucide-${Og(sP(n))}-icon`,`lucide-${Og(n)}`]:["lucide-icon"])},[...(e??t??[]).map(g=>Bu(...g)),...u.default?[u.default()]:[]])};/**
 * @license @lucide/vue v1.33.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Kn=(n,e)=>(t,{slots:i,attrs:r})=>Bu(lP,{...r,...t,iconNode:e,name:n},i.default?{default:i.default}:void 0);/**
 * @license @lucide/vue v1.33.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const cP=[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["path",{d:"M4.929 4.929 19.07 19.071",key:"196cmz"}]],uP=Kn("ban",cP);/**
 * @license @lucide/vue v1.33.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const dP=[["path",{d:"M20 6 9 17l-5-5",key:"1gmf2c"}]],fP=Kn("check",dP);/**
 * @license @lucide/vue v1.33.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const hP=[["path",{d:"m15 18-6-6 6-6",key:"1wnfg3"}]],ly=Kn("chevron-left",hP);/**
 * @license @lucide/vue v1.33.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const pP=[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["path",{d:"m9 12 2 2 4-4",key:"dzmm74"}]],cy=Kn("circle-check",pP);/**
 * @license @lucide/vue v1.33.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const mP=[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["path",{d:"m15 9-6 6",key:"1uzhvr"}],["path",{d:"m9 9 6 6",key:"z0biqf"}]],gP=Kn("circle-x",mP);/**
 * @license @lucide/vue v1.33.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const _P=[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["path",{d:"M12 6v6l4 2",key:"mmk7yg"}]],uy=Kn("clock",_P);/**
 * @license @lucide/vue v1.33.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const xP=[["rect",{width:"14",height:"14",x:"8",y:"8",rx:"2",ry:"2",key:"17jyea"}],["path",{d:"M4 16c-1.1 0-2-.9-2-2V4c0-1.1.9-2 2-2h10c1.1 0 2 .9 2 2",key:"zix9uf"}]],vP=Kn("copy",xP);/**
 * @license @lucide/vue v1.33.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const yP=[["path",{d:"M12 7v14",key:"1akyts"}],["path",{d:"M20 11v8a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2v-8",key:"1sqzm4"}],["path",{d:"M7.5 7a1 1 0 0 1 0-5A4.8 8 0 0 1 12 7a4.8 8 0 0 1 4.5-5 1 1 0 0 1 0 5",key:"kc0143"}],["rect",{x:"3",y:"7",width:"18",height:"4",rx:"1",key:"1hberx"}]],dy=Kn("gift",yP);/**
 * @license @lucide/vue v1.33.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const bP=[["path",{d:"M2.586 17.414A2 2 0 0 0 2 18.828V21a1 1 0 0 0 1 1h3a1 1 0 0 0 1-1v-1a1 1 0 0 1 1-1h1a1 1 0 0 0 1-1v-1a1 1 0 0 1 1-1h.172a2 2 0 0 0 1.414-.586l.814-.814a6.5 6.5 0 1 0-4-4z",key:"1s6t7t"}],["circle",{cx:"16.5",cy:"7.5",r:".5",fill:"currentColor",key:"w0ekpg"}]],Cu=Kn("key-round",bP);/**
 * @license @lucide/vue v1.33.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const SP=[["path",{d:"M21 12a9 9 0 1 1-6.219-8.56",key:"13zald"}]],fy=Kn("loader-circle",SP);/**
 * @license @lucide/vue v1.33.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const wP=[["path",{d:"m22 7-8.991 5.727a2 2 0 0 1-2.009 0L2 7",key:"132q7q"}],["rect",{x:"2",y:"4",width:"20",height:"16",rx:"2",key:"izxlao"}]],hy=Kn("mail",wP);/**
 * @license @lucide/vue v1.33.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const MP=[["path",{d:"M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8",key:"1357e3"}],["path",{d:"M3 3v5h5",key:"1xhq8a"}],["path",{d:"M12 7v5l4 2",key:"1fdv2h"}]],hp=Kn("rotate-ccw-clock",MP);/**
 * @license @lucide/vue v1.33.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const EP=[["path",{d:"M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8",key:"1357e3"}],["path",{d:"M3 3v5h5",key:"1xhq8a"}]],py=Kn("rotate-ccw",EP);/**
 * @license @lucide/vue v1.33.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const TP=[["path",{d:"M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z",key:"oel41y"}],["path",{d:"m9 12 2 2 4-4",key:"dzmm74"}]],id=Kn("shield-check",TP);/**
 * @license @lucide/vue v1.33.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const AP=[["rect",{width:"14",height:"20",x:"5",y:"2",rx:"2",ry:"2",key:"1yt0o3"}],["path",{d:"M12 18h.01",key:"mhygvu"}]],kg=Kn("smartphone",AP);/**
 * @license @lucide/vue v1.33.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const CP=[["path",{d:"M15 21v-5a1 1 0 0 0-1-1h-4a1 1 0 0 0-1 1v5",key:"slp6dd"}],["path",{d:"M17.774 10.31a1.12 1.12 0 0 0-1.549 0 2.5 2.5 0 0 1-3.451 0 1.12 1.12 0 0 0-1.548 0 2.5 2.5 0 0 1-3.452 0 1.12 1.12 0 0 0-1.549 0 2.5 2.5 0 0 1-3.77-3.248l2.889-4.184A2 2 0 0 1 7 2h10a2 2 0 0 1 1.653.873l2.895 4.192a2.5 2.5 0 0 1-3.774 3.244",key:"o0xfot"}],["path",{d:"M4 10.95V19a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-8.05",key:"wn3emo"}]],RP=Kn("store",CP),PP={class:"flex flex-col"},DP={class:"flex items-center gap-3"},LP={class:"w-10 h-10 sm:w-11 sm:h-11 rounded-full bg-white/20 backdrop-blur-sm flex items-center justify-center flex-shrink-0"},IP={class:"p-4 sm:p-5"},NP={class:"mb-4"},UP={class:"relative"},FP={class:"absolute left-3 top-1/2 -translate-y-1/2 text-secondary-400"},OP=["value"],kP={key:0,class:"text-[10px] text-accent-500 mt-1"},BP={key:1,class:"text-[10px] text-secondary-400 mt-1"},zP={class:"mb-4"},VP={class:"relative"},HP={class:"absolute left-3 top-1/2 -translate-y-1/2 text-secondary-400"},GP=["value"],WP={key:0,class:"text-[10px] text-accent-500 mt-1"},$P={key:1,class:"text-[10px] text-secondary-400 mt-1"},XP={class:"mb-4"},jP={class:"relative"},YP={class:"absolute left-3 top-1/2 -translate-y-1/2 text-secondary-400"},qP=["value"],KP={key:0,class:"text-[10px] text-accent-500 mt-1"},ZP={class:"mb-4"},JP={class:"relative"},QP={class:"absolute left-3 top-1/2 -translate-y-1/2 text-secondary-400"},e5=["value"],t5={key:0,class:"text-[10px] text-accent-500 mt-1"},n5={key:1,class:"text-[10px] text-secondary-400 mt-1"},i5={class:"flex items-start gap-2 bg-secondary-50 border border-secondary-200 rounded-lg p-3 mb-4"},r5=["disabled"],s5={__name:"RedemptionForm",props:{merchant:{type:Object,required:!0},isSubmitting:{type:Boolean,default:!1}},emits:["submit"],setup(n,{emit:e}){const t=n,i=e,r=we(""),s=we(""),o=we(""),a=we(""),l=we({redemptionCode:"",mobileno:"",confirmMobileno:"",email:""}),c=y=>y.toUpperCase().replace(/[^A-Z0-9]/g,"").slice(0,8),u=y=>{const v=y.replace(/\D/g,"").slice(0,11);return v.length<=3?v:v.length<=7?`${v.slice(0,3)} ${v.slice(3)}`:`${v.slice(0,3)} ${v.slice(3,7)} ${v.slice(7)}`},d=y=>{r.value=c(y.target.value),l.value.redemptionCode=""},f=y=>{s.value=u(y.target.value),l.value.mobileno="",o.value&&o.value!==s.value?l.value.confirmMobileno="Mobile numbers do not match":l.value.confirmMobileno=""},h=y=>{o.value=u(y.target.value),l.value.confirmMobileno=""},m=y=>{a.value=y.target.value,l.value.email=""},x=()=>{l.value={redemptionCode:"",mobileno:"",confirmMobileno:"",email:""};let y=!0;return r.value.length!==8&&(l.value.redemptionCode="Redemption code must be exactly 8 characters",y=!1),s.value.replace(/\D/g,"").length<10&&(l.value.mobileno="Enter a valid mobile number",y=!1),o.value!==s.value&&(l.value.confirmMobileno="Mobile numbers do not match",y=!1),/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(a.value)||(l.value.email="Enter a valid email address",y=!1),y},p=Xt(()=>r.value.length===8&&s.value.replace(/\D/g,"").length>=10&&o.value===s.value&&/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(a.value)),g=()=>{!x()||t.isSubmitting||i("submit",{redemptionCode:r.value,mobileno:s.value.replace(/\s/g,""),email:a.value})};return(y,v)=>(Y(),Q("div",PP,[_("div",{class:"px-4 sm:px-5 py-4 sm:py-5 flex-shrink-0",style:Gt({background:`linear-gradient(135deg, ${n.merchant.hexColor}, ${n.merchant.hexColor}cc)`})},[_("div",DP,[_("div",LP,[et(Xe(Cu),{class:"w-5 h-5 sm:w-5.5 sm:h-5.5 text-white"})]),v[0]||(v[0]=_("div",null,[_("div",{class:"text-white font-bold text-sm sm:text-base leading-tight"},"Redeem your eGift"),_("div",{class:"text-white/70 text-[10px] sm:text-[11px] mt-0.5"},"Enter your details to redeem")],-1))])],4),_("div",IP,[_("div",NP,[v[1]||(v[1]=_("label",{class:"block text-[11px] sm:text-xs font-semibold text-secondary-700 mb-1.5"}," Redemption Code ",-1)),_("div",UP,[_("div",FP,[et(Xe(Cu),{class:"w-4 h-4"})]),_("input",{value:r.value,onInput:d,type:"text",inputmode:"text",placeholder:"ABC12345",maxlength:"8",class:rt(["w-full bg-secondary-50 border border-secondary-200 rounded-lg pl-9 pr-3 py-2.5 text-sm text-secondary-900 placeholder-secondary-400 focus:outline-none focus:border-primary-500 focus:ring-2 focus:ring-primary-500/20 transition-all font-mono uppercase tracking-wider",{"border-accent-500 focus:border-accent-500 focus:ring-accent-500/20":l.value.redemptionCode}])},null,42,OP)]),l.value.redemptionCode?(Y(),Q("p",kP,pe(l.value.redemptionCode),1)):(Y(),Q("p",BP,"Enter the 8-character code from your eGift"))]),_("div",zP,[v[2]||(v[2]=_("label",{class:"block text-[11px] sm:text-xs font-semibold text-secondary-700 mb-1.5"}," Mobile Number ",-1)),_("div",VP,[_("div",HP,[et(Xe(kg),{class:"w-4 h-4"})]),_("input",{value:s.value,onInput:f,type:"tel",inputmode:"numeric",placeholder:"09XX XXX XXXX",class:rt(["w-full bg-secondary-50 border border-secondary-200 rounded-lg pl-9 pr-3 py-2.5 text-sm text-secondary-900 placeholder-secondary-400 focus:outline-none focus:border-primary-500 focus:ring-2 focus:ring-primary-500/20 transition-all",{"border-accent-500 focus:border-accent-500 focus:ring-accent-500/20":l.value.mobileno}])},null,42,GP)]),l.value.mobileno?(Y(),Q("p",WP,pe(l.value.mobileno),1)):(Y(),Q("p",$P,"We'll send a one-time PIN to verify your number"))]),_("div",XP,[v[3]||(v[3]=_("label",{class:"block text-[11px] sm:text-xs font-semibold text-secondary-700 mb-1.5"}," Retype Mobile Number ",-1)),_("div",jP,[_("div",YP,[et(Xe(kg),{class:"w-4 h-4"})]),_("input",{value:o.value,onInput:h,type:"tel",inputmode:"numeric",placeholder:"09XX XXX XXXX",class:rt(["w-full bg-secondary-50 border border-secondary-200 rounded-lg pl-9 pr-3 py-2.5 text-sm text-secondary-900 placeholder-secondary-400 focus:outline-none focus:border-primary-500 focus:ring-2 focus:ring-primary-500/20 transition-all",{"border-accent-500 focus:border-accent-500 focus:ring-accent-500/20":l.value.confirmMobileno}])},null,42,qP)]),l.value.confirmMobileno?(Y(),Q("p",KP,pe(l.value.confirmMobileno),1)):qt("",!0)]),_("div",ZP,[v[4]||(v[4]=_("label",{class:"block text-[11px] sm:text-xs font-semibold text-secondary-700 mb-1.5"}," Email Address ",-1)),_("div",JP,[_("div",QP,[et(Xe(hy),{class:"w-4 h-4"})]),_("input",{value:a.value,onInput:m,type:"email",inputmode:"email",placeholder:"you@email.com",class:rt(["w-full bg-secondary-50 border border-secondary-200 rounded-lg pl-9 pr-3 py-2.5 text-sm text-secondary-900 placeholder-secondary-400 focus:outline-none focus:border-primary-500 focus:ring-2 focus:ring-primary-500/20 transition-all",{"border-accent-500 focus:border-accent-500 focus:ring-accent-500/20":l.value.email}])},null,42,e5)]),l.value.email?(Y(),Q("p",t5,pe(l.value.email),1)):(Y(),Q("p",n5,"We'll send your eGift receipt to this email"))]),_("div",i5,[et(Xe(id),{class:"w-4 h-4 text-primary-500 flex-shrink-0 mt-0.5"}),v[5]||(v[5]=_("p",{class:"text-[10px] text-secondary-500 leading-relaxed"}," Your transaction is secured. We never store your personal information. ",-1))]),_("button",{onClick:g,disabled:!p.value||n.isSubmitting,class:rt(["w-full py-3 rounded-lg font-semibold text-sm transition-all duration-300 flex items-center justify-center gap-2 cursor-pointer",p.value&&!n.isSubmitting?"text-white shadow-lg hover:opacity-90 active:scale-[0.98]":"bg-secondary-200 text-secondary-400 cursor-not-allowed"]),style:Gt(p.value&&!n.isSubmitting?{background:n.merchant.hexColor,boxShadow:`0 4px 15px ${n.merchant.hexColor}40`}:{})},[n.isSubmitting?(Y(),Yn(Xe(fy),{key:0,class:"w-4 h-4 animate-spin"})):(Y(),Q(We,{key:1},[et(Xe(Cu),{class:"w-4 h-4"}),v[6]||(v[6]=_("span",null,"Redeem Now",-1))],64))],14,r5)])]))}},o5={class:"flex flex-col"},a5={class:"flex items-center gap-3"},l5={class:"p-4 sm:p-5"},c5={class:"flex items-center gap-2 bg-secondary-50 border border-secondary-200 rounded-lg p-3 mb-5"},u5={class:"text-[11px] text-secondary-600"},d5={class:"font-semibold text-secondary-900"},f5={class:"flex gap-2 sm:gap-2.5 mb-4"},h5=["value","onInput","onKeydown"],p5={key:0,class:"text-[11px] text-accent-500 mb-3"},m5={class:"flex items-center justify-between mb-5"},g5={class:"flex items-center gap-1.5 text-[11px] text-secondary-400"},_5={key:0},x5={key:1},v5=["disabled"],y5={class:"flex items-start gap-2 bg-secondary-50 border border-secondary-200 rounded-lg p-3 mb-4"},b5=["disabled"],S5={__name:"OtpVerification",props:{merchant:{type:Object,required:!0},phone:{type:String,default:""}},emits:["verified","back","resend"],setup(n,{emit:e}){const t=n,i=e,r=we(["","","","","",""]),s=we([]),o=we(!1),a=we(!1),l=we(30),c=we("");let u=null;const d=Xt(()=>{if(!t.phone)return"your mobile number";const v=t.phone.replace(/\D/g,"");return v.length<=3?v:v.length<=7?`${v.slice(0,3)} ${v.slice(3)}`:`${v.slice(0,3)} ${v.slice(3,7)} ${v.slice(7)}`}),f=Xt(()=>r.value.every(v=>v!=="")),h=(v,b)=>{var R;const C=b.target.value.replace(/\D/g,"").slice(-1);r.value[v]=C,c.value="",C&&v<5&&((R=s.value[v+1])==null||R.focus())},m=(v,b)=>{var C,R,E;b.key==="Backspace"&&!r.value[v]&&v>0&&((C=s.value[v-1])==null||C.focus()),b.key==="ArrowLeft"&&v>0&&((R=s.value[v-1])==null||R.focus()),b.key==="ArrowRight"&&v<5&&((E=s.value[v+1])==null||E.focus())},x=v=>{var R;const b=v.clipboardData.getData("text").replace(/\D/g,"").slice(0,6);if(!b)return;v.preventDefault();const C=b.split("");r.value=["","","","","",""],C.forEach((E,S)=>{r.value[S]=E}),(R=s.value[Math.min(C.length,5)])==null||R.focus()},p=async()=>{!f.value||o.value||(o.value=!0,c.value="",setTimeout(()=>{o.value=!1,i("verified")},1200))},g=async()=>{a.value||l.value>0||(a.value=!0,await i("resend"),a.value=!1,l.value=30,y())},y=()=>{u&&clearInterval(u),u=setInterval(()=>{l.value--,l.value<=0&&(clearInterval(u),u=null)},1e3)};return yn(()=>{y(),setTimeout(()=>{var v;return(v=s.value[0])==null?void 0:v.focus()},300)}),Cn(()=>{u&&clearInterval(u)}),li(f,v=>{v&&setTimeout(()=>p(),300)}),(v,b)=>(Y(),Q("div",o5,[_("div",{class:"px-4 sm:px-5 py-4 sm:py-5 flex-shrink-0",style:Gt({background:`linear-gradient(135deg, ${n.merchant.hexColor}, ${n.merchant.hexColor}cc)`})},[_("div",a5,[_("button",{onClick:b[0]||(b[0]=C=>i("back")),class:"w-8 h-8 rounded-full bg-white/20 hover:bg-white/30 backdrop-blur-sm flex items-center justify-center transition-colors cursor-pointer","aria-label":"Go back"},[et(Xe(ly),{class:"w-4 h-4 text-white"})]),b[1]||(b[1]=_("div",null,[_("div",{class:"text-white font-bold text-sm sm:text-base leading-tight"},"Verify OTP"),_("div",{class:"text-white/70 text-[10px] sm:text-[11px] mt-0.5"},"Enter the code sent to your phone")],-1))])],4),_("div",l5,[_("div",c5,[et(Xe(hy),{class:"w-4 h-4 text-primary-500 flex-shrink-0"}),_("p",u5,[b[2]||(b[2]=Ii(" We sent a 6-digit code to ",-1)),_("span",d5,pe(d.value),1)])]),_("div",f5,[(Y(!0),Q(We,null,it(r.value,(C,R)=>(Y(),Q("input",{key:R,ref_for:!0,ref:E=>{E&&(s.value[R]=E)},value:C,onInput:E=>h(R,E),onKeydown:E=>m(R,E),onPaste:x,type:"tel",inputmode:"numeric",maxlength:"1",class:rt(["w-11 h-12 sm:w-12 sm:h-12 text-center text-lg font-bold text-secondary-900 bg-secondary-50 border border-secondary-200 rounded-lg focus:outline-none focus:border-primary-500 focus:ring-2 focus:ring-primary-500/20 transition-all",{"border-primary-500 ring-2 ring-primary-500/20":C}])},null,42,h5))),128))]),c.value?(Y(),Q("p",p5,pe(c.value),1)):qt("",!0),_("div",m5,[_("div",g5,[et(Xe(uy),{class:"w-3.5 h-3.5"}),l.value>0?(Y(),Q("span",_5,"Resend in "+pe(l.value)+"s",1)):(Y(),Q("span",x5,"Code expired"))]),_("button",{onClick:g,disabled:l.value>0||a.value,class:rt(["text-[11px] font-semibold transition-colors cursor-pointer",l.value>0?"text-secondary-300 cursor-not-allowed":"text-primary-500 hover:text-primary-600"])},pe(a.value?"Sending...":"Resend Code"),11,v5)]),_("div",y5,[et(Xe(id),{class:"w-4 h-4 text-primary-500 flex-shrink-0 mt-0.5"}),b[3]||(b[3]=_("p",{class:"text-[10px] text-secondary-500 leading-relaxed"}," Never share your OTP with anyone. Our team will never ask for this code. ",-1))]),_("button",{onClick:p,disabled:!f.value||o.value,class:rt(["w-full py-3 rounded-lg font-semibold text-sm transition-all duration-300 flex items-center justify-center gap-2 cursor-pointer",f.value&&!o.value?"text-white shadow-lg hover:opacity-90 active:scale-[0.98]":"bg-secondary-200 text-secondary-400 cursor-not-allowed"]),style:Gt(f.value&&!o.value?{background:n.merchant.hexColor,boxShadow:`0 4px 15px ${n.merchant.hexColor}40`}:{})},[o.value?(Y(),Yn(Xe(fy),{key:0,class:"w-4 h-4 animate-spin"})):(Y(),Q(We,{key:1},[et(Xe(id),{class:"w-4 h-4"}),b[4]||(b[4]=_("span",null,"Verify & Redeem",-1))],64))],14,b5)])]))}},w5={class:"flex flex-col"},M5={class:"w-14 h-14 sm:w-16 sm:h-16 rounded-full bg-white/20 backdrop-blur-sm mx-auto mb-3 flex items-center justify-center"},E5={class:"p-4 sm:p-5"},T5={class:"bg-white border border-secondary-200 rounded-xl p-4 sm:p-5 mb-4 shadow-sm"},A5={class:"text-2xl sm:text-3xl font-bold text-secondary-900 font-mono tracking-wider"},C5={class:"flex items-center gap-1.5 mt-1"},R5={class:"text-[10px] sm:text-[11px] text-secondary-500"},P5={class:"bg-secondary-50 border border-secondary-200 rounded-xl p-4 sm:p-5 mb-4"},D5={class:"flex items-center justify-between gap-2"},L5={class:"text-sm sm:text-base font-mono font-semibold text-secondary-900"},I5={class:"bg-secondary-50 border border-secondary-200 rounded-xl p-4 sm:p-5 mb-4"},N5={class:"space-y-2"},U5={class:"flex items-start gap-2"},F5={class:"text-[11px] text-secondary-600 leading-relaxed"},O5={class:"flex items-start gap-2 bg-secondary-50 border border-secondary-200 rounded-lg p-3 mb-4"},k5={__name:"RedemptionSuccess",props:{merchant:{type:Object,required:!0},referenceNumber:{type:String,default:""},redemptionCode:{type:String,default:"ABC12345"}},emits:["new-redemption"],setup(n,{emit:e}){const t=n,i=e,r=we(!1),s=Xt(()=>t.referenceNumber||"RDM-XXXXXX"),o=async()=>{try{await navigator.clipboard.writeText(s.value),r.value=!0,setTimeout(()=>{r.value=!1},2e3)}catch{r.value=!1}};return(a,l)=>(Y(),Q("div",w5,[_("div",{class:"px-4 sm:px-5 py-5 sm:py-6 flex-shrink-0 text-center",style:Gt({background:`linear-gradient(135deg, ${n.merchant.hexColor}, ${n.merchant.hexColor}cc)`})},[_("div",M5,[et(Xe(cy),{class:"w-7 h-7 sm:w-8 sm:h-8 text-white"})]),l[1]||(l[1]=_("div",{class:"text-white font-bold text-base sm:text-lg"},"Redemption Successful!",-1)),l[2]||(l[2]=_("div",{class:"text-white/70 text-[11px] sm:text-xs mt-1"},"Your eGift has been sent to your account",-1))],4),_("div",E5,[_("div",T5,[l[3]||(l[3]=_("div",{class:"text-[10px] sm:text-[11px] text-secondary-400 uppercase tracking-wider mb-1"},"Redemption Code",-1)),_("div",A5,pe(n.redemptionCode),1),_("div",C5,[et(Xe(Cu),{class:"w-3.5 h-3.5 text-primary-500"}),_("span",R5,pe(n.merchant.name)+" eGift",1)])]),_("div",P5,[l[4]||(l[4]=_("div",{class:"text-[10px] sm:text-[11px] text-secondary-400 uppercase tracking-wider mb-2"},"Reference Number",-1)),_("div",D5,[_("span",L5,pe(s.value),1),_("button",{onClick:o,class:"flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg bg-white border border-secondary-200 text-[10px] sm:text-[11px] font-medium text-secondary-600 hover:border-primary-500 hover:text-primary-600 transition-colors cursor-pointer"},[r.value?(Y(),Yn(Xe(fP),{key:1,class:"w-3.5 h-3.5 text-primary-500"})):(Y(),Yn(Xe(vP),{key:0,class:"w-3.5 h-3.5"})),_("span",null,pe(r.value?"Copied!":"Copy"),1)])])]),_("div",I5,[l[7]||(l[7]=_("div",{class:"text-[10px] sm:text-[11px] text-secondary-400 uppercase tracking-wider mb-2"},"What's Next?",-1)),_("div",N5,[_("div",U5,[l[5]||(l[5]=_("div",{class:"w-5 h-5 rounded-full bg-primary-500/10 flex items-center justify-center flex-shrink-0 mt-0.5"},[_("span",{class:"text-[9px] font-bold text-primary-600"},"1")],-1)),_("p",F5,"Check your "+pe(n.merchant.name)+" app for the eGift",1)]),l[6]||(l[6]=Rs('<div class="flex items-start gap-2"><div class="w-5 h-5 rounded-full bg-primary-500/10 flex items-center justify-center flex-shrink-0 mt-0.5"><span class="text-[9px] font-bold text-primary-600">2</span></div><p class="text-[11px] text-secondary-600 leading-relaxed">Use the eGift at any participating merchant</p></div><div class="flex items-start gap-2"><div class="w-5 h-5 rounded-full bg-primary-500/10 flex items-center justify-center flex-shrink-0 mt-0.5"><span class="text-[9px] font-bold text-primary-600">3</span></div><p class="text-[11px] text-secondary-600 leading-relaxed">Keep your reference number for support</p></div>',2))])]),_("div",O5,[et(Xe(id),{class:"w-4 h-4 text-primary-500 flex-shrink-0 mt-0.5"}),l[8]||(l[8]=_("p",{class:"text-[10px] text-secondary-500 leading-relaxed"}," This transaction is protected. Contact support if you have any issues with your redemption. ",-1))]),_("button",{onClick:l[0]||(l[0]=c=>i("new-redemption")),class:"w-full py-3 rounded-lg font-semibold text-sm transition-all duration-300 flex items-center justify-center gap-2 cursor-pointer",style:Gt({background:n.merchant.hexColor,boxShadow:`0 4px 15px ${n.merchant.hexColor}40`})},[et(Xe(py),{class:"w-4 h-4 text-white"}),l[9]||(l[9]=_("span",{class:"text-white"},"New Redemption",-1))],4)])]))}},B5={class:"flex flex-col h-full"},z5={class:"px-4 sm:px-5 py-3 sm:py-4 bg-white border-b border-secondary-200 flex-shrink-0"},V5={class:"flex items-center justify-between"},H5={class:"flex items-center gap-2.5"},G5={class:"flex items-center gap-2"},W5={class:"text-[10px] text-secondary-400"},$5={class:"px-4 sm:px-5 py-2.5 bg-white border-b border-secondary-200 flex-shrink-0 overflow-x-auto"},X5={class:"flex gap-1.5"},j5=["onClick"],Y5={class:"flex-1 overflow-y-auto min-h-0 overscroll-contain bg-secondary-50"},q5={key:0,class:"flex flex-col items-center justify-center py-12"},K5={class:"w-12 h-12 rounded-full bg-secondary-100 flex items-center justify-center mb-3"},Z5={key:1,class:"p-3 sm:p-4 space-y-2"},J5={class:"flex items-start justify-between gap-2 mb-2"},Q5={class:"flex items-center gap-2 min-w-0"},e4={class:"w-7 h-7 rounded-full bg-secondary-100 flex items-center justify-center flex-shrink-0"},t4={class:"min-w-0"},n4={class:"text-[11px] font-semibold text-secondary-900 truncate"},i4={class:"text-[9px] text-secondary-400 font-mono truncate"},r4={class:"flex items-center justify-between pl-9"},s4={class:"text-[10px] text-secondary-400"},o4={class:"text-[11px] font-bold text-secondary-900"},a4={__name:"RedemptionHistory",props:{items:{type:Array,default:()=>[]}},emits:["close"],setup(n,{emit:e}){const t=n,i=e,r=we("all"),s={processing:{label:"Processing",icon:uy,color:"text-yellow-500",bg:"bg-yellow-500/10",border:"border-yellow-500/20"},voided:{label:"Voided",icon:gP,color:"text-accent-500",bg:"bg-accent-500/10",border:"border-accent-500/20"},successful:{label:"Successful",icon:cy,color:"text-emerald-500",bg:"bg-emerald-500/10",border:"border-emerald-500/20"},redeemed:{label:"Redeemed",icon:py,color:"text-primary-500",bg:"bg-primary-500/10",border:"border-primary-500/20"},cancelled:{label:"Cancelled",icon:uP,color:"text-secondary-400",bg:"bg-secondary-400/10",border:"border-secondary-400/20"}},o=["all","processing","voided","successful","redeemed","cancelled"],a=Xt(()=>r.value==="all"?t.items:t.items.filter(c=>c.status===r.value)),l=c=>s[c]||s.processing;return(c,u)=>(Y(),Q("div",B5,[_("div",z5,[_("div",V5,[_("div",H5,[_("button",{onClick:u[0]||(u[0]=d=>i("close")),class:"w-8 h-8 rounded-full bg-secondary-100 hover:bg-secondary-200 flex items-center justify-center transition-colors cursor-pointer","aria-label":"Close history"},[et(Xe(ly),{class:"w-4 h-4 text-secondary-600"})]),_("div",G5,[et(Xe(hp),{class:"w-4 h-4 text-primary-500"}),u[1]||(u[1]=_("span",{class:"text-sm font-bold text-secondary-900"},"Redemption History",-1))])]),_("span",W5,pe(a.value.length)+" records",1)])]),_("div",$5,[_("div",X5,[(Y(),Q(We,null,it(o,d=>_("button",{key:d,onClick:f=>r.value=d,class:rt(["px-2.5 py-1 rounded-full text-[10px] font-medium whitespace-nowrap transition-all cursor-pointer",r.value===d?"bg-primary-500 text-white shadow-md shadow-primary-500/25":"bg-secondary-100 text-secondary-500 hover:bg-secondary-200"])},pe(d==="all"?"All":s[d].label),11,j5)),64))])]),_("div",Y5,[a.value.length===0?(Y(),Q("div",q5,[_("div",K5,[et(Xe(hp),{class:"w-5 h-5 text-secondary-400"})]),u[2]||(u[2]=_("p",{class:"text-xs text-secondary-400"},"No redemption records found",-1))])):(Y(),Q("div",Z5,[(Y(!0),Q(We,null,it(a.value,d=>(Y(),Q("div",{key:d.id,class:"bg-white border border-secondary-200 rounded-xl p-3 sm:p-3.5 hover:border-primary-500/30 hover:shadow-sm transition-all"},[_("div",J5,[_("div",Q5,[_("div",e4,[et(Xe(dy),{class:"w-3.5 h-3.5 text-secondary-500"})]),_("div",t4,[_("div",n4,pe(d.id),1),_("div",i4,pe(d.code),1)])]),_("span",{class:rt(["inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[9px] font-medium border flex-shrink-0",[l(d.status).bg,l(d.status).color,l(d.status).border]])},[(Y(),Yn(A1(l(d.status).icon),{class:"w-3 h-3"})),Ii(" "+pe(l(d.status).label),1)],2)]),_("div",r4,[_("span",s4,pe(d.date),1),_("span",o4,pe(d.amount),1)])]))),128))]))])]))}},l4={class:"w-full h-full bg-secondary-900 light:bg-secondary-100 overflow-y-auto relative flex flex-col"},c4={key:0,class:"flex items-center gap-2 px-3 sm:px-4 py-2 bg-secondary-800 light:bg-white border-b border-secondary-700 light:border-secondary-200 flex-shrink-0"},u4={class:"flex-1 max-w-md mx-auto"},d4={class:"bg-secondary-700/50 light:bg-secondary-100 rounded-md px-2 sm:px-3 py-1 text-[10px] sm:text-xs text-secondary-400 light:text-secondary-500 flex items-center gap-1.5 sm:gap-2 truncate"},f4={class:"truncate"},h4={class:"flex-1 flex items-center justify-center p-2 sm:p-4 mb-10"},p4={class:"w-full max-w-[430px] bg-white light:bg-white rounded-2xl shadow-2xl overflow-hidden relative flex flex-col border border-secondary-200 light:border-secondary-200"},m4={class:"px-4 sm:px-5 py-3 sm:py-4"},g4={class:"flex items-center justify-between"},_4={class:"flex items-center gap-2.5"},x4={class:"w-9 h-9 sm:w-10 sm:h-10 rounded-full bg-white flex items-center justify-center flex-shrink-0 shadow-md"},v4={key:0,class:"w-5 h-5 sm:w-6 sm:h-6",viewBox:"0 0 24 24",fill:"none"},y4={key:1,class:"w-5 h-5 sm:w-6 sm:h-6",viewBox:"0 0 24 24",fill:"none"},b4={key:2,class:"w-5 h-5 sm:w-6 sm:h-6",viewBox:"0 0 24 24",fill:"none"},S4={key:3,class:"w-5 h-5 sm:w-6 sm:h-6",viewBox:"0 0 24 24",fill:"none"},w4={key:4,class:"w-5 h-5 sm:w-6 sm:h-6",viewBox:"0 0 24 24",fill:"none"},M4={class:"flex flex-col"},E4={class:"text-white font-bold text-sm sm:text-base leading-tight"},T4={class:"text-white/70 text-[9px] sm:text-[10px]"},A4={class:"flex items-center gap-1.5"},C4={class:"relative"},R4={key:0,class:"absolute right-0 top-full mt-1 w-44 bg-white rounded-xl shadow-2xl border border-secondary-200 overflow-hidden z-30"},P4=["onClick"],D4={class:"text-[11px] font-medium text-secondary-700 flex-1 text-left"},L4=["aria-label"],I4={class:"bg-secondary-50 light:bg-secondary-50"},N4={key:0,class:"absolute inset-0 z-20 bg-secondary-50 light:bg-secondary-50"},U4={__name:"RedemptionApp",props:{showChrome:{type:Boolean,default:!0}},setup(n){const e=n,t=[{name:"GCash",vanityUrl:"gcash",hexColor:"#007CFF",tagline:"Redeem your eGift",logo:"gcash"},{name:"ShopeePay",vanityUrl:"shopeepay",hexColor:"#EE4D2D",tagline:"Redeem your eGift",logo:"shopeepay"},{name:"Maya",vanityUrl:"maya",hexColor:"#00A6A6",tagline:"Redeem your eGift",logo:"maya"},{name:"GrabPay",vanityUrl:"grabpay",hexColor:"#00B14F",tagline:"Redeem your eGift",logo:"grabpay"},{name:"Coins.ph",vanityUrl:"coinsph",hexColor:"#F7931A",tagline:"Redeem your eGift",logo:"coinsph"}],i=we(0),r=we(!1),s=Xt(()=>t[i.value]),o=we("form"),a=we(!1),l=we(!1),c=we({}),u=we(""),d=we([{id:"RDM-2024-001",code:"GC-4821-9034",amount:"₱500.00",date:"Aug 20, 2024",status:"successful"},{id:"RDM-2024-002",code:"GC-7712-4456",amount:"₱1,000.00",date:"Aug 18, 2024",status:"redeemed"},{id:"RDM-2024-003",code:"GC-3390-1287",amount:"₱250.00",date:"Aug 15, 2024",status:"processing"},{id:"RDM-2024-004",code:"GC-9054-6671",amount:"₱750.00",date:"Aug 12, 2024",status:"voided"},{id:"RDM-2024-005",code:"GC-1188-3390",amount:"₱300.00",date:"Aug 10, 2024",status:"cancelled"}]),f=y=>{i.value=y,r.value=!1,o.value="form",c.value={},u.value="",a.value=!1},h=y=>{c.value=y,l.value=!0,setTimeout(()=>{l.value=!1,o.value="otp"},1200)},m=()=>{u.value="RDM-"+Math.random().toString(36).slice(2,8).toUpperCase(),o.value="success"},x=()=>{o.value="form"},p=()=>{o.value="form",c.value={},u.value=""},g=()=>new Promise(y=>{setTimeout(y,800)});return(y,v)=>(Y(),Q("div",l4,[e.showChrome?(Y(),Q("div",c4,[v[4]||(v[4]=_("div",{class:"flex gap-1.5"},[_("span",{class:"w-2.5 h-2.5 sm:w-3 sm:h-3 rounded-full bg-accent-500"}),_("span",{class:"w-2.5 h-2.5 sm:w-3 sm:h-3 rounded-full bg-yellow-500"}),_("span",{class:"w-2.5 h-2.5 sm:w-3 sm:h-3 rounded-full bg-primary-500"})],-1)),_("div",u4,[_("div",d4,[v[3]||(v[3]=_("svg",{class:"w-2.5 h-2.5 sm:w-3 sm:h-3 flex-shrink-0",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24"},[_("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"2",d:"M12 11c0 3.517-1.009 6.799-2.753 9.571m-3.44-2.04l.054-.09A13.916 13.916 0 008 8a4 4 0 118 0c0 1.017-.07 2.019-.203 3m-2.118 6.844A21.88 21.88 0 0115.171 17m3.839 1.132c.645-2.266.99-4.659.99-7.132A8 8 0 008 4.07M3 15.364c.64-1.319 1-2.8 1-4.364 0-1.457.39-2.823 1.07-4"})],-1)),_("span",f4,"https://redemption."+pe(s.value.vanityUrl)+".com/redeem",1)])])])):qt("",!0),_("div",h4,[_("div",p4,[_("div",{class:"flex-shrink-0 h-40",style:Gt({background:`linear-gradient(135deg, ${s.value.hexColor}, ${s.value.hexColor}cc)`})},[_("div",m4,[_("div",g4,[_("div",_4,[_("div",x4,[s.value.logo==="gcash"?(Y(),Q("svg",v4,[...v[5]||(v[5]=[_("path",{d:"M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8z",fill:"#007CFF"},null,-1),_("path",{d:"M12 6c-3.31 0-6 2.69-6 6s2.69 6 6 6 6-2.69 6-6-2.69-6-6-6zm0 10c-2.21 0-4-1.79-4-4s1.79-4 4-4 4 1.79 4 4-1.79 4-4 4z",fill:"#007CFF"},null,-1),_("circle",{cx:"12",cy:"12",r:"2",fill:"#007CFF"},null,-1)])])):s.value.logo==="shopeepay"?(Y(),Q("svg",y4,[...v[6]||(v[6]=[_("path",{d:"M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8z",fill:"#EE4D2D"},null,-1),_("path",{d:"M12 6c-3.31 0-6 2.69-6 6s2.69 6 6 6 6-2.69 6-6-2.69-6-6-6zm0 10c-2.21 0-4-1.79-4-4s1.79-4 4-4 4 1.79 4 4-1.79 4-4 4z",fill:"#EE4D2D"},null,-1),_("circle",{cx:"12",cy:"12",r:"2",fill:"#EE4D2D"},null,-1)])])):s.value.logo==="maya"?(Y(),Q("svg",b4,[...v[7]||(v[7]=[_("path",{d:"M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8z",fill:"#00A6A6"},null,-1),_("path",{d:"M12 6c-3.31 0-6 2.69-6 6s2.69 6 6 6 6-2.69 6-6-2.69-6-6-6zm0 10c-2.21 0-4-1.79-4-4s1.79-4 4-4 4 1.79 4 4-1.79 4-4 4z",fill:"#00A6A6"},null,-1),_("circle",{cx:"12",cy:"12",r:"2",fill:"#00A6A6"},null,-1)])])):s.value.logo==="grabpay"?(Y(),Q("svg",S4,[...v[8]||(v[8]=[_("path",{d:"M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8z",fill:"#00B14F"},null,-1),_("path",{d:"M12 6c-3.31 0-6 2.69-6 6s2.69 6 6 6 6-2.69 6-6-2.69-6-6-6zm0 10c-2.21 0-4-1.79-4-4s1.79-4 4-4 4 1.79 4 4-1.79 4-4 4z",fill:"#00B14F"},null,-1),_("circle",{cx:"12",cy:"12",r:"2",fill:"#00B14F"},null,-1)])])):(Y(),Q("svg",w4,[...v[9]||(v[9]=[_("path",{d:"M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8z",fill:"#F7931A"},null,-1),_("path",{d:"M12 6c-3.31 0-6 2.69-6 6s2.69 6 6 6 6-2.69 6-6-2.69-6-6-6zm0 10c-2.21 0-4-1.79-4-4s1.79-4 4-4 4 1.79 4 4-1.79 4-4 4z",fill:"#F7931A"},null,-1),_("circle",{cx:"12",cy:"12",r:"2",fill:"#F7931A"},null,-1)])]))]),_("div",M4,[_("div",E4,pe(s.value.name),1),_("div",T4,pe(s.value.tagline),1)])]),_("div",A4,[_("div",C4,[_("button",{onClick:v[0]||(v[0]=b=>r.value=!r.value),class:"w-8 h-8 sm:w-9 sm:h-9 rounded-full bg-white/20 hover:bg-white/30 backdrop-blur-sm flex items-center justify-center transition-colors cursor-pointer","aria-label":"Switch merchant"},[et(Xe(RP),{class:"w-4 h-4 sm:w-4.5 sm:h-4.5 text-white"})]),et(Na,{name:"dropdown"},{default:Uo(()=>[r.value?(Y(),Q("div",R4,[v[10]||(v[10]=_("div",{class:"px-3 py-2 text-[9px] font-semibold text-secondary-400 uppercase tracking-wider border-b border-secondary-100"},"Partnered Merchants",-1)),(Y(),Q(We,null,it(t,(b,C)=>_("button",{key:b.vanityUrl,onClick:R=>f(C),class:"w-full px-3 py-2.5 flex items-center gap-2.5 hover:bg-secondary-50 transition-colors cursor-pointer"},[_("span",{class:"w-5 h-5 rounded-full flex items-center justify-center flex-shrink-0",style:Gt({background:b.hexColor})},[et(Xe(dy),{class:"w-2.5 h-2.5 text-white"})],4),_("span",D4,pe(b.name),1),i.value===C?(Y(),Q("span",{key:0,class:"w-1.5 h-1.5 rounded-full",style:Gt({background:b.hexColor})},null,4)):qt("",!0)],8,P4)),64))])):qt("",!0)]),_:1})]),_("button",{onClick:v[1]||(v[1]=b=>a.value=!a.value),class:"w-8 h-8 sm:w-9 sm:h-9 rounded-full bg-white/20 hover:bg-white/30 backdrop-blur-sm flex items-center justify-center transition-colors cursor-pointer","aria-label":a.value?"Close history":"View redemption history"},[et(Xe(hp),{class:"w-4 h-4 sm:w-4.5 sm:h-4.5 text-white"})],8,L4)])])])],4),_("div",I4,[et(Na,{name:"fade-slide"},{default:Uo(()=>[a.value?(Y(),Q("div",N4,[et(a4,{items:d.value,onClose:v[2]||(v[2]=b=>a.value=!1)},null,8,["items"])])):qt("",!0)]),_:1}),_("div",null,[o.value==="form"?(Y(),Yn(s5,{key:0,merchant:s.value,"is-submitting":l.value,onSubmit:h},null,8,["merchant","is-submitting"])):o.value==="otp"?(Y(),Yn(S5,{key:1,merchant:s.value,phone:c.value.mobileno,onVerified:m,onBack:x,onResend:g},null,8,["merchant","phone"])):(Y(),Yn(k5,{key:2,merchant:s.value,"reference-number":u.value,"redemption-code":c.value.redemptionCode||"ABC12345",onNewRedemption:p},null,8,["merchant","reference-number","redemption-code"]))])])])])]))}},my=Ks(U4,[["__scopeId","data-v-b1ed1387"]]),F4={class:"w-full h-full bg-secondary-900 light:bg-secondary-100 overflow-hidden relative flex flex-col"},O4={class:"flex items-center gap-2 px-3 sm:px-4 py-2 bg-secondary-800 light:bg-white border-b border-secondary-700 light:border-secondary-200 flex-shrink-0"},k4={class:"flex-1 max-w-md mx-auto"},B4={class:"bg-secondary-700/50 light:bg-secondary-100 rounded-md px-2 sm:px-3 py-1 text-[10px] sm:text-xs text-secondary-400 light:text-secondary-500 flex items-center gap-1.5 sm:gap-2 truncate"},z4={class:"truncate"},V4={key:1,class:"flex-1 flex flex-col min-h-0 relative"},H4={class:"flex items-center justify-between px-3 sm:px-6 py-2.5 sm:py-3 bg-secondary-800 light:bg-white border-b border-secondary-700 light:border-secondary-200 flex-shrink-0"},G4={class:"flex items-center gap-2 sm:gap-4"},W4={key:0,class:"absolute -top-1 -right-1 w-3.5 h-3.5 sm:w-4 sm:h-4 bg-accent-500 rounded-full text-[8px] sm:text-[9px] text-white flex items-center justify-center font-bold"},$4={class:"flex-1 p-3 sm:p-4 grid grid-cols-2 sm:grid-cols-3 gap-2 sm:gap-3 overflow-y-auto min-h-0 overscroll-contain"},X4={class:"text-[9px] sm:text-[10px] text-secondary-400 light:text-secondary-500 mb-1 truncate"},j4={class:"flex items-center justify-between"},Y4={class:"text-[10px] sm:text-xs font-semibold text-primary-500"},q4=["onClick"],K4={key:0,class:"absolute inset-y-0 right-0 w-64 sm:w-80 bg-secondary-800 light:bg-white border-l border-secondary-700 light:border-secondary-200 shadow-2xl z-20 flex flex-col"},Z4={class:"flex items-center justify-between px-4 py-3 border-b border-secondary-700 light:border-secondary-200"},J4={class:"flex-1 overflow-y-auto p-4 space-y-3 overscroll-contain"},Q4={key:0,class:"text-center py-8"},eD={class:"flex-1 min-w-0"},tD={class:"text-[10px] text-white light:text-secondary-900 font-medium truncate"},nD={class:"text-[9px] text-primary-500"},iD={class:"flex items-center gap-1.5"},rD=["onClick"],sD={class:"text-[10px] text-white light:text-secondary-900 w-4 text-center"},oD=["onClick"],aD={class:"p-4 border-t border-secondary-700 light:border-secondary-200"},lD={class:"flex justify-between mb-3"},cD={class:"text-sm font-bold text-white light:text-secondary-900"},uD={key:2,class:"flex-1 flex flex-col min-h-0"},dD={class:"px-3 sm:px-6 py-2.5 bg-secondary-800/50 light:bg-secondary-100/50 border-b border-secondary-700 light:border-secondary-200 flex-shrink-0"},fD={class:"flex gap-2"},hD=["value"],pD={class:"flex-1 p-2 sm:p-4 flex gap-2 sm:gap-3 overflow-x-auto min-h-0"},mD={class:"flex-1 min-w-[140px] sm:min-w-0 bg-secondary-800/50 light:bg-secondary-200/50 rounded-lg p-2 sm:p-2.5 flex flex-col"},gD={class:"flex items-center justify-between mb-2 px-1 flex-shrink-0"},_D={class:"text-[8px] sm:text-[9px] text-secondary-500 light:text-secondary-400"},xD={class:"space-y-1.5 sm:space-y-2 overflow-y-auto flex-1 min-h-0 overscroll-contain"},vD=["onClick"],yD={class:"flex items-start gap-1.5"},bD=["onClick"],SD={class:"flex-1 min-w-0"},wD={class:"text-[9px] sm:text-[10px] text-white light:text-secondary-900 leading-tight"},MD={class:"flex-1 min-w-[140px] sm:min-w-0 bg-secondary-800/50 light:bg-secondary-200/50 rounded-lg p-2 sm:p-2.5 flex flex-col"},ED={class:"flex items-center justify-between mb-2 px-1 flex-shrink-0"},TD={class:"text-[8px] sm:text-[9px] text-secondary-500 light:text-secondary-400"},AD={class:"space-y-1.5 sm:space-y-2 overflow-y-auto flex-1 min-h-0 overscroll-contain"},CD=["onClick"],RD={class:"flex items-start gap-1.5"},PD=["onClick"],DD={class:"flex-1 min-w-0"},LD={class:"text-[9px] sm:text-[10px] text-white light:text-secondary-900 leading-tight"},ID={class:"flex-1 min-w-[140px] sm:min-w-0 bg-secondary-800/50 light:bg-secondary-200/50 rounded-lg p-2 sm:p-2.5 flex flex-col"},ND={class:"flex items-center justify-between mb-2 px-1 flex-shrink-0"},UD={class:"text-[8px] sm:text-[9px] text-secondary-500 light:text-secondary-400"},FD={class:"space-y-1.5 sm:space-y-2 overflow-y-auto flex-1 min-h-0 overscroll-contain"},OD=["onClick"],kD={class:"flex items-start gap-1.5"},BD={class:"flex-1 min-w-0"},zD={class:"text-[9px] sm:text-[10px] text-secondary-400 light:text-secondary-500 line-through leading-tight"},VD={key:3,class:"flex-1 flex flex-col min-h-0"},HD={class:"flex items-center justify-between px-3 sm:px-6 py-2.5 sm:py-3 bg-secondary-800 light:bg-white border-b border-secondary-700 light:border-secondary-200 flex-shrink-0"},GD={class:"flex items-center gap-2"},WD={class:"flex rounded-lg overflow-hidden border border-secondary-600 light:border-secondary-200"},$D={class:"px-3 sm:px-6 py-2.5 bg-secondary-800/50 light:bg-secondary-100/50 border-b border-secondary-700 light:border-secondary-200 flex-shrink-0 relative"},XD={class:"flex gap-2"},jD={class:"flex-1 relative"},YD={key:0,class:"absolute left-3 sm:left-6 right-3 sm:right-6 top-full mt-1 bg-secondary-800 light:bg-white border border-secondary-700 light:border-secondary-200 rounded-lg shadow-xl z-10 overflow-hidden"},qD=["onClick"],KD={class:"ml-auto text-secondary-500 light:text-secondary-400"},ZD={class:"px-3 sm:px-6 py-3 sm:py-4 bg-gradient-to-br from-primary-600/30 to-primary-500/10 flex-shrink-0"},JD={class:"flex items-center justify-between"},QD={class:"text-2xl sm:text-3xl font-bold text-white light:text-secondary-900"},eL={class:"text-[9px] sm:text-[10px] text-secondary-400 light:text-secondary-500 mt-0.5"},tL={class:"text-[8px] sm:text-[9px] text-secondary-500 light:text-secondary-400 mt-0.5"},nL={class:"text-4xl sm:text-5xl"},iL={class:"px-3 sm:px-6 py-2.5 flex-shrink-0"},rL={class:"flex gap-1.5 sm:gap-2 overflow-x-auto"},sL={class:"text-[8px] sm:text-[9px] text-secondary-500 light:text-secondary-400 mb-0.5"},oL={class:"text-sm sm:text-base mb-0.5"},aL={class:"text-[9px] sm:text-[10px] font-semibold text-white light:text-secondary-900"},lL={class:"flex-1 px-3 sm:px-6 pb-3 sm:pb-4 min-h-0 overflow-y-auto overscroll-contain"},cL={class:"space-y-1 sm:space-y-1.5"},uL={class:"text-[9px] sm:text-[10px] text-secondary-400 light:text-secondary-500 w-8 sm:w-10"},dL={class:"text-sm sm:text-base"},fL={class:"flex-1 mx-2 sm:mx-3 h-1 bg-secondary-700 light:bg-secondary-200 rounded-full overflow-hidden"},hL={class:"text-[9px] sm:text-[10px] text-white light:text-secondary-900 font-semibold w-10 sm:w-12 text-right"},pL={key:4,class:"flex-1 flex flex-col min-h-0"},mL={class:"flex-1 flex overflow-hidden min-h-0"},gL={class:"w-10 sm:w-14 bg-secondary-800 light:bg-white border-r border-secondary-700 light:border-secondary-200 flex flex-col items-center py-2 sm:py-3 gap-2 sm:gap-3 flex-shrink-0"},_L={class:"flex-1 p-2 sm:p-4 overflow-y-auto min-h-0 overscroll-contain"},xL={class:"flex gap-1.5 sm:gap-2 mb-3 flex-wrap"},vL=["onClick"],yL={class:"grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-3 mb-3"},bL={class:"bg-secondary-800 light:bg-white rounded-lg p-2 sm:p-3 border border-secondary-700 light:border-secondary-200"},SL={class:"text-sm sm:text-lg font-bold text-white light:text-secondary-900"},wL={class:"bg-secondary-800 light:bg-white rounded-lg p-2 sm:p-3 border border-secondary-700 light:border-secondary-200"},ML={class:"text-sm sm:text-lg font-bold text-white light:text-secondary-900"},EL={class:"bg-secondary-800 light:bg-white rounded-lg p-2 sm:p-3 border border-secondary-700 light:border-secondary-200"},TL={class:"text-sm sm:text-lg font-bold text-white light:text-secondary-900"},AL={class:"bg-secondary-800 light:bg-white rounded-lg p-2 sm:p-3 border border-secondary-700 light:border-secondary-200"},CL={class:"text-sm sm:text-lg font-bold text-white light:text-secondary-900"},RL={class:"bg-secondary-800 light:bg-white rounded-lg p-2.5 sm:p-3 border border-secondary-700 light:border-secondary-200 mb-3"},PL={class:"h-20 sm:h-24 flex items-end gap-1"},DL=["onMouseenter","onMouseleave"],LL={class:"text-[6px] sm:text-[7px] text-secondary-500 light:text-secondary-400"},IL={class:"grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3"},NL={class:"bg-secondary-800 light:bg-white rounded-lg p-2.5 sm:p-3 border border-secondary-700 light:border-secondary-200"},UL={class:"space-y-1.5 sm:space-y-2"},FL=["onClick"],OL={class:"text-[8px] sm:text-[9px] text-secondary-400 light:text-secondary-500 flex-1"},kL={class:"text-[8px] sm:text-[9px] font-semibold text-white light:text-secondary-900"},BL={class:"bg-secondary-800 light:bg-white rounded-lg p-2.5 sm:p-3 border border-secondary-700 light:border-secondary-200"},zL={class:"space-y-1.5 sm:space-y-2"},VL={class:"text-[8px] sm:text-[9px] text-primary-500"},HL={key:5,class:"flex-1 flex flex-col min-h-0"},GL={class:"px-3 sm:px-6 py-2.5 sm:py-3 bg-secondary-800 light:bg-white border-b border-secondary-700 light:border-secondary-200 flex-shrink-0"},WL={class:"flex gap-1.5 sm:gap-2"},$L={class:"flex-1 relative"},XL={class:"px-3 sm:px-6 py-2 flex gap-1.5 sm:gap-2 overflow-x-auto flex-shrink-0"},jL=["onClick"],YL={class:"flex-1 px-3 sm:px-6 pb-3 sm:pb-4 grid grid-cols-2 gap-2 sm:gap-3 overflow-y-auto min-h-0 overscroll-contain"},qL=["onClick"],KL={class:"absolute top-1.5 right-1.5 bg-accent-500 text-white text-[7px] sm:text-[8px] px-1.5 py-0.5 rounded-full font-medium"},ZL={class:"p-2 sm:p-2.5"},JL={class:"text-[9px] sm:text-[10px] text-white light:text-secondary-900 font-medium mb-1 truncate"},QL={class:"flex items-center gap-1"},eI={class:"text-[8px] sm:text-[9px] text-secondary-500 light:text-secondary-400"},tI={class:"ml-auto text-[7px] sm:text-[8px] text-secondary-500 light:text-secondary-400"},nI={key:0,class:"col-span-2 text-center py-8"},iI={class:"flex items-start justify-between mb-3"},rI={class:"text-3xl"},sI={class:"text-sm font-bold text-white light:text-secondary-900 mb-1"},oI={class:"flex items-center gap-2 mb-3"},aI={class:"text-yellow-500 text-xs"},lI={class:"text-[9px] text-secondary-500 light:text-secondary-400"},cI={class:"text-[9px] text-secondary-500 light:text-secondary-400"},uI={class:"space-y-2 mb-4"},dI={key:6,class:"flex-1 flex flex-col min-h-0"},fI={class:"flex items-center justify-between px-3 sm:px-6 py-2.5 sm:py-3 bg-secondary-800 light:bg-white border-b border-secondary-700 light:border-secondary-200 flex-shrink-0"},hI={class:"flex gap-2 sm:gap-4 text-[9px] sm:text-[10px] text-secondary-400 light:text-secondary-500"},pI=["onClick"],mI={class:"flex-1 overflow-y-auto min-h-0 overscroll-contain"},gI={key:0,class:"h-full flex items-center justify-center px-4 sm:px-6 bg-gradient-to-br from-secondary-800 to-secondary-900 light:from-white light:to-secondary-100"},_I={class:"text-center"},xI={class:"flex gap-2 justify-center"},vI={key:1,class:"p-4 sm:p-6"},yI={class:"space-y-2 mb-4"},bI={class:"grid grid-cols-2 gap-2"},SI={class:"text-[9px] sm:text-[10px] text-primary-500 font-medium"},wI={class:"mt-1.5 h-1 bg-secondary-700 light:bg-secondary-200 rounded-full overflow-hidden"},MI={key:2,class:"p-4 sm:p-6"},EI={class:"grid grid-cols-2 gap-2 sm:gap-3"},TI={key:3,class:"p-4 sm:p-6"},AI={class:"px-3 sm:px-6 py-2 sm:py-3 bg-secondary-800 light:bg-white border-t border-secondary-700 light:border-secondary-200 flex-shrink-0"},CI={class:"flex justify-center gap-1.5 sm:gap-3 overflow-x-auto"},RI={key:7,class:"flex-1 flex flex-col min-h-0"},PI={class:"flex items-center justify-between px-3 sm:px-6 py-2.5 sm:py-3 bg-secondary-800 light:bg-white border-b border-secondary-700 light:border-secondary-200 flex-shrink-0"},DI={class:"text-xs sm:text-sm font-bold text-primary-500"},LI={class:"flex gap-2 sm:gap-3 text-[9px] sm:text-[10px] text-secondary-400 light:text-secondary-500"},II=["onClick"],NI={class:"flex-1 overflow-y-auto min-h-0 overscroll-contain"},UI={key:0,class:"h-full flex items-center justify-center px-4 sm:px-6 bg-gradient-to-br from-primary-600/20 to-primary-500/5"},FI={class:"text-center max-w-sm"},OI={class:"text-sm sm:text-base font-bold text-white light:text-secondary-900 mb-1.5"},kI={class:"text-[9px] sm:text-[10px] text-secondary-400 light:text-secondary-500 mb-3 sm:mb-4 leading-relaxed"},BI={class:"flex gap-1.5 sm:gap-2 justify-center flex-wrap"},zI={key:1,class:"p-4 sm:p-6"},VI={class:"space-y-2"},HI={class:"text-[9px] sm:text-[10px] text-secondary-300 light:text-secondary-600 leading-relaxed"},GI={key:2,class:"p-4 sm:p-6"},WI={class:"space-y-2"},$I={__name:"ProjectPreview",props:{project:{type:Object,required:!0}},setup(n){const e=n,t=Xt(()=>{const ce=e.project.title.toLowerCase();return ce.includes("redemption")||ce.includes("merchant")?"redemption":ce.includes("e-commerce")?"ecommerce":ce.includes("task")?"task":ce.includes("weather")?"weather":ce.includes("social")||ce.includes("analytics")?"analytics":ce.includes("recipe")?"recipe":ce.includes("portfolio")||ce.includes("template")?"portfolio":"generic"}),i=[{id:1,name:"Wireless Headphones",price:89,emoji:"🎧",color:"from-purple-500 to-indigo-500"},{id:2,name:"Smart Watch",price:199,emoji:"⌚",color:"from-blue-500 to-cyan-500"},{id:3,name:"Laptop Stand",price:45,emoji:"💻",color:"from-emerald-500 to-teal-500"},{id:4,name:"Mechanical Keyboard",price:129,emoji:"⌨️",color:"from-amber-500 to-orange-500"},{id:5,name:"USB-C Hub",price:59,emoji:"🔌",color:"from-rose-500 to-pink-500"},{id:6,name:"Desk Lamp",price:35,emoji:"💡",color:"from-yellow-500 to-amber-500"}],r=xa([]),s=we(!1),o=Xt(()=>r.reduce((ce,M)=>ce+M.qty,0)),a=Xt(()=>r.reduce((ce,M)=>ce+M.price*M.qty,0)),l=ce=>{const M=r.find(A=>A.id===ce.id);M?M.qty++:r.push({...ce,qty:1})},c=ce=>{const M=r.findIndex(A=>A.id===ce);M!==-1&&r.splice(M,1)},u=(ce,M)=>{const A=r.find(H=>H.id===ce);A&&(A.qty+=M,A.qty<=0&&c(ce))},d=xa({todo:[{id:1,title:"Design landing page",tag:"Design",tagColor:"bg-purple-500/20 text-purple-400",done:!1},{id:2,title:"Set up database schema",tag:"Backend",tagColor:"bg-blue-500/20 text-blue-400",done:!1},{id:3,title:"Write API endpoints",tag:"Backend",tagColor:"bg-blue-500/20 text-blue-400",done:!1}],progress:[{id:4,title:"Build auth system",tag:"Frontend",tagColor:"bg-emerald-500/20 text-emerald-400",done:!1},{id:5,title:"Implement dark mode",tag:"UI",tagColor:"bg-amber-500/20 text-amber-400",done:!1}],done:[{id:6,title:"Project setup",tag:"Setup",tagColor:"bg-gray-500/20 text-gray-400",done:!0},{id:7,title:"Create wireframes",tag:"Design",tagColor:"bg-purple-500/20 text-purple-400",done:!0},{id:8,title:"Configure CI/CD",tag:"DevOps",tagColor:"bg-rose-500/20 text-rose-400",done:!0}]}),f=we(""),h=we("General"),m=["General","Design","Frontend","Backend","UI","DevOps"],x=()=>{f.value.trim()&&(d.todo.push({id:Date.now(),title:f.value.trim(),tag:h.value,tagColor:"bg-primary-500/20 text-primary-400",done:!1}),f.value="")},p=(ce,M)=>{const A=d[ce].find(H=>H.id===M);if(A)if(A.done=!A.done,A.done){const H=d[ce].findIndex(q=>q.id===M),[ne]=d[ce].splice(H,1);d.done.push(ne)}else{const H=d.done.findIndex(q=>q.id===M),[ne]=d.done.splice(H,1);d.todo.push(ne)}},g=(ce,M,A)=>{const H=d[ce].findIndex(q=>q.id===A);if(H===-1)return;const[ne]=d[ce].splice(H,1);d[M].push(ne)},y={Manila:{temp:28,condition:"Partly Cloudy",emoji:"⛅",humidity:72,wind:12},Tokyo:{temp:22,condition:"Clear Sky",emoji:"☀️",humidity:55,wind:8},"New York":{temp:18,condition:"Rainy",emoji:"🌧️",humidity:85,wind:20},London:{temp:15,condition:"Cloudy",emoji:"☁️",humidity:78,wind:15},Sydney:{temp:25,condition:"Sunny",emoji:"🌤️",humidity:60,wind:10}},v=we("Manila"),b=we(""),C=we("C"),R=Xt(()=>y[v.value]||y.Manila),E=Xt(()=>{const ce=R.value.temp;return C.value==="C"?ce:Math.round(ce*9/5+32)}),S=Xt(()=>{const ce=R.value.temp;return Array.from({length:6},(M,A)=>({time:`${(A+1)*3}:00`,temp:ce+[0,2,3,1,-1,-2][A],emoji:["⛅","☀️","☀️","⛅","☁️","🌙"][A]}))}),T=Xt(()=>{const ce=R.value.temp;return["Mon","Tue","Wed","Thu","Fri","Sat","Sun"].map((A,H)=>({day:A,high:ce+[2,4,3,5,1,0,-1][H],low:ce-[4,3,5,2,6,5,7][H],emoji:["⛅","☀️","🌧️","⛅","☀️","☁️","🌧️"][H]}))}),U=Xt(()=>{const ce=b.value.toLowerCase();return ce?Object.keys(y).filter(M=>M.toLowerCase().includes(ce)):Object.keys(y)}),I=ce=>{v.value=ce,b.value=""},L=xa({followers:12800,engagement:4.2,reach:45200,posts:128}),G=we("All"),B=["All","Instagram","Twitter","LinkedIn"],V={All:{followers:12800,engagement:4.2,reach:45200,posts:128},Instagram:{followers:8500,engagement:5.1,reach:28e3,posts:64},Twitter:{followers:3200,engagement:3.4,reach:12e3,posts:42},LinkedIn:{followers:1100,engagement:2.8,reach:5200,posts:22}},$=Xt(()=>{const M=(V[G.value]||V.All).followers/12800;return[30,45,38,60,52,75,68,90,82,100,88,95].map((A,H)=>({value:Math.round(A*M),label:["J","F","M","A","M","J","J","A","S","O","N","D"][H]}))}),k=ce=>{G.value=ce;const M=V[ce]||V.All;L.followers=M.followers,L.engagement=M.engagement,L.reach=M.reach,L.posts=M.posts},Z=[{id:1,name:"Creamy Garlic Pasta",time:25,rating:4.5,emoji:"🍝",category:"Dinner",color:"from-amber-500/40 to-orange-500/40"},{id:2,name:"Avocado Toast",time:10,rating:4.2,emoji:"🥑",category:"Breakfast",color:"from-emerald-500/40 to-green-500/40"},{id:3,name:"Chocolate Cake",time:45,rating:4.8,emoji:"🍰",category:"Dessert",color:"from-rose-500/40 to-pink-500/40"},{id:4,name:"Chicken Stir Fry",time:20,rating:3.9,emoji:"🍗",category:"Lunch",color:"from-red-500/40 to-orange-500/40"},{id:5,name:"Berry Smoothie",time:5,rating:4.6,emoji:"🥤",category:"Breakfast",color:"from-purple-500/40 to-indigo-500/40"},{id:6,name:"Beef Tacos",time:30,rating:4.4,emoji:"🌮",category:"Dinner",color:"from-yellow-500/40 to-amber-500/40"}],j=we("All"),F=we(""),ue=we(null),ge=["All","Breakfast","Lunch","Dinner","Dessert"],_e=Xt(()=>Z.filter(ce=>{const M=j.value==="All"||ce.category===j.value,A=ce.name.toLowerCase().includes(F.value.toLowerCase());return M&&A})),ye=ce=>{ue.value=ce},Ae=we("home"),ee=["home","about","projects","contact"],fe=ce=>{Ae.value=ce},le=we("home"),Pe=["home","features","about"],Ce=ce=>{le.value=ce};return(ce,M)=>(Y(),Q("div",F4,[_("div",O4,[M[16]||(M[16]=_("div",{class:"flex gap-1.5"},[_("span",{class:"w-2.5 h-2.5 sm:w-3 sm:h-3 rounded-full bg-accent-500"}),_("span",{class:"w-2.5 h-2.5 sm:w-3 sm:h-3 rounded-full bg-yellow-500"}),_("span",{class:"w-2.5 h-2.5 sm:w-3 sm:h-3 rounded-full bg-primary-500"})],-1)),_("div",k4,[_("div",B4,[M[15]||(M[15]=_("svg",{class:"w-2.5 h-2.5 sm:w-3 sm:h-3 flex-shrink-0",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24"},[_("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"2",d:"M12 11c0 3.517-1.009 6.799-2.753 9.571m-3.44-2.04l.054-.09A13.916 13.916 0 008 8a4 4 0 118 0c0 1.017-.07 2.019-.203 3m-2.118 6.844A21.88 21.88 0 0115.171 17m3.839 1.132c.645-2.266.99-4.659.99-7.132A8 8 0 008 4.07M3 15.364c.64-1.319 1-2.8 1-4.364 0-1.457.39-2.823 1.07-4"})],-1)),_("span",z4,pe(n.project.demo),1)])])]),t.value==="redemption"?(Y(),Yn(my,{key:0,"show-chrome":!1,class:"flex-1 min-h-0"})):t.value==="ecommerce"?(Y(),Q("div",V4,[_("div",H4,[M[19]||(M[19]=_("div",{class:"text-primary-500 font-bold text-xs sm:text-sm"},"🛍️ ShopHub",-1)),_("div",G4,[M[18]||(M[18]=_("div",{class:"hidden sm:flex gap-3 text-[10px] text-secondary-400 light:text-secondary-500"},[_("span",{class:"cursor-pointer hover:text-primary-500 transition-colors"},"Home"),_("span",{class:"cursor-pointer hover:text-primary-500 transition-colors"},"Products"),_("span",{class:"cursor-pointer hover:text-primary-500 transition-colors"},"About")],-1)),_("button",{onClick:M[0]||(M[0]=A=>s.value=!s.value),class:"relative w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-primary-500/20 flex items-center justify-center hover:bg-primary-500/30 transition-colors cursor-pointer","aria-label":"Open cart"},[M[17]||(M[17]=_("svg",{class:"w-4 h-4 sm:w-5 sm:h-5 text-primary-500",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24"},[_("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"2",d:"M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z"})],-1)),o.value>0?(Y(),Q("span",W4,pe(o.value),1)):qt("",!0)])])]),M[25]||(M[25]=Rs('<div class="px-3 sm:px-6 py-3 sm:py-4 bg-gradient-to-r from-primary-600 to-primary-500 flex-shrink-0" data-v-67e9e612><div class="text-white" data-v-67e9e612><div class="text-[9px] sm:text-[10px] uppercase tracking-wider opacity-80 mb-1" data-v-67e9e612>Summer Sale</div><div class="text-xs sm:text-sm font-bold mb-1.5 sm:mb-2" data-v-67e9e612>Up to 50% Off Everything</div><div class="inline-block bg-white text-primary-600 text-[9px] sm:text-[10px] font-semibold px-2.5 sm:px-3 py-1 rounded-full cursor-pointer hover:bg-primary-50 transition-colors" data-v-67e9e612>Shop Now →</div></div></div>',1)),_("div",$4,[(Y(),Q(We,null,it(i,A=>_("div",{key:A.id,class:"bg-secondary-800 light:bg-white rounded-lg p-2 sm:p-2.5 border border-secondary-700 light:border-secondary-200 hover:border-primary-500/50 transition-all duration-200 cursor-pointer hover:shadow-lg hover:shadow-primary-500/10"},[_("div",{class:rt(["aspect-square rounded-md bg-gradient-to-br mb-2 flex items-center justify-center text-2xl sm:text-3xl",A.color])},[_("span",null,pe(A.emoji),1)],2),_("div",X4,pe(A.name),1),_("div",j4,[_("div",Y4,"$"+pe(A.price),1),_("button",{onClick:Ds(H=>l(A),["stop"]),class:"w-5 h-5 sm:w-6 sm:h-6 rounded bg-primary-500 hover:bg-primary-400 flex items-center justify-center transition-colors cursor-pointer","aria-label":"Add to cart"},[...M[20]||(M[20]=[_("svg",{class:"w-3 h-3 sm:w-3.5 sm:h-3.5 text-white",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24"},[_("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"2",d:"M12 4v16m8-8H4"})],-1)])],8,q4)])])),64))]),et(Na,{name:"slide"},{default:Uo(()=>[s.value?(Y(),Q("div",K4,[_("div",Z4,[M[22]||(M[22]=_("span",{class:"text-xs font-semibold text-white light:text-secondary-900"},"Shopping Cart",-1)),_("button",{onClick:M[1]||(M[1]=A=>s.value=!1),class:"text-secondary-400 hover:text-white light:hover:text-secondary-900 transition-colors cursor-pointer","aria-label":"Close cart"},[...M[21]||(M[21]=[_("svg",{class:"w-4 h-4",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24"},[_("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"2",d:"M6 18L18 6M6 6l12 12"})],-1)])])]),_("div",J4,[r.length===0?(Y(),Q("div",Q4,[...M[23]||(M[23]=[_("div",{class:"text-3xl mb-2"},"🛒",-1),_("p",{class:"text-xs text-secondary-400 light:text-secondary-500"},"Your cart is empty",-1),_("p",{class:"text-[10px] text-secondary-500 light:text-secondary-400 mt-1"},"Add some products!",-1)])])):qt("",!0),(Y(!0),Q(We,null,it(r,A=>(Y(),Q("div",{key:A.id,class:"flex items-center gap-3 bg-secondary-700/50 light:bg-secondary-100 rounded-lg p-2.5"},[_("div",{class:rt(["w-8 h-8 rounded-md bg-gradient-to-br flex items-center justify-center text-sm flex-shrink-0",A.color])},pe(A.emoji),3),_("div",eD,[_("div",tD,pe(A.name),1),_("div",nD,"$"+pe(A.price),1)]),_("div",iD,[_("button",{onClick:H=>u(A.id,-1),class:"w-4 h-4 rounded bg-secondary-600 light:bg-secondary-200 text-white light:text-secondary-900 text-[9px] flex items-center justify-center hover:bg-accent-500 transition-colors cursor-pointer"},"−",8,rD),_("span",sD,pe(A.qty),1),_("button",{onClick:H=>u(A.id,1),class:"w-4 h-4 rounded bg-secondary-600 light:bg-secondary-200 text-white light:text-secondary-900 text-[9px] flex items-center justify-center hover:bg-primary-500 transition-colors cursor-pointer"},"+",8,oD)])]))),128))]),_("div",aD,[_("div",lD,[M[24]||(M[24]=_("span",{class:"text-[10px] text-secondary-400 light:text-secondary-500"},"Total",-1)),_("span",cD,"$"+pe(a.value.toFixed(2)),1)]),_("button",{onClick:M[2]||(M[2]=A=>s.value=!1),class:"w-full py-2 rounded-lg bg-primary-600 hover:bg-primary-500 text-white text-[10px] font-semibold transition-colors cursor-pointer"}," Checkout ")])])):qt("",!0)]),_:1})])):t.value==="task"?(Y(),Q("div",uD,[M[30]||(M[30]=Rs('<div class="flex items-center justify-between px-3 sm:px-6 py-2.5 sm:py-3 bg-secondary-800 light:bg-white border-b border-secondary-700 light:border-secondary-200 flex-shrink-0" data-v-67e9e612><div class="flex items-center gap-2" data-v-67e9e612><div class="w-5 h-5 sm:w-6 sm:h-6 rounded bg-primary-500 flex items-center justify-center" data-v-67e9e612><svg class="w-3 h-3 sm:w-3.5 sm:h-3.5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-67e9e612><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4" data-v-67e9e612></path></svg></div><span class="text-xs sm:text-sm font-semibold text-white light:text-secondary-900" data-v-67e9e612>TaskFlow</span></div><div class="flex items-center gap-1.5 sm:gap-2" data-v-67e9e612><div class="w-5 h-5 sm:w-6 sm:h-6 rounded-full bg-primary-500/20 flex items-center justify-center text-[9px] sm:text-[10px] text-primary-500 font-bold" data-v-67e9e612>+</div><div class="w-5 h-5 sm:w-6 sm:h-6 rounded-full bg-accent-500/20 flex items-center justify-center text-[9px] sm:text-[10px] text-accent-500 font-bold" data-v-67e9e612>A</div><div class="w-5 h-5 sm:w-6 sm:h-6 rounded-full bg-yellow-500/20 flex items-center justify-center text-[9px] sm:text-[10px] text-yellow-500 font-bold" data-v-67e9e612>B</div></div></div>',1)),_("div",dD,[_("div",fD,[wc(_("input",{"onUpdate:modelValue":M[3]||(M[3]=A=>f.value=A),onKeyup:Xb(x,["enter"]),type:"text",placeholder:"Add a new task...",class:"flex-1 bg-secondary-700/50 light:bg-white border border-secondary-600 light:border-secondary-200 rounded-lg px-3 py-1.5 text-[10px] sm:text-xs text-white light:text-secondary-900 placeholder-secondary-500 light:placeholder-secondary-400 focus:outline-none focus:border-primary-500 transition-colors"},null,544),[[zd,f.value]]),wc(_("select",{"onUpdate:modelValue":M[4]||(M[4]=A=>h.value=A),class:"bg-secondary-700/50 light:bg-white border border-secondary-600 light:border-secondary-200 rounded-lg px-2 py-1.5 text-[9px] sm:text-[10px] text-secondary-300 light:text-secondary-600 focus:outline-none focus:border-primary-500 transition-colors cursor-pointer"},[(Y(),Q(We,null,it(m,A=>_("option",{key:A,value:A},pe(A),9,hD)),64))],512),[[Hb,h.value]]),_("button",{onClick:x,class:"px-3 py-1.5 rounded-lg bg-primary-600 hover:bg-primary-500 text-white text-[10px] sm:text-xs font-semibold transition-colors cursor-pointer flex-shrink-0"}," Add ")])]),_("div",pD,[_("div",mD,[_("div",gD,[M[26]||(M[26]=_("span",{class:"text-[9px] sm:text-[10px] font-semibold text-secondary-400 light:text-secondary-500"},"TO DO",-1)),_("span",_D,pe(d.todo.length),1)]),_("div",xD,[(Y(!0),Q(We,null,it(d.todo,A=>(Y(),Q("div",{key:A.id,class:"bg-secondary-800 light:bg-white rounded-md p-2 sm:p-2.5 border border-secondary-700 light:border-secondary-200 hover:border-primary-500/40 transition-colors cursor-pointer group",onClick:H=>g("todo","progress",A.id)},[_("div",yD,[_("button",{onClick:Ds(H=>p("todo",A.id),["stop"]),class:"w-3.5 h-3.5 sm:w-4 sm:h-4 rounded-full border border-secondary-500 light:border-secondary-300 flex-shrink-0 mt-0.5 hover:border-primary-500 transition-colors cursor-pointer","aria-label":"Mark as done"},null,8,bD),_("div",SD,[_("div",wD,pe(A.title),1),_("span",{class:rt(["inline-block mt-1 px-1.5 py-0.5 rounded-full text-[7px] sm:text-[8px] font-medium",A.tagColor])},pe(A.tag),3)])])],8,vD))),128))])]),_("div",MD,[_("div",ED,[M[27]||(M[27]=_("span",{class:"text-[9px] sm:text-[10px] font-semibold text-primary-500"},"IN PROGRESS",-1)),_("span",TD,pe(d.progress.length),1)]),_("div",AD,[(Y(!0),Q(We,null,it(d.progress,A=>(Y(),Q("div",{key:A.id,class:"bg-secondary-800 light:bg-white rounded-md p-2 sm:p-2.5 border border-primary-500/30 hover:border-primary-500/60 transition-colors cursor-pointer group",onClick:H=>g("progress","done",A.id)},[_("div",RD,[_("button",{onClick:Ds(H=>p("progress",A.id),["stop"]),class:"w-3.5 h-3.5 sm:w-4 sm:h-4 rounded-full border border-primary-500 flex-shrink-0 mt-0.5 hover:bg-primary-500/20 transition-colors cursor-pointer","aria-label":"Mark as done"},null,8,PD),_("div",DD,[_("div",LD,pe(A.title),1),_("span",{class:rt(["inline-block mt-1 px-1.5 py-0.5 rounded-full text-[7px] sm:text-[8px] font-medium",A.tagColor])},pe(A.tag),3)])])],8,CD))),128))])]),_("div",ID,[_("div",ND,[M[28]||(M[28]=_("span",{class:"text-[9px] sm:text-[10px] font-semibold text-primary-500"},"DONE",-1)),_("span",UD,pe(d.done.length),1)]),_("div",FD,[(Y(!0),Q(We,null,it(d.done,A=>(Y(),Q("div",{key:A.id,class:"bg-secondary-800 light:bg-white rounded-md p-2 sm:p-2.5 border border-secondary-700 light:border-secondary-200 opacity-70 hover:opacity-100 transition-opacity cursor-pointer",onClick:H=>p("done",A.id)},[_("div",kD,[M[29]||(M[29]=_("div",{class:"w-3.5 h-3.5 sm:w-4 sm:h-4 rounded-full bg-primary-500 flex items-center justify-center flex-shrink-0 mt-0.5"},[_("svg",{class:"w-2 h-2 sm:w-2.5 sm:h-2.5 text-white",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24"},[_("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"3",d:"M5 13l4 4L19 7"})])],-1)),_("div",BD,[_("div",zD,pe(A.title),1),_("span",{class:rt(["inline-block mt-1 px-1.5 py-0.5 rounded-full text-[7px] sm:text-[8px] font-medium",A.tagColor])},pe(A.tag),3)])])],8,OD))),128))])])])])):t.value==="weather"?(Y(),Q("div",VD,[_("div",HD,[M[31]||(M[31]=_("div",{class:"flex items-center gap-2"},[_("span",{class:"text-base sm:text-lg"},"🌤️"),_("span",{class:"text-xs sm:text-sm font-semibold text-white light:text-secondary-900"},"SkyCast")],-1)),_("div",GD,[_("div",WD,[_("button",{onClick:M[5]||(M[5]=A=>C.value="C"),class:rt(["px-2 py-0.5 text-[9px] sm:text-[10px] font-semibold transition-colors cursor-pointer",C.value==="C"?"bg-primary-600 text-white":"text-secondary-400 light:text-secondary-500 hover:text-white light:hover:text-secondary-900"])},"°C",2),_("button",{onClick:M[6]||(M[6]=A=>C.value="F"),class:rt(["px-2 py-0.5 text-[9px] sm:text-[10px] font-semibold transition-colors cursor-pointer",C.value==="F"?"bg-primary-600 text-white":"text-secondary-400 light:text-secondary-500 hover:text-white light:hover:text-secondary-900"])},"°F",2)])])]),_("div",$D,[_("div",XD,[_("div",jD,[M[32]||(M[32]=_("svg",{class:"w-3 h-3 sm:w-3.5 sm:h-3.5 absolute left-2.5 top-1/2 -translate-y-1/2 text-secondary-500 light:text-secondary-400",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24"},[_("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"2",d:"M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"})],-1)),wc(_("input",{"onUpdate:modelValue":M[7]||(M[7]=A=>b.value=A),type:"text",placeholder:"Search city...",class:"w-full bg-secondary-700/50 light:bg-white border border-secondary-600 light:border-secondary-200 rounded-lg pl-7 pr-3 py-1.5 text-[10px] sm:text-xs text-white light:text-secondary-900 placeholder-secondary-500 light:placeholder-secondary-400 focus:outline-none focus:border-primary-500 transition-colors"},null,512),[[zd,b.value]])])]),b.value?(Y(),Q("div",YD,[(Y(!0),Q(We,null,it(U.value,A=>(Y(),Q("button",{key:A,onClick:H=>I(A),class:"w-full px-3 py-2 text-left text-[10px] sm:text-xs text-secondary-300 light:text-secondary-600 hover:bg-primary-500/10 hover:text-primary-500 transition-colors cursor-pointer flex items-center gap-2"},[_("span",null,pe(y[A].emoji),1),_("span",null,pe(A),1),_("span",KD,pe(y[A].temp)+"°",1)],8,qD))),128))])):qt("",!0)]),_("div",ZD,[_("div",JD,[_("div",null,[_("div",QD,pe(E.value)+"°"+pe(C.value),1),_("div",eL,pe(R.value.condition),1),_("div",tL,pe(v.value)+" • 💧 "+pe(R.value.humidity)+"% • 🌬️ "+pe(R.value.wind)+" km/h",1)]),_("div",nL,pe(R.value.emoji),1)])]),_("div",iL,[M[33]||(M[33]=_("div",{class:"text-[9px] sm:text-[10px] font-semibold text-secondary-400 light:text-secondary-500 mb-1.5 uppercase tracking-wider"},"Hourly Forecast",-1)),_("div",rL,[(Y(!0),Q(We,null,it(S.value,(A,H)=>(Y(),Q("div",{key:H,class:"flex-1 min-w-[50px] sm:min-w-0 bg-secondary-800 light:bg-white rounded-lg p-1.5 sm:p-2 text-center border border-secondary-700 light:border-secondary-200 hover:border-primary-500/40 transition-colors cursor-pointer"},[_("div",sL,pe(A.time),1),_("div",oL,pe(A.emoji),1),_("div",aL,pe(A.temp)+"°",1)]))),128))])]),_("div",lL,[M[34]||(M[34]=_("div",{class:"text-[9px] sm:text-[10px] font-semibold text-secondary-400 light:text-secondary-500 mb-1.5 uppercase tracking-wider"},"7-Day Forecast",-1)),_("div",cL,[(Y(!0),Q(We,null,it(T.value,(A,H)=>(Y(),Q("div",{key:H,class:"flex items-center justify-between bg-secondary-800 light:bg-white rounded-md px-2.5 sm:px-3 py-1.5 sm:py-2 border border-secondary-700 light:border-secondary-200 hover:border-primary-500/40 transition-colors cursor-pointer"},[_("span",uL,pe(A.day),1),_("span",dL,pe(A.emoji),1),_("div",fL,[_("div",{class:"h-full bg-gradient-to-r from-yellow-500 to-primary-500 rounded-full",style:Gt({width:(A.high-10)*5+"%"})},null,4)]),_("span",hL,pe(A.high)+"° / "+pe(A.low)+"°",1)]))),128))])])])):t.value==="analytics"?(Y(),Q("div",pL,[_("div",mL,[_("div",gL,[M[36]||(M[36]=_("div",{class:"w-6 h-6 sm:w-7 sm:h-7 rounded-lg bg-primary-500 flex items-center justify-center"},[_("svg",{class:"w-3.5 h-3.5 sm:w-4 sm:h-4 text-white",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24"},[_("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"2",d:"M13 7h8m0 0v8m0-8l-8 8-4-4-6 6"})])],-1)),(Y(),Q(We,null,it(4,A=>_("div",{key:A,class:"w-5 h-5 sm:w-6 sm:h-6 rounded-md bg-secondary-700/50 light:bg-secondary-200 flex items-center justify-center cursor-pointer hover:bg-primary-500/20 transition-colors"},[...M[35]||(M[35]=[_("div",{class:"w-2.5 h-2.5 sm:w-3 sm:h-3 rounded-sm bg-secondary-500 light:bg-secondary-400"},null,-1)])])),64))]),_("div",_L,[_("div",xL,[(Y(),Q(We,null,it(B,A=>_("button",{key:A,onClick:H=>k(A),class:rt(["px-2 sm:px-3 py-1 rounded-full text-[8px] sm:text-[9px] font-medium transition-all cursor-pointer",G.value===A?"bg-primary-600 text-white shadow-md shadow-primary-500/25":"bg-secondary-800 light:bg-white text-secondary-400 light:text-secondary-500 border border-secondary-700 light:border-secondary-200 hover:text-white light:hover:text-secondary-900"])},pe(A),11,vL)),64))]),_("div",yL,[_("div",bL,[M[37]||(M[37]=_("div",{class:"text-[8px] sm:text-[9px] text-secondary-500 light:text-secondary-400 mb-0.5"},"Followers",-1)),_("div",SL,pe(L.followers.toLocaleString()),1),M[38]||(M[38]=_("div",{class:"text-[8px] sm:text-[9px] text-primary-500 mt-0.5"},"▲ 12%",-1))]),_("div",wL,[M[39]||(M[39]=_("div",{class:"text-[8px] sm:text-[9px] text-secondary-500 light:text-secondary-400 mb-0.5"},"Engagement",-1)),_("div",ML,pe(L.engagement)+"%",1),M[40]||(M[40]=_("div",{class:"text-[8px] sm:text-[9px] text-primary-500 mt-0.5"},"▲ 0.8%",-1))]),_("div",EL,[M[41]||(M[41]=_("div",{class:"text-[8px] sm:text-[9px] text-secondary-500 light:text-secondary-400 mb-0.5"},"Reach",-1)),_("div",TL,pe(L.reach.toLocaleString()),1),M[42]||(M[42]=_("div",{class:"text-[8px] sm:text-[9px] text-primary-500 mt-0.5"},"▲ 23%",-1))]),_("div",AL,[M[43]||(M[43]=_("div",{class:"text-[8px] sm:text-[9px] text-secondary-500 light:text-secondary-400 mb-0.5"},"Posts",-1)),_("div",CL,pe(L.posts),1),M[44]||(M[44]=_("div",{class:"text-[8px] sm:text-[9px] text-primary-500 mt-0.5"},"▲ 5%",-1))])]),_("div",RL,[M[45]||(M[45]=_("div",{class:"text-[9px] sm:text-[10px] font-semibold text-secondary-400 light:text-secondary-500 mb-2"},"Engagement Over Time",-1)),_("div",PL,[(Y(!0),Q(We,null,it($.value,(A,H)=>(Y(),Q("div",{key:H,class:"flex-1 flex flex-col items-center gap-1 group cursor-pointer",onMouseenter:ne=>A.hover=!0,onMouseleave:ne=>A.hover=!1},[_("div",{class:rt(["w-full rounded-t bg-gradient-to-t from-primary-600 to-primary-400 transition-all duration-300 group-hover:from-primary-500 group-hover:to-primary-300",{"opacity-40":H%3===0}]),style:Gt({height:A.value+"%"})},null,6),_("span",LL,pe(A.label),1)],40,DL))),128))])]),_("div",IL,[_("div",NL,[M[46]||(M[46]=_("div",{class:"text-[9px] sm:text-[10px] font-semibold text-secondary-400 light:text-secondary-500 mb-2"},"Platforms",-1)),_("div",UL,[(Y(),Q(We,null,it(["Instagram","Twitter","LinkedIn"],(A,H)=>_("div",{key:A,class:"flex items-center gap-2 cursor-pointer hover:bg-secondary-700/30 light:hover:bg-secondary-100 rounded-md px-1.5 py-1 transition-colors",onClick:ne=>k(A)},[_("div",{class:rt(["w-3.5 h-3.5 sm:w-4 sm:h-4 rounded-full",["bg-primary-500","bg-accent-500","bg-yellow-500"][H]])},null,2),_("span",OL,pe(A),1),_("span",kL,pe([45,30,25][H])+"%",1)],8,FL)),64))])]),_("div",BL,[M[48]||(M[48]=_("div",{class:"text-[9px] sm:text-[10px] font-semibold text-secondary-400 light:text-secondary-500 mb-2"},"Top Posts",-1)),_("div",zL,[(Y(),Q(We,null,it(3,A=>_("div",{key:A,class:"flex items-center gap-2 cursor-pointer hover:bg-secondary-700/30 light:hover:bg-secondary-100 rounded-md px-1.5 py-1 transition-colors"},[_("div",{class:rt(["w-5 h-5 sm:w-6 sm:h-6 rounded bg-gradient-to-br flex items-center justify-center text-[10px] sm:text-xs flex-shrink-0",["from-primary-500/30 to-primary-500/10","from-accent-500/30 to-accent-500/10","from-yellow-500/30 to-yellow-500/10"][A-1]])},pe(["📸","🐦","💼"][A-1]),3),M[47]||(M[47]=_("div",{class:"flex-1 min-w-0"},[_("div",{class:"h-1.5 bg-secondary-700 light:bg-secondary-200 rounded mb-1 w-4/5"}),_("div",{class:"h-1 bg-secondary-700 light:bg-secondary-200 rounded w-1/2"})],-1)),_("span",VL,pe([1200,890,650][A-1]),1)])),64))])])])])])])):t.value==="recipe"?(Y(),Q("div",HL,[_("div",GL,[M[51]||(M[51]=Rs('<div class="flex items-center justify-between mb-2" data-v-67e9e612><div class="text-xs sm:text-sm font-bold text-primary-500" data-v-67e9e612>🍳 FlavorFind</div><div class="w-6 h-6 sm:w-7 sm:h-7 rounded-full bg-primary-500/20 flex items-center justify-center cursor-pointer hover:bg-primary-500/30 transition-colors" data-v-67e9e612><svg class="w-3.5 h-3.5 sm:w-4 sm:h-4 text-primary-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-67e9e612><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" data-v-67e9e612></path></svg></div></div>',1)),_("div",WL,[_("div",$L,[M[49]||(M[49]=_("svg",{class:"w-3 h-3 sm:w-3.5 sm:h-3.5 absolute left-2.5 top-1/2 -translate-y-1/2 text-secondary-500 light:text-secondary-400",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24"},[_("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"2",d:"M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"})],-1)),wc(_("input",{"onUpdate:modelValue":M[8]||(M[8]=A=>F.value=A),type:"text",placeholder:"Search recipes...",class:"w-full bg-secondary-700/50 light:bg-secondary-100 rounded-lg pl-7 pr-3 py-1.5 sm:py-2 text-[10px] sm:text-xs text-white light:text-secondary-900 placeholder-secondary-500 light:placeholder-secondary-400 focus:outline-none focus:border-primary-500 border border-transparent focus:border-primary-500/50 transition-colors"},null,512),[[zd,F.value]])]),M[50]||(M[50]=_("button",{class:"bg-primary-500 hover:bg-primary-400 rounded-lg px-3 sm:px-4 py-1.5 sm:py-2 flex items-center transition-colors cursor-pointer"},[_("span",{class:"text-[10px] sm:text-xs text-white font-semibold"},"Search")],-1))])]),_("div",XL,[(Y(),Q(We,null,it(ge,A=>_("button",{key:A,onClick:H=>j.value=A,class:rt(["px-2.5 sm:px-3 py-1 rounded-full text-[8px] sm:text-[9px] font-medium whitespace-nowrap transition-all cursor-pointer",j.value===A?"bg-primary-500 text-white shadow-md shadow-primary-500/25":"bg-secondary-800 light:bg-white text-secondary-400 light:text-secondary-500 border border-secondary-700 light:border-secondary-200 hover:text-white light:hover:text-secondary-900"])},pe(A),11,jL)),64))]),_("div",YL,[(Y(!0),Q(We,null,it(_e.value,A=>(Y(),Q("div",{key:A.id,onClick:H=>ye(A),class:"bg-secondary-800 light:bg-white rounded-lg overflow-hidden border border-secondary-700 light:border-secondary-200 hover:border-primary-500/50 hover:shadow-lg hover:shadow-primary-500/10 transition-all duration-200 cursor-pointer"},[_("div",{class:rt(["h-14 sm:h-16 bg-gradient-to-br relative flex items-center justify-center text-2xl sm:text-3xl",A.color])},[_("span",null,pe(A.emoji),1),_("div",KL,"⏱ "+pe(A.time)+" min",1)],2),_("div",ZL,[_("div",JL,pe(A.name),1),_("div",QL,[M[52]||(M[52]=_("span",{class:"text-yellow-500 text-[9px] sm:text-[10px]"},"★",-1)),_("span",eI,pe(A.rating),1),_("span",tI,pe(A.category),1)])])],8,qL))),128)),_e.value.length===0?(Y(),Q("div",nI,[...M[53]||(M[53]=[_("div",{class:"text-3xl mb-2"},"🔍",-1),_("p",{class:"text-xs text-secondary-400 light:text-secondary-500"},"No recipes found",-1)])])):qt("",!0)]),et(Na,{name:"fade"},{default:Uo(()=>[ue.value?(Y(),Q("div",{key:0,class:"absolute inset-0 bg-dark-900/80 light:bg-secondary-900/80 backdrop-blur-sm z-20 flex items-center justify-center p-4",onClick:M[12]||(M[12]=A=>ue.value=null)},[_("div",{class:"bg-secondary-800 light:bg-white rounded-xl max-w-sm w-full p-5 border border-secondary-700 light:border-secondary-200 shadow-2xl",onClick:M[11]||(M[11]=Ds(()=>{},["stop"]))},[_("div",iI,[_("div",rI,pe(ue.value.emoji),1),_("button",{onClick:M[9]||(M[9]=A=>ue.value=null),class:"text-secondary-400 hover:text-white light:hover:text-secondary-900 transition-colors cursor-pointer","aria-label":"Close recipe"},[...M[54]||(M[54]=[_("svg",{class:"w-4 h-4",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24"},[_("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"2",d:"M6 18L18 6M6 6l12 12"})],-1)])])]),_("h3",sI,pe(ue.value.name),1),_("div",oI,[_("span",aI,"★ "+pe(ue.value.rating),1),M[55]||(M[55]=_("span",{class:"text-[9px] text-secondary-500 light:text-secondary-400"},"•",-1)),_("span",lI,"⏱ "+pe(ue.value.time)+" min",1),M[56]||(M[56]=_("span",{class:"text-[9px] text-secondary-500 light:text-secondary-400"},"•",-1)),_("span",cI,pe(ue.value.category),1)]),_("div",uI,[(Y(),Q(We,null,it(4,A=>_("div",{key:A,class:"flex items-center gap-2"},[M[57]||(M[57]=_("div",{class:"w-1.5 h-1.5 rounded-full bg-primary-500 flex-shrink-0"},null,-1)),_("div",{class:"h-1.5 bg-secondary-700 light:bg-secondary-200 rounded flex-1",style:Gt({width:60+A*8+"%"})},null,4)])),64))]),_("button",{onClick:M[10]||(M[10]=A=>ue.value=null),class:"w-full py-2 rounded-lg bg-primary-600 hover:bg-primary-500 text-white text-[10px] font-semibold transition-colors cursor-pointer"}," Start Cooking ")])])):qt("",!0)]),_:1})])):t.value==="portfolio"?(Y(),Q("div",dI,[_("div",fI,[M[58]||(M[58]=_("div",{class:"text-xs sm:text-sm font-bold text-primary-500"},"👨‍💻 DevName",-1)),_("div",hI,[(Y(),Q(We,null,it(ee,A=>_("button",{key:A,onClick:H=>fe(A),class:rt(["capitalize cursor-pointer transition-colors",Ae.value===A?"text-primary-500 font-semibold":"hover:text-white light:hover:text-secondary-900"])},pe(A),11,pI)),64))])]),_("div",mI,[Ae.value==="home"?(Y(),Q("div",gI,[_("div",_I,[M[59]||(M[59]=Rs('<div class="w-14 h-14 sm:w-16 sm:h-16 rounded-full bg-gradient-to-br from-primary-500 to-primary-700 mx-auto mb-3 sm:mb-4 flex items-center justify-center" data-v-67e9e612><svg class="w-7 h-7 sm:w-8 sm:h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-67e9e612><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" data-v-67e9e612></path></svg></div><div class="text-base sm:text-lg font-bold text-white light:text-secondary-900 mb-1.5" data-v-67e9e612>Hi, I&#39;m a Developer</div><div class="text-[9px] sm:text-[10px] text-secondary-400 light:text-secondary-500 mb-3 sm:mb-4" data-v-67e9e612>Building beautiful web experiences</div>',3)),_("div",xI,[_("button",{onClick:M[13]||(M[13]=A=>fe("projects")),class:"bg-primary-500 hover:bg-primary-400 text-white text-[9px] sm:text-[10px] font-semibold px-3 sm:px-4 py-1.5 rounded-full transition-colors cursor-pointer"},"View Work"),_("button",{onClick:M[14]||(M[14]=A=>fe("contact")),class:"border border-secondary-600 light:border-secondary-300 text-secondary-300 light:text-secondary-600 hover:text-white light:hover:text-secondary-900 text-[9px] sm:text-[10px] font-semibold px-3 sm:px-4 py-1.5 rounded-full transition-colors cursor-pointer"},"Contact Me")])])])):Ae.value==="about"?(Y(),Q("div",vI,[M[60]||(M[60]=_("h3",{class:"text-sm sm:text-base font-bold text-white light:text-secondary-900 mb-3"},"About Me",-1)),_("div",yI,[(Y(),Q(We,null,it(4,A=>_("div",{key:A,class:"h-2 bg-secondary-700 light:bg-secondary-200 rounded",style:Gt({width:70+A*5+"%"})},null,4)),64))]),_("div",bI,[(Y(),Q(We,null,it(["Vue.js","React","Node.js","TypeScript","Tailwind","GraphQL"],A=>_("div",{key:A,class:"bg-secondary-800 light:bg-white rounded-lg p-2.5 border border-secondary-700 light:border-secondary-200 text-center"},[_("div",SI,pe(A),1),_("div",wI,[_("div",{class:"h-full bg-primary-500 rounded-full",style:Gt({width:60+A.length*3+"%"})},null,4)])])),64))])])):Ae.value==="projects"?(Y(),Q("div",MI,[M[62]||(M[62]=_("h3",{class:"text-sm sm:text-base font-bold text-white light:text-secondary-900 mb-3"},"My Projects",-1)),_("div",EI,[(Y(),Q(We,null,it(4,A=>_("div",{key:A,class:"bg-secondary-800 light:bg-white rounded-lg overflow-hidden border border-secondary-700 light:border-secondary-200 hover:border-primary-500/50 transition-colors cursor-pointer"},[_("div",{class:rt(["h-12 sm:h-16 bg-gradient-to-br flex items-center justify-center text-xl sm:text-2xl",["from-primary-500/30 to-primary-500/10","from-accent-500/30 to-accent-500/10","from-yellow-500/30 to-yellow-500/10","from-blue-500/30 to-blue-500/10"][A-1]])},pe(["📱","🌐","🎮","📊"][A-1]),3),M[61]||(M[61]=_("div",{class:"p-2 sm:p-2.5"},[_("div",{class:"h-1.5 bg-secondary-700 light:bg-secondary-200 rounded mb-1 w-4/5"}),_("div",{class:"h-1 bg-secondary-700 light:bg-secondary-200 rounded w-1/2"})],-1))])),64))])])):(Y(),Q("div",TI,[...M[63]||(M[63]=[Rs('<h3 class="text-sm sm:text-base font-bold text-white light:text-secondary-900 mb-3" data-v-67e9e612>Get In Touch</h3><div class="space-y-2 mb-4" data-v-67e9e612><div class="flex items-center gap-2 bg-secondary-800 light:bg-white rounded-lg p-2.5 border border-secondary-700 light:border-secondary-200" data-v-67e9e612><span class="text-base" data-v-67e9e612>📧</span><span class="text-[9px] sm:text-[10px] text-secondary-400 light:text-secondary-500" data-v-67e9e612>hello@devname.com</span></div><div class="flex items-center gap-2 bg-secondary-800 light:bg-white rounded-lg p-2.5 border border-secondary-700 light:border-secondary-200" data-v-67e9e612><span class="text-base" data-v-67e9e612>💼</span><span class="text-[9px] sm:text-[10px] text-secondary-400 light:text-secondary-500" data-v-67e9e612>linkedin.com/in/devname</span></div><div class="flex items-center gap-2 bg-secondary-800 light:bg-white rounded-lg p-2.5 border border-secondary-700 light:border-secondary-200" data-v-67e9e612><span class="text-base" data-v-67e9e612>🐙</span><span class="text-[9px] sm:text-[10px] text-secondary-400 light:text-secondary-500" data-v-67e9e612>github.com/devname</span></div></div><button class="w-full py-2 rounded-lg bg-primary-600 hover:bg-primary-500 text-white text-[10px] font-semibold transition-colors cursor-pointer" data-v-67e9e612>Send Message</button>',3)])]))]),_("div",AI,[_("div",CI,[(Y(),Q(We,null,it(["Vue","React","Node","Python","Go"],A=>_("div",{key:A,class:"px-2 sm:px-2.5 py-0.5 sm:py-1 rounded-md bg-secondary-700/50 light:bg-secondary-100 text-[8px] sm:text-[9px] text-secondary-400 light:text-secondary-500 border border-secondary-700 light:border-secondary-200 whitespace-nowrap"},pe(A),1)),64))])])])):(Y(),Q("div",RI,[_("div",PI,[_("div",DI,pe(n.project.title),1),_("div",LI,[(Y(),Q(We,null,it(Pe,A=>_("button",{key:A,onClick:H=>Ce(A),class:rt(["capitalize cursor-pointer transition-colors",le.value===A?"text-primary-500 font-semibold":"hover:text-white light:hover:text-secondary-900"])},pe(A),11,II)),64))])]),_("div",NI,[le.value==="home"?(Y(),Q("div",UI,[_("div",FI,[M[64]||(M[64]=_("div",{class:"w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-primary-500/20 mx-auto mb-2 sm:mb-3 flex items-center justify-center"},[_("svg",{class:"w-5 h-5 sm:w-6 sm:h-6 text-primary-500",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24"},[_("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"1.5",d:"M4 5a1 1 0 011-1h14a1 1 0 011 1v14a1 1 0 01-1 1H5a1 1 0 01-1-1V5z"}),_("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"1.5",d:"M8 9h8M8 13h5"})])],-1)),_("div",OI,pe(n.project.title),1),_("div",kI,pe(n.project.description),1),_("div",BI,[(Y(!0),Q(We,null,it(n.project.tech.slice(0,3),A=>(Y(),Q("div",{key:A,class:"px-2 sm:px-2.5 py-0.5 sm:py-1 rounded-full bg-primary-500/10 text-[8px] sm:text-[9px] text-primary-500 border border-primary-500/20"},pe(A),1))),128))])])])):le.value==="features"?(Y(),Q("div",zI,[M[66]||(M[66]=_("h3",{class:"text-sm sm:text-base font-bold text-white light:text-secondary-900 mb-3"},"Features",-1)),_("div",VI,[(Y(!0),Q(We,null,it(n.project.features||["Feature 1","Feature 2","Feature 3","Feature 4"],(A,H)=>(Y(),Q("div",{key:H,class:"flex items-start gap-2 bg-secondary-800 light:bg-white rounded-lg p-2.5 sm:p-3 border border-secondary-700 light:border-secondary-200"},[M[65]||(M[65]=_("div",{class:"w-5 h-5 sm:w-6 sm:h-6 rounded-full bg-primary-500/20 flex items-center justify-center flex-shrink-0"},[_("svg",{class:"w-3 h-3 sm:w-3.5 sm:h-3.5 text-primary-500",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24"},[_("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"2",d:"M5 13l4 4L19 7"})])],-1)),_("span",HI,pe(A),1)]))),128))])])):(Y(),Q("div",GI,[M[67]||(M[67]=_("h3",{class:"text-sm sm:text-base font-bold text-white light:text-secondary-900 mb-3"},"About",-1)),_("div",WI,[(Y(),Q(We,null,it(5,A=>_("div",{key:A,class:"h-2 bg-secondary-700 light:bg-secondary-200 rounded",style:Gt({width:65+A*5+"%"})},null,4)),64))])]))])]))]))}},Bg=Ks($I,[["__scopeId","data-v-67e9e612"]]),XI={class:"min-h-full flex flex-col lg:flex-row"},jI={class:"relative lg:w-1/2 lg:h-screen overflow-hidden flex-shrink-0"},YI=["src","alt"],qI={class:"absolute bottom-0 left-0 right-0 p-5 sm:p-8 lg:hidden bg-gradient-to-t from-dark-900/90 via-dark-900/50 to-transparent"},KI={class:"text-xl sm:text-3xl font-bold text-white mb-2"},ZI={class:"flex flex-wrap gap-2"},JI={class:"flex-1 p-5 sm:p-8 lg:p-12 lg:overflow-y-auto"},QI={class:"hidden lg:block text-4xl font-bold text-white light:text-secondary-900 mb-4"},eN={class:"hidden lg:flex flex-wrap gap-2 mb-6"},tN={class:"mb-8"},nN={class:"text-secondary-300 light:text-secondary-600 leading-relaxed text-lg"},iN={class:"mb-8"},rN={class:"space-y-3"},sN={class:"flex flex-wrap gap-4"},oN=["href"],aN={key:0,class:"fixed inset-0 z-[10001] bg-dark-900/95 light:bg-secondary-900/95 backdrop-blur-sm flex flex-col"},lN={class:"flex items-center justify-between px-4 py-3 bg-secondary-800 light:bg-white border-b border-secondary-700 light:border-secondary-200 flex-shrink-0"},cN={__name:"ProjectDetailModal",props:{project:{type:Object,required:!0},originRect:{type:Object,default:null}},emits:["close"],setup(n,{emit:e}){const t=n,i=e,r=Xt(()=>{const y=t.project.title.toLowerCase();return y.includes("redemption")||y.includes("merchant")}),s=we(!1),o=["Responsive design that works across all devices","Optimized performance with lazy loading and code splitting","Clean, maintainable code following best practices","Accessible UI with semantic HTML and ARIA labels"],a=we(null),l=we(null),c=we(null),u=we(null),d=we(null),f=we(!1);let h=null;const m=async()=>{if(await Lr(),!a.value||!l.value)return;const y=a.value,v=l.value,b=c.value,C=t.originRect||{left:0,top:0,width:0,height:0},R=window.innerWidth,E=window.innerHeight;$e.set(y,{opacity:0,pointerEvents:"none"}),$e.set(v,{position:"fixed",left:C.left,top:C.top,width:C.width,height:C.height,margin:0,borderRadius:"1rem",zIndex:9999,overflow:"hidden"}),$e.set(b,{opacity:0,y:30}),$e.to(y,{opacity:1,duration:.3,ease:"power2.out",pointerEvents:"auto"}),h=$e.timeline({defaults:{ease:"power3.inOut"}}),h.to(v,{left:0,top:0,width:R,height:E,borderRadius:0,duration:.7}).to(b,{opacity:1,y:0,duration:.5,ease:"power2.out"},"-=0.3").from(d.value,{opacity:0,scale:.8,duration:.3,ease:"back.out(1.7)"},"-=0.2")},x=()=>{if(f.value)return;f.value=!0;const y=a.value,v=l.value,b=c.value,C=t.originRect||{left:0,top:0,width:0,height:0};h&&h.kill(),$e.timeline({defaults:{ease:"power3.inOut"},onComplete:()=>{i("close")}}).to(b,{opacity:0,y:-30,duration:.3,ease:"power2.in"}).to(v,{left:C.left,top:C.top,width:C.width,height:C.height,borderRadius:"1rem",duration:.6},"-=0.1").to(y,{opacity:0,duration:.3,ease:"power2.in"},"-=0.3")},p=y=>{y.key==="Escape"&&x()},g=y=>{y.stopPropagation()};return li(s,y=>{var v;y?Lr(()=>{var b;(b=u.value)==null||b.addEventListener("wheel",g,{passive:!1})}):(v=u.value)==null||v.removeEventListener("wheel",g)}),yn(()=>{var v;m(),document.body.style.overflow="hidden";const y=Va();y&&y.stop(),(v=c.value)==null||v.addEventListener("wheel",g,{passive:!1}),window.addEventListener("keydown",p)}),Cn(()=>{var v,b;document.body.style.overflow="";const y=Va();y&&y.start(),(v=c.value)==null||v.removeEventListener("wheel",g),(b=u.value)==null||b.removeEventListener("wheel",g),window.removeEventListener("keydown",p),h&&h.kill()}),(y,v)=>(Y(),Q("div",{ref_key:"overlayRef",ref:a,class:"fixed inset-0 z-[9998] bg-dark-900/90 light:bg-secondary-900/90 backdrop-blur-sm",onClick:Ds(x,["self"])},[_("div",{ref_key:"cardRef",ref:l,class:"bg-secondary-800 light:bg-white shadow-2xl"},[_("button",{ref_key:"closeBtnRef",ref:d,onClick:x,class:"fixed top-4 right-4 z-[10000] w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-dark-900/80 light:bg-white/90 border border-secondary-700 light:border-secondary-200 flex items-center justify-center text-secondary-300 light:text-secondary-600 hover:text-primary-400 light:hover:text-primary-600 hover:border-primary-500/50 transition-colors duration-200 shadow-lg backdrop-blur-sm","aria-label":"Close project details"},[...v[2]||(v[2]=[_("svg",{class:"w-5 h-5 sm:w-6 sm:h-6",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24"},[_("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"2",d:"M6 18L18 6M6 6l12 12"})],-1)])],512),_("div",{ref_key:"contentRef",ref:c,class:"h-full w-full overflow-y-auto overscroll-contain"},[_("div",XI,[_("div",jI,[_("img",{src:n.project.image,alt:n.project.title,class:"w-full h-[60vh] sm:h-[55vh] lg:hidden object-cover"},null,8,YI),et(Bg,{project:n.project,class:"hidden lg:block w-full h-full"},null,8,["project"]),_("div",qI,[_("h2",KI,pe(n.project.title),1),_("div",ZI,[(Y(!0),Q(We,null,it(n.project.tech,b=>(Y(),Q("span",{key:b,class:"text-xs text-primary-300 bg-primary-500/20 px-3 py-1 rounded-full backdrop-blur-sm"},pe(b),1))),128))])])]),_("div",JI,[_("h2",QI,pe(n.project.title),1),_("div",eN,[(Y(!0),Q(We,null,it(n.project.tech,b=>(Y(),Q("span",{key:b,class:"text-sm text-primary-400 bg-primary-500/10 px-3 py-1 rounded-full"},pe(b),1))),128))]),_("div",tN,[v[3]||(v[3]=_("h3",{class:"text-lg font-semibold text-primary-400 light:text-primary-600 mb-3 uppercase tracking-wider"}," About This Project ",-1)),_("p",nN,pe(n.project.description),1)]),_("div",iN,[v[5]||(v[5]=_("h3",{class:"text-lg font-semibold text-primary-400 light:text-primary-600 mb-3 uppercase tracking-wider"}," Key Features ",-1)),_("ul",rN,[(Y(!0),Q(We,null,it(n.project.features||o,(b,C)=>(Y(),Q("li",{key:C,class:"flex items-start gap-3 text-secondary-300 light:text-secondary-600"},[v[4]||(v[4]=_("svg",{class:"w-5 h-5 text-primary-500 mt-0.5 flex-shrink-0",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24"},[_("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"2",d:"M5 13l4 4L19 7"})],-1)),_("span",null,pe(b),1)]))),128))])]),_("div",sN,[_("a",{href:n.project.github,target:"_blank",rel:"noopener noreferrer",class:"inline-flex items-center gap-2 px-6 py-3 rounded-lg bg-secondary-700 light:bg-secondary-100 text-white light:text-secondary-900 font-medium hover:bg-primary-600 light:hover:bg-primary-600 light:hover:text-white transition-colors duration-300"},[...v[6]||(v[6]=[_("svg",{class:"w-5 h-5",fill:"currentColor",viewBox:"0 0 24 24"},[_("path",{"fill-rule":"evenodd",d:"M12 2C6.477 2 2 6.484 2 12.017c0 4.425 2.865 8.18 6.839 9.504.5.092.682-.217.682-.483 0-.237-.008-.868-.013-1.703-2.782.605-3.369-1.343-3.369-1.343-.454-1.158-1.11-1.466-1.11-1.466-.908-.62.069-.608.069-.608 1.003.07 1.531 1.032 1.531 1.032.892 1.53 2.341 1.088 2.91.832.092-.647.35-1.088.636-1.338-2.22-.253-4.555-1.113-4.555-4.951 0-1.093.39-1.988 1.029-2.688-.103-.253-.446-1.272.098-2.65 0 0 .84-.27 2.75 1.026A9.564 9.564 0 0112 6.844c.85.004 1.705.115 2.504.337 1.909-1.296 2.747-1.027 2.747-1.027.546 1.379.202 2.398.1 2.651.64.7 1.028 1.595 1.028 2.688 0 3.848-2.339 4.695-4.566 4.943.359.309.678.92.678 1.855 0 1.338-.012 2.419-.012 2.747 0 .268.18.58.688.482A10.019 10.019 0 0022 12.017C22 6.484 17.522 2 12 2z","clip-rule":"evenodd"})],-1),Ii(" View Code ",-1)])],8,oN),_("button",{onClick:v[0]||(v[0]=b=>s.value=!0),class:"lg:hidden inline-flex items-center gap-2 px-6 py-3 rounded-lg bg-primary-600 text-white font-medium hover:bg-primary-500 transition-colors duration-300 shadow-lg shadow-primary-500/25 cursor-pointer"},[...v[7]||(v[7]=[_("svg",{class:"w-5 h-5",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24"},[_("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"2",d:"M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"})],-1),Ii(" Live Demo ",-1)])])])])])],512)],512),et(Na,{name:"demo-fade"},{default:Uo(()=>[s.value?(Y(),Q("div",aN,[_("div",lN,[v[9]||(v[9]=_("div",{class:"flex items-center gap-2"},[_("svg",{class:"w-4 h-4 text-primary-500",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24"},[_("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"2",d:"M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"})]),_("span",{class:"text-sm font-semibold text-white light:text-secondary-900"},"Live Demo")],-1)),_("button",{onClick:v[1]||(v[1]=b=>s.value=!1),class:"w-9 h-9 rounded-full bg-secondary-700/50 light:bg-secondary-100 flex items-center justify-center text-secondary-300 light:text-secondary-600 hover:text-white light:hover:text-secondary-900 transition-colors cursor-pointer","aria-label":"Close live demo"},[...v[8]||(v[8]=[_("svg",{class:"w-4 h-4",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24"},[_("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"2",d:"M6 18L18 6M6 6l12 12"})],-1)])])]),_("div",{ref_key:"demoContentRef",ref:u,class:"flex-1 min-h-0 overflow-y-auto overscroll-contain"},[r.value?(Y(),Yn(my,{key:0,class:"w-full h-full"})):(Y(),Yn(Bg,{key:1,project:n.project,class:"w-full h-full"},null,8,["project"]))],512)])):qt("",!0)]),_:1})],512))}},uN=Ks(cN,[["__scopeId","data-v-b2fb25b3"]]),dN={class:"h-1 bg-secondary-800/50 light:bg-secondary-300 backdrop-blur-sm"},fN={class:"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"},hN={class:"flex flex-wrap gap-3"},pN=["onClick"],mN={key:0,class:"ml-auto flex items-center gap-1 p-1 rounded-lg bg-secondary-800 border border-secondary-700 light:bg-secondary-100 light:border-secondary-200"},gN={class:"grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6"},_N={__name:"ProjectsSection",setup(n){$e.registerPlugin(ct);const e=we("All"),t=we("carousel"),i=we(!1),r=we(0),s=we(0),o=we(!1),a=we(null),l=we(null),c=we(null),u=we(null),d=we(null),f=we(null),h=we(null),m=we(null),x=we(null),p=we(null);let g=[],y=null,v=null,b=null,C=null;const R=Xt(()=>{const j=Of.flatMap(F=>F.tech);return["All",...new Set(j)]}),E=Xt(()=>e.value==="All"?Of:Of.filter(j=>j.tech.includes(e.value))),S=j=>{e.value=j},T=({project:j,originRect:F})=>{x.value=j,p.value=F},U=()=>{x.value=null,p.value=null};li(E,async()=>{await Lr(),G(),t.value==="horizontal"&&k()});const I=j=>{i.value||(t.value=j,j==="horizontal"?Lr(()=>k()):Z())},L=j=>{i.value=j.matches,j.matches&&(t.value="grid",Z())},G=()=>{if(!d.value)return;const j=d.value.getBoundingClientRect(),F=window.innerHeight,ue=j.height-F,ge=Math.min(Math.max(-j.top,0),ue);r.value=ue>0?ge/ue*100:100},B=()=>{v&&window.removeEventListener("scroll",v,{passive:!0}),v=()=>G(),window.addEventListener("scroll",v,{passive:!0}),G()},V=()=>{if(!f.value)return;const j=f.value.getBoundingClientRect(),F=window.innerHeight,ge=j.height-F;if(o.value=j.top<F&&j.bottom>0,ge>0){const _e=Math.min(Math.max(-j.top,0),ge);s.value=_e/ge*100}else s.value=o.value?100:0},$=()=>{b&&window.removeEventListener("scroll",b,{passive:!0}),b=()=>V(),window.addEventListener("scroll",b,{passive:!0}),V()},k=()=>{if(Z(),!h.value||!m.value||!u.value)return;const j=m.value,F=u.value,ge=j.scrollWidth-window.innerWidth;ge<=0||(C=$e.to(j,{x:-ge,ease:"none",scrollTrigger:{trigger:F,start:"top top",end:()=>`+=${ge}`,pin:!0,pinSpacing:!0,scrub:!0,anticipatePin:1,invalidateOnRefresh:!0,preventOverlaps:!0,fastScrollEnd:!0}}))},Z=()=>{var j;C&&((j=C.scrollTrigger)==null||j.kill(),C.kill(),C=null)};return yn(()=>{y=window.matchMedia("(max-width: 768px)"),i.value=y.matches,i.value&&(t.value="grid"),y.addEventListener("change",L),g.push(...h0(a.value,{x:-120,start:"top 85%"})),g.push(...f0(u.value,{y:60,duration:1.2,start:"top 80%",blur:14})),B(),$()}),Cn(()=>{g.forEach(j=>j.kill()),Z(),y&&y.removeEventListener("change",L),v&&window.removeEventListener("scroll",v,{passive:!0}),b&&window.removeEventListener("scroll",b,{passive:!0})}),(j,F)=>(Y(),Q("section",{ref_key:"sectionRef",ref:f,id:"projects",class:rt(["pt-20 pb-0 bg-dark-800 light:bg-white relative",t.value==="horizontal"?"overflow-visible":"overflow-hidden"])},[F[5]||(F[5]=_("div",{class:"absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-primary-500/50 to-transparent"},null,-1)),o.value?(Y(),Q("div",{key:0,class:rt(["fixed top-16 left-0 right-0 z-40 transition-opacity duration-300",s.value>=100?"opacity-0 pointer-events-none":"opacity-100"])},[_("div",dN,[_("div",{class:"h-full bg-gradient-to-r from-primary-500 to-accent-500 light:from-primary-500 light:to-accent-500 transition-all duration-150 ease-out",style:Gt({width:s.value+"%"})},null,4)])],2)):qt("",!0),_("div",fN,[_("h2",{ref_key:"titleRef",ref:a,class:"section-title"},"Featured Projects",512),_("p",{ref_key:"subtitleRef",ref:l,class:"section-subtitle"},"A selection of projects I've built",512),_("div",{ref_key:"filterRef",ref:c,class:"flex flex-wrap items-center gap-3 mb-10"},[_("div",hN,[(Y(!0),Q(We,null,it(R.value,ue=>(Y(),Q("button",{key:ue,onClick:ge=>S(ue),class:rt(["px-4 py-2 rounded-lg text-sm font-medium transition-all duration-300 hover:scale-105",e.value===ue?"bg-primary-600 text-white shadow-lg shadow-primary-500/25":"bg-secondary-800 text-secondary-400 hover:text-white border border-secondary-700 light:bg-white light:text-secondary-500 light:hover:text-primary-500 light:border-secondary-200 light:hover:border-primary-500"])},pe(ue),11,pN))),128))]),i.value?qt("",!0):(Y(),Q("div",mN,[_("button",{onClick:F[0]||(F[0]=ue=>I("grid")),class:rt(["px-3 py-1.5 rounded-md text-sm font-medium transition-all duration-300",t.value==="grid"?"bg-primary-600 text-white shadow-md shadow-primary-500/25":"text-secondary-400 hover:text-white light:text-secondary-500 light:hover:text-secondary-900"]),"aria-label":"Grid view"},[...F[2]||(F[2]=[_("svg",{class:"w-4 h-4",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24"},[_("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"2",d:"M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z"})],-1)])],2),_("button",{onClick:F[1]||(F[1]=ue=>I("carousel")),class:rt(["px-3 py-1.5 rounded-md text-sm font-medium transition-all duration-300",t.value==="carousel"?"bg-primary-600 text-white shadow-md shadow-primary-500/25":"text-secondary-400 hover:text-white light:text-secondary-500 light:hover:text-secondary-900"]),"aria-label":"Carousel view"},[...F[3]||(F[3]=[_("svg",{class:"w-4 h-4",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24"},[_("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"2",d:"M4 6h16M4 12h16M4 18h16"})],-1)])],2)]))],512)]),_("div",{ref_key:"wheelContainerRef",ref:u,class:"w-full"},[t.value==="grid"?(Y(),Q("div",{key:0,ref_key:"gridContainerRef",ref:d,class:"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-20"},[_("div",gN,[(Y(!0),Q(We,null,it(E.value,ue=>(Y(),Yn(Ug,{key:ue.id,project:ue,onOpen:T},null,8,["project"]))),128))]),F[4]||(F[4]=_("div",{class:"mt-10 flex justify-center"},[_("div",{class:"w-64 sm:w-80"})],-1))],512)):t.value==="carousel"?(Y(),Yn(KR,{key:1,projects:E.value,onOpen:T},null,8,["projects"])):t.value==="horizontal"?(Y(),Q("div",{key:2,ref_key:"horizontalContainerRef",ref:h,class:"relative h-screen overflow-hidden"},[_("div",{ref_key:"horizontalTrackRef",ref:m,class:"flex items-center gap-8 px-8 sm:px-12 lg:px-16 h-full w-max"},[(Y(!0),Q(We,null,it(E.value,ue=>(Y(),Q("div",{key:ue.id,class:"w-[320px] sm:w-[380px] lg:w-[420px] shrink-0"},[et(Ug,{project:ue,onOpen:T},null,8,["project"])]))),128))],512)],512)):qt("",!0)],512),x.value?(Y(),Yn(uN,{key:1,project:x.value,"origin-rect":p.value,onClose:U},null,8,["project","origin-rect"])):qt("",!0)],2))}},xN={id:"contact",class:"py-20 bg-dark-800 light:bg-white relative overflow-hidden"},vN={class:"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"},yN={class:"text-center mb-16"},bN={class:"text-center"},SN={class:"flex items-center justify-center gap-4"},wN=["href","aria-label"],MN={class:"w-6 h-6",fill:"currentColor",viewBox:"0 0 24 24"},EN=["d"],TN={__name:"ContactSection",setup(n){const e=we(null),t=we(null),i=we(null);let r=[];const s=[{name:"GitHub",href:"https://github.com/pixel-user-512",icon:"M12 2C6.477 2 2 6.484 2 12.017c0 4.425 2.865 8.18 6.839 9.504.5.092.682-.217.682-.483 0-.237-.008-.868-.013-1.703-2.782.605-3.369-1.343-3.369-1.343-.454-1.158-1.11-1.466-1.11-1.466-.908-.62.069-.608.069-.608 1.003.07 1.531 1.032 1.531 1.032.892 1.53 2.341 1.088 2.91.832.092-.647.35-1.088.636-1.338-2.22-.253-4.555-1.113-4.555-4.951 0-1.093.39-1.988 1.029-2.688-.103-.253-.446-1.272.098-2.65 0 0 .84-.27 2.75 1.026A9.564 9.564 0 0112 6.844c.85.004 1.705.115 2.504.337 1.909-1.296 2.747-1.027 2.747-1.027.546 1.379.202 2.398.1 2.651.64.7 1.028 1.595 1.028 2.688 0 3.848-2.339 4.695-4.566 4.943.359.309.678.92.678 1.855 0 1.338-.012 2.419-.012 2.747 0 .268.18.58.688.482A10.019 10.019 0 0022 12.017C22 6.484 17.522 2 12 2z"},{name:"LinkedIn",href:"https://linkedin.com/in/kenneth-paul-cortez",icon:"M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.225 0z"}];return yn(()=>{r.push(...h0(t.value,{x:-120,start:"top 85%"})),r.push(...f0(e.value,{y:60,duration:1.2,stagger:.15,start:"top 80%",blur:14}))}),Cn(()=>{r.forEach(o=>o.kill())}),(o,a)=>(Y(),Q("section",xN,[a[2]||(a[2]=_("div",{class:"absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-primary-500/50 to-transparent"},null,-1)),_("div",vN,[_("div",yN,[_("h2",{ref_key:"titleRef",ref:t,class:"section-title"},"Get In Touch",512),_("p",{ref_key:"subtitleRef",ref:i,class:"section-subtitle"},"Have a project in mind? Let's work together!",512)]),_("div",{ref_key:"infoRef",ref:e,class:"max-w-3xl mx-auto"},[a[1]||(a[1]=Rs('<div class="text-center mb-12"><p class="text-secondary-400 light:text-secondary-500 text-lg leading-relaxed"> I&#39;m always open to discussing new projects, creative ideas, or opportunities to be part of your vision. Feel free to reach out! </p></div><div class="grid sm:grid-cols-2 gap-4 mb-12"><a href="mailto:kenneth.cortez.512@gmail.com" class="group flex items-center gap-4 bg-secondary-800/50 border border-secondary-700 rounded-2xl p-5 hover:border-primary-500/50 hover:bg-secondary-800/80 transition-all duration-300 light:bg-white light:border-secondary-200 light:hover:border-primary-500/50"><span class="w-12 h-12 flex items-center justify-center bg-secondary-800 border border-secondary-700 rounded-xl group-hover:border-primary-500/50 group-hover:scale-110 transition-all duration-300 light:bg-secondary-50 light:border-secondary-200 shrink-0"><svg class="w-6 h-6 text-primary-400 light:text-primary-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path></svg></span><span class="min-w-0"><span class="block text-xs text-secondary-500 light:text-secondary-400 uppercase tracking-wider mb-1">Email</span><span class="block text-secondary-200 light:text-secondary-700 font-medium truncate">kenneth.cortez.512@gmail.com</span></span></a><a href="tel:+639664002142" class="group flex items-center gap-4 bg-secondary-800/50 border border-secondary-700 rounded-2xl p-5 hover:border-primary-500/50 hover:bg-secondary-800/80 transition-all duration-300 light:bg-white light:border-secondary-200 light:hover:border-primary-500/50"><span class="w-12 h-12 flex items-center justify-center bg-secondary-800 border border-secondary-700 rounded-xl group-hover:border-primary-500/50 group-hover:scale-110 transition-all duration-300 light:bg-secondary-50 light:border-secondary-200 shrink-0"><svg class="w-6 h-6 text-primary-400 light:text-primary-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path></svg></span><span class="min-w-0"><span class="block text-xs text-secondary-500 light:text-secondary-400 uppercase tracking-wider mb-1">Phone</span><span class="block text-secondary-200 light:text-secondary-700 font-medium">+63 (966) 400-2142</span></span></a></div>',2)),_("div",bN,[a[0]||(a[0]=_("h4",{class:"text-white light:text-secondary-900 text-sm font-semibold uppercase tracking-wider mb-5"},"Follow Me",-1)),_("div",SN,[(Y(),Q(We,null,it(s,l=>_("a",{key:l.name,href:l.href,target:"_blank",rel:"noopener noreferrer",class:"w-12 h-12 flex items-center justify-center bg-secondary-800 border border-secondary-700 rounded-xl text-secondary-400 hover:text-primary-400 hover:border-primary-500/50 hover:scale-110 transition-all duration-300 light:bg-white light:border-secondary-200 light:text-secondary-500 light:hover:text-primary-600","aria-label":l.name},[(Y(),Q("svg",MN,[_("path",{d:l.icon},null,8,EN)]))],8,wN)),64))])])],512)])]))}},AN={class:"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"},CN={class:"flex flex-col md:flex-row items-center justify-between gap-4"},RN={class:"text-secondary-400 light:text-secondary-500 text-sm"},PN={class:"flex items-center gap-6"},DN={__name:"Footer",setup(n){const e=new Date().getFullYear(),t=we(null);let i=[];const r=()=>{const s=Va();s?s.scrollTo(0):window.scrollTo({top:0,behavior:"smooth"})};return yn(()=>{i=f0(t.value,{y:30,duration:1,start:"top bottom",blur:8})}),Cn(()=>{i.forEach(s=>s.kill())}),(s,o)=>(Y(),Q("footer",{ref_key:"footerRef",ref:t,class:"bg-dark-800 border-t border-dark-700 light:bg-white light:border-secondary-200 py-8"},[_("div",AN,[_("div",CN,[_("div",RN," © "+pe(Xe(e))+" Kenneth Paul Cortez ",1),_("div",PN,[_("a",{href:"#home",onClick:Ds(r,["prevent"]),class:"text-secondary-400 hover:text-primary-400 light:text-secondary-500 light:hover:text-primary-600 transition-colors duration-200 text-sm"}," Home "),o[0]||(o[0]=_("a",{href:"#about",class:"text-secondary-400 hover:text-primary-400 light:text-secondary-500 light:hover:text-primary-600 transition-colors duration-200 text-sm"}," About ",-1)),o[1]||(o[1]=_("a",{href:"#projects",class:"text-secondary-400 hover:text-primary-400 light:text-secondary-500 light:hover:text-primary-600 transition-colors duration-200 text-sm"}," Projects ",-1)),o[2]||(o[2]=_("a",{href:"#contact",class:"text-secondary-400 hover:text-primary-400 light:text-secondary-500 light:hover:text-primary-600 transition-colors duration-200 text-sm"}," Contact ",-1))]),o[3]||(o[3]=_("div",{class:"text-secondary-500 light:text-secondary-400 text-sm"},[Ii(" Built with "),_("span",{class:"text-primary-500"},"Vue 3"),Ii(" & "),_("span",{class:"text-primary-500"},"Tailwind CSS")],-1))])])],512))}},LN={__name:"BackToTop",setup(n){const e=we(!1),t=()=>{e.value=window.scrollY>400},i=()=>{const r=Va();r?r.scrollTo(0):window.scrollTo({top:0,behavior:"smooth"})};return yn(()=>{window.addEventListener("scroll",t)}),Cn(()=>{window.removeEventListener("scroll",t)}),(r,s)=>(Y(),Yn(Na,{"enter-active-class":"transition-all duration-300 ease-out","enter-from-class":"opacity-0 translate-y-4","enter-to-class":"opacity-100 translate-y-0","leave-active-class":"transition-all duration-300 ease-in","leave-from-class":"opacity-100 translate-y-0","leave-to-class":"opacity-0 translate-y-4"},{default:Uo(()=>[e.value?(Y(),Q("button",{key:0,onClick:i,class:"fixed bottom-6 right-6 z-50 w-12 h-12 flex items-center justify-center bg-primary-500 hover:bg-primary-600 text-white rounded-xl shadow-lg shadow-primary-500/25 hover:scale-110 transition-all duration-300","aria-label":"Back to top"},[...s[0]||(s[0]=[_("svg",{class:"w-6 h-6",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24"},[_("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"2",d:"M5 15l7-7 7 7"})],-1)])])):qt("",!0)]),_:1}))}},IN={__name:"MouseTrail",setup(n){const{isMouseTrailEnabled:e}=vv();let t=null;const i=()=>{t||(t=hR({size:45,trailLength:400,trailWidth:16}))},r=()=>{t&&(t(),t=null)};return yn(()=>{e.value&&i()}),Cn(()=>{r()}),li(e,s=>{s?i():r()}),(s,o)=>null}},NN={__name:"IntroLoader",setup(n){const e=we(!0),t=we(null);return yn(()=>{document.body.style.overflow="hidden";const i=getComputedStyle(document.documentElement).getPropertyValue("--color-primary-500").trim();t.value.style.backgroundColor=`rgb(${i})`;const r={size:3};t.value.style.setProperty("--hole-size",`${r.size}%`),$e.delayedCall(.5,()=>{$e.to(r,{size:100,duration:.6,ease:"power2.inOut",onUpdate:()=>{t.value.style.setProperty("--hole-size",`${r.size}%`)},onComplete:()=>{e.value=!1,document.body.style.overflow=""}})})}),Cn(()=>{document.body.style.overflow=""}),(i,r)=>e.value?(Y(),Q("div",{key:0,ref_key:"overlayRef",ref:t,class:"intro-overlay"},null,512)):qt("",!0)}},UN=Ks(NN,[["__scopeId","data-v-151ea3fb"]]),FN={class:"min-h-screen bg-dark-900 light:bg-secondary-50"},ON={__name:"App",setup(n){return Qw(),(e,t)=>(Y(),Q("div",FN,[et(FM),_("main",null,[et(eR),et(uR),et(RR),et(_N),et(TN)]),et(DN),et(LN),et(IN),et(UN)]))}};qb(ON).mount("#app");
